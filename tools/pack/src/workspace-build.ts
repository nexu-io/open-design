...
const BUILD_COMMANDS = [
  { args: ["--filter", "@marketing-ax/components", "build"] },
  { args: ["--filter", "@marketing-ax/contracts", "build"] },
  { args: ["--filter", "@marketing-ax/registry-protocol", "build"] },
  { args: ["--filter", "@marketing-ax/sidecar-proto", "build"] },
  { args: ["--filter", "@marketing-ax/launcher-proto", "build"] },
  { args: ["--filter", "@marketing-ax/sidecar", "build"] },
  { args: ["--filter", "@marketing-ax/platform", "build"] },
  { args: ["--filter", "@marketing-ax/download", "build"] },
  { args: ["--filter", "@marketing-ax/host", "build"] },
  { args: ["--filter", "@marketing-ax/agui-adapter", "build"] },
