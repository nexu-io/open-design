...
LangString MAX_REMOVE_LOCAL_DATA_TITLE 1033 "Remove local data"
LangString MAX_REMOVE_LOCAL_DATA_TITLE 2052 "删除本地数据"
LangString MAX_REMOVE_LOCAL_DATA_TITLE 1028 "刪除本機資料"
LangString MAX_REMOVE_LOCAL_DATA_TITLE 1046 "Remover dados locais"
...
LangString MAX_REMOVE_LOCAL_DATA_HINT 1033 "Choose whether the uninstaller should remove M-AX data stored on this computer."
LangString MAX_REMOVE_LOCAL_DATA_HINT 2052 "请选择卸载程序是否删除此电脑上保存的 M-AX 数据。"
LangString MAX_REMOVE_LOCAL_DATA_HINT 1028 "請選擇解除安裝程式是否刪除此電腦上儲存的 M-AX 資料。"
LangString MAX_REMOVE_LOCAL_DATA_HINT 1046 "Escolha se o desinstalador deve remover os dados do M-AX armazenados neste computador."
LangString MAX_REMOVE_LOCAL_DATA_HINT 1049 "Выберите, должен ли деинсталлятор удалить данные M-AX, сохраненные на этом компьютере."
LangString MAX_REMOVE_LOCAL_DATA_HINT 1065 "انتخاب کنید که حذف‌کننده داده‌های M-AX ذخیره‌شده در این رایانه را حذف کند یا نه."

LangString MAX_REMOVE_LOCAL_DATA_CHECKBOX 1033 "Remove local M-AX data:"
LangString MAX_REMOVE_LOCAL_DATA_CHECKBOX 2052 "删除本地 M-AX 数据："
LangString MAX_REMOVE_LOCAL_DATA_CHECKBOX 1028 "刪除本機 M-AX 資料："
LangString MAX_REMOVE_LOCAL_DATA_CHECKBOX 1046 "Remover dados locais do M-AX:"
LangString MAX_REMOVE_LOCAL_DATA_CHECKBOX 1049 "Удалить локальные данные M-AX:"
LangString MAX_REMOVE_LOCAL_DATA_CHECKBOX 1065 "حذف داده‌های محلی M-AX:"
...
Function un.OpenDesignLocalDataPage
  ...
  \${NSD_CreateLabel} 0 0 100% 24u "$(MAX_REMOVE_LOCAL_DATA_HINT)"
  Pop $0
  \${NSD_CreateCheckbox} 0 34u 100% 36u "$(MAX_REMOVE_LOCAL_DATA_CHECKBOX) $odLocalDataRoot"
...
!macro customUnInstall
  ...
  \${If} $odRemoveLocalData != "0"
    DetailPrint "Removing local M-AX data: $odLocalDataRoot"
