...
async function fixture(script = 'node -e "console.log(\'executed contract test\')"') {
  ...
  const ids = [...EXACT_DATA_PLAN_NODE_IDS, "electron.contract.build", "electron.contract.test", "electron.platform.build", "electron.capsule.build", "electron.shell.build", "electron.shell.test",
