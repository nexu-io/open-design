 ...
 * was leaving the daemon ungated because `MAX_REQUIRE_DESKTOP_AUTH=1`
...
import { APP_KEYS, type DaemonStatusSnapshot, type WebStatusSnapshot } from "@marketing-ax/sidecar-proto";
