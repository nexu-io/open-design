...
The **Design system** dropdown ships with 71 bundled product systems and 57 design skills sourced from [`awesome-design-skills`](https://github.com/bergside/awesome-design-skills), plus 2 hand-authored starters (Neutral Modern, Warm Editorial). Pick one to skin every prototype in that brand's aesthetic.
