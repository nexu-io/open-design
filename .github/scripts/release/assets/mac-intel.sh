...
source_dmg="$RUNNER_TEMP/tools-pack/out/mac/namespaces/$TOOLS_PACK_NAMESPACE/dmg/Marketing AX-$TOOLS_PACK_NAMESPACE.dmg"
source_zip="$RUNNER_TEMP/tools-pack/out/mac/namespaces/$TOOLS_PACK_NAMESPACE/zip/Marketing AX-$TOOLS_PACK_NAMESPACE.zip"
...
versioned_dmg="marketing-ax-${RELEASE_VERSION}${asset_suffix}-mac-x64.dmg"
versioned_zip="marketing-ax-${RELEASE_VERSION}${asset_suffix}-mac-x64.zip"
