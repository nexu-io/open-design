...
_MATERIAL_SPECS = {
    "mtl_body": {"base_color": (0.55, 0.5, 0.45, 1), "roughness": 0.9, "metallic": 0},
    "mtl_face": {"base_color": (0.3, 0.6, 0.35, 1), "roughness": 0.85, "metallic": 0},
}

_part("prp_head", "box", (0.375, 0.375, 0.375), (0, 0, 1.1875), "z", False, "mtl_face")
_part("prp_leg_l", "box", (0.125, 0.125, 0.375), (-0.125, 0, 0.1875), "z", False, "mtl_body")
_part("prp_leg_r", "box", (0.125, 0.125, 0.375), (0.125, 0, 0.1875), "z", False, "mtl_body")
_part("prp_torso", "box", (0.5, 0.25, 0.75), (0, 0, 0.6875), "z", False, "mtl_body")

# Hero camera framed from the solved bounds — derived, not guessed.
bpy.ops.object.camera_add(location=(1.479865, -1.479865, 1.895805))
...
bpy.ops.object.light_add(type="AREA", location=(1.887976, -1.887976, 2.575476))
key = bpy.context.object
key.name = "lgt_key"
key.data.energy = 3020.761493
key.data.size = 1.510381
