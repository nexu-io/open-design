...
_MATERIAL_SPECS = {
    "mtl_lamp": {"base_color": (1, 0.92, 0.75, 1), "roughness": 0.4, "metallic": 0, "emission": (1, 0.85, 0.6, 1), "emission_strength": 4},
    "mtl_stone": {"base_color": (0.62, 0.6, 0.55, 1), "roughness": 0.9, "metallic": 0},
    "mtl_wood": {"base_color": (0.45, 0.3, 0.18, 1), "roughness": 0.65, "metallic": 0},
}

_part("prp_column", "cylinder", (0.12, 0.12, 1.4), (-0.99, -0.59, 0.819), "z", False, "mtl_stone")
_part("prp_column_2", "cylinder", (0.12, 0.12, 1.4), (0.99, -0.59, 0.819), "z", False, "mtl_stone")
_part("prp_column_3", "cylinder", (0.12, 0.12, 1.4), (-0.99, 0.59, 0.819), "z", False, "mtl_stone")
_part("prp_column_4", "cylinder", (0.12, 0.12, 1.4), (0.99, 0.59, 0.819), "z", False, "mtl_stone")
_part("prp_finial", "cone", (0.14, 0.14, 0.2), (0.88, 0.48, 1.7), "z", False, "mtl_wood")
_part("prp_lamp", "sphere", (0.16, 0.16, 0.16), (0, 0, 1.68), "z", False, "mtl_lamp")
_part("prp_plinth", "box", (2.4, 1.6, 0.12), (0, 0, 0.06), "z", False, "mtl_stone")
_part("prp_ring", "torus", (0.5, 0.5, 0.08), (0, 0, 0.159), "z", False, "mtl_wood")
_part("prp_roof", "box", (2.3, 1.5, 0.08), (0, 0, 1.561), "z", False, "mtl_wood")

# Hero camera framed from the solved bounds — derived, not guessed.
bpy.ops.object.camera_add(location=(3.331306, -3.331306, 3.62))
...
bpy.ops.object.light_add(type="AREA", location=(4.25, -4.25, 5.15))
