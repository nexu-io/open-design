...
- `packages/electron-capsule`: updatable loading/startup presentation implementation. Shell supplies product policy and media; the carrier grants presentation permission. Never depend on Shell source or introduce another lifecycle authority.
