...
- `packages/electron-capsule`: updatable loading and startup/session orchestration. Shell supplies product policy and media; the carrier grants presentation permission and owns startup protection. Never depend on Shell source or introduce another lifecycle authority.
