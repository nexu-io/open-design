...
const responses = [
  { path: '/workspace/project' } satisfies NativeFolderDialogSelectedResponse,
  { path: null } satisfies NativeFolderDialogCancelledResponse,
  {
...
] satisfies NativeFolderDialogResponse[];
