...
export type AnalyticsEventPayload =
  ...
  | { event: 'agent_context_compaction_started'; props: AgentContextCompactionStartedProps }
  | { event: 'agent_context_compaction_completed'; props: AgentContextCompactionCompletedProps }
  | { event: 'agent_context_compaction_failed'; props: AgentContextCompactionFailedProps }
  | { event: 'context_compaction_ui_result'; props: ContextCompactionUiResultProps }
