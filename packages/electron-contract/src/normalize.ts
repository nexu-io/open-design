 ...
 */
export function normalizeOpenDesignElectronProjectImportResult(input: unknown): OpenDesignElectronProjectImportResult {
  if (!isRecord(input)) {
 ...
 */
export function normalizeOpenDesignElectronProjectReplaceWorkingDirResult(
  input: unknown,
): OpenDesignElectronProjectReplaceWorkingDirResult {
  if (!isRecord(input)) {
 ...
 */
export function normalizeOpenDesignElectronPickWorkingDirResult(
  input: unknown,
): OpenDesignElectronPickWorkingDirResult {
  if (!isRecord(input)) {
