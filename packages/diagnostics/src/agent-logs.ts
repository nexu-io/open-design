...
export interface AgentCliLogOptions {
  ...
  homeDir: string;
  /** Marketing AX data dir (MAX_DATA_DIR); fallback location of the AMR OpenCode home. */
  dataDir?: string | null;
  /**
...
/**
 * Collect the native on-disk logs of the coding-agent CLIs Marketing AX drives:
