...
runtime/window owners. Carrier identity, activation recording and
the quit barrier precede Capsule execution. Node/native preparation belongs after
the local first-screen mount through the product definition's prepareNodeRuntime;
propagate startup cancellation and settle preparation before process teardown.
Do not recreate carrier ownership here or rely on
...
activation, advances the final fence and transfers quit ownership (protocol v6).
