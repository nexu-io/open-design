...
const residualAllowedPathPrefixes = [
  ...
  // Vendored upstream website-clone probe helpers (Jane-xiaoer/claude-skill-web-clone).
  // They are plugin assets staged into project cwd for direct Node execution.
