...
export const STANDALONE_CLOSURE_SOURCE_FILES = Object.freeze([
  ...
  "packages/closure/src/store/binding.ts",
  "packages/closure/src/store/distribution/index.ts",
  ...
  "shells/electron/src/launcher-policy.ts",
  ...
  "tools/pack/src/closure/index.ts",
