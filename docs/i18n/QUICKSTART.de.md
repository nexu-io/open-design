...
- **pnpm:** `11.15.x`. Das Repository pinnt `pnpm@11.15.0` über `packageManager`; verwenden Sie Corepack, damit automatisch die gepinnte Version gewählt wird.
...
```bash
corepack enable
corepack pnpm --version   # sollte 11.15.0 ausgeben
```
