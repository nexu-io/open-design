...
| **Core Team** | Time interno do Marketing AX. Possui acesso total de escrita ao repositório e é a autoridade final em decisões de governança. Composição mantida internamente. |
