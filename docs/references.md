...
- **What we don't:**
  - **Electron as the product runtime** — the product UI remains the shared Next.js web app; `shells/electron` composes the Electron host over the same daemon/web Closure resources.
