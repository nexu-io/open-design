...
1. Add Library Search transfer replay so a recent import history entry can reopen the same conflict mode and packet summary for repeatable studio setup.
