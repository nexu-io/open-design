...
1. Wire OneShot Cover Run into the CoverVisionOS handoff path for professional book-cover production.
2. Add a history/reuse surface so strong prompts, scorecards, and export packets can become reusable templates.
