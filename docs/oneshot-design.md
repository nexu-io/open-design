...
1. Add Library Search packet history so completed imports and exports leave a local audit trail with timestamp, counts, conflicts, and operator choices.
