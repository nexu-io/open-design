...
## Step 5: Open Marketing AX in Your Browser

Open:
- `http://localhost:7456/`

You should see the Marketing AX interface.

![Marketing AX home (desktop)](../screenshots/deployment/docker/01-open-design-home.png)
![Marketing AX home (mobile)](../screenshots/deployment/docker/03-open-design-mobile.png)
