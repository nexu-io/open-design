...
- **캐릭터 레퍼런스 이미지 = 캐릭터 정체성 유일 정본(캐논)** (표지·본문 모든 배경
  ...
  `design-systems/bodoc/assets/character-sheet.png` — 마스코트 "보닥이" 섹션형
  ...
  매트 질감·혀 노출 입·부속물 없음·바디 색 = 시트 COLOR PALETTE 첫 블루 스와치
  균일**(더 연한/시안 쏠림 변형 금지 — 도그푸딩-7 카드 02·04 색 드리프트 실측).
