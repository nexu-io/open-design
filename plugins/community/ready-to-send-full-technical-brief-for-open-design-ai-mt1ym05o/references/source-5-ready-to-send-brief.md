...
**Current data:** ~63 units across ~10 sections on the live published site.
...
2. **Database** — ~63 units across ~10 sections, data persists across redeployments on published site
