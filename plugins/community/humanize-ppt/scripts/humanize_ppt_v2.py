...
.outline{{display:grid;gap:6px;max-height:18vh;overflow:auto}}.outline button{{text-align:start;border:0;border-radius:8px;padding:8px 10px;background:transparent;color:var(--muted);cursor:pointer}}.outline button.active{{background:rgba(88,166,255,.14);color:var(--text)}}
