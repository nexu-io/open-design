...
Canonical design-system title: ENSIDEX — a Wyoming Design System

ENSIDEX — a Wyoming technology company building AI agents, operating systems and platforms. Voice: sharp, confident, modern, evidence-first, bilingual Arabic/English. Visual identity: near-black backgrounds tending purple (#050505 / #0B0712 / #171022) with a single purple accent gradient (#8A2BE2→#A855F7), white text on an opacity scale, glassy nav, 24px card radii, soft purple glow. Wordmark: ENSIDE in white with a purple X. No navy, no cyan, no gold (gold = legal docs only). Fonts: Plus Jakarta Sans (Latin), Tajawal (Arabic), JetBrains Mono (numbers).
...
Formalized by Open Design from candidate ec3cda2f-c31f-4906-80b8-ef0c2fe7b95f.
