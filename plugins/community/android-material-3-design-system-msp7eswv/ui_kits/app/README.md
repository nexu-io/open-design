...
- `interaction-check.html` runs the browser regression suite for composer initial focus/value retention, modal focus containment/restoration, replacement snackbar timing, responsive safe areas, short-viewport dialog access, pane scrolling, actionable controls, contrast, and target sizes.
