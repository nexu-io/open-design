...
6. **Build the form**. Two fields: First Name (optional, for personalization), Work Email (required). A "Join Waitlist" button. That's it. No secondary CTAs, no newsletter checkboxes, no privacy links in the form itself. On submission, hide the form and show a simple thank-you message: "You're on the list. We'll be in touch." Use the body typeface. Make the button the only dark/emphasized element—it's the whole point.
...
- **Mobile fit**: No scrolling required at 375px viewport.
