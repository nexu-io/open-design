...
description: |
  ...
  (Vendored from the stitch-utilities plugin of google-labs-code/stitch-skills; original
  skill id `taste-design`. Requires the Stitch MCP server to be configured — see
