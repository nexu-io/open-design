...
export const MEDIA_PROVIDERS: MediaProvider[] = [
  ...
  { id: 'runway', label: 'Runway', hint: 'Gen-4.5 video + gen4_image stills', integrated: true, defaultBaseUrl: 'https://api.dev.runwayml.com', docsUrl: 'https://docs.dev.runwayml.com' },
  { id: 'luma', label: 'Luma Dream Machine', hint: 'Ray-2 video via Dream Machine API', integrated: true, defaultBaseUrl: 'https://api.lumalabs.ai/dream-machine/v1', docsUrl: 'https://docs.lumalabs.ai' },
