...
// The provider cache-alias matrix and the inclusive-vs-additive input rule live
// in contracts because the run cost decomposition needs the same knowledge; a
// second copy would drift the moment an alias is added.
import {
