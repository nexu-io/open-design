...
import type { CritiqueConfig, PanelEvent } from '@marketing-ax/contracts/critique';
import { panelEventToSse } from '@marketing-ax/contracts/critique';
...
const tracer = trace.getTracer('@marketing-ax/daemon/critique');
