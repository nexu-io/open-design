 ...
 * `MAX_CRITIQUE_ENABLED=1` rather than relying on the client toggle,
 ...
 *   3. Environment override (`MAX_CRITIQUE_ENABLED=1`). Useful for
...
export interface RolloutInputs {
  /** Effective rollout phase. Reads from `MAX_CRITIQUE_ROLLOUT_PHASE`
  ...
  /** Environment override (`MAX_CRITIQUE_ENABLED=1`). */
...
/**
 * Parse `MAX_CRITIQUE_ENABLED`. Recognises the canonical truthy /
