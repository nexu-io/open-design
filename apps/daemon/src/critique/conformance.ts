...
import type { DegradedReason, PanelEvent, PanelistRole } from '@marketing-ax/contracts/critique';
import { CRITIQUE_PROTOCOL_VERSION } from '@marketing-ax/contracts/critique';
