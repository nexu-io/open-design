...
export type RecordPublicFilePublication = (scope: PublicFilePublicationScope, publication: PublicFilePublication, mapping: ShareFileMapping, reopened?: boolean) => PublicFilePublicationRevision;
...
export function createPublicFilePublicationRecorder(
  ...
  return db.transaction((scope: PublicFilePublicationScope, publication: PublicFilePublication, mapping: ShareFileMapping, reopened = false) => {
    ...
    enqueue(db, { scope, publicationRevision, publicFilePath, reopened });
