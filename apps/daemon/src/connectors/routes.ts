...
<html lang="en">
  <head>
    ...
    <title>${connectorLabelHtml} connected · Marketing AX</title>
    <style>
      :root {
        --bg: #faf9f7;
        --bg-panel: #ffffff;
  ...
  <body>
    <main aria-labelledby="callback-title">
      <div class="chrome" aria-label="Marketing AX">
        <span class="brand-mark" aria-hidden="true">OD</span>
        <span class="brand-title">Marketing AX</span>
      </div>
      <section class="content">
        ...
        <div>
          ...
          <p>Your connector is ready to use in Marketing AX.</p>
        </div>
    ...
    <script>
      (() => {
        ...
        function showManualCloseHint() {
          ...
          hint.textContent = 'Your browser blocked automatic closing. You can close this tab and return to Marketing AX.';
        }
        ...
        try {
          if (hasLiveOpener()) {
            ...
            hint.textContent = 'You can close this tab and return to Marketing AX.';
          }
        } catch {
          hint.textContent = 'You can close this tab and return to Marketing AX.';
        }
