...
function taskTraceAttributes(
  ...
  return attributes([
    ...
    ['langfuse.trace.metadata.settlement_reason', aggregate.root.settlementReason ?? undefined],
    ['langfuse.trace.metadata.auto_round_count', aggregate.root.autoRoundCount],
    ['langfuse.trace.metadata.deliverable_written', aggregate.root.deliverableWritten],
    ['langfuse.trace.metadata.blocked_reason_codes', jsonString(aggregate.root.blockedReasonCodes)],
    ['langfuse.trace.metadata.agent_launch', aggregate.root.agentLaunch],
...
const TASK_TRACE_ATTRIBUTE_KEYS = [
  ...
  'langfuse.trace.metadata.auto_round_count',
  'langfuse.trace.metadata.deliverable_written',
