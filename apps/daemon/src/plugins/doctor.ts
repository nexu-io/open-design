...
//
//   - Validates the manifest using @marketing-ax/plugin-runtime's validateSafe.
...
import { manifestSourceDigest, resolveContext, validateSafe, type RegistryView } from '@marketing-ax/plugin-runtime';
