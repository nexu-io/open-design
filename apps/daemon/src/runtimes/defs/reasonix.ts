...
// REASONIX_ACP_SYSTEM_APPEND. This ensures the model follows Marketing AX's
// design workflow (artifact output, design system, skill instructions)
// instead of treating every request as a pure coding task.
const DESIGN_INSTRUCTIONS = `# Marketing AX integration — MUST follow

You are running inside Marketing AX, a design tool. The user message contains
