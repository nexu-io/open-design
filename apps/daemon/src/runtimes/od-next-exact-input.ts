...
export const OD_NEXT_EXACT_INPUT_MAP_V1 = [
  ...
  },
  {
    ...
    source: 'persisted historical clarification finalText',
    owner: 'turn serializer',
    stage: 'clarification',
    note: 'Persisted text identity for historical records only; no new clarification or repair turns are created.',
  },
  {
    id: 'contract_repair_turn',
    classification: 'stage_turn',
    source: 'persisted historical contract-repair finalText',
    owner: 'turn serializer',
  ...
  },
  {
    id: 'production_turn',
    classification: 'stage_turn',
    source: 'composeOdNextMarkerProductionTurn()',
    owner: 'turn serializer',
    stage: 'production',
    note: 'Marker-authorized production continuation; does not re-seed the first Bundle.',
  },
  {
