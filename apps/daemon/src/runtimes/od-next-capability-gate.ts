...
function descriptorForAgent(agentId: string, amrRuntime?: import('@open-design/contracts').AmrRuntime): OdNextRuntimePathDescriptor | null {
  // Pi has a different protocol/tool surface and no verified native-child
  // fixture in this registry. Never admit it using Vela/OpenCode's evidence.
  if (agentId === 'amr' && amrRuntime === 'pi') return null;
