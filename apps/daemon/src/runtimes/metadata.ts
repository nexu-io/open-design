...
> = {
  ...
  amr: {
    installUrl: 'https://marketing-ax.example/amr',
    docsUrl: 'https://github.com/marketing-ax/marketing-ax/blob/main/docs/new-agent-runtime-acp.md',
  },
  claude: {
  ...
  hermes: {
    installUrl: 'https://github.com/marketing-ax/marketing-ax/blob/main/docs/agent-adapters.md',
