...
const SIBLINGS = new Map<string, { taskKind: string }>([
  ...
  ['od-wireframe', { taskKind: 'new-generation' }],
  ['od-mobile-app', { taskKind: 'new-generation' }],
  ['od-document', { taskKind: 'new-generation' }],
  ['od-social-card', { taskKind: 'new-generation' }],
  ['od-technical-diagram', { taskKind: 'new-generation' }],
