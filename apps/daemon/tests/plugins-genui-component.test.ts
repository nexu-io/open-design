...
//
// Two contracts:
//   1. The Zod schema in @marketing-ax/contracts accepts the new
...
import { GenUISurfaceSpecSchema } from '@marketing-ax/contracts';
import { validateSafe } from '@marketing-ax/plugin-runtime';
