...
const en: HomeCopy = {
  ...
  aboutCaptionCredit: '(Marketing AX, MMXXVI)',
  ...
  testimonialQuotePre: '“Marketing AX helped us turn vague',
...
const zhCN: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '“Marketing AX 帮我们把模糊的',
...
const ja: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '「Marketing AX は私たちの曖昧な',
...
const ko: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '"Marketing AX 은 우리의 모호한',
...
const zhTW: Partial<HomeCopy> = {
  ...
  testimonialLabel: '合作者 · Nº 06',
  testimonialQuotePre: '「Marketing AX 幫我們把模糊的',
  testimonialQuoteEm1: 'AI 想法',
...
const de: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '„Marketing AX hat uns geholfen, vage',
...
const fr: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '« Marketing AX nous a aidés à transformer de vagues',
...
const esES: Partial<HomeCopy> = {
  ...
  testimonialQuotePre: '«Marketing AX nos ayudó a convertir',
...
const ptBR: Partial<HomeCopy> = {
  ...
  testimonialLabel: 'Colaboradores · Nº 06',
  testimonialQuotePre: '"O Marketing AX nos ajudou a transformar',
