...
const FAQ_EN: FaqItem[] =
  [
    ...
    { q: "How do the plans differ? Can Free use hosted models?", a: "Free does not include Open Design model credits and supports local CLI plus BYOK only. Plus, Pro, and Max grant $20, $100, and $200 in monthly Open Design model credits for different usage levels. Every plan, including Free, supports BYOK." },
    { q: "Does the price change after the first-month offer?", a: "Monthly plans start with a first-month offer: Plus $16, Pro $70, Max $120. Renewals then use the standard monthly price of $20, $100, or $200. The first-month offer applies only to new monthly subscriptions and once per account. Yearly billing does not use the first-month offer because it already has a lower monthly equivalent." },
    { q: "What is the difference between yearly and monthly billing?", a: "Yearly billing charges once for the full year at a lower monthly equivalent: Plus $14/mo (save 30%), Pro $60/mo (save 40%), Max $98/mo (save 51%). Monthly billing renews each month and can use the first-month offer. Yearly plans renew annually." },
...
const FAQ_ZH: FaqItem[] =
  [
    ...
    { q: "各套餐有什么区别？Free 能用托管模型吗？", a: "Free 不含 Open Design 模型额度，仅支持本地 CLI 与 BYOK 自带密钥；Plus / Pro / Max 每月分别发放 $20 / $100 / $200 的 Open Design 模型额度，适用从个人轻度到团队高频的不同强度。所有套餐（含 Free）都支持 BYOK。" },
    { q: "首月特惠之后价格会变吗？", a: "月付首月享特惠价（Plus $16、Pro $70、Max $120），次月起按原价续费（$20 / $100 / $200）。首月特惠仅适用于月付的新订阅、每个账户限一次；年付不参与首月特惠，但本身已是更低的折后月单价。" },
    { q: "年付和月付有什么区别？", a: "年付一次性支付全年，折合月单价更低：Plus $14/月（省 30%）、Pro $60/月（省 40%）、Max $98/月（省 51%）。月付按月扣费、首月享特惠。年付一次性扣除全年费用，到期后按年续费。" },
...
const FAQ_ZH_TW: FaqItem[] =
  [
    ...
    { q: "各套餐有什麼差異？Free 能使用托管模型嗎？", a: "Free 不含 Open Design 模型額度，僅支援本地 CLI 與 BYOK。Plus、Pro、Max 每月分別發放 $20、$100、$200 的 Open Design 模型額度，適用不同使用強度。所有套餐（含 Free）都支援 BYOK。" },
    { q: "首月優惠後價格會改變嗎？", a: "月付首月享優惠價：Plus $16、Pro $70、Max $120。之後按標準月費 $20、$100、$200 續費。首月優惠僅適用於新的月付訂閱，且每個帳戶限一次；年付不參與首月優惠，因為年付本身已是較低月均價。" },
    { q: "年付和月付有什麼不同？", a: "年付一次支付全年，折合月費更低：Plus $14/月（省 30%）、Pro $60/月（省 40%）、Max $98/月（省 51%）。月付逐月續費並可使用首月優惠；年付按年續費。" },
...
const FAQ_PT_BR: FaqItem[] =
  [
    ...
    { q: "Como os planos diferem? O Free usa modelos hospedados?", a: "O Free não inclui créditos de modelo Open Design e oferece apenas CLI local com BYOK. Plus, Pro e Max concedem $20, $100 e $200 em créditos mensais para diferentes níveis de uso. Todos os planos, incluindo Free, aceitam BYOK." },
    { q: "O preço muda após a oferta do primeiro mês?", a: "Planos mensais começam com oferta no primeiro mês: Plus $16, Pro $70, Max $120. Depois renovam pelo preço padrão de $20, $100 ou $200. A oferta vale apenas para novas assinaturas mensais e uma vez por conta. O anual já tem preço mensal equivalente menor." },
    { q: "Qual a diferença entre anual e mensal?", a: "O anual cobra o ano inteiro de uma vez com equivalente mensal menor: Plus $14/mês, Pro $60/mês, Max $98/mês. O mensal renova todo mês e pode usar a oferta do primeiro mês. Planos anuais renovam anualmente." },
...
const FAQ_ES: FaqItem[] =
  [
    ...
    { q: "¿En qué se diferencian los planes? ¿Free usa modelos alojados?", a: "Free no incluye créditos de modelo Open Design y solo admite CLI local con BYOK. Plus, Pro y Max conceden $20, $100 y $200 de créditos mensuales para distintos niveles de uso. Todos los planes, incluido Free, admiten BYOK." },
    { q: "¿El precio cambia después de la oferta del primer mes?", a: "Los planes mensuales empiezan con oferta: Plus $16, Pro $70, Max $120. Después renuevan al precio estándar de $20, $100 o $200. La oferta aplica solo a nuevas suscripciones mensuales y una vez por cuenta. El anual ya tiene un equivalente mensual menor." },
    { q: "¿Cuál es la diferencia entre anual y mensual?", a: "El anual cobra todo el año de una vez con equivalente mensual menor: Plus $14/mes, Pro $60/mes, Max $98/mes. El mensual renueva cada mes y puede usar la oferta del primer mes. Los planes anuales renuevan anualmente." },
...
const FAQ_RU: FaqItem[] =
  [
    ...
    { q: "Чем отличаются планы? Может ли Free использовать размещенные модели?", a: "Free не включает кредиты моделей Open Design и поддерживает только локальный CLI с BYOK. Plus, Pro и Max дают $20, $100 и $200 ежемесячных кредитов для разных уровней использования. Все планы, включая Free, поддерживают BYOK." },
    { q: "Меняется ли цена после предложения первого месяца?", a: "Месячные планы начинаются с предложения первого месяца: Plus $16, Pro $70, Max $120. Затем продлеваются по стандартной цене $20, $100 или $200. Предложение действует только для новых месячных подписок и один раз на аккаунт. Годовой план уже имеет более низкий месячный эквивалент." },
    { q: "В чем разница между годовой и месячной оплатой?", a: "Годовая оплата списывается за весь год сразу и имеет более низкий месячный эквивалент: Plus $14/мес., Pro $60/мес., Max $98/мес. Месячная оплата продлевается каждый месяц и может использовать предложение первого месяца. Годовые планы продлеваются раз в год." },
...
const FAQ_FR: FaqItem[] =
  [
    ...
    { q: "Quelle est la différence entre les plans ? Free utilise-t-il les modèles hébergés ?", a: "Free n'inclut pas de crédits Open Design et prend seulement en charge le CLI local avec BYOK. Plus, Pro et Max accordent $20, $100 et $200 de crédits mensuels pour différents niveaux d'usage. Tous les plans, y compris Free, prennent en charge BYOK." },
    { q: "Le prix change-t-il après l'offre du premier mois ?", a: "Les plans mensuels commencent avec une offre premier mois : Plus $16, Pro $70, Max $120. Ensuite, ils renouvellent au prix standard de $20, $100 ou $200. L'offre ne s'applique qu'aux nouveaux abonnements mensuels, une fois par compte. Le plan annuel a déjà un équivalent mensuel réduit." },
    { q: "Quelle différence entre facturation annuelle et mensuelle ?", a: "L'annuel facture toute l'année en une fois avec un équivalent mensuel plus bas : Plus $14/mois, Pro $60/mois, Max $98/mois. Le mensuel renouvelle chaque mois et peut utiliser l'offre du premier mois. Les plans annuels renouvellent chaque année." },
...
const FAQ_KO: FaqItem[] =
  [
    ...
    { q: "각 플랜은 어떻게 다른가요? Free도 호스팅 모델을 쓸 수 있나요?", a: "Free에는 Open Design 모델 크레딧이 포함되지 않으며 로컬 CLI와 BYOK만 지원합니다. Plus, Pro, Max는 각각 월 $20, $100, $200 상당의 크레딧을 제공해 사용량 수준에 맞게 선택할 수 있습니다. Free를 포함한 모든 플랜은 BYOK를 지원합니다." },
    { q: "첫 달 할인 이후 가격이 바뀌나요?", a: "월간 플랜은 첫 달 할인으로 시작합니다: Plus $16, Pro $70, Max $120. 이후에는 표준 월 가격인 $20, $100, $200으로 갱신됩니다. 첫 달 할인은 신규 월간 구독에 계정당 한 번만 적용됩니다. 연간 결제는 이미 월 환산 가격이 더 낮습니다." },
    { q: "연간 결제와 월간 결제의 차이는 무엇인가요?", a: "연간 결제는 1년치를 한 번에 결제하며 월 환산 가격이 더 낮습니다: Plus $14/월, Pro $60/월, Max $98/월. 월간 결제는 매달 갱신되며 첫 달 할인을 사용할 수 있습니다. 연간 플랜은 매년 갱신됩니다." },
...
const FAQ_DE: FaqItem[] =
  [
    ...
    { q: "Wie unterscheiden sich die Pläne? Kann Free gehostete Modelle nutzen?", a: "Free enthält keine Open Design Modell-Credits und unterstützt nur lokale CLI plus BYOK. Plus, Pro und Max gewähren monatlich $20, $100 und $200 Credits für unterschiedliche Nutzungslevel. Alle Pläne, einschließlich Free, unterstützen BYOK." },
    { q: "Ändert sich der Preis nach dem Angebot im ersten Monat?", a: "Monatspläne starten mit einem Angebot im ersten Monat: Plus $16, Pro $70, Max $120. Danach verlängern sie sich zum Standardpreis von $20, $100 oder $200. Das Angebot gilt nur für neue monatliche Subscriptions und einmal pro Konto. Jahrespläne haben bereits einen niedrigeren monatlichen Gegenwert." },
    { q: "Was ist der Unterschied zwischen jährlicher und monatlicher Abrechnung?", a: "Jährliche Abrechnung bezahlt das ganze Jahr auf einmal mit niedrigerem Monatsgegenwert: Plus $14/Monat, Pro $60/Monat, Max $98/Monat. Monatlich verlängert sich jeden Monat und kann das Erstmonatsangebot nutzen. Jahrespläne verlängern sich jährlich." },
...
const FAQ_JA: FaqItem[] =
  [
    ...
    { q: "各プランの違いは？Free でホストモデルは使えますか？", a: "Free には Open Design モデルクレジットが含まれず、ローカル CLI と BYOK のみをサポートします。Plus、Pro、Max はそれぞれ月 $20、$100、$200 のクレジットを付与し、利用量に応じて選べます。Free を含むすべてのプランで BYOK を利用できます。" },
    { q: "初月オファー後に価格は変わりますか？", a: "月額プランは初月オファーで開始します：Plus $16、Pro $70、Max $120。以降は標準月額 $20、$100、$200 で更新されます。初月オファーは新規月額サブスクリプションにアカウントごと 1 回のみ適用されます。年額はすでに月換算価格が低くなっています。" },
    { q: "年額と月額の違いは何ですか？", a: "年額は 1 年分を一括で支払い、月換算価格が低くなります：Plus $14/月、Pro $60/月、Max $98/月。月額は毎月更新され、初月オファーを利用できます。年額プランは毎年更新されます。" },
