...
export interface HeaderProductMenuCopy {
  ...
  tools: string;
  toolItems: [string, string, string];
  agent: string;
  plugins: string;
...
const HEADER_PRODUCT_MENU_COPY: Record<LandingLocaleCode, HeaderProductMenuCopy> = {
  en: {
    ...
    tools: 'Tools',
    toolItems: ['AI Wireframe Generator', 'AI UI Generator', 'Design to Code'],
    agent: 'Agent',
    plugins: 'Plugins',
  ...
  zh: {
    ...
    tools: '工具',
    toolItems: ['AI 线框图生成器', 'AI UI 生成器', '设计转代码'],
    agent: 'Agent',
    plugins: '插件',
  ...
  'zh-tw': {
    ...
    tools: '工具',
    toolItems: ['AI 線框圖生成器', 'AI UI 產生器', '設計轉程式碼'],
    agent: 'Agent',
    plugins: '外掛',
  ...
  ja: {
    ...
    tools: 'ツール',
    toolItems: ['AI ワイヤーフレーム生成', 'AI UI ジェネレーター', 'デザインからコードへ'],
    agent: 'エージェント',
    plugins: 'プラグイン',
  ...
  ko: {
    ...
    tools: '도구',
    toolItems: ['AI 와이어프레임 생성기', 'AI UI 생성기', '디자인을 코드로'],
    agent: '에이전트',
    plugins: '플러그인',
  ...
  de: {
    ...
    tools: 'Tools',
    toolItems: ['KI-Wireframe-Generator', 'KI-UI-Generator', 'Design zu Code'],
    agent: 'Agent',
    plugins: 'Plugins',
  ...
  fr: {
    ...
    tools: 'Outils',
    toolItems: ['Générateur de wireframe IA', 'Générateur d’UI IA', 'Du design au code'],
    agent: 'Agent',
    plugins: 'Plugins',
  ...
  ru: {
    ...
    tools: 'Инструменты',
    toolItems: ['ИИ-генератор вайрфреймов', 'ИИ-генератор UI', 'Дизайн в код'],
    agent: 'Агенты',
    plugins: 'Плагины',
  ...
  es: {
    ...
    tools: 'Herramientas',
    toolItems: ['Generador de wireframes IA', 'Generador de UI con IA', 'De diseño a código'],
    agent: 'Agente',
    plugins: 'Plugins',
  ...
  'pt-br': {
    ...
    tools: 'Ferramentas',
    toolItems: ['Gerador de wireframe com IA', 'Gerador de UI com IA', 'Design para código'],
    agent: 'Agente',
    plugins: 'Plugins',
  ...
  it: {
    ...
    tools: 'Strumenti',
    toolItems: ['Generatore di wireframe IA', 'Generatore di UI IA', 'Dal design al codice'],
    agent: 'Agente',
    plugins: 'Plugin',
  ...
  vi: {
    ...
    tools: 'Công cụ',
    toolItems: ['Trình tạo wireframe AI', 'Trình tạo UI AI', 'Thiết kế sang mã'],
    agent: 'Agent',
    plugins: 'Plugin',
  ...
  pl: {
    ...
    tools: 'Narzędzia',
    toolItems: ['Generator wireframe’ów AI', 'Generator UI AI', 'Projekt na kod'],
    agent: 'Agent',
    plugins: 'Wtyczki',
  ...
  id: {
    ...
    tools: 'Alat',
    toolItems: ['Generator Wireframe AI', 'Generator UI AI', 'Desain ke Kode'],
    agent: 'Agent',
    plugins: 'Plugin',
  ...
  nl: {
    ...
    tools: 'Tools',
    toolItems: ['AI-wireframegenerator', 'AI-UI-generator', 'Ontwerp naar code'],
    agent: 'Agent',
    plugins: 'Plug-ins',
  ...
  ar: {
    ...
    tools: 'الأدوات',
    toolItems: ['مولّد الإطار السلكي بالذكاء الاصطناعي', 'مولّد واجهات المستخدم بالذكاء الاصطناعي', 'من التصميم إلى الكود'],
    agent: 'الوكلاء',
    plugins: 'الإضافات',
  ...
  tr: {
    ...
    tools: 'Araçlar',
    toolItems: ['Yapay Zekâ Tel Çerçeve Oluşturucu', 'Yapay Zekâ UI Oluşturucu', 'Tasarımdan Koda'],
    agent: 'Agent',
    plugins: 'Eklentiler',
  ...
  uk: {
    ...
    tools: 'Інструменти',
    toolItems: ['ШІ-генератор каркасів', 'ШІ-генератор UI', 'Дизайн у код'],
    agent: 'Агенти',
    plugins: 'Плагіни',
