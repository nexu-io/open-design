  ...
  agentInstall: {
    ...
    steps: [
      ...
      },
      {
        ...
        body:
          'Прочитайте требуемые селектор и версию из release-manifest.json, затем сравните их с состоянием Codex, полученным при проверке. При первой установке отсутствие MCP open-design — это нормально. Если имя маркетплейса open-design ссылается на другой источник, остановитесь и сообщите о конфликте. Сохраняйте open-design@open-design только в том случае, если установленная версия совпадает с версией, указанной в release-manifest.json.',
      },
      {
