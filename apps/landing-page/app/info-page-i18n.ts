...
export type AgentGuideCopy = {
  ...
  // "With Marketing AX" — the drive-to-OD section
  withOdTitle: string;
  withOdLead: string;
  withOdSteps: string[];
...
const INFO_PAGE_COPY: Partial<Record<LandingLocaleCode, InfoPageCopy>> = {
  en: {
    ...
    official: {
      title: 'Official Marketing AX — Source page, GitHub, releases, and aliases',
      description:
        'Official source page for Marketing AX (also searched as OpenDesign, open-design, opendesign, Open Design AI, OD). Canonical site, GitHub repository, releases, Discord, license, and maintainer identity in one place.',
      breadcrumb: 'Official',
      label: 'Source · Nº 00',
      heading: 'Official Marketing AX source page.',
      lead:
        'Marketing AX (also searched as OpenDesign, open-design, opendesign, or Open Design AI) is the official open-source AI design workspace from the nexu-io/open-design project. This page lists every canonical surface so you can verify the source for yourself.',
      ...
      aliases: [
        { label: 'Marketing AX', body: 'display name in the product UI, blog, and READMEs.' },
      ...
      maintainerBody:
        'Marketing AX is developed in the open at github.com/nexu-io/open-design and released under the Apache-2.0 license. Issues, RFCs, and roadmap conversations happen on GitHub Issues and Discord.',
      runtimeTitle: 'What runs on your machine',
      runtimeBody: 'Marketing AX ships three runnable surfaces — all open source, all local-first:',
      runtimeItems: [
    ...
    quickstart: {
      title: 'Marketing AX quickstart — Install in three commands (Node 24, pnpm)',
      description:
        'Install Marketing AX locally with three commands. Requirements (Node 24, pnpm 10.33.2), commands, expected output, troubleshooting, and how to generate your first design artifact with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen.',
      breadcrumb: 'Quickstart',
      label: 'Install · Nº 01',
      heading: 'Marketing AX quickstart.',
      lead:
        'Marketing AX runs entirely on your machine. Three commands gets you from a clean checkout to a running daemon, web UI, and your first generated design artifact.',
      ...
      nextItems: [
        ...
        { label: 'Compare Marketing AX', body: 'with Claude Design, Figma Make, v0, and Lovable.' },
    ...
    agents: {
      title: 'Marketing AX agents — {count} BYOK adapters',
      description:
        'Marketing AX ships {count} BYOK adapters out of the box. Drive design from the same agent you use for code — no separate vendor login.',
      breadcrumb: 'Agents',
      label: 'Adapters · Nº 04',
      heading: (count) => `${count} BYOK agents, one skill protocol.`,
      lead: (count) =>
        `Marketing AX ships ${count} first-party adapters out of the box. The same composable skills and portable DESIGN.md systems work with every one. BYOK throughout — your keys, your spend, your data.`,
      adaptersTitle: 'How adapters plug in',
      adaptersBody:
        'Every adapter is a thin shim between the agent native message format and Marketing AX skill protocol. Adding a new adapter is a single file — no fork required.',
      tiers: [
        {
          label: 'Tier 1 — first-party tested',
          blurb:
            'Battle-tested daily by the Marketing AX maintainers. Stream-JSON IPC where supported, full AskUserQuestion mid-turn, skill-aware system prompts.',
        },
        {
      ...
      byokLead: 'BYOK ("bring your own key") in Marketing AX keeps credentials and spend on your side:',
      byokItems: [
      ...
      ctaBody:
        'Pick the agent already on your laptop, point Marketing AX at it, and start rendering.',
    },
    compare: {
      title: 'Marketing AX vs Figma, Lovable, Bolt, v0, Framer — honest comparisons',
      description:
        'Compare Marketing AX to the major AI design and app-building tools. Hosted vs local-first, BYOK vs vendor-locked, single-shot generation vs portable DESIGN.md systems.',
      breadcrumb: 'Compare',
      label: 'Evaluation · Nº 02',
      heading: 'Marketing AX vs everything else.',
      lead:
        'Short, honest summaries of how Marketing AX relates to the other AI design and app-building tools you might be evaluating. Each links to a full, candid comparison.',
      toc: ['vs Claude Design', 'vs Figma', 'vs Lovable', 'vs Bolt', 'vs v0', 'vs Framer', 'Honest limits'],
      comparisons: [
        {
          competitor: 'Claude Design',
          summary:
            'Hosted product tied to a single vendor. Marketing AX is local-first, BYOK, and Apache-2.0 — your skills and DESIGN.md live in your repo.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'Figma',
          summary:
            'Figma is a hosted, hands-on design canvas. Marketing AX is agent-driven and local-first, with your brand and artifacts as files in your repo.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'Lovable',
          summary:
            'Lovable ships hosted prompt-to-app builds. Marketing AX is the design-first, BYOK layer for the coding agent you already use.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'Bolt',
          summary:
            'Bolt builds running full-stack apps in the browser. Marketing AX produces design artifacts you own, locally, with your own agent.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'v0',
          summary:
            'v0 generates hosted UI tuned for the Vercel and React stack. Marketing AX generates design with any agent, locally, as files you own.',
          cta: 'Read the full comparison ->',
        },
        {
          competitor: 'Framer',
          summary:
            'Framer is a hosted no-code site builder. Marketing AX is the open-source, agent-driven alternative that keeps design as files you deploy anywhere.',
          cta: 'Read the full comparison ->',
        },
      ],
      limitsTitle: "Honest limits — what Marketing AX isn't",
      limitsBody:
        'Marketing AX is not trying to be every hosted AI design tool. These questions describe the trade-offs instead of glossing them.',
      limitsFaq: [
        { name: 'Does Marketing AX offer a hosted web sandbox?', text: 'No. Marketing AX is local-first by design.' },
        { name: 'Can I use Marketing AX without installing anything?', text: 'Not today. The minimum is a local daemon plus a coding agent.' },
        { name: 'Is Marketing AX a v0 / Lovable / Bolt replacement?', text: 'It depends. Marketing AX focuses on prompt-to-design-artifact via a skill protocol you can fork.' },
        { name: 'Does Marketing AX send my data to Anthropic, OpenAI, or Google?', text: 'Only your prompt and skill context goes to the provider whose key you brought.' },
        { name: 'Can I self-host Marketing AX on my own infrastructure?', text: 'Yes. Apache-2.0 license, Node 24 daemon, no required SaaS.' },
      ],
    },
    claudeAlternative: {
      title: 'Open-source Claude Design alternative — Marketing AX (BYOK, local-first)',
      description:
        'Marketing AX is the open-source, local-first alternative to Claude Design. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen.',
      breadcrumb: 'Open-source Claude Design alternative',
      label: 'Alternative · Nº 03',
      heading: 'Open-source Claude Design alternative.',
      lead:
        'Marketing AX is the official open-source, local-first alternative to Claude Design. BYOK with the agent you already use, keep your brand as a portable DESIGN.md file, and ship artifacts as files in your project.',
      tldrTitle: 'TL;DR',
      tldrBody:
      ...
      localByokBody: [
        'Marketing AX runs a desktop app, a local daemon, and Markdown skill/system catalogs on your machine.',
      ...
      pickOpenTitle: 'Pick Marketing AX if',
      pickOpen: [
      ...
      migrateSteps: [
        'Install Marketing AX from the quickstart.',
      ...
      faqTitle: 'FAQ',
      faq: [
        { name: 'Is Marketing AX really a drop-in alternative to Claude Design?', text: 'Not literally, but they overlap on prompt-to-design-artifact use cases.' },
        { name: 'Can I use Claude as my agent in Marketing AX?', text: 'Yes. Marketing AX supports Claude Code and Anthropic API BYOK flows.' },
        { name: 'What happens to my Claude Design designs?', text: 'You can keep using Claude Design alongside Marketing AX; migration is manual today.' },
        { name: 'Does Marketing AX generate the same artifact types?', text: 'Yes for common types: landing pages, decks, dashboards, social posts, brand systems, and prototypes.' },
        ...
        { name: 'Who builds and maintains Marketing AX?', text: 'The project lives at github.com/nexu-io/open-design and is Apache-2.0.' },
      ],
    ...
    alternatives: {
      lovable: {
        title: 'Open-source Lovable alternative — Marketing AX (design-first, BYOK, local)',
        description:
          'Marketing AX is the open-source, local-first alternative to Lovable for design-first work. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — artifacts ship as files in your repo.',
        breadcrumb: 'Open-source Lovable alternative',
        label: 'Alternative · Lovable',
        heading: 'Open-source Lovable alternative.',
        lead:
          'Lovable turns a prompt into a deployed full-stack app. Marketing AX is a self-evolving design agent for Claude Code — local-first, BYOK, open source — focused on design artifacts and a portable brand rather than shipping the backend. Different primary job, overlapping prompt-to-UI surface.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Lovable ships hosted apps; Marketing AX ships design artifacts as files you own. If you want a design-first, BYOK, open-source workflow with your own agent, Marketing AX is the alternative — and it is honest about where Lovable wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'Marketing AX runs a desktop app, a local daemon, and Markdown skill/system catalogs on your machine — no design output is forced through a vendor cloud.',
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is Marketing AX a drop-in replacement for Lovable?', text: 'No. Lovable ships deployed full-stack apps; Marketing AX is design-first and produces artifacts you own. They overlap on prompt-to-UI, not on hosting a backend.' },
          { name: 'Can Marketing AX build a full app like Lovable?', text: 'Marketing AX focuses on design artifacts, prototypes, and brand systems. For production backends and one-click hosting, Lovable is the better fit.' },
          { name: 'Which agent does Marketing AX use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. API spend bills to your account.' },
          { name: 'Is Marketing AX really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Can I keep using Lovable alongside Marketing AX?', text: 'Yes. Many teams prototype design in Marketing AX and ship apps in Lovable; migration is manual today.' },
        ...
        rich: {
          heroCtaLead:
            'Marketing AX is the open-source, local-first design layer around the coding agent you already use — your key, your files, a curated skill and design-system library.',
          heroCtaActions: [
          ...
          heroImage: {
            ...
            alt: 'Marketing AX vs Lovable — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'Lovable turns a prompt into a deployed full-stack app. Marketing AX is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — focused on producing design artifacts and a portable brand you keep as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                ...
                { kind: 'p', text: 'It is closed-source and runs in the vendor cloud, billed by subscription and per-message credits. That is a different posture from Marketing AX, which is a local-first, open-source design agent you point your own coding agent at — and the two overlap on prompt-to-UI, not on hosting a backend.' },
                { kind: 'ul', items: [
            ...
            },
            {
              ...
              blocks: [
                { kind: 'p', text: 'Marketing AX runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine. No design output is forced through a vendor cloud, and your brand lives in your repo as a portable DESIGN.md file every skill respects.' },
                { kind: 'p', text: 'You bring your own agent key. Credentials stay in local config or environment variables — Marketing AX never proxies them — and the API spend bills directly to you.' },
              ],
            },
            {
              id: 'compare',
              heading: 'Marketing AX vs Lovable, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'Marketing AX', 'Lovable'], rows: [
                ...
                { kind: 'p', text: 'Where Lovable wins: if your goal is a deployed, hosted full-stack app with the backend wired up for you, Lovable does that out of the box and Marketing AX does not. Marketing AX is design-first.' },
              ],
            },
            {
              id: 'who-picks',
              ...
              blocks: [
                ...
                { kind: 'p', text: 'Pick Marketing AX if:' },
                { kind: 'ul', items: [
                  'You want design artifacts and a brand as version-controlled files.',
                  'You want BYOK with your existing coding agent.',
                  'You want open source you can fork, rebrand, embed in CLI, or self-host.',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Lovable into Marketing AX',
              blocks: [
          ...
          faq: [
            { name: 'Is Marketing AX a drop-in replacement for Lovable?', text: 'No. Lovable ships deployed full-stack apps; Marketing AX is design-first and produces artifacts you own. They overlap on prompt-to-UI, not on hosting a backend.' },
            { name: 'Can Marketing AX build a full app like Lovable?', text: 'Marketing AX focuses on design artifacts, prototypes, and brand systems. For production backends and one-click hosting, Lovable is the better fit.' },
            { name: 'Which agent does Marketing AX use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. API spend bills to your account and credentials are never proxied through us.' },
            { name: 'Is Marketing AX really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
            { name: 'Can I keep using Lovable alongside Marketing AX?', text: 'Yes. Many teams prototype design in Marketing AX and ship apps in Lovable; migration is manual today.' },
            { name: 'Is Marketing AX affiliated with Lovable?', text: 'No. Marketing AX is an independent, open-source project. Lovable is a trademark of its owner; this is an unaffiliated comparison.' },
          ],
          ctaTitle: 'Design-first, in three commands.',
          ctaBody:
            'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
      ...
      figma: {
        title: 'Open-source Figma alternative — Marketing AX (design-first, BYOK, local)',
        description:
          'Marketing AX is the open-source, local-first alternative to Figma for agent-driven design. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — your brand and artifacts live as files in your repo.',
        breadcrumb: 'Open-source Figma alternative',
        label: 'Alternative · Figma',
        heading: 'Open-source Figma alternative.',
        lead:
          'Figma is a hosted, collaborative canvas you design on by hand. Marketing AX is a self-evolving design agent for Claude Code — local-first, BYOK, Apache-2.0 — where you drive design through your coding agent and keep a portable brand as files. Different shape, same goal: shipped interfaces.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Figma is a manual cloud design tool; Marketing AX is an agent-driven, local-first, open-source design layer. If you want files in your repo and BYOK over a hosted canvas, Marketing AX is the alternative — and it is honest about where Figma wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'Marketing AX runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine — your designs are files, not cloud documents.',
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is Marketing AX a drop-in replacement for Figma?', text: 'No. Figma is a hands-on collaborative canvas; Marketing AX is an agent-driven, local-first design layer. They overlap on producing interfaces, not on real-time canvas editing.' },
          { name: 'Can I still use Figma alongside Marketing AX?', text: 'Yes. Many teams design in Figma and use Marketing AX to generate and iterate from a portable brand; migration is manual today.' },
          { name: 'Which agent does Marketing AX use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. Credentials are never proxied through us.' },
          { name: 'Is Marketing AX really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Is Marketing AX affiliated with Figma?', text: 'No. Marketing AX is an independent, open-source project. Figma is a trademark of its owner; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Design-first, in three commands.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
        rich: {
          ...
          heroImage: {
            ...
            alt: 'Marketing AX vs Figma — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'Figma turns a cloud canvas into shared, hands-on interface design. Marketing AX is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — where you drive design through your agent and keep a portable brand as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                ...
                { kind: 'p', text: 'It is closed-source and runs in the vendor cloud, billed per editor seat. Marketing AX is a different shape: a local-first, open-source design agent you point your own coding agent at — the two overlap on producing interfaces, not on real-time canvas editing.' },
                { kind: 'ul', items: [
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'p', text: 'Marketing AX runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine. Your designs are files, not cloud documents, and your brand lives in your repo as a portable DESIGN.md file every skill respects.' },
                { kind: 'p', text: 'You bring your own agent key. Credentials stay in local config or environment variables — Marketing AX never proxies them — and the API spend bills directly to you.' },
              ],
            },
            {
              id: 'compare',
              heading: 'Marketing AX vs Figma, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'Marketing AX', 'Figma'], rows: [
                ...
                { kind: 'p', text: 'Where Figma wins: hands-on vector editing, a real-time multiplayer canvas, and a deep, mature plugin and component ecosystem. If that hands-on canvas is the job, Figma is hard to beat — Marketing AX is design-first and agent-driven instead.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Figma into Marketing AX',
              blocks: [
      ...
      bolt: {
        title: 'Open-source Bolt alternative — Marketing AX (design-first, BYOK, local)',
        description:
          'Marketing AX is the open-source, local-first alternative to Bolt (bolt.new) for design-first work. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — artifacts ship as files in your repo.',
        breadcrumb: 'Open-source Bolt alternative',
        label: 'Alternative · Bolt',
        heading: 'Open-source Bolt alternative.',
        lead:
          'Bolt (bolt.new) turns a prompt into a running full-stack app in the browser. Marketing AX is a self-evolving design agent for Claude Code — local-first, BYOK, open source — focused on design artifacts and a portable brand rather than shipping the backend. Different primary job, overlapping prompt-to-UI surface.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Bolt ships hosted apps; Marketing AX ships design artifacts as files you own. If you want a design-first, BYOK, open-source workflow with your own agent, Marketing AX is the alternative — and it is honest about where Bolt wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'Marketing AX runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine — no design output is forced through a vendor cloud.',
          'You bring your own agent key; credentials stay local and never proxy through us, and API spend bills to you.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is Marketing AX a drop-in replacement for Bolt?', text: 'No. Bolt ships running full-stack apps; Marketing AX is design-first and produces artifacts you own. They overlap on prompt-to-UI, not on running a backend.' },
          { name: 'Can Marketing AX build a full app like Bolt?', text: 'Marketing AX focuses on design artifacts, prototypes, and brand systems. For an instant in-browser full-stack app, Bolt is the better fit.' },
          { name: 'Which agent does Marketing AX use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. API spend bills to your account and credentials are never proxied through us.' },
          { name: 'Is Marketing AX really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Is Marketing AX affiliated with Bolt?', text: 'No. Marketing AX is an independent, open-source project. Bolt and bolt.new are trademarks of their owner; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Design-first, in three commands.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
        rich: {
          ...
          heroImage: {
            ...
            alt: 'Marketing AX vs Bolt — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'Bolt turns a prompt into a running full-stack app in the browser. Marketing AX is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — focused on producing design artifacts and a portable brand you keep as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                ...
                { kind: 'p', text: 'It is closed-source and hosted, billed by subscription and per-token credits. Marketing AX is a different posture: a local-first, open-source design agent you point your own coding agent at — and the two overlap on prompt-to-UI, not on running a backend.' },
                { kind: 'ul', items: [
            ...
            {
              id: 'compare',
              heading: 'Marketing AX vs Bolt, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'Marketing AX', 'Bolt'], rows: [
                ...
                { kind: 'p', text: 'Where Bolt wins: if your goal is an instant, running full-stack app in the browser with the dev environment wired up for you, Bolt does that out of the box. Marketing AX is design-first.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Bolt into Marketing AX',
              blocks: [
      ...
      v0: {
        title: 'Open-source v0 alternative — Marketing AX (design-first, BYOK, local)',
        description:
          'Marketing AX is the open-source, local-first alternative to v0 by Vercel for design-first work. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — artifacts ship as files in your repo.',
        breadcrumb: 'Open-source v0 alternative',
        label: 'Alternative · v0',
        heading: 'Open-source v0 alternative.',
        lead:
          'v0 by Vercel turns a prompt into hosted UI components. Marketing AX is a self-evolving design agent for Claude Code — local-first, BYOK, open source — that drives any coding agent and keeps your brand and artifacts as files. Closest overlap of the bunch: prompt-to-UI, different posture.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'v0 generates UI in Vercel’s hosted flow; Marketing AX generates design with your own agent, locally, as files you own. If you want BYOK, any agent, and open source over a hosted generator, Marketing AX is the alternative — and it is honest about where v0 wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'Marketing AX runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine — your UI is files, not hosted generations.',
          'You bring your own agent key; credentials stay local and never proxy through us, and API spend bills to you.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is Marketing AX a drop-in replacement for v0?', text: 'No. v0 generates UI in Vercel’s hosted flow; Marketing AX is design-first and produces artifacts you own with any agent. They overlap on prompt-to-UI, not on the Vercel-hosted pipeline.' },
          { name: 'Does Marketing AX lock me to a stack?', text: 'No. BYOK with any supported agent, and your output is plain files in your repo — not tied to one framework or host.' },
          { name: 'Which agent does Marketing AX use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. API spend bills to your account and credentials are never proxied through us.' },
          { name: 'Is Marketing AX really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Is Marketing AX affiliated with v0 or Vercel?', text: 'No. Marketing AX is an independent, open-source project. v0 and Vercel are trademarks of their owner; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Design-first, in three commands.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
        rich: {
          ...
          heroImage: {
            ...
            alt: 'Marketing AX vs v0 — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'v0 by Vercel turns a prompt into hosted UI components, tuned for the React and Vercel ecosystem. Marketing AX is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — focused on producing design artifacts and a portable brand you keep as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                ...
                { kind: 'p', text: 'It is closed-source and runs in the vendor cloud, billed by subscription and per-generation credits. Marketing AX is a different posture: a local-first, open-source design agent you point your own coding agent at — overlapping on prompt-to-UI, not on the Vercel-hosted pipeline.' },
                { kind: 'ul', items: [
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'p', text: 'Marketing AX runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine. Your UI is files, not hosted generations, and your brand lives in your repo as a portable DESIGN.md file every skill respects.' },
                { kind: 'p', text: 'You bring your own agent key. Credentials stay in local config or environment variables — Marketing AX never proxies them — and the API spend bills directly to you.' },
              ],
            },
            {
              id: 'compare',
              heading: 'Marketing AX vs v0, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'Marketing AX', 'v0'], rows: [
                ...
                { kind: 'p', text: 'Where v0 wins: if you live in the Vercel, Next.js and React ecosystem and want UI generated and deployed in one tight hosted flow, v0 is built for exactly that. Marketing AX is design-first and stack-agnostic.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from v0 into Marketing AX',
              blocks: [
      ...
      framer: {
        title: 'Open-source Framer alternative — Marketing AX (design-first, BYOK, local)',
        description:
          'Marketing AX is the open-source, local-first alternative to Framer for agent-driven design. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — your brand and artifacts live as files in your repo.',
        breadcrumb: 'Open-source Framer alternative',
        label: 'Alternative · Framer',
        heading: 'Open-source Framer alternative.',
        lead:
          'Framer is a hosted, no-code visual builder for designing and publishing sites. Marketing AX is a self-evolving design agent for Claude Code — local-first, BYOK, open source — where you drive design through your coding agent and keep a portable brand as files. Different shape, same goal: shipped interfaces.',
        tldrTitle: 'TL;DR',
        tldrBody:
          'Framer is a hosted no-code site builder; Marketing AX is an agent-driven, local-first, open-source design layer. If you want files in your repo and BYOK over a hosted canvas, Marketing AX is the alternative — and it is honest about where Framer wins.',
        toc: ['Why people search', 'Local-first + BYOK', 'Feature comparison', 'Who should pick which', 'Migration / first run', 'FAQ'],
        ...
        localByokTitle: 'Local-first + BYOK, explained',
        localByokBody: [
          'Marketing AX runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine — your designs are files, not a hosted project.',
          'You bring your own agent key; credentials stay local and never proxy through us, and API spend bills to you.',
        ],
        featureTitle: 'Feature comparison',
        features: [
        ...
        faqTitle: 'FAQ',
        faq: [
          { name: 'Is Marketing AX a drop-in replacement for Framer?', text: 'No. Framer is a hosted no-code site builder; Marketing AX is an agent-driven, local-first design layer. They overlap on producing interfaces, not on no-code publishing and hosting.' },
          { name: 'Can Marketing AX publish a site like Framer?', text: 'Marketing AX produces design artifacts and code you own; you deploy them yourself. For an all-in-one no-code builder plus hosting, Framer is the better fit.' },
          { name: 'Which agent does Marketing AX use?', text: 'Your choice — BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen. Credentials are never proxied through us.' },
          { name: 'Is Marketing AX really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Is Marketing AX affiliated with Framer?', text: 'No. Marketing AX is an independent, open-source project. Framer is a trademark of its owner; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Design-first, in three commands.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
        rich: {
          ...
          heroImage: {
            ...
            alt: 'Marketing AX vs Framer — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'Framer turns a hosted, no-code canvas into designed and published websites. Marketing AX is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — where you drive design through your agent and keep a portable brand as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                ...
                { kind: 'p', text: 'It is closed-source and runs in the vendor cloud, billed by subscription. Marketing AX is a different posture: a local-first, open-source design agent you point your own coding agent at — overlapping on producing interfaces, not on no-code publishing and hosting.' },
                { kind: 'ul', items: [
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'p', text: 'Marketing AX runs a desktop app, a local daemon, and Markdown skill and design-system catalogs on your machine. Your designs are files, not a hosted project, and your brand lives in your repo as a portable DESIGN.md file every skill respects.' },
                { kind: 'p', text: 'You bring your own agent key. Credentials stay in local config or environment variables — Marketing AX never proxies them — and the API spend bills directly to you.' },
              ],
            },
            {
              id: 'compare',
              heading: 'Marketing AX vs Framer, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'Marketing AX', 'Framer'], rows: [
                ...
                { kind: 'p', text: 'Where Framer wins: if you want a no-code visual builder that designs and publishes a marketing site with hosting included, Framer does that end to end. Marketing AX is design-first and agent-driven instead.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Framer into Marketing AX',
              blocks: [
      ...
      'claude-design': {
        title: 'Open-source Claude Design alternative — Marketing AX (BYOK, local-first)',
        description:
          'Marketing AX is the open-source, local-first alternative to Claude Design. BYOK with Claude Code, Codex, Cursor, Gemini, OpenCode, or Qwen — your skills and DESIGN.md live in your repo.',
        breadcrumb: 'Open-source Claude Design alternative',
        label: 'Alternative · Claude Design',
        heading: 'Open-source Claude Design alternative.',
        lead:
          'Marketing AX is the open-source, local-first alternative to Claude Design. Same use case — prompt to design artifact — different posture: BYOK with the agent you already use, keep your brand as a portable DESIGN.md file, and ship artifacts as files in your project.',
        tldrTitle: 'TL;DR',
        tldrBody:
        ...
        faq: [
          { name: 'Is Marketing AX really a drop-in alternative to Claude Design?', text: 'Not literally, but they overlap on prompt-to-design-artifact use cases.' },
          { name: 'Can I use Claude as my agent in Marketing AX?', text: 'Yes. Marketing AX supports Claude Code and Anthropic API BYOK flows; credentials are never proxied through us.' },
          { name: 'What happens to my Claude Design designs?', text: 'You can keep using Claude Design alongside Marketing AX; migration is manual today.' },
          { name: 'Does Marketing AX generate the same artifact types?', text: 'Yes for common types: landing pages, decks, dashboards, social posts, brand systems, and prototypes.' },
          { name: 'Is Marketing AX really open source?', text: 'Yes. It lives at github.com/nexu-io/open-design under Apache-2.0 and is self-hostable.' },
          { name: 'Is Marketing AX affiliated with Anthropic or Claude?', text: 'No. Marketing AX is an independent, open-source project. Claude is a trademark of Anthropic; this is an unaffiliated comparison.' },
        ],
        ctaTitle: 'Switch in three commands.',
        ctaBody:
          'Star the repo, grab the desktop build, or run the install in your terminal. Your DESIGN.md system stays in your repo from the first render onward.',
        rich: {
          ...
          heroImage: {
            ...
            alt: 'Marketing AX vs Claude Design — warm-paper editorial illustration of code converging into a design hub',
          },
          intro: [
            'Claude Design is a hosted, vendor-managed product for prompt-to-design work. Marketing AX is a self-evolving design agent for Claude Code and other coding agents — local-first, BYOK, Apache-2.0 — that keeps your skills and a portable brand as files in your own repo.',
          ...
          sections: [
            {
              ...
              blocks: [
                ...
                { kind: 'p', text: 'Marketing AX is a different posture: a local-first, open-source design agent you point your own coding agent at — overlapping on the prompt-to-design-artifact job, not on being a hosted product.' },
                { kind: 'ul', items: [
            ...
            },
            {
              ...
              heading: 'Local-first + BYOK, explained',
              blocks: [
                { kind: 'p', text: 'Marketing AX runs a desktop app, a local daemon, and Markdown skill/system catalogs on your machine. No design output is forced through a vendor cloud, and your brand lives in your repo as a portable DESIGN.md file every skill respects.' },
                { kind: 'p', text: 'You bring your own agent key. Credentials stay in local config or environment variables — Marketing AX never proxies them — and the API spend bills directly to you.' },
              ],
            },
            {
              id: 'compare',
              heading: 'Marketing AX vs Claude Design, feature by feature',
              blocks: [
                { kind: 'table', columns: ['Feature', 'Marketing AX', 'Claude Design'], rows: [
                  ['License', 'Apache-2.0, full source on GitHub', 'Closed-source, hosted product'],
                  ['Runtime', 'Local daemon on your machine', 'Vendor cloud'],
                ...
                { kind: 'p', text: 'Where Claude Design wins: zero local setup, one vendor bill, and a hosted UI. If that convenience is the priority, a hosted product is hard to beat — Marketing AX trades it for ownership, BYOK, and open source.' },
              ],
            },
            {
              id: 'who-picks',
            ...
            {
              id: 'migrate',
              heading: 'Moving a design from Claude Design into Marketing AX',
              blocks: [
    ...
    download: {
      title: 'Download Marketing AX — desktop app for macOS, Windows & Linux',
      description:
        'Download the latest Marketing AX desktop build. Install and create — sign in once, pick a model, start designing. macOS (Apple Silicon & Intel), Windows, and Linux.',
      breadcrumb: 'Download',
      label: 'Download',
      heading: 'Download Marketing AX.',
      lead:
      ...
      autoCtaFallback: 'Download Marketing AX',
      ...
      ctaBody:
        'Install from source in three commands, or drive Marketing AX headlessly from your existing coding agent.',
    },
  },
};
...
const COMPACT_DOWNLOAD_COPY: Partial<Record<LandingLocaleCode, DownloadCopy>> = {
  ja: {
    ...
    title: 'Marketing AX をダウンロード — macOS / Windows / Linux デスクトップアプリ',
    description:
      '最新の Marketing AX デスクトップ版をダウンロード。入れたらすぐ作れます——一度サインインし、モデルを選んで、デザインを開始。macOS（Apple Silicon と Intel）、Windows、Linux に対応。',
    breadcrumb: 'ダウンロード',
    label: 'ダウンロード',
    heading: 'Marketing AX をダウンロード。',
    lead:
      '入れたらすぐ作れます——API キー不要、設定不要。デスクトップ版は公式モデルルーター内蔵。一度サインインすればデザインを始められます。',
    autoCtaPrefix: 'ダウンロード:',
    autoCtaFallback: 'Marketing AX をダウンロード',
    recommended: 'おすすめ',
    publishedPrefix: '公開日',
    ...
    ctaTitle: 'ターミナル派ですか？',
    ctaBody:
      '3 つのコマンドでソースからインストール、または既存のコーディングエージェントから Marketing AX をヘッドレスで動かせます。',
  },
  ko: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Marketing AX 다운로드 — macOS / Windows / Linux 데스크톱 앱',
    description:
      '최신 Marketing AX 데스크톱 빌드를 다운로드하세요. 설치하면 바로 제작——한 번 로그인하고 모델을 고른 뒤 디자인을 시작하세요. macOS(Apple Silicon 및 Intel), Windows, Linux 지원.',
    breadcrumb: '다운로드',
    label: '다운로드',
    heading: 'Marketing AX 다운로드.',
    lead:
      '설치하면 바로 제작——API 키도, 설정도 필요 없습니다. 데스크톱 앱에는 공식 모델 라우터가 내장되어 있어 한 번 로그인하면 바로 디자인할 수 있습니다.',
    autoCtaPrefix: '다운로드 대상:',
    autoCtaFallback: 'Marketing AX 다운로드',
    recommended: '추천',
    publishedPrefix: '출시일',
    releaseNotes: '릴리스 노트',
    ...
    ctaBody:
      '세 개의 명령으로 소스에서 설치하거나, 기존 코딩 에이전트에서 Marketing AX을 헤드리스로 구동하세요.',
  },
  de: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Marketing AX herunterladen — Desktop-App für macOS, Windows & Linux',
    description:
    ...
    breadcrumb: 'Download',
    label: 'Download',
    heading: 'Marketing AX herunterladen.',
    lead:
    ...
    autoCtaFallback: 'Marketing AX herunterladen',
    ...
    ctaBody:
      'Installiere aus dem Quellcode mit drei Befehlen oder steuere Marketing AX headless aus deinem bestehenden Coding-Agent.',
  },
  fr: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Télécharger Marketing AX — application de bureau pour macOS, Windows et Linux',
    description:
      'Téléchargez la dernière version bureau d’Marketing AX. Installez et créez — connectez-vous une fois, choisissez un modèle, commencez à concevoir. macOS (Apple Silicon et Intel), Windows et Linux.',
    breadcrumb: 'Télécharger',
    label: 'Télécharger',
    heading: 'Télécharger Marketing AX.',
    lead:
    ...
    autoCtaFallback: 'Télécharger Marketing AX',
    ...
    ctaBody:
      'Installez depuis les sources en trois commandes, ou pilotez Marketing AX en mode headless depuis votre agent de code existant.',
  },
  ru: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Скачать Marketing AX — десктопное приложение для macOS, Windows и Linux',
    description:
      'Скачайте последнюю десктопную сборку Marketing AX. Установите и создавайте — войдите один раз, выберите модель, начните проектировать. macOS (Apple Silicon и Intel), Windows и Linux.',
    breadcrumb: 'Скачать',
    label: 'Скачать',
    heading: 'Скачать Marketing AX.',
    lead:
    ...
    autoCtaFallback: 'Скачать Marketing AX',
    ...
    ctaBody:
      'Установите из исходников тремя командами или управляйте Marketing AX в headless-режиме из вашего существующего агента для кода.',
  },
  es: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Descargar Marketing AX — app de escritorio para macOS, Windows y Linux',
    description:
      'Descarga la última versión de escritorio de Marketing AX. Instala y crea: inicia sesión una vez, elige un modelo y empieza a diseñar. macOS (Apple Silicon e Intel), Windows y Linux.',
    breadcrumb: 'Descargar',
    label: 'Descargar',
    heading: 'Descargar Marketing AX.',
    lead:
    ...
    autoCtaFallback: 'Descargar Marketing AX',
    ...
    ctaBody:
      'Instala desde el código fuente con tres comandos, o controla Marketing AX en modo headless desde tu agente de código actual.',
  },
  'pt-br': {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Baixar Marketing AX — app de desktop para macOS, Windows e Linux',
    description:
      'Baixe a versão de desktop mais recente do Marketing AX. Instale e crie: faça login uma vez, escolha um modelo e comece a projetar. macOS (Apple Silicon e Intel), Windows e Linux.',
    breadcrumb: 'Baixar',
    label: 'Baixar',
    heading: 'Baixar Marketing AX.',
    lead:
    ...
    autoCtaFallback: 'Baixar Marketing AX',
    recommended: 'Recomendado',
    ...
    ctaBody:
      'Instale a partir do código-fonte com três comandos, ou controle o Marketing AX em modo headless pelo seu agente de código atual.',
  },
  it: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Scarica Marketing AX — app desktop per macOS, Windows e Linux',
    description:
      'Scarica l’ultima build desktop di Marketing AX. Installa e crea: accedi una volta, scegli un modello e inizia a progettare. macOS (Apple Silicon e Intel), Windows e Linux.',
    breadcrumb: 'Scarica',
    label: 'Scarica',
    heading: 'Scarica Marketing AX.',
    lead:
    ...
    autoCtaFallback: 'Scarica Marketing AX',
    ...
    ctaBody:
      'Installa dai sorgenti con tre comandi, oppure pilota Marketing AX in modalità headless dal tuo agente di coding esistente.',
  },
  vi: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Tải Marketing AX — ứng dụng máy tính cho macOS, Windows và Linux',
    description:
      'Tải bản dựng máy tính Marketing AX mới nhất. Cài đặt là tạo được ngay — đăng nhập một lần, chọn mô hình và bắt đầu thiết kế. macOS (Apple Silicon và Intel), Windows và Linux.',
    breadcrumb: 'Tải xuống',
    label: 'Tải xuống',
    heading: 'Tải Marketing AX.',
    lead:
    ...
    autoCtaFallback: 'Tải Marketing AX',
    ...
    ctaBody:
      'Cài đặt từ mã nguồn bằng ba lệnh, hoặc điều khiển Marketing AX ở chế độ headless từ agent lập trình hiện có của bạn.',
  },
  pl: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Pobierz Marketing AX — aplikacja desktopowa na macOS, Windows i Linux',
    description:
      'Pobierz najnowszą wersję desktopową Marketing AX. Zainstaluj i twórz — zaloguj się raz, wybierz model i zacznij projektować. macOS (Apple Silicon i Intel), Windows oraz Linux.',
    breadcrumb: 'Pobierz',
    label: 'Pobierz',
    heading: 'Pobierz Marketing AX.',
    lead:
    ...
    autoCtaFallback: 'Pobierz Marketing AX',
    ...
    ctaBody:
      'Zainstaluj ze źródeł trzema poleceniami albo steruj Marketing AX w trybie headless ze swojego agenta do kodowania.',
  },
  id: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Unduh Marketing AX — aplikasi desktop untuk macOS, Windows & Linux',
    description:
      'Unduh build desktop Marketing AX terbaru. Pasang lalu berkarya — masuk sekali, pilih model, mulai mendesain. macOS (Apple Silicon & Intel), Windows, dan Linux.',
    breadcrumb: 'Unduh',
    label: 'Unduh',
    heading: 'Unduh Marketing AX.',
    lead:
    ...
    autoCtaFallback: 'Unduh Marketing AX',
    ...
    ctaBody:
      'Pasang dari sumber dengan tiga perintah, atau jalankan Marketing AX secara headless dari agen coding Anda yang sudah ada.',
  },
  nl: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Marketing AX downloaden — desktop-app voor macOS, Windows en Linux',
    description:
      'Download de nieuwste Marketing AX desktop-build. Installeren en maken — één keer inloggen, een model kiezen en beginnen met ontwerpen. macOS (Apple Silicon en Intel), Windows en Linux.',
    breadcrumb: 'Downloaden',
    label: 'Downloaden',
    heading: 'Marketing AX downloaden.',
    lead:
    ...
    autoCtaFallback: 'Marketing AX downloaden',
    ...
    ctaBody:
      'Installeer vanuit de broncode met drie commando’s, of stuur Marketing AX headless aan vanuit je bestaande coding-agent.',
  },
  ar: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'تنزيل Marketing AX — تطبيق سطح المكتب لنظام macOS وWindows وLinux',
    description:
      'نزّل أحدث إصدار سطح مكتب من Marketing AX. ثبّت وابدأ الإنشاء — سجّل الدخول مرة واحدة، اختر نموذجًا، وابدأ التصميم. يدعم macOS (Apple Silicon وIntel) وWindows وLinux.',
    breadcrumb: 'تنزيل',
    label: 'تنزيل',
    heading: 'تنزيل Marketing AX.',
    lead:
    ...
    autoCtaFallback: 'تنزيل Marketing AX',
    recommended: 'موصى به',
    ...
    ctaBody:
      'ثبّت من المصدر بثلاثة أوامر، أو شغّل Marketing AX بوضع headless من وكيل البرمجة الحالي لديك.',
  },
  tr: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Marketing AX’i indir — macOS, Windows ve Linux için masaüstü uygulaması',
    description:
      'En son Marketing AX masaüstü sürümünü indirin. Kurun ve üretmeye başlayın — bir kez giriş yapın, bir model seçin, tasarlamaya başlayın. macOS (Apple Silicon ve Intel), Windows ve Linux.',
    breadcrumb: 'İndir',
    label: 'İndir',
    heading: 'Marketing AX’i indir.',
    lead:
    ...
    autoCtaFallback: 'Marketing AX’i indir',
    ...
    ctaBody:
      'Kaynaktan üç komutla kurun veya Marketing AX’i mevcut kodlama aracınızdan headless olarak çalıştırın.',
  },
  uk: {
    ...INFO_PAGE_COPY.en!.download,
    title: 'Завантажити Marketing AX — десктопний застосунок для macOS, Windows і Linux',
    description:
      'Завантажте найновішу десктопну збірку Marketing AX. Встановіть і творіть — увійдіть один раз, виберіть модель, почніть проєктувати. macOS (Apple Silicon та Intel), Windows і Linux.',
    breadcrumb: 'Завантажити',
    label: 'Завантажити',
    heading: 'Завантажити Marketing AX.',
    lead:
    ...
    autoCtaFallback: 'Завантажити Marketing AX',
    ...
    ctaBody:
      'Встановіть із джерел трьома командами або керуйте Marketing AX у headless-режимі з наявного агента для кодування.',
  },
};
...
INFO_PAGE_COPY.zh = {
  ...
  official: {
    ...
    title: '官方 Marketing AX —— 来源页、GitHub、发布与别名',
    description:
      'Marketing AX 官方来源页：canonical 网站、GitHub 仓库、发布、Discord、许可证和维护者身份都集中在这里。',
    breadcrumb: '官方',
    label: '来源 · Nº 00',
    heading: '官方 Marketing AX 来源页。',
    lead:
      'Marketing AX（也会被搜索为 OpenDesign、open-design、opendesign 或 Open Design AI）是 nexu-io/open-design 项目的官方开源 AI 设计工作台。这个页面列出所有 canonical 入口，方便你自行核验来源。',
    ...
    aliases: [
      { label: 'Marketing AX', body: '产品 UI、博客和 README 中的展示名。' },
    ...
    maintainerBody:
      'Marketing AX 在 github.com/nexu-io/open-design 公开开发，并以 Apache-2.0 发布。Issue、RFC 和路线图讨论都在 GitHub Issues 与 Discord 进行。',
    runtimeTitle: '你的机器上运行什么',
    runtimeBody: 'Marketing AX 提供三个可运行表面，全部开源、全部本地优先：',
    runtimeItems: [
  ...
  quickstart: {
    ...
    title: 'Marketing AX 快速开始 —— 三条命令安装（Node 24、pnpm）',
    description:
      '用三条命令在本地安装 Marketing AX。包含 Node 24、pnpm 10.33.2 要求、命令、预期输出、排障和首次生成设计 artifact 的步骤。',
    breadcrumb: '快速开始',
    label: '安装 · Nº 01',
    heading: 'Marketing AX 快速开始。',
    lead: 'Marketing AX 完全运行在你的机器上。三条命令就能从干净 checkout 到本地 daemon、Web UI 和第一个设计 artifact。',
    ...
    nextItems: [
      ...
      { label: '比较 Marketing AX', body: '了解它和 Claude Design、Figma Make、v0、Lovable 的差异。' },
  ...
  agents: {
    ...
    title: 'Marketing AX Agent —— {count} 个 BYOK 适配器',
    description: 'Marketing AX 内置 {count} 个 BYOK 适配器。直接用你写代码时已经在用的 Agent 来驱动设计，无需额外厂商登录。',
    breadcrumb: 'Agent',
    label: '适配器 · Nº 04',
    heading: (count) => `${count} 个 BYOK Agent，一套 Skill 协议。`,
    lead: (count) =>
      `Marketing AX 内置 ${count} 个一方适配器。同一套可组合 Skill 和可移植 DESIGN.md 系统可以用于每一个 Agent。全程 BYOK：你的密钥、你的成本、你的数据。`,
    adaptersTitle: '适配器如何接入',
    adaptersBody:
      '每个适配器都是很薄的一层 shim，把 Agent 原生消息格式翻译成 Marketing AX Skill 协议。新增适配器通常只是一个文件，不需要 fork 整个产品。',
    tiers: [
      { label: 'Tier 1 —— 一方日常验证', blurb: 'Marketing AX 维护者每天使用的适配器。支持时会使用 Stream-JSON IPC、AskUserQuestion 中途交互和 Skill-aware system prompt。' },
    ...
    byokLead: 'Marketing AX 中的 BYOK（bring your own key）意味着凭据和成本都留在你这一侧：',
    byokItems: [
    ...
    ctaBody: '选择你电脑上已有的 Agent，把 Marketing AX 指向它，然后开始渲染。',
  },
  compare: {
    ...INFO_PAGE_COPY.en!.compare,
    title: 'Marketing AX vs Claude Design、Figma Make、v0、Lovable —— 诚实对比',
    description:
      '比较 Marketing AX 与主流 AI 设计工具：云端托管 vs 本地优先、BYOK vs 厂商锁定、一次性生成 vs 可移植 DESIGN.md 系统。',
    breadcrumb: '对比',
    label: '评估 · Nº 02',
    heading: 'Marketing AX 与其它工具的对比。',
    lead: '这里用简短、诚实的摘要说明 Marketing AX 与你可能正在评估的其它 AI 设计工具之间的关系。',
    toc: ['vs Claude Design', 'vs Figma Make', 'vs v0', 'vs Lovable / Bolt', 'vs Open CoDesign', '真实限制'],
    comparisons: [
      { competitor: 'Claude Design', summary: '绑定单一厂商的云端产品。Marketing AX 本地优先、BYOK、Apache-2.0，Skill 与 DESIGN.md 都留在你的 repo。', cta: '阅读完整对比 ->' },
      { competitor: 'Figma Make', summary: 'Figma Make 侧重在 Figma 内 prompt-to-mockup。Marketing AX 把可移植 artifact 直接交付到你的项目。', cta: '查看仓库中的迁移说明 ->' },
      { competitor: 'v0 by Vercel', summary: 'v0 在云端 runtime 生成 React 组件。Marketing AX 在本地生成 deck、dashboard、landing page 和品牌系统。', cta: '查看仓库中的迁移说明 ->' },
      { competitor: 'Lovable / Bolt', summary: 'Lovable 和 Bolt 侧重云端 prompt-to-app。Marketing AX 是给你已有 Agent 使用的设计 Skill 层。', cta: '查看仓库中的迁移说明 ->' },
      { competitor: 'Open CoDesign', summary: 'Open CoDesign 是同领域开源项目。Marketing AX 可以通过 Skill 协议包装 codesign 类型工作流。', cta: '查看仓库中的迁移说明 ->' },
    ],
    limitsTitle: '真实限制 —— Marketing AX 不是什么',
    limitsBody: 'Marketing AX 不试图成为所有云端 AI 设计工具。下面的问题说明实际取舍，而不是把限制包装掉。',
    limitsFaq: [
      { name: 'Marketing AX 有云端 Web sandbox 吗？', text: '没有。Marketing AX 的设计目标就是本地优先。' },
      { name: '不安装任何东西可以使用 Marketing AX 吗？', text: '目前不行。最小形态是本地 daemon 加一个 coding agent。' },
      { name: 'Marketing AX 是 v0 / Lovable / Bolt 替代品吗？', text: '取决于场景。Marketing AX 聚焦通过可 fork 的 Skill 协议生成设计 artifact。' },
      { name: 'Marketing AX 会把我的数据发给 Anthropic、OpenAI 或 Google 吗？', text: '只会把 prompt 与 Skill 上下文发给你自己带 key 的 provider。' },
      { name: '可以把 Marketing AX 自托管到自己的基础设施吗？', text: '可以。Apache-2.0、Node 24 daemon、没有必需 SaaS。' },
    ],
  },
  claudeAlternative: {
    ...INFO_PAGE_COPY.en!.claudeAlternative,
    title: 'Claude Design 开源替代方案 —— Marketing AX（BYOK、本地优先）',
    description:
      'Marketing AX 是 Claude Design 的开源、本地优先替代方案。支持 Claude Code、Codex、Cursor、Gemini、OpenCode 或 Qwen 的 BYOK 工作流。',
    breadcrumb: 'Claude Design 开源替代方案',
    label: '替代方案 · Nº 03',
    heading: 'Claude Design 的开源替代方案。',
    lead:
      'Marketing AX 是官方开源、本地优先的 Claude Design 替代方案。你可以用自己已有的 Agent BYOK，把品牌保存为可移植 DESIGN.md 文件，并把 artifact 作为项目文件交付。',
    tldrTitle: '简版结论',
    ...
    localByokBody: [
      'Marketing AX 在你的机器上运行桌面应用、本地 daemon，以及 Markdown 形式的 Skill/System 目录。',
    ...
    pickOpenTitle: '适合 Marketing AX 的情况',
    ...
    migrateSteps: ['按快速开始安装 Marketing AX。', '打开 Web UI，让 Agent 查看一个你喜欢的 Claude Design artifact。', '让 Agent 把品牌提取成 DESIGN.md 文件。', '选择一个 Skill，用新品牌渲染。'],
    migrateClosing: '之后每个 Skill 都能沿用你的品牌，不需要反复重新提示。',
    faqTitle: 'FAQ',
    faq: [
      { name: 'Marketing AX 真的是 Claude Design 的 drop-in 替代吗？', text: '不是字面上的 drop-in，但它们都覆盖 prompt-to-design-artifact 这个用途。' },
      { name: '可以在 Marketing AX 中使用 Claude 作为 Agent 吗？', text: '可以。Marketing AX 支持 Claude Code 和 Anthropic API BYOK。' },
      { name: '我的 Claude Design 设计怎么办？', text: '你可以继续并行使用 Claude Design；目前迁移是手动的。' },
      { name: 'Marketing AX 能生成相同类型的 artifact 吗？', text: '常见类型可以：落地页、演示文稿、仪表盘、社交内容、品牌系统和原型。' },
      { name: '为什么说 open-source Claude Design，而不是 open-source AI design tool？', text: '因为很多用户就是用这个形状来描述他们在找的产品。' },
      { name: '谁在构建和维护 Marketing AX？', text: '项目位于 github.com/nexu-io/open-design，许可证为 Apache-2.0。' },
    ],
    ctaTitle: '三条命令切换。',
  ...
  download: {
    ...INFO_PAGE_COPY.en!.download,
    title: '下载 Marketing AX —— macOS / Windows / Linux 桌面客户端',
    description:
      '下载最新版 Marketing AX 桌面客户端。装上就能创作——登录一次、选个模型、开始设计。支持 macOS（Apple Silicon 与 Intel）、Windows、Linux。',
    breadcrumb: '下载',
    label: '下载',
    heading: '下载 Marketing AX。',
    lead: '装上就能创作——不需要 API key、零配置。桌面端内置官方 model router，登录一次即可开始设计。',
    autoCtaPrefix: '下载适用于',
    autoCtaFallback: '下载 Marketing AX',
    recommended: '推荐',
    publishedPrefix: '发布于',
    releaseNotes: '更新日志',
    platformsTitle: '全部平台',
    ...
    ctaTitle: '更喜欢用终端？',
    ctaBody: '三条命令从源码安装，或用你现有的编码 agent 以 headless 方式驱动 Marketing AX。',
  },
};
...
INFO_PAGE_COPY['zh-tw'] = {
  ...
  official: {
    ...
    title: '官方 Marketing AX —— 來源頁、GitHub、發布與別名',
    description:
      'Marketing AX 官方來源頁：canonical 網站、GitHub repo、發布、Discord、授權與維護者身份都集中在這裡。',
    breadcrumb: '官方',
    heading: '官方 Marketing AX 來源頁。',
    lead:
      'Marketing AX（也會被搜尋為 OpenDesign、open-design、opendesign 或 Open Design AI）是 nexu-io/open-design 專案的官方開源 AI 設計工作台。這個頁面列出所有 canonical 入口，方便你自行核驗來源。',
    canonicalBody: '請收藏 open-design.ai 與 GitHub repo。其他入口都應回到這兩個來源之一。',
    aliasesTitle: '命名與別名',
    aliasesLead: '不同工具、受眾與語言環境裡，這個專案會以幾種方式被搜尋和書寫：',
    aliases: [
      { label: 'Marketing AX', body: '產品 UI、部落格與 README 中的展示名。' },
    ...
    maintainerBody:
      'Marketing AX 在 github.com/nexu-io/open-design 公開開發，並以 Apache-2.0 發布。Issue、RFC 與路線圖討論都在 GitHub Issues 與 Discord 進行。',
    runtimeTitle: '你的機器上執行什麼',
    runtimeBody: 'Marketing AX 提供三個可執行表面，全部開源、全部本地優先：',
    runtimeItems: [
  ...
  quickstart: {
    ...
    title: 'Marketing AX 快速開始 —— 三條命令安裝（Node 24、pnpm）',
    description:
      '用三條命令在本地安裝 Marketing AX。包含 Node 24、pnpm 10.33.2 要求、命令、預期輸出、排障與首次生成設計 artifact 的步驟。',
    breadcrumb: '快速開始',
    heading: 'Marketing AX 快速開始。',
    lead: 'Marketing AX 完全執行在你的機器上。三條命令就能從乾淨 checkout 到本地 daemon、Web UI 和第一個設計 artifact。',
  ...
  agents: {
    ...
    title: 'Marketing AX Agent —— {count} 個 BYOK adapter',
    description: 'Marketing AX 內建 {count} 個 BYOK adapter。直接用你寫程式時已經在用的 Agent 來驅動設計，無需額外供應商登入。',
    breadcrumb: 'Agent',
    heading: (count) => `${count} 個 BYOK Agent，一套 Skill 協議。`,
    lead: (count) =>
      `Marketing AX 內建 ${count} 個一方 adapter。同一套可組合 Skill 與可移植 DESIGN.md 系統可以用於每一個 Agent。全程 BYOK：你的密鑰、你的成本、你的資料。`,
    adaptersTitle: 'Adapter 如何接入',
    adaptersBody:
      '每個 adapter 都是很薄的一層 shim，把 Agent 原生訊息格式翻譯成 Marketing AX Skill 協議。新增 adapter 通常只是一個檔案，不需要 fork 整個產品。',
    vendor: '供應商',
    credential: '憑據',
    byokTitle: '這裡的 BYOK 是什麼意思',
    byokLead: 'Marketing AX 中的 BYOK（bring your own key）意味著憑據和成本都留在你這一側：',
    byokItems: [
    ...
    ctaBody: '選擇你電腦上已有的 Agent，把 Marketing AX 指向它，然後開始渲染。',
  },
  compare: {
    ...INFO_PAGE_COPY.zh!.compare,
    title: 'Marketing AX vs Claude Design、Figma Make、v0、Lovable —— 誠實比較',
    breadcrumb: '比較',
    label: '評估 · Nº 02',
    heading: 'Marketing AX 與其他工具的比較。',
    lead: '這裡用簡短、誠實的摘要說明 Marketing AX 與你可能正在評估的其他 AI 設計工具之間的關係。',
    limitsTitle: '真實限制 —— Marketing AX 不是什麼',
    limitsBody: 'Marketing AX 不試圖成為所有雲端 AI 設計工具。下面的問題說明實際取捨，而不是把限制包裝掉。',
  },
  claudeAlternative: {
    ...INFO_PAGE_COPY.zh!.claudeAlternative,
    title: 'Claude Design 開源替代方案 —— Marketing AX（BYOK、本地優先）',
    description:
      'Marketing AX 是 Claude Design 的開源、本地優先替代方案。支援 Claude Code、Codex、Cursor、Gemini、OpenCode 或 Qwen 的 BYOK 工作流。',
    breadcrumb: 'Claude Design 開源替代方案',
    label: '替代方案 · Nº 03',
    heading: 'Claude Design 的開源替代方案。',
    lead:
      'Marketing AX 是官方開源、本地優先的 Claude Design 替代方案。你可以用自己已有的 Agent BYOK，把品牌保存為可移植 DESIGN.md 檔案，並把 artifact 作為專案檔案交付。',
    tldrTitle: '簡版結論',
    ...
    pickOpenTitle: '適合 Marketing AX 的情況',
    migrateTitle: '遷移 / 首次執行',
    faqTitle: 'FAQ',
    faq: [
      { name: 'Marketing AX 真的是 Claude Design 的 drop-in 替代嗎？', text: '不是字面上的 drop-in，但它們都覆蓋 prompt-to-design-artifact 這個用途。' },
      { name: '可以在 Marketing AX 中使用 Claude 作為 Agent 嗎？', text: '可以。Marketing AX 支援 Claude Code 和 Anthropic API BYOK。' },
      { name: '我的 Claude Design 設計怎麼辦？', text: '你可以繼續並行使用 Claude Design；目前遷移是手動的。' },
      { name: 'Marketing AX 能生成相同類型的 artifact 嗎？', text: '常見類型可以：落地頁、簡報、儀表板、社群內容、品牌系統和原型。' },
      { name: '為什麼說 open-source Claude Design，而不是 open-source AI design tool？', text: '因為很多使用者就是用這個形狀來描述他們在找的產品。' },
      { name: '誰在構建和維護 Marketing AX？', text: '專案位於 github.com/nexu-io/open-design，授權為 Apache-2.0。' },
    ],
    ctaTitle: '三條命令切換。',
...
> = {
  ja: {
    ...
    reusable: {
      sourceBody: 'この項目は Marketing AX の正規の入口と同じプロジェクトを指します。',
    ...
    official: {
      title: '公式 Marketing AX — 出典、GitHub、リリース、別名',
      description: 'Marketing AX の正規ページ、GitHub、リリース、コミュニティ、ライセンスをまとめた確認用ページです。',
      breadcrumb: '公式',
      label: '出典 · Nº 00',
      heading: '公式 Marketing AX 出典ページ。',
      lead: 'Marketing AX は nexu-io/open-design プロジェクトのオープンソース AI デザインワークスペースです。',
    },
    quickstart: {
      title: 'Marketing AX クイックスタート — Node 24 と pnpm で開始',
      description: 'Marketing AX をローカルに入れ、daemon、Web UI、最初の artifact まで進む手順です。',
      breadcrumb: 'クイックスタート',
      label: 'インストール · Nº 01',
      heading: 'Marketing AX クイックスタート。',
      lead: 'ローカル環境だけで起動し、既存のエージェントからデザイン生成を始められます。',
      ctaTitle: 'ローカルで始める。',
    },
    agents: {
      title: 'Marketing AX エージェント — {count} 個の BYOK アダプター',
      description: '普段使っているコーディングエージェントから Marketing AX のスキルを実行できます。',
      breadcrumb: 'エージェント',
      label: 'アダプター · Nº 04',
      heading: '{count} 個の BYOK エージェント、1 つのスキルプロトコル。',
      lead: 'Marketing AX は {count} 個のアダプターで、同じスキルと DESIGN.md を複数のエージェントから使えます。',
      ctaTitle: '{count} 個のアダプター。あなたのエージェント。',
    },
    compare: {
      title: 'Marketing AX と主要 AI デザインツールの比較',
      description: 'ローカル優先、BYOK、オープンソース、ポータブルな DESIGN.md という観点で比較します。',
      breadcrumb: '比較',
      label: '評価 · Nº 02',
      heading: 'Marketing AX と他の選択肢。',
      lead: 'Marketing AX はホスト型ツールではなく、エージェントで動かすローカル優先のデザイン層です。',
    },
    claudeAlternative: {
      title: 'Claude Design のオープンソース代替 — Marketing AX',
      description: 'Marketing AX は BYOK とローカル優先を軸にした Claude Design 代替です。',
...
function compactInfoTextFromHome(locale: LandingLocaleCode): CompactInfoPageText {
  ...
  return {
    ...
    official: {
      title: `${labels.official} · Marketing AX`,
      description: summary,
      breadcrumb: labels.official,
      label: labels.official,
      heading: `${labels.official} · Marketing AX`,
      lead,
    },
    quickstart: {
      title: `${labels.quickstart} · Marketing AX`,
      description: lead,
      breadcrumb: labels.quickstart,
      label: labels.quickstart,
      heading: `${labels.quickstart} · Marketing AX`,
      lead,
      ctaTitle: labels.next,
    },
    agents: {
      title: `${labels.agents} · Marketing AX`,
      description: lead,
    ...
    compare: {
      title: `${labels.compare} · Marketing AX`,
      description: summary,
      breadcrumb: labels.compare,
      label: labels.compare,
      heading: `${labels.compare} · Marketing AX`,
      lead,
    },
    claudeAlternative: {
      title: `${labels.alternative} · Marketing AX`,
      description: summary,
      breadcrumb: labels.alternative,
      label: labels.alternative,
      heading: `${labels.alternative} · Marketing AX`,
