...
> = {
  fr: homeFallbackCopy({
    railRight: 'Marketing AX — vol. 01 · no 26 · Apache-2.0',
    railLeft: 'Skills · systèmes · agents · BYOK · local d’abord',
    discordAria: 'Rejoindre le Discord Marketing AX',
    ...
    heroLead: (skills, systems) =>
      `Marketing AX est l’alternative officielle, local-first, à Claude Design. Votre agent de code — Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen — devient un moteur de design avec ${skills} skills composables et ${systems} systèmes DESIGN.md portables.`,
    ...
    officialAria: 'Source officielle Marketing AX',
    ...
    about: {
      ...
      caption: 'Études de forme · perception · imagination machinique. (Marketing AX, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Édité par Marketing AX',
    ...
    testimonial: {
      ...
      quote: '« Marketing AX a transformé des idées IA floues en un système visuel net, crédible et réellement nouveau. »',
  ...
  ru: homeFallbackCopy({
    railRight: 'Marketing AX — том 01 · выпуск № 26 · Apache-2.0',
    railLeft: 'Skills · системы · агенты · BYOK · local-first',
    discordAria: 'Присоединиться к Discord Marketing AX',
    ...
    heroLead: (skills, systems) =>
      `Marketing AX — официальная local-first альтернатива Claude Design. Ваш coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode или Qwen — становится дизайн-движком с ${skills} составными skills и ${systems} переносимыми DESIGN.md-системами.`,
    ...
    officialAria: 'Официальный источник Marketing AX',
    ...
    about: {
      ...
      caption: 'Исследования формы · восприятия · машинного воображения. (Marketing AX, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Редакция Marketing AX',
    ...
    testimonial: {
      ...
      label: 'Соавторы',
      quote: '«Marketing AX помог превратить расплывчатые AI-идеи в четкую, надежную и действительно новую визуальную систему.»',
  ...
  es: homeFallbackCopy({
    railRight: 'Marketing AX — vol. 01 · número 26 · Apache-2.0',
    railLeft: 'Skills · sistemas · agentes · BYOK · local-first',
    discordAria: 'Unirse al Discord de Marketing AX',
    ...
    heroLead: (skills, systems) =>
      `Marketing AX es la alternativa oficial, local-first, a Claude Design. Tu agente de código — Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen — se convierte en un motor de diseño con ${skills} skills componibles y ${systems} sistemas DESIGN.md portables.`,
    ...
    officialAria: 'Fuente oficial de Marketing AX',
    ...
    about: {
      ...
      caption: 'Estudios de forma · percepción · imaginación maquínica. (Marketing AX, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Editado por Marketing AX',
    ...
    testimonial: {
      ...
      label: 'Colaboradores',
      quote: '«Marketing AX convirtió ideas de IA borrosas en un sistema visual nítido, creíble y realmente nuevo.»',
  ...
  'pt-br': homeFallbackCopy({
    railRight: 'Marketing AX — vol. 01 · edição nº 26 · Apache-2.0',
    railLeft: 'Skills · sistemas · agentes · BYOK · local-first',
    discordAria: 'Entrar no Discord do Marketing AX',
    ...
    heroLead: (skills, systems) =>
      `Marketing AX é a alternativa oficial, local-first, ao Claude Design. Seu agente de código — Claude Code, Codex, Cursor, Gemini, OpenCode ou Qwen — vira um motor de design com ${skills} skills componíveis e ${systems} sistemas DESIGN.md portáteis.`,
    ...
    officialAria: 'Fonte oficial do Marketing AX',
    ...
    about: {
      ...
      caption: 'Estudos de forma · percepção · imaginação maquínica. (Marketing AX, MMXXVI)',
    },
    capabilities: {
      rule: 'Capacidades · skills · sistemas',
    ...
    testimonial: {
      ...
      label: 'Colaboradores',
      quote: '“Marketing AX transformou ideias vagas de IA em um sistema visual nítido, confiável e realmente novo.”',
  ...
  it: homeFallbackCopy({
    railRight: 'Marketing AX — vol. 01 · numero 26 · Apache-2.0',
    railLeft: 'Skill · sistemi · agenti · BYOK · local-first',
    discordAria: 'Entra nel Discord di Marketing AX',
    ...
    heroLead: (skills, systems) =>
      `Marketing AX è l’alternativa ufficiale, local-first, a Claude Design. Il tuo agente di codice — Claude Code, Codex, Cursor, Gemini, OpenCode o Qwen — diventa un motore di design con ${skills} skill componibili e ${systems} sistemi DESIGN.md portabili.`,
    ...
    officialAria: 'Fonte ufficiale Marketing AX',
    ...
    about: {
      ...
      caption: 'Studi di forma · percezione · immaginazione macchinica. (Marketing AX, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Redazione Marketing AX',
    ...
    testimonial: {
      ...
      label: 'Collaboratori',
      quote: '“Marketing AX ha trasformato idee AI vaghe in un sistema visivo nitido, credibile e davvero nuovo.”',
  ...
  vi: homeFallbackCopy({
    railRight: 'Marketing AX — tập 01 · số 26 · Apache-2.0',
    railLeft: 'Skill · hệ thống · agent · BYOK · ưu tiên local',
    discordAria: 'Tham gia Discord Marketing AX',
    ...
    heroLead: (skills, systems) =>
      `Marketing AX là lựa chọn chính thức, ưu tiên local, thay Claude Design. Agent viết code bạn đang dùng — Claude Code, Codex, Cursor, Gemini, OpenCode hoặc Qwen — trở thành engine thiết kế với ${skills} skill có thể ghép và ${systems} hệ DESIGN.md di động.`,
    ...
    officialAria: 'Nguồn chính thức của Marketing AX',
    ...
    about: {
      ...
      caption: 'Nghiên cứu hình thái · tri giác · tưởng tượng máy. (Marketing AX, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Biên tập bởi Marketing AX',
    ...
    testimonial: {
      ...
      label: 'Cộng tác viên',
      quote: '“Marketing AX biến ý tưởng AI mơ hồ thành một hệ thị giác sắc nét, đáng tin và thật sự mới.”',
  ...
  pl: homeFallbackCopy({
    railRight: 'Marketing AX — tom 01 · wydanie nr 26 · Apache-2.0',
    railLeft: 'Skills · systemy · agenci · BYOK · lokalnie najpierw',
    discordAria: 'Dołącz do Discorda Marketing AX',
    ...
    heroLead: (skills, systems) =>
      `Marketing AX to oficjalna, lokalna z założenia alternatywa dla Claude Design. Twój agent do kodu — Claude Code, Codex, Cursor, Gemini, OpenCode albo Qwen — staje się silnikiem designu z ${skills} kompozycyjnymi skills i ${systems} przenośnymi systemami DESIGN.md.`,
    ...
    officialAria: 'Oficjalne źródło Marketing AX',
    ...
    about: {
      ...
      caption: 'Studia formy · percepcji · wyobraźni maszynowej. (Marketing AX, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Redakcja Marketing AX',
      label: 'Wybrane prace',
    ...
    testimonial: {
      ...
      quote: '„Marketing AX zmienił niejasne idee AI w ostry, wiarygodny i naprawdę nowy system wizualny.”',
  ...
  id: homeFallbackCopy({
    railRight: 'Marketing AX — vol. 01 · edisi nº 26 · Apache-2.0',
    railLeft: 'Skill · sistem · agent · BYOK · local-first',
    discordAria: 'Bergabung ke Discord Marketing AX',
    ...
    heroLead: (skills, systems) =>
      `Marketing AX adalah alternatif resmi, local-first, untuk Claude Design. Agent coding yang sudah Anda pakai — Claude Code, Codex, Cursor, Gemini, OpenCode, atau Qwen — menjadi mesin desain dengan ${skills} skill komposable dan ${systems} sistem DESIGN.md portabel.`,
    ...
    officialAria: 'Sumber resmi Marketing AX',
    ...
    about: {
      ...
      caption: 'Studi bentuk · persepsi · imajinasi mesin. (Marketing AX, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Disunting Marketing AX',
      label: 'Karya pilihan',
    ...
    testimonial: {
      ...
      label: 'Kolaborator',
      quote: '“Marketing AX mengubah ide AI yang samar menjadi sistem visual yang tajam, dapat dipercaya, dan benar-benar baru.”',
  ...
  nl: homeFallbackCopy({
    railRight: 'Marketing AX — deel 01 · nummer 26 · Apache-2.0',
    railLeft: 'Skills · systemen · agents · BYOK · local-first',
    discordAria: 'Word lid van Marketing AX Discord',
    ...
    heroLead: (skills, systems) =>
      `Marketing AX is het officiële local-first alternatief voor Claude Design. Je bestaande code-agent — Claude Code, Codex, Cursor, Gemini, OpenCode of Qwen — wordt een design-engine met ${skills} combineerbare skills en ${systems} draagbare DESIGN.md-systemen.`,
    ...
    officialAria: 'Officiële bron van Marketing AX',
    ...
    about: {
      ...
      caption: 'Studies naar vorm · perceptie · machinale verbeelding. (Marketing AX, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Marketing AX-redactie',
    ...
    testimonial: {
      ...
      label: 'Samenwerkers',
      quote: '“Marketing AX veranderde vage AI-ideeën in een scherp, geloofwaardig en echt nieuw visueel systeem.”',
  ...
  ar: homeFallbackCopy({
    railRight: 'Marketing AX — المجلد 01 · العدد 26 · Apache-2.0',
    railLeft: 'Skills · أنظمة · Agents · BYOK · محلي أولاً',
    discordAria: 'الانضمام إلى Discord الخاص بـ Marketing AX',
    ...
    heroLead: (skills, systems) =>
      `Marketing AX هو البديل الرسمي المحلي أولاً لـ Claude Design. يتحول agent البرمجة الذي تستخدمه — Claude Code أو Codex أو Cursor أو Gemini أو OpenCode أو Qwen — إلى محرك تصميم يعتمد على ${skills} skills قابلة للتركيب و ${systems} أنظمة DESIGN.md قابلة للنقل.`,
    ...
    officialAria: 'المصدر الرسمي لـ Marketing AX',
    ...
    about: {
      ...
      caption: 'دراسات في الشكل · الإدراك · الخيال الآلي. (Marketing AX, MMXXVI)',
    },
    capabilities: {
    ...
    testimonial: {
      ...
      label: 'المتعاونون',
      quote: '“حوّل Marketing AX أفكار AI الغامضة إلى نظام بصري حاد وموثوق وجديد فعلاً.”',
    ...
    faqSection: {
      ...
      label: 'أسئلة Marketing AX الشائعة',
  ...
  tr: homeFallbackCopy({
    railRight: 'Marketing AX — cilt 01 · sayı nº 26 · Apache-2.0',
    railLeft: 'Skill · sistem · agent · BYOK · local-first',
    discordAria: 'Marketing AX Discord’a katıl',
    ...
    heroLead: (skills, systems) =>
      `Marketing AX, Claude Design’ın resmi local-first alternatifidir. Kullandığın coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode veya Qwen — ${skills} birleştirilebilir skill ve ${systems} taşınabilir DESIGN.md sistemiyle bir tasarım motoruna dönüşür.`,
    ...
    officialAria: 'Marketing AX resmi kaynağı',
    ...
    about: {
      ...
      caption: 'Form · algı · makine imgelemi çalışmaları. (Marketing AX, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Marketing AX editörlüğü',
    ...
    testimonial: {
      ...
      label: 'İşbirlikçiler',
      quote: '“Marketing AX belirsiz AI fikirlerini keskin, güvenilir ve gerçekten yeni bir görsel sisteme dönüştürdü.”',
  ...
  uk: homeFallbackCopy({
    railRight: 'Marketing AX — том 01 · випуск № 26 · Apache-2.0',
    railLeft: 'Skills · системи · агенти · BYOK · local-first',
    discordAria: 'Приєднатися до Discord Marketing AX',
    ...
    heroLead: (skills, systems) =>
      `Marketing AX — офіційна local-first альтернатива Claude Design. Ваш coding agent — Claude Code, Codex, Cursor, Gemini, OpenCode або Qwen — стає design engine із ${skills} composable skills та ${systems} portable DESIGN.md systems.`,
    ...
    officialAria: 'Офіційне джерело Marketing AX',
    ...
    about: {
      ...
      caption: 'Дослідження форми · сприйняття · машинної уяви. (Marketing AX, MMXXVI)',
    },
    capabilities: {
    ...
    work: {
      ...
      editedBy: 'Редакція Marketing AX',
    ...
    testimonial: {
      ...
      label: 'Співтворці',
      quote: '«Marketing AX допоміг перетворити нечіткі AI-ідеї на гостру, надійну й справді нову візуальну систему.»',
