...
const zhTw: HomeExtra = {
  ...
  heroSub:
    'Figma 與 Claude Design 的 Agent-native 替代方案。\n桌面用戶端優先，接入 21 個 Coding Agent、150 個 Design System，Apache-2.0。',
...
const vi: HomeExtra = {
  ...
  heroSub:
    'Giải pháp agent-native thay thế cho Figma và Claude Design.\nƯu tiên desktop, với 21 coding agent, 150 design system và giấy phép Apache-2.0.',
...
const pl: HomeExtra = {
  ...
  heroSub:
    'Agent-native alternatywa dla Figmy i Claude Design.\nDesktop-first, z 21 agentami kodu, 150 design systemami i licencją Apache-2.0.',
...
const id: HomeExtra = {
  ...
  heroSub:
    'Alternatif agent-native untuk Figma dan Claude Design.\nDesktop-first, dengan 21 coding agent, 150 design system, dan lisensi Apache-2.0.',
...
const nl: HomeExtra = {
  ...
  heroSub:
    'Een agent-native alternatief voor Figma en Claude Design.\nDesktop-first, met 21 coding agents, 150 design systems en een Apache-2.0-licentie.',
...
const ar: HomeExtra = {
  ...
  heroSub:
    'بديل أصيل للوكلاء عن Figma و Claude Design.\nالأولوية لسطح المكتب، مع 21 وكيل برمجة و150 نظام تصميم ورخصة Apache-2.0.',
...
const uk: HomeExtra = {
  ...
  heroSub:
    'Agent-native альтернатива Figma та Claude Design.\nDesktop-first, з 21 кодинг-агентами, 150 дизайн-системами та ліцензією Apache-2.0.',
