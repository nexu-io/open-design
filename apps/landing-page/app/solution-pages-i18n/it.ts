...
export const IT: SolutionLocaleCopy = {
  aiWireframeGenerator: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Prototipo di app multischermo a mosaico' },
      { thumb: 'example-qiaomu-wizard', caption: 'Flusso di onboarding HR' },
      { thumb: 'example-skill-mengto-landing', caption: 'Layout di landing di prodotto' },
      { thumb: 'example-style-claymorphism', caption: 'Wireframe web in stile morbido' },
    ],
  ...
  aiUiGenerator: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Prototipo di app multischermo a mosaico' },
      { thumb: 'example-qiaomu-wizard', caption: 'Flusso di onboarding HR' },
      { thumb: 'example-skill-mengto-landing', caption: 'UI di landing di prodotto' },
      { thumb: 'example-style-claymorphism', caption: 'UI web in stile morbido' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Sfoglia i template',
  ...
  designToCode: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Prototipo di app multischermo a mosaico' },
      { thumb: 'example-qiaomu-wizard', caption: 'Flusso di onboarding HR' },
      { thumb: 'example-skill-mengto-landing', caption: 'Landing di prodotto in codice' },
      { thumb: 'example-style-claymorphism', caption: 'Build web in stile morbido' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Sfoglia i template',
  ...
  aiLandingPageGenerator: {
    ...
    gallery: [
      { thumb: 'example-skill-mengto-landing', caption: 'Pagina di lancio prodotto' },
      { thumb: 'example-qiaomu-landing', caption: 'Pagina marketing SaaS' },
      { thumb: 'example-qiaomu-coming-soon', caption: 'Flusso di raccolta lista d’attesa' },
      { thumb: 'example-style-claymorphism', caption: 'Layout di landing in stile morbido' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Sfoglia i template',
  ...
  figmaToCode: {
    ...
    gallery: [
      ...
      { thumb: 'example-skill-mengto-landing', caption: 'Frame di landing in codice' },
      { thumb: 'example-style-claymorphism', caption: 'Build web in stile morbido' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Sfoglia i template',
  ...
  screenshotToCode: {
    ...
    gallery: [
      ...
      { thumb: 'example-skill-mengto-landing', caption: 'Screenshot di landing in codice' },
      { thumb: 'example-style-claymorphism', caption: 'Build web in stile morbido' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Sfoglia i template',
  ...
  aiPrototypeGenerator: {
    ...
    gallery: [
      ...
      { thumb: 'example-style-claymorphism', caption: 'Prototipo web in stile morbido' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Sfoglia i template',
  ...
  prototype: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Prototipo di app multischermo a mosaico' },
      { thumb: "example-qiaomu-wizard", caption: "Flusso di onboarding HR" },
      { thumb: "example-skill-mengto-landing", caption: "Landing page di prodotto" },
      { thumb: "example-style-claymorphism", caption: "Prototipo web in stile soft" },
    ],
    exampleHref: '/plugins/templates/',
  ...
  dashboard: {
    ...
    features: [
      { title: "Analytics di prodotto", body: "Utenti attivi, funnel, retention — le metriche in cui vive un team di prodotto.", thumb: "example-qiaomu-dashboard" },
      { title: "Metriche di repository e dev", body: "Stelle, PR, salute della CI — dashboard di ingegneria dai tuoi stessi dati.", thumb: "example-m3-ops-dashboard" },
      { title: "Report finanziari", body: "Ricavi, burn e autonomia di cassa disposti come un report da condividere.", thumb: "example-trading-analysis-dashboard-template" },
      ...
      { title: "Social e marketing", body: "Performance dei canali e monitoraggio delle campagne in un’unica vista.", thumb: "example-social-media-matrix-tracker-template" },
      { title: "Report di settore", body: "Report strutturati per qualsiasi ambito — dal clinico al trading.", thumb: "example-promax-health-dashboard" },
    ],
    ...
    gallery: [
      { thumb: "example-impeccable-insight-dashboard", caption: "Report di dati" },
      { thumb: "example-live-artifact", caption: "Dashboard di operazioni dal vivo" },
  ...
  image: {
    ...
    features: [
      { title: "Card social", body: "Card per X / Twitter composte con il tuo titolo e il tuo brand.", thumb: "example-html-ppt-xhs-pastel-card" },
      { title: "Copertine di articoli", body: "Copertine editoriali, in stile rivista, per post e newsletter.", thumb: "example-html-ppt-zhangzara-retro-zine" },
      { title: "Card Xiaohongshu", body: "Card in stile RedNote calibrate per quel feed.", thumb: "example-html-ppt-xhs-white-editorial" },
      { title: "Grafiche hero", body: "Visual hero liquidi e sfumati per siti e lanci.", thumb: "example-frame-liquid-bg-hero" },
      { title: "Caroselli", body: "Caroselli social multi-slide che restano coerenti tra i fotogrammi.", thumb: "example-html-ppt-xhs-white-editorial" },
    ...
    gallery: [
      ...
      { thumb: "example-image-poster", caption: "Poster in stile rivista" },
  ...
  video: {
    ...
    features: [
      ...
      { title: "Set di fotogrammi di movimento", body: "Fotogrammi animati riutilizzabili che componi in una clip.", thumb: "example-frame-glitch-title" },
  ...
  roleSoloBuilder: {
    ...
    features: [
      { title: 'Landing page', body: 'Landing di marketing e SaaS, navigabili e online.', thumb: 'example-qiaomu-landing' },
      { title: 'Prototipi di prodotto', body: 'App web multischermata per validare l’idea.', thumb: 'example-web-prototype' },
      { title: 'Dashboard', body: 'Metriche e viste di amministrazione per il tuo prodotto.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Grafiche di brand', body: 'Copertine e poster in linea con il tuo brand.', thumb: 'example-image-poster' },
      { title: 'Flussi mobile', body: 'Schermate di app quando vai oltre il web.', thumb: 'example-mobile-app' },
      { title: 'Card social', body: 'Card di lancio e aggiornamento per ogni canale.', thumb: 'example-html-ppt-xhs-pastel-card' },
    ],
    ...
    gallery: [
      ...
      { thumb: 'example-qiaomu-dashboard', caption: 'Dashboard di prodotto' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: 'Card social di lancio' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Sfoglia i template',
  ...
  roleDesigner: {
    ...
    features: [
      { title: 'Layout editoriali', body: 'Composizioni con art direction, guidate dalla griglia.', thumb: 'example-skill-swiss-design' },
      { title: 'Copertine di articolo', body: 'Copertine e feature in stile rivista.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
      { title: 'Poster', body: 'Poster tipografici decisi e in linea con il brand.', thumb: 'example-image-poster' },
      { title: 'Set social', body: 'Caroselli multi-frame coerenti.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: 'Schermate di app', body: 'Schermate mobile e web ad alta fedeltà.', thumb: 'example-mobile-app' },
      { title: 'Dashboard', body: 'Interfacce dati che rispettano il tuo sistema.', thumb: 'example-qiaomu-dashboard' },
    ],
    ...
    gallery: [
      { thumb: 'example-skill-swiss-design', caption: 'Layout editoriale' },
      { thumb: 'example-html-ppt-zhangzara-retro-zine', caption: 'Copertina da rivista' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: 'Carosello social' },
      { thumb: 'example-image-poster', caption: 'Poster tipografico' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Sfoglia i template',
  ...
  roleEngineering: {
    ...
    features: [
      ...
      { title: 'Dashboard di dev', body: 'Dashboard di repository, CI e metriche.', thumb: 'example-m3-ops-dashboard' },
      { title: 'Report di dati', body: 'Report strutturati a partire dai tuoi dati.', thumb: 'example-impeccable-insight-dashboard' },
      { title: 'Dashboard di amministrazione', body: 'Strumenti interni e viste di amministrazione.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Landing page', body: 'Pagine di marketing senza aspettare il design.', thumb: 'example-qiaomu-landing' },
    ...
    gallery: [
      ...
      { thumb: 'example-m3-ops-dashboard', caption: 'Dashboard di dev' },
      { thumb: 'example-impeccable-insight-dashboard', caption: 'Report di dati' },
  ...
  roleProductManagers: {
    ...
    features: [
      ...
      { title: 'Flussi di onboarding', body: 'Benvenuto → setup → primo avvio.', thumb: 'example-qiaomu-wizard' },
      { title: 'Board e flussi di lavoro', body: 'Kanban e interfacce di processo per le specifiche.', thumb: 'example-kanban-board' },
      { title: 'Dashboard', body: 'Viste di metriche per inquadrare il problema.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Prototipi web', body: 'Flussi web multischermata da rivedere.', thumb: 'example-web-prototype' },
      { title: 'Viste di trend', body: 'Snapshot a 30 giorni e di trend per dare contesto.', thumb: 'example-trading-analysis-dashboard-template' },
    ],
    ...
    gallery: [
      ...
      { thumb: 'example-qiaomu-wizard', caption: 'Flusso di onboarding' },
  ...
  roleMarketing: {
    ...
    features: [
      { title: 'Landing page', body: 'Landing di campagna e prodotto, deployabili.', thumb: 'example-qiaomu-landing' },
      { title: 'Card social', body: 'Card X / Twitter in linea con il brand.', thumb: 'example-html-ppt-xhs-pastel-card' },
      { title: 'Caroselli', body: 'Set social multi-slide, coerenti.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: 'Poster', body: 'Poster di annuncio ed evento.', thumb: 'example-image-poster' },
      { title: 'Copertine di articolo', body: 'Copertine per blog e newsletter.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
    ...
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: 'Landing page di campagna' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: 'Card social' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: 'Carosello social' },
      { thumb: 'example-image-poster', caption: 'Poster di annuncio' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Sfoglia i template',
