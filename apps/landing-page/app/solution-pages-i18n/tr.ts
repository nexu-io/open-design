...
export const TR: SolutionLocaleCopy = {
  aiWireframeGenerator: {
    title: 'AI Tel Kafes Oluşturucu — OpenDesign ile komuttan tel kafese',
    description:
      'Bir komutu düzenlenebilir, çok ekranlı tel kafeslere dönüştüren — ve onları yayına alınan koda kadar taşıyan ücretsiz, açık kaynaklı bir AI tel kafes oluşturucu. OpenDesign zaten kullandığınız kodlama ajanının içinde çalışır, böylece tel kafes ile gerçek ürün tek bir kaynağı paylaşır.',
    ...
    tldrBody:
      'Çoğu AI tel kafes oluşturucu size sonradan yeniden kuracağınız bir resim verir. OpenDesign tel kafesi kodlama ajanınızın içinde üretir ve onu komuttan yayına alınan koda kadar taşır — dışa aktarma adımı yok, teslim boşluğu yok, koltuk başı sayaç yok.',
    stepsTitle: 'AI tel kafes oluşturucu nasıl çalışır',
    steps: [
      {
        title: 'Ekranı tarif edin',
        body: 'Ajanınıza neyin tel kafesini çizeceğinizi sade bir dille söyleyin — “bir kenar çubuğu, bir istatistik satırı ve bir son etkinlik tablosu içeren bir pano.” OpenDesign tel kafes becerisini yükler, böylece ajan yalnızca tek bir durağan görsel değil, yapı ve hiyerarşi kurar.',
    ...
    tableTitle: 'OpenDesign, tipik AI tel kafes oluşturuculara karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'OpenDesign ile',
    ...
    galleryTitle: 'OpenDesign ile oluşturulan tel kafesler',
    galleryLead:
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Çok ekranlı döşeme uygulama prototipi' },
      { thumb: 'example-qiaomu-wizard', caption: 'İK katılım akışı' },
      { thumb: 'example-skill-mengto-landing', caption: 'Ürün açılış düzeni' },
      { thumb: 'example-style-claymorphism', caption: 'Yumuşak stilde web tel kafesi' },
    ],
    ...
    faq: [
      {
        ...
        a: 'Evet. OpenDesign açık kaynaktır ve zaten kullandığınız kodlama ajanının içinde kendi sağlayıcı anahtarlarınızla çalışır — tel kafes oluşturucunun kendisinde koltuk başı ya da kredi başı sayaç yoktur.',
      },
      {
      ...
      },
      {
        ...
        a: 'OpenDesign; Claude Code, Codex, Cursor Agent, Gemini CLI ve bir düzine kadar diğer birinci taraf adaptörle çalışır. Kendi sağlayıcı anahtarlarınızı getirirsiniz; sizin için hiçbir şey barındırılmaz.',
      },
    ],
    ctaTitle: 'İlk tel kafesinizi bu gece üretin',
    ctaBody:
      'Depoya yıldız verin, OpenDesign’ı kurun ve bir sonraki ekran fikrinizi düzenlenebilir bir tel kafese — ardından yayına alınan koda — zaten kullandığınız ajanda dönüştürün.',
    relatedTitle: 'İlgili araçlar ve rehberler',
    related: [
      { href: '/solutions/ai-ui-generator/', label: 'AI UI oluşturucu' },
      { href: '/solutions/design-to-code/', label: 'OpenDesign ile tasarımdan koda' },
      { href: '/blog/design-to-code-tools/', label: 'En iyi tasarımdan koda araçları' },
      { href: '/solutions/prototype/', label: 'OpenDesign ile prototipleme' },
    ],
  },
  aiUiGenerator: {
    title: 'AI UI Oluşturucu — OpenDesign ile komuttan üretim arayüzüne',
    description:
      'Bir komutu gerçek, bileşen tabanlı bir arayüze dönüştüren — ve onu yayına alınan koda kadar taşıyan ücretsiz, açık kaynaklı bir AI UI oluşturucu. OpenDesign zaten kullandığınız kodlama ajanının içinde çalışır, böylece üretilen arayüz ile üretim kodu aynı çıktıdır.',
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Çoğu AI UI oluşturucu size bir maket ya da kullan-at bir React parçası verir. OpenDesign arayüzü kodlama ajanınızın içinde üretir ve onu komuttan yayına alınan koda kadar taşır — gerçek bileşenler, sizin tasarım sisteminiz, dışa aktarma adımı yok, koltuk başı sayaç yok.',
    stepsTitle: 'AI UI oluşturucu nasıl çalışır',
    steps: [
      {
        title: 'Arayüzü tarif edin',
        body: 'Ajanınıza ne kuracağını sade bir dille söyleyin — “bir kenar çubuğu, sekmeli bölümler ve bir kaydetme çubuğu içeren bir ayarlar sayfası.” OpenDesign UI becerisini yükler, böylece ajan tek seferlik bir ekran değil, gerçek bileşenlere ve bir tasarım sistemine başvurur.',
    ...
    tableTitle: 'OpenDesign, tipik AI UI oluşturuculara karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'OpenDesign ile',
    ...
    galleryTitle: 'OpenDesign ile oluşturulan arayüzler',
    galleryLead:
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Çok ekranlı döşeme uygulama prototipi' },
      { thumb: 'example-qiaomu-wizard', caption: 'İK katılım akışı' },
      { thumb: 'example-skill-mengto-landing', caption: 'Ürün açılış arayüzü' },
      { thumb: 'example-style-claymorphism', caption: 'Yumuşak stilde web arayüzü' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Şablonlara göz atın',
    ...
    faq: [
      {
        ...
        a: 'Evet. OpenDesign açık kaynaktır ve zaten kullandığınız kodlama ajanının içinde kendi sağlayıcı anahtarlarınızla çalışır — UI oluşturucunun kendisinde koltuk başı ya da kredi başı sayaç yoktur.',
      },
      {
    ...
    ctaBody:
      'Depoya yıldız verin, OpenDesign’ı kurun ve bir sonraki arayüz fikrinizi gerçek, bileşen tabanlı bir arayüze — ardından yayına alınan koda — zaten kullandığınız ajanda dönüştürün.',
    relatedTitle: 'İlgili araçlar ve rehberler',
    related: [
      ...
      { href: '/solutions/designer/', label: 'Tasarımcılar için OpenDesign' },
    ],
  },
  designToCode: {
    title: 'Tasarımdan Koda — OpenDesign ile bir tasarımı yayına alınan koda dönüştürün',
    description:
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Çoğu tasarımdan koda aracı, sonradan başında beklediğiniz tek seferlik bir anlık görüntü dışa aktarır. OpenDesign tasarım ile kodu ajanınızın içinde tek bir canlı çıktı olarak tutar — konuşarak yineleyin, sahip olduğunuz kodu yayına alın, koltuk başı sayaç yok.',
    stepsTitle: 'Tasarımdan koda nasıl çalışır',
    steps: [
      {
        title: 'Bir komuttan ya da bir tasarımdan başlayın',
        body: 'Ekranı sade bir dille tarif edin ya da ajanınızı bir tasarım yönüne yönlendirin. OpenDesign doğru beceriyi yükler, böylece ajan kırılgan, tek seferlik bir dönüşüm değil, yapı ve bileşenler kurar.',
    ...
    tableTitle: 'OpenDesign, tipik tasarımdan koda araçlarına karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'OpenDesign ile',
    ...
    galleryTitle: 'OpenDesign ile tasarımdan yayına alınanlar',
    galleryLead:
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Çok ekranlı döşeme uygulama prototipi' },
      { thumb: 'example-qiaomu-wizard', caption: 'İK katılım akışı' },
      { thumb: 'example-skill-mengto-landing', caption: 'Kod içinde ürün açılışı' },
      { thumb: 'example-style-claymorphism', caption: 'Yumuşak stilde web yapımı' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Şablonlara göz atın',
    ...
    faq: [
      {
        ...
        a: 'Evet. OpenDesign açık kaynaktır ve zaten kullandığınız kodlama ajanının içinde kendi sağlayıcı anahtarlarınızla çalışır — tasarımdan koda iş akışının kendisinde koltuk başı ya da kredi başı sayaç yoktur.',
      },
      {
    ...
    ctaBody:
      'Depoya yıldız verin, OpenDesign’ı kurun ve bir sonraki ekranınızı — komut, tel kafes ya da tasarım — zaten kullandığınız ajanda temiz, yayına alınabilir koda dönüştürün.',
    relatedTitle: 'İlgili araçlar ve rehberler',
    related: [
      { href: '/solutions/ai-wireframe-generator/', label: 'AI tel kafes oluşturucu' },
      { href: '/solutions/ai-ui-generator/', label: 'AI UI oluşturucu' },
      { href: '/blog/design-to-code-tools/', label: 'En iyi tasarımdan koda araçları' },
      { href: '/solutions/engineering/', label: 'Mühendislik için OpenDesign' },
    ],
  },
  aiLandingPageGenerator: {
    title: 'AI Açılış Sayfası Oluşturucu — komuttan yayına alabileceğiniz açılış sayfasına',
    description:
      'Bir komutu gerçek, duyarlı bir açılış sayfasına dönüştüren — ve onu yayına alınan koda kadar taşıyan ücretsiz, açık kaynaklı bir AI açılış sayfası oluşturucu. OpenDesign zaten kullandığınız kodlama ajanının içinde çalışır, böylece üretilen sayfa ile dağıtılan sayfa sahip olduğunuz aynı çıktıdır.',
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Çoğu AI açılış sayfası oluşturucu sayfanızı kendi düzenleyicilerine kilitler ve koltuk başı ücretlendirir. OpenDesign açılış sayfasını kodlama ajanınızın içinde üretir ve onu komuttan yayına alınan koda taşır — gerçek bölümler, sizin markanız, dışa aktarma adımı yok, koltuk başı sayaç yok.',
    stepsTitle: 'AI açılış sayfası oluşturucu nasıl çalışır',
    steps: [
      {
        title: 'Sayfayı tarif edin',
        body: 'Ajanınıza sade bir dille ne kuracağını söyleyin — “bir not alma uygulaması için bir tanıtım sayfası: hero, üç özellik, fiyatlandırma ve bir bekleme listesi formu.” OpenDesign açılış sayfası becerisini yükler, böylece ajan net bir hiyerarşiyle gerçek bölümler yerleştirir.',
    ...
    tableTitle: 'OpenDesign, tipik AI açılış sayfası oluşturuculara karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'OpenDesign ile',
    ...
    galleryTitle: 'OpenDesign ile oluşturulan açılış sayfaları',
    galleryLead:
    ...
    gallery: [
      { thumb: 'example-skill-mengto-landing', caption: 'Ürün tanıtım sayfası' },
      { thumb: 'example-qiaomu-landing', caption: 'SaaS pazarlama sayfası' },
      { thumb: 'example-qiaomu-coming-soon', caption: 'Bekleme listesi yakalama akışı' },
      { thumb: 'example-style-claymorphism', caption: 'Yumuşak stilde açılış düzeni' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Şablonlara göz atın',
    ...
    faq: [
      {
        ...
        a: 'Evet. OpenDesign açık kaynaktır ve zaten kullandığınız kodlama ajanının içinde kendi sağlayıcı anahtarlarınızla çalışır — açılış sayfası oluşturucunun kendisinde koltuk başı ya da sayfa başı sayaç yoktur.',
      },
      {
    ...
    ctaBody:
      'Depoya yıldız verin, OpenDesign’ı kurun ve bir sonraki tanıtım fikrinizi gerçek, duyarlı bir açılış sayfasına — ardından yayına alınan koda — zaten kullandığınız ajanda dönüştürün.',
    relatedTitle: 'İlgili araçlar ve rehberler',
    related: [
      { href: '/solutions/ai-ui-generator/', label: 'AI UI oluşturucu' },
      { href: '/solutions/design-to-code/', label: 'OpenDesign ile tasarımdan koda' },
      { href: '/solutions/marketing/', label: 'Pazarlama için OpenDesign' },
      { href: '/blog/best-ai-design-tools/', label: 'En iyi AI tasarım araçları' },
    ],
  },
  figmaToCode: {
    title: 'Figma’dan Koda — OpenDesign ile Figma tasarımlarını yayına alınan koda dönüştürün',
    description:
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Çoğu Figma’dan koda eklentisi, sonradan yeniden yazacağınız mutlak konumlu biçimlendirmenin tek seferlik bir anlık görüntüsünü dışa aktarır. OpenDesign tasarımı ve kodu ajanınızın içinde tek bir canlı çıktı olarak tutar — çerçeveleri Figma MCP üzerinden çekin, konuşarak yineleyin, sahip olduğunuz kodu yayına alın.',
    stepsTitle: 'Figma’dan koda nasıl çalışır',
    steps: [
      {
        title: 'Figma’yı ajanınıza bağlayın',
        body: 'Figma MCP kurulduğunda, kodlama ajanınız — Claude Code, Codex, Cursor Agent — bir Figma dosyasını ya da seçili bir çerçeveyi doğrudan okuyabilir. OpenDesign doğru beceriyi yükler, böylece ajan kırılgan bir piksel kopyası değil, tasarım niyetini yapıya dönüştürür.',
    ...
    tableTitle: 'OpenDesign, tipik Figma’dan koda araçlarına karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'OpenDesign ile',
    ...
    galleryTitle: 'OpenDesign ile Figma’dan yayına',
    galleryLead:
    ...
    gallery: [
      ...
      { thumb: 'example-skill-mengto-landing', caption: 'Kodda açılış çerçevesi' },
      { thumb: 'example-style-claymorphism', caption: 'Yumuşak stilde web yapımı' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Şablonlara göz atın',
    ...
    faq: [
      {
        q: 'OpenDesign Figma’yı nasıl koda dönüştürür?',
      ...
      {
        q: 'Ücretsiz mi?',
        a: 'Evet. OpenDesign açık kaynaktır ve zaten kullandığınız kodlama ajanının içinde kendi sağlayıcı anahtarlarınızla çalışır — Figma’dan koda iş akışının kendisinde koltuk başı ya da dışa aktarma başı sayaç yoktur.',
      },
      {
        q: 'Hangi ajanlarla çalışır?',
        a: 'OpenDesign; Claude Code, Codex, Cursor Agent, Gemini CLI ve bir düzine kadar diğer birinci taraf adaptörle çalışır. Kendi sağlayıcı anahtarlarınızı ve kendi Figma MCP kurulumunuzu getirirsiniz; sizin için hiçbir şey barındırılmaz.',
      },
    ],
    ctaTitle: 'Bir sonraki Figma çerçevenizi bu gece koda dönüştürün',
    ctaBody:
      'Depoya yıldız verin, OpenDesign’ı kurun, Figma MCP’yi bağlayın ve bir sonraki Figma tasarımınızı zaten kullandığınız ajanda temiz, yayına alınabilir koda dönüştürün.',
    relatedTitle: 'İlgili araçlar ve rehberler',
    related: [
      { href: '/solutions/design-to-code/', label: 'OpenDesign ile tasarımdan koda' },
      { href: '/solutions/ai-ui-generator/', label: 'AI UI oluşturucu' },
      { href: '/agents/claude-code-design/', label: 'Claude Code için OpenDesign' },
      { href: '/solutions/engineering/', label: 'Mühendislik için OpenDesign' },
    ],
  },
  screenshotToCode: {
    title: 'Screenshot to Code — OpenDesign ile ekran görüntüsünü koda dönüştürün',
    description:
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Çoğu ekran görüntüsünden koda aracı, sonradan yeniden yazacağınız tek seferlik, mutlak konumlu biçimlendirme üretir. OpenDesign ekran görüntüsünü kodlama ajanınızın içinde temiz, bileşen tabanlı koda yeniden kurar — gerçek yapı, sizin tasarım sisteminiz, dışa aktarma adımı yok, koltuk başı sayaç yok.',
    stepsTitle: 'Ekran görüntüsünden koda nasıl çalışır',
    steps: [
      {
        title: 'Ekran görüntüsünü bırakın',
        body: 'Ajanınıza istediğiniz ekranın bir görselini verin — bir uygulamanın, bir web sitesinin ya da bir tasarımın ekran görüntüsü. OpenDesign doğru beceriyi yükler, böylece ajan yalnızca pikselleri değil, düzeni ve niyeti okur.',
    ...
    tableTitle: 'OpenDesign, tipik ekran görüntüsünden koda araçlarına karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'OpenDesign ile',
    ...
    galleryTitle: 'OpenDesign ile bir ekran görüntüsünden yeniden kuruldu',
    galleryLead:
    ...
    gallery: [
      ...
      { thumb: 'example-skill-mengto-landing', caption: 'Kodda açılış ekran görüntüsü' },
      { thumb: 'example-style-claymorphism', caption: 'Yumuşak stilde web yapımı' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Şablonlara göz atın',
    ...
    faq: [
      {
        q: 'OpenDesign bir ekran görüntüsünü nasıl koda dönüştürür?',
        a: 'Kodlama ajanınıza ekranın bir görselini verirsiniz ve OpenDesign doğru beceriyi yükler, böylece ajan onu temiz, bileşen tabanlı kod olarak yeniden kurar — yalnızca pikselleri çizmek yerine düzeni ve niyeti okuyarak.',
      },
      {
        q: 'Ne tür bir kod üretiyor?',
      ...
      {
        q: 'Ücretsiz mi?',
        a: 'Evet. OpenDesign açık kaynaktır ve zaten kullandığınız kodlama ajanının içinde kendi sağlayıcı anahtarlarınızla çalışır — ekran görüntüsünden koda iş akışının kendisinde koltuk başı ya da kredi başı sayaç yoktur.',
      },
      {
        q: 'Hangi ajanlarla çalışır?',
        a: 'OpenDesign; Claude Code, Codex, Cursor Agent, Gemini CLI ve bir düzine kadar diğer birinci taraf adaptörle çalışır. Kendi sağlayıcı anahtarlarınızı getirirsiniz; sizin için hiçbir şey barındırılmaz.',
    ...
    ctaBody:
      'Depoya yıldız verin, OpenDesign’ı kurun ve istediğiniz ekranın bir görüntüsünü zaten kullandığınız ajanda temiz, yayına alınabilir koda dönüştürün.',
    relatedTitle: 'İlgili araçlar ve rehberler',
    related: [
      { href: '/solutions/figma-to-code/', label: 'OpenDesign ile Figma’dan koda' },
      { href: '/solutions/design-to-code/', label: 'OpenDesign ile tasarımdan koda' },
      { href: '/solutions/ai-ui-generator/', label: 'AI UI oluşturucu' },
      { href: '/solutions/engineering/', label: 'Mühendislik için OpenDesign' },
    ],
  ...
  htmlToPpt: {
    title: 'HTML to PPT — OpenDesign ile HTML’i düzenlenebilir bir PowerPoint’a dönüştürün',
    description:
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Çoğu HTML-to-PPT dönüştürücü sayfanızı düzenleyemeyeceğiniz statik slayt görüntülerine düzleştirir. OpenDesign desteyi kodlama ajanınızın içinde HTML olarak oluşturur ve gerçek, düzenlenebilir bir .pptx dışa aktarır — yerel metin ve şekiller, kendi tasarım sisteminiz, koltuk başına ücret yok, tedarikçi kilidi yok.',
    stepsTitle: 'HTML to PPT nasıl çalışır',
    steps: [
      {
        title: 'HTML’den, bir belgeden ya da bir komuttan başlayın',
        body: 'Ajanınızı bir HTML sayfasına, bir markdown belgesine yönlendirin ya da yalnızca desteyi anlatın. OpenDesign doğru beceriyi yükler, böylece ajan yalnızca ham işaretlemeyi değil, yapıyı ve amacı okur — başlıklar, bölümler, veriler.',
      ...
      },
      {
        ...
        body: 'OpenDesign’ın pptx-generator’ı HTML destesini gerçek bir PowerPoint’a dönüştürür — yerel şekiller, düzenlenebilir metin ve hâlâ değiştirebileceğiniz grafikler — slayt başına düz bir görüntü değil, HTML-to-PPTX doğruluğu denetimiyle.',
    ...
    tableTitle: 'OpenDesign ile tipik HTML-to-PPT dönüştürücülerinin karşılaştırması',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'OpenDesign ile',
    ...
    galleryLead:
      'OpenDesign tarafından işlenmiş, düzenlenebilir bir .pptx’e dışa aktarmaya hazır gerçek desteler. İçeriğinize yakın bir tema seçin, varyasyonunuzu anlatın; ajan desteyi oluşturur — ardından size ait olan PowerPoint’u size teslim eder.',
    gallery: [
    ...
    faq: [
      {
        q: 'OpenDesign HTML’i bir PPT’ye nasıl dönüştürür?',
        a: 'Kodlama ajanınız içeriği temiz bir HTML destesine dönüştürür, ardından OpenDesign’ın pptx-generator becerisi bunu gerçek, düzenlenebilir bir .pptx olarak dışa aktarır — yerel şekiller ve metin, HTML-to-PPTX doğruluğu için denetlenmiş, slayt başına düz bir görüntü değil.',
      },
      {
      ...
      {
        q: 'Ücretsiz mi?',
        a: 'Evet. OpenDesign açık kaynaktır ve zaten kullandığınız kodlama ajanının içinde kendi anahtarlarınızla çalışır — HTML-to-PPT akışında dosya başına ya da kredi başına ücret yoktur.',
      },
      {
        q: 'Slayt üretmekten farkı nedir?',
        a: 'Bir deste üretmek genellikle bir komuttan ya da taslaktan başlar; HTML to PPT, zaten sahip olduğunuz HTML ya da markdown’dan başlar ve düzenlenebilir .pptx dışa aktarımına odaklanır. İkisi de aynı OpenDesign deste motorunu kullanır — taslak öncelikli akış için slaytlar kullanım örneğine bakın.',
      },
    ],
    ctaTitle: 'Bir sonraki HTML destenizi düzenlenebilir bir PPT’ye dönüştürün',
    ctaBody:
      'Depoya yıldız verin, OpenDesign’ı kurun ve HTML’i — ya da bir komutu — temiz bir desteye ve gerçek, düzenlenebilir bir .pptx’e dönüştürün, zaten kullandığınız ajanda.',
    relatedTitle: 'İlgili araçlar ve rehberler',
    related: [
  ...
  aiPrototypeGenerator: {
    ...
    lead: 'Akışı tarif edin, ajanınız gerçek, tıklanabilir bir prototip üretsin — bağlı ekranlar, tutarlı stiller, çalışan etkileşimler. Bir taslakta duran prototip oluşturucuların aksine, OpenDesign aynı ürünü yayına alınan koda taşır; zaten çalıştırdığınız ajanda.',
    heroImageAlt:
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Çoğu AI prototip oluşturucu (Figma, Cursor, Penpot), sonradan yeniden kuracağınız tıklanabilir bir taslakta durur. OpenDesign prototipi kodlama ajanınızın içinde üretir ve komuttan yayına alınan koda taşır — dışa aktarma adımı yok, teslim boşluğu yok, koltuk başı sayaç yok.',
    stepsTitle: 'AI prototip oluşturucu nasıl çalışır',
    steps: [
      {
        title: 'Akışı tarif edin',
        body: 'Ajanınıza yolculuğu sade bir dille anlatın — “bir katılım akışı: kayıt, plan seçici ve bir gösterge paneli.” OpenDesign prototip becerisini yükler, böylece ajan tek bir statik çerçeve değil, bağlı ekranlar düzenler.',
    ...
    tableTitle: 'OpenDesign, tipik AI prototip oluşturuculara karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'OpenDesign ile',
    ...
    galleryTitle: 'OpenDesign ile kurulan prototipler',
    galleryLead:
    ...
    gallery: [
      ...
      { thumb: 'example-style-claymorphism', caption: 'Yumuşak stilde web prototipi' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Şablonlara göz atın',
    ...
    faq: [
      {
        ...
        a: 'Evet. OpenDesign açık kaynaktır ve zaten kullandığınız kodlama ajanının içinde kendi sağlayıcı anahtarlarınızla çalışır — prototip oluşturucunun kendisinde koltuk başı ya da kredi başı sayaç yoktur.',
      },
      {
        q: 'Figma, Cursor ya da Penpot prototip oluşturucularından farkı ne?',
        a: 'Onlar kendi uygulamalarının içinde tıklanabilir bir taslakta durur. OpenDesign prototipi kodlama ajanınızda üretir ve aynı ürünü, sahip olduğunuz, yayına alınan koda kadar taşır — dışa aktarma yok, üretim için yeniden kurma yok.',
      },
      {
    ...
    ctaBody:
      'Depoya yıldız verin, OpenDesign’ı kurun ve bir sonraki akışınızı tıklanabilir bir prototipe — ve ardından yayına alınan koda — zaten kullandığınız ajanda dönüştürün.',
    relatedTitle: 'İlgili araçlar ve rehberler',
    related: [
      { href: '/solutions/prototype/', label: 'OpenDesign ile prototipleme' },
      { href: '/solutions/ai-wireframe-generator/', label: 'AI tel kafes oluşturucu' },
  ...
  prototype: {
    title: 'OpenDesign + Claude Code ile etkileşimli prototipler oluşturun',
    description:
      'Bir komutu, terminalden çıkmadan tıklanabilir, çok ekranlı bir prototipe dönüştürün. OpenDesign, kodlama ajanınıza tasarım becerilerini, şablonları ve tasarım sistemini vererek tarayıcıda açabileceğiniz gerçek prototipler üretmesini sağlar.',
    breadcrumb: 'Prototip',
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'OpenDesign, zaten kullandığınız kodlama ajanının tasarım katmanıdır. Prototipleme için bu, tek bir paragraflık bir fikirden tek bir oturumda gezilebilir, stillendirilmiş bir prototipe geçmek demektir — tasarım aracı yok, dışa aktarma adımı yok, teslim boşluğu yok.',
    stepsTitle: 'OpenDesign ile prototipleme nasıl çalışır',
    steps: [
      {
        title: 'Akışı tarif edin',
        body: 'Ajanınıza ne kurduğunuzu sade bir dille anlatın — “bir karşılama ekranı, bir plan seçici ve bir onay ekranı içeren bir katılım akışı.” OpenDesign prototip becerisini yükler, böylece ajan tek bir sayfa değil ekranlar üretmesi gerektiğini bilir.',
        imageAlt:
      ...
      },
      {
        ...
        body: 'Ajan, OpenDesign’dan bir tasarım sistemi ve prototip şablonları uygular, böylece her ekran taslak gibi görünmek yerine tipografiyi, boşlukları ve bileşenleri paylaşır. Kopuk maketler değil, tutarlı bir ekran kümesi elde edersiniz.',
        imageAlt:
    ...
    tableTitle: 'OpenDesign ile prototipleme, eski yönteme karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'OpenDesign ile',
    ...
    galleryTitle: 'İnsanların OpenDesign ile oluşturduğu prototipler',
    galleryLead:
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Çok ekranlı döşeme uygulama prototipi' },
      { thumb: "example-qiaomu-wizard", caption: "İK katılım akışı" },
      { thumb: "example-skill-mengto-landing", caption: "Ürün açılış sayfası" },
      { thumb: "example-style-claymorphism", caption: "Yumuşak stilde web prototipi" },
    ],
    exampleHref: '/plugins/templates/',
    ...
    faq: [
      {
        q: 'OpenDesign ile prototip yapmak için Figma gibi bir tasarım aracına ihtiyacım var mı?',
        a: 'Hayır. OpenDesign kodlama ajanınızın içinde çalışır ve prototipleri HTML olarak işler. Akışı dille tarif edersiniz; ajan ekranları üretir. Öğrenilecek ya da ücreti ödenecek ayrı bir tuval aracı yoktur.',
      },
      {
      ...
      },
      {
        ...
        a: 'OpenDesign; Claude Code, Codex, Cursor Agent, Gemini CLI ve bir düzineden fazla birinci taraf bağdaştırıcıyla çalışır. Kendi sağlayıcı anahtarlarınızı getirirsiniz; hiçbir şey sizin için barındırılmaz.',
      },
      {
    ...
    ctaBody:
      'Depoya yıldız verin, OpenDesign’ı kurun ve bir sonraki “ya şöyle olsaydı”yı tıklayabileceğiniz bir şeye dönüştürün — zaten kullandığınız ajanda.',
  },
  dashboard: {
    title: 'OpenDesign + Claude Code ile veri panoları oluşturun',
    description:
    ...
    lead: 'Ajanınıza neyi göstereceğini ve nasıl hissettirmesi gerektiğini söyleyin. OpenDesign grafik desenlerini, düzen sistemini ve görsel dili sağlar, böylece varsayılan stilli bir bileşen yığını değil, tutarlı ve sunulabilir bir pano elde edersiniz.',
    heroImageAlt:
      'Soldaki ham sayıların sağda temiz bir grafik ve KPI kartı panosuna aktığını gösteren editöryel illüstrasyon',
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'OpenDesign, metriklerinizin sade dildeki bir tanımını ajanınızın HTML olarak işlediği stillendirilmiş bir panoya dönüştürür — deponuzda sürümlenir, her yere barındırılabilir, koltuk başı BI aboneliği olmadan.',
    stepsTitle: 'OpenDesign ile panolar nasıl çalışır',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'OpenDesign grafik ve düzen şablonları sunar, böylece trendler çizgi grafiğe, dökümler çubuklara ve oranlar doğru görsele dönüşür — uyumsuz varsayılanlar yerine baştan sona tutarlı tipografi ve boşluk.',
    ...
    tableTitle: 'OpenDesign ile panolar, eski yönteme karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'OpenDesign ile',
    ...
    features: [
      { title: "Ürün analitiği", body: "Etkin kullanıcılar, hunidiler, elde tutma — bir ürün ekibinin içinde yaşadığı metrikler.", thumb: "example-qiaomu-dashboard" },
      { title: "Depo ve geliştirici metrikleri", body: "Yıldızlar, PR’lar, CI sağlığı — kendi verinizden mühendislik panoları.", thumb: "example-m3-ops-dashboard" },
      { title: "Finans raporları", body: "Gelir, harcama, pist; paylaşılabilir bir rapor olarak yerleştirilir.", thumb: "example-trading-analysis-dashboard-template" },
      ...
      { title: "Sosyal ve pazarlama", body: "Kanal performansı ve kampanya takibi tek bir görünümde.", thumb: "example-social-media-matrix-tracker-template" },
      { title: "Alan raporları", body: "Her alan için yapılandırılmış raporlar — klinikten alım satıma.", thumb: "example-promax-health-dashboard" },
    ],
    galleryTitle: 'İnsanların OpenDesign ile oluşturduğu panolar',
    galleryLead:
    ...
    gallery: [
      { thumb: "example-impeccable-insight-dashboard", caption: "Veri raporu" },
      { thumb: "example-live-artifact", caption: "Canlı operasyon panosu" },
    ...
    faqTitle: 'Pano SSS',
    faq: [
      { q: 'Tableau veya Looker gibi bir BI aracına ihtiyacım var mı?', a: 'Hayır. OpenDesign panoları kodlama ajanınızın içinde HTML olarak işler. Metrikleri tarif eder ve verinize yönlendirirsiniz; lisanslanacak ya da öğrenilecek ayrı bir BI platformu yoktur.' },
    ...
    ctaBody:
      'Depoya yıldız verin, OpenDesign’ı kurun ve metriklerinizi her yere barındırabileceğiniz bir panoya dönüştürün — zaten kullandığınız ajanda.',
  },
  slides: {
    title: 'OpenDesign + Claude Code ile sunum desteleri oluşturun',
    description:
      'Bir taslağı, herhangi bir sunum uygulaması açmadan tasarlanmış, markaya uygun bir slayt destesine dönüştürün. OpenDesign kodlama ajanınıza deste şablonları ve bir görsel sistem verir, slaytları sunabileceğiniz, dışa aktarabileceğiniz veya paylaşabileceğiniz HTML olarak işler.',
    breadcrumb: 'Slaytlar',
    label: 'Kullanım örneği · Slaytlar',
    heading: 'Tasarlanmış görünen desteler, bir komutla yazılır',
    lead: 'Ajanınıza bir taslak ve bir ton verin. OpenDesign bir deste şablonu ve görsel sistem uygular, böylece her slayt yerleştirilir, dizilir ve markaya uygundur — boş bir arka plandaki madde listesi değil.',
    heroImageAlt:
      'Soldaki bir taslağın sağda bir dizi tasarlanmış sunum slaytına dönüştüğünü gösteren editöryel illüstrasyon',
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'OpenDesign bir taslağı ajanınızın tek bir oturumda işlediği tasarlanmış bir HTML destesine dönüştürür — tarayıcıda sunun, PDF veya PPTX olarak dışa aktarın ve kaynağı deponuzda tutun.',
    stepsTitle: 'OpenDesign ile desteler nasıl çalışır',
    steps: [
      ...
      { title: 'Bir deste stili seçin', body: 'OpenDesign deste şablonları sunar — editöryel, İsviçre-uluslararası, koyu teknik ve daha fazlası. Ajan birini uygular, böylece tipografi, ızgara ve vurgular her slayt boyunca tutarlı kalır.', imageAlt: 'Birkaç deste stili seçeneğinin yan yana dizildiğini gösteren illüstrasyon' },
    ...
    tableTitle: 'OpenDesign ile desteler, eski yönteme karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'OpenDesign ile',
    ...
    galleryTitle: 'İnsanların OpenDesign ile oluşturduğu desteler',
    galleryLead:
    ...
    faq: [
      { q: 'PowerPoint ya da Keynote’a ihtiyacım var mı?', a: 'Hayır. OpenDesign desteleri kodlama ajanınızın içinde HTML olarak işler ve PDF veya PPTX olarak dışa aktarabilir. Tarayıcıdan sunarsınız ya da bir dosya teslim edersiniz — kurmak için herhangi bir sunum uygulaması gerekmez.' },
    ...
    ctaBody:
      'Depoya yıldız verin, OpenDesign’ı kurun ve taslağınızı tasarlanmış bir desteye dönüştürün — zaten kullandığınız ajanda.',
    relatedTitle: 'İlgili araçlar ve rehberler',
    related: [
      { href: '/solutions/html-to-ppt/', label: 'OpenDesign ile HTML to PPT' },
      { href: '/solutions/design-to-code/', label: 'OpenDesign ile tasarımdan koda' },
      { href: '/plugins/templates/', label: 'Deste şablonlarına göz atın' },
      { href: '/solutions/marketing/', label: 'Pazarlama için OpenDesign' },
    ],
  ...
  image: {
    title: 'OpenDesign + Claude Code ile markaya uygun grafikler oluşturun',
    description:
    ...
    lead: 'İhtiyacınız olan kartı ya da kapağı tarif edin. OpenDesign onu gerçek yazı, ızgara ve marka renklerinizle düzenler — sonra bir tasarım uygulamasıyla ya da genel bir şablonla boğuşmak yerine, görsel olarak dışa aktarabileceğiniz HTML olarak işler.',
    heroImageAlt:
      'Bir komutun bir dizi yerleştirilmiş sosyal kart ve makale kapağına dönüştüğünü gösteren editöryel illüstrasyon',
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'OpenDesign bir komutu, ajanınızın HTML olarak işleyip PNG’ye dışa aktardığı dizilmiş, markaya uygun bir grafiğe dönüştürür — yinelenebilir, sürümlenebilir ve koltuk başı tasarım araçlarından arınmış.',
    stepsTitle: 'OpenDesign ile grafikler nasıl çalışır',
    steps: [
      ...
      { title: 'Marka sistemini uygulayın', body: 'OpenDesign renklerinizi, yazınızı ve boşluklarınızı yeniden kullanılabilir bir tasarım sisteminden çeker, böylece her kart tek seferlik görünmek yerine markanızın geri kalanıyla eşleşir.', imageAlt: 'Marka renkleri ve yazının bir kart düzenine uygulandığını gösteren illüstrasyon' },
    ...
    tableTitle: 'OpenDesign ile grafikler, eski yönteme karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'OpenDesign ile',
    ...
    features: [
      { title: "Sosyal kartlar", body: "Başlığınız ve markanızla düzenlenmiş X / Twitter kartları.", thumb: "example-html-ppt-xhs-pastel-card" },
      { title: "Makale kapakları", body: "Yazılar ve bültenler için editöryel, dergi tarzı kapaklar.", thumb: "example-html-ppt-zhangzara-retro-zine" },
      { title: "Xiaohongshu kartları", body: "O akış için ayarlanmış RedNote tarzı kartlar.", thumb: "example-html-ppt-xhs-white-editorial" },
      { title: "Hero grafikleri", body: "Siteler ve lansmanlar için akışkan, geçişli hero görselleri.", thumb: "example-frame-liquid-bg-hero" },
      { title: "Karuseller", body: "Kareler boyunca tutarlı kalan çok slaytlı sosyal karuseller.", thumb: "example-html-ppt-xhs-white-editorial" },
    ...
    galleryTitle: 'İnsanların OpenDesign ile oluşturduğu grafikler',
    galleryLead:
    ...
    gallery: [
      ...
      { thumb: "example-image-poster", caption: "Dergi tarzı afiş" },
    ...
    faqTitle: 'Görsel SSS',
    faq: [
      { q: 'Bu, Midjourney gibi bir yapay zekâ görsel üreticisi mi?', a: 'Hayır. OpenDesign grafikleri gerçek düzen ve tipografiyle düzenler — başlığınız, markanız, tam boyutlar — ve PNG olarak dışa aktardığınız HTML olarak işler. Bu, piksel üretimi değil, tasarım düzenlemesidir.' },
    ...
    ctaBody:
      'Depoya yıldız verin, OpenDesign’ı kurun ve bir komutu markaya uygun bir grafiğe dönüştürün — zaten kullandığınız ajanda.',
  },
  video: {
    title: 'OpenDesign + Claude Code ile hareketli grafikler ve kısa video oluşturun',
    description:
    ...
    lead: 'İstediğiniz anı tarif edin — bir başlık açılışı, bir veri animasyonu, bir logo kapanışı. OpenDesign hareketli kareleri marka sisteminizle düzenler ve videoya işler, hareketli grafik paketi gerekmez.',
    heroImageAlt:
      'Bir senaryonun bir dizi hareketli video karesine dönüştüğünü gösteren editöryel illüstrasyon',
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'OpenDesign bir senaryoyu, ajanınızın kısa biçimli videoya işlediği hareketli, markaya uygun karelere dönüştürür — HTML’den düzenlenir, deponuzda sürümlenir, öğrenilecek bir zaman çizelgesi düzenleyicisi olmadan.',
    stepsTitle: 'OpenDesign ile hareket nasıl çalışır',
    steps: [
    ...
    tableTitle: 'OpenDesign ile hareket, eski yönteme karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'OpenDesign ile',
    ...
    features: [
      ...
      { title: "Hareket kare kümeleri", body: "Bir klibe düzenlediğiniz yeniden kullanılabilir hareketli kareler.", thumb: "example-frame-glitch-title" },
    ...
    galleryTitle: 'İnsanların OpenDesign ile oluşturduğu hareket',
    galleryLead:
    ...
    faqTitle: 'Video SSS',
    faq: [
      { q: 'After Effects ya da bir hareketli grafik paketine ihtiyacım var mı?', a: 'Hayır. OpenDesign hareketli kareleri HTML’de düzenler ve kodlama ajanınızın içinde videoya işler. Öğrenilecek ya da lisanslanacak bir zaman çizelgesi düzenleyicisi yoktur.' },
    ...
    ctaBody:
      'Depoya yıldız verin, OpenDesign’ı kurun ve bir senaryoyu harekete dönüştürün — zaten kullandığınız ajanda.',
  },
  designSystem: {
    title: 'OpenDesign + Claude Code ile bir tasarım sistemi kurun ve uygulayın',
    description:
    ...
    lead: 'Markanızı bir kez tanımlayın, OpenDesign onu her çıktıya taşısın — prototipler, desteler, panolar, grafikler. Sistem, deponuzda ajanın okuduğu bir DESIGN.md olarak yaşar, böylece tutarlılık elle değil, otomatiktir.',
    heroImageAlt:
      'Tek bir tasarım sisteminin markaya uygun birçok çıktıya ışıdığını gösteren editöryel illüstrasyon',
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'OpenDesign markanızı, ajanınızın her çıktıya uyguladığı taşınabilir bir tasarım sistemi olarak yakalar — deponuzda bir kez tanımlanır, her yerde uygulanır, onu denetleyen merkezi bir tasarım aracı olmadan.',
    stepsTitle: 'OpenDesign ile tasarım sistemleri nasıl çalışır',
    steps: [
      { title: 'Sistemi yakalayın', body: 'Markanızı tarif edin — renkler, yazı, boşluk, ses — ya da çıkarması için ajanı mevcut bir siteye yönlendirin. OpenDesign bunu projenizde yaşayan bir DESIGN.md içine yazar.', imageAlt: 'Bir markanın tek bir tasarım sistemi dosyasına yakalandığını gösteren illüstrasyon' },
      { title: 'Kanıtlanmış bir temelden başlayın', body: 'OpenDesign 140’tan fazla referans tasarım sistemi sunar — Apple ve Linear’dan editöryel ve brütaliste. Boş bir sayfadan başlamak yerine markanıza yakın olan birini çatallayın.', imageAlt: 'Bir referans tasarım sistemleri galerisinin gezildiğini gösteren illüstrasyon' },
    ...
    tableTitle: 'OpenDesign ile tasarım sistemleri, eski yönteme karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'OpenDesign ile',
    ...
    galleryTitle: 'OpenDesign’daki tasarım sistemleri',
    galleryLead:
    ...
    faq: [
      { q: 'Buradaki tasarım sistemi tam olarak nedir?', a: 'Deponuzda renkleri, yazıyı, boşluğu, bileşenleri ve sesi yakalayan bir DESIGN.md dosyası. Her OpenDesign becerisi onu okur, böylece markanız ajanın ürettiği her şeye otomatik olarak uygulanır.' },
      { q: 'Sıfırdan başlamak zorunda mıyım?', a: 'Hayır. OpenDesign çatallayabileceğiniz 140’tan fazla referans tasarım sistemi sunar — Apple ve Linear’dan editöryel ve brütaliste — sonra markanıza uyarlarsınız.' },
    ...
    ctaBody:
      'Depoya yıldız verin, OpenDesign’ı kurun ve ajanınıza her yerde uygulayacağı tek bir marka verin — zaten kullandığınız ajanda.',
  },
  roleSoloBuilder: {
    title: 'Tek kişilik geliştiriciler ve bağımsız hackerlar için OpenDesign',
    description:
      'Tek kişilik bir ekip gibi ürün çıkarın. OpenDesign, kodlama agent’ınızı girişiminizin tasarım yarısına dönüştürür — prototipler, açılış sayfaları, panolar ve marka görselleri, hepsi tek bir komutla, hepsi markaya uygun, hepsi deponuzda.',
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'OpenDesign, tek kişilik bir kurucunun hiç sahip olmadığı tasarım departmanıdır: ürününüzün ihtiyaç duyduğu her yüzeyde komuttan ürüne, tek bir markayla, sıfır devir teslimle ve ek araç olmadan.',
    stepsTitle: 'Tek kişilik bir geliştirici OpenDesign’ı nasıl kullanır',
    steps: [
      {
    ...
    tableTitle: 'OpenDesign ile tek başına inşa etmek vs. zor yoldan yapmak',
    ...
    features: [
      { title: 'Açılış sayfaları', body: 'Pazarlama ve SaaS açılışları, tıklanabilir ve canlı.', thumb: 'example-qiaomu-landing' },
      { title: 'Ürün prototipleri', body: 'Fikri doğrulamak için çok ekranlı web uygulamaları.', thumb: 'example-web-prototype' },
      { title: 'Panolar', body: 'Ürününüz için metrik ve yönetim görünümleri.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Marka grafikleri', body: 'Markanıza uyan kapaklar ve posterler.', thumb: 'example-image-poster' },
      { title: 'Mobil akışlar', body: 'Web’in ötesine geçtiğinizde uygulama ekranları.', thumb: 'example-mobile-app' },
      { title: 'Sosyal kartlar', body: 'Her kanal için lansman ve güncelleme kartları.', thumb: 'example-html-ppt-xhs-pastel-card' },
    ],
    galleryTitle: 'OpenDesign ile tek başına inşa edildi',
    galleryLead:
      'Tek kişilik bir girişimin ihtiyaç duyduğu her yüzey, tek bir komuttan. Bir sonraki adımınıza yakın olanı seçin ve anlatın.',
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: 'SaaS açılış sayfası' },
      { thumb: 'example-web-prototype', caption: 'Ürün prototipi' },
      { thumb: 'example-qiaomu-dashboard', caption: 'Ürün panosu' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: 'Lansman sosyal kartı' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Şablonlara göz atın',
    ...
    ctaBody:
      'Depoya yıldız verin, OpenDesign’ı kurun ve tek bir agent’ın tasarım ekibiniz olmasına izin verin — zaten kullandığınız agent’ta.',
  },
  roleDesigner: {
    title: 'Tasarımcılar için OpenDesign',
    description:
      'Zamanınızı zahmete değil, zevke harcayın. OpenDesign, agent’ınızın tekrar eden üretim işini — varyantlar, durumlar, tam tasarım sistemleri — üstlenmesini sağlar; siz görünümü yönetir ve son sözü söylersiniz.',
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'OpenDesign, hiç yorulmayan üretim asistanıdır: tasarım sistemini siz tanımlar ve zevki siz belirlersiniz; agent gerisini üretir, sisteme uygun, deponuzun içinde.',
    stepsTitle: 'Bir tasarımcı OpenDesign’ı nasıl kullanır',
    steps: [
      {
    ...
    tableTitle: 'OpenDesign ile tasarlamak vs. el yordamı',
    tableColCapability: 'Neye ihtiyacınız var',
    tableColWithOd: 'OpenDesign ile',
    ...
    features: [
      { title: 'Editöryel düzenler', body: 'Sanat yönetimli, ızgara odaklı kompozisyonlar.', thumb: 'example-skill-swiss-design' },
      { title: 'Makale kapakları', body: 'Dergi tarzı kapaklar ve dosyalar.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
      { title: 'Posterler', body: 'Markaya uygun, cesur tipografik posterler.', thumb: 'example-image-poster' },
      { title: 'Sosyal setler', body: 'Tutarlı çok kareli galeriler.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: 'Uygulama ekranları', body: 'Yüksek çözünürlüklü mobil ve web ekranları.', thumb: 'example-mobile-app' },
      { title: 'Panolar', body: 'Sisteminize saygılı veri arayüzü.', thumb: 'example-qiaomu-dashboard' },
    ],
    galleryTitle: 'OpenDesign ile yönetildi',
    galleryLead:
      'Agent’ın yönlendirmeyle ürettiği, sisteme uygun, yüksek çözünürlüklü işler. Stilinize yakın olanı seçin ve rafine edin.',
    gallery: [
      { thumb: 'example-skill-swiss-design', caption: 'Editöryel düzen' },
      { thumb: 'example-html-ppt-zhangzara-retro-zine', caption: 'Dergi kapağı' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: 'Sosyal galeri' },
      { thumb: 'example-image-poster', caption: 'Tipografik poster' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Şablonlara göz atın',
    ...
    ctaBody:
      'Depoya yıldız verin, OpenDesign’ı kurun ve siz zevki belirlerken üretimi agent yapsın — zaten kullandığınız agent’ta.',
  },
  roleEngineering: {
    title: 'Mühendisler için OpenDesign',
    description:
      'Tasarım devir teslimini atlayın. OpenDesign, bir DESIGN.md’yi kodlama agent’ınızın doğrudan yazdığı gerçek bir ön uca dönüştürür — sisteme uygun arayüz, prototipler ve panolar, depoda, Figma gidiş dönüşü olmadan.',
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'OpenDesign, tasarım sistemini makine tarafından okunabilir kılarak tasarımcı-mühendis boşluğunu kapatır: kodunuzu yazan aynı agent sistemi uygular ve gerçek arayüzü işler.',
    stepsTitle: 'Bir mühendis OpenDesign’ı nasıl kullanır',
    steps: [
      {
    ...
    tableTitle: 'OpenDesign ile ön uç vs. devir teslim yolu',
    tableColCapability: 'Neye ihtiyacınız var',
    tableColWithOd: 'OpenDesign ile',
    ...
    features: [
      ...
      { title: 'Geliştirici panoları', body: 'Depo, CI ve metrik panoları.', thumb: 'example-m3-ops-dashboard' },
      { title: 'Veri raporları', body: 'Verinizden yapılandırılmış raporlar.', thumb: 'example-impeccable-insight-dashboard' },
      { title: 'Yönetim panoları', body: 'Dahili araçlar ve yönetim görünümleri.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Açılış sayfaları', body: 'Tasarımı beklemeden pazarlama sayfaları.', thumb: 'example-qiaomu-landing' },
      { title: 'Kanban / panolar', body: 'Dahili iş akışı arayüzleri.', thumb: 'example-kanban-board' },
    ],
    galleryTitle: 'Mühendisler tarafından OpenDesign ile inşa edildi',
    galleryLead:
    ...
    gallery: [
      ...
      { thumb: 'example-m3-ops-dashboard', caption: 'Geliştirici panosu' },
      { thumb: 'example-impeccable-insight-dashboard', caption: 'Veri raporu' },
    ...
    ctaBody:
      'Depoya yıldız verin, OpenDesign’ı kurun ve bir DESIGN.md’yi ön uca dönüştürün — zaten kullandığınız agent’ta.',
  },
  roleProductManagers: {
    title: 'Ürün yöneticileri için OpenDesign',
    description:
      'Bir fikri iletmek için tasarım kapasitesini beklemeyi bırakın. OpenDesign, bir ürün yöneticisinin bir komutu tıklanabilir bir prototipe ya da tel çerçeveye dönüştürmesini sağlar — paydaşları hizalamak ve ekibi bilgilendirmek için, tasarım talebi açmadan.',
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'OpenDesign, bir ürün yöneticisine fikirleri somutlaştırmanın tasarımsız bir yolunu sunar: hizalama ve bilgilendirme için komuttan prototipe, ekibin tasarım bütçesini harcamadan.',
    stepsTitle: 'Bir ürün yöneticisi OpenDesign’ı nasıl kullanır',
    steps: [
      {
        title: 'Akışı anlatın',
    ...
    tableTitle: 'OpenDesign ile ürün yöneticiliği vs. tasarımı beklemek',
    tableColCapability: 'Neye ihtiyacınız var',
    tableColWithOd: 'OpenDesign ile',
    ...
    features: [
      ...
      { title: 'İlk kurulum akışları', body: 'Karşılama → kurulum → ilk çalıştırma.', thumb: 'example-qiaomu-wizard' },
      { title: 'Panolar ve iş akışları', body: 'Spesifikasyonlar için Kanban ve süreç arayüzleri.', thumb: 'example-kanban-board' },
      { title: 'Panolar', body: 'Sorunu çerçevelemek için metrik görünümleri.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Web prototipleri', body: 'İncelenecek çok ekranlı web akışları.', thumb: 'example-web-prototype' },
      { title: 'Trend görünümleri', body: 'Bağlam için 30 günlük ve trend anlık görüntüleri.', thumb: 'example-trading-analysis-dashboard-template' },
    ],
    galleryTitle: 'Ürün yöneticileri tarafından OpenDesign ile prototiplendi',
    galleryLead:
    ...
    gallery: [
      ...
      { thumb: 'example-qiaomu-wizard', caption: 'İlk kurulum akışı' },
    ...
    ctaBody:
      'Depoya yıldız verin, OpenDesign’ı kurun ve bir sonraki spesifikasyonunuzu insanların tıklayabileceği bir şeye dönüştürün — zaten kullandığınız agent’ta.',
  },
  roleMarketing: {
    title: 'Pazarlama ekipleri için OpenDesign',
    description:
      'Kampanyaları içerik hızında çıkarın. OpenDesign, agent’ınızın bir komuttan açılış sayfaları, sosyal kartlar ve kampanya görselleri üretmesini sağlar — markaya uygun, talep üzerine, tasarım kuyruğuna girmeden.',
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'OpenDesign, pazarlama için her zaman açık tasarım kaynağıdır: açılış sayfaları ve sosyal için komuttan içeriğe, markaya uygun, böylece kampanyalar metin yazdığınız hızda yayına alınır.',
    stepsTitle: 'Bir pazarlama ekibi OpenDesign’ı nasıl kullanır',
    steps: [
      {
    ...
    tableTitle: 'OpenDesign ile pazarlama vs. her zamanki telaş',
    tableColCapability: 'Neye ihtiyacınız var',
    tableColWithOd: 'OpenDesign ile',
    tableColWithout: 'Bugün onsuz',
    tableRows: [
    ...
    features: [
      { title: 'Açılış sayfaları', body: 'Kampanya ve ürün açılışları, dağıtılabilir.', thumb: 'example-qiaomu-landing' },
      { title: 'Sosyal kartlar', body: 'Markaya uygun X / Twitter kartları.', thumb: 'example-html-ppt-xhs-pastel-card' },
      { title: 'Galeriler', body: 'Tutarlı, çok slaytlı sosyal setler.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: 'Posterler', body: 'Duyuru ve etkinlik posterleri.', thumb: 'example-image-poster' },
      { title: 'Makale kapakları', body: 'Blog ve bülten kapakları.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
      { title: 'Web sayfaları', body: 'Mikro siteler ve kampanya sayfaları.', thumb: 'example-web-prototype' },
    ],
    galleryTitle: 'Pazarlama tarafından OpenDesign ile yayına alındı',
    galleryLead:
      'Bir komuttan işlenmiş, markaya uygun kampanya içerikleri. Kampanyanıza yakın olanı seçin ve metninizi yerleştirin.',
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: 'Kampanya açılış sayfası' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: 'Sosyal kart' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: 'Sosyal galeri' },
      { thumb: 'example-image-poster', caption: 'Duyuru posteri' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Şablonlara göz atın',
    ...
    ctaBody:
      'Depoya yıldız verin, OpenDesign’ı kurun ve brief’leri markaya uygun içeriklere dönüştürün — zaten kullandığınız agent’ta.',
  },
};
