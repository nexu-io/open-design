...
export const TR: SolutionLocaleCopy = {
  prototype: {
    title: 'Marketing AX + Claude Code ile etkileşimli prototipler oluşturun',
    description:
      'Bir komutu, terminalden çıkmadan tıklanabilir, çok ekranlı bir prototipe dönüştürün. Marketing AX, kodlama ajanınıza tasarım becerilerini, şablonları ve tasarım sistemini vererek tarayıcıda açabileceğiniz gerçek prototipler üretmesini sağlar.',
    breadcrumb: 'Prototip',
    ...
    tldrBody:
      'Marketing AX, zaten kullandığınız kodlama ajanının tasarım katmanıdır. Prototipleme için bu, tek bir paragraflık bir fikirden tek bir oturumda gezilebilir, stillendirilmiş bir prototipe geçmek demektir — tasarım aracı yok, dışa aktarma adımı yok, teslim boşluğu yok.',
    stepsTitle: 'Marketing AX ile prototipleme nasıl çalışır',
    steps: [
      {
        title: 'Akışı tarif edin',
        body: 'Ajanınıza ne kurduğunuzu sade bir dille anlatın — “bir karşılama ekranı, bir plan seçici ve bir onay ekranı içeren bir katılım akışı.” Marketing AX prototip becerisini yükler, böylece ajan tek bir sayfa değil ekranlar üretmesi gerektiğini bilir.',
        imageAlt:
      ...
      },
      {
        ...
        body: 'Ajan, Marketing AX’dan bir tasarım sistemi ve prototip şablonları uygular, böylece her ekran taslak gibi görünmek yerine tipografiyi, boşlukları ve bileşenleri paylaşır. Kopuk maketler değil, tutarlı bir ekran kümesi elde edersiniz.',
        imageAlt:
    ...
    tableTitle: 'Marketing AX ile prototipleme, eski yönteme karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'Marketing AX ile',
    ...
    galleryTitle: 'İnsanların Marketing AX ile oluşturduğu prototipler',
    galleryLead:
    ...
    faq: [
      {
        q: 'Marketing AX ile prototip yapmak için Figma gibi bir tasarım aracına ihtiyacım var mı?',
        a: 'Hayır. Marketing AX kodlama ajanınızın içinde çalışır ve prototipleri HTML olarak işler. Akışı dille tarif edersiniz; ajan ekranları üretir. Öğrenilecek ya da ücreti ödenecek ayrı bir tuval aracı yoktur.',
      },
      {
      ...
      },
      {
        ...
        a: 'Marketing AX; Claude Code, Codex, Cursor Agent, Gemini CLI ve bir düzineden fazla birinci taraf bağdaştırıcıyla çalışır. Kendi sağlayıcı anahtarlarınızı getirirsiniz; hiçbir şey sizin için barındırılmaz.',
      },
      {
    ...
    ctaBody:
      'Depoya yıldız verin, Marketing AX’ı kurun ve bir sonraki “ya şöyle olsaydı”yı tıklayabileceğiniz bir şeye dönüştürün — zaten kullandığınız ajanda.',
  },
  dashboard: {
    title: 'Marketing AX + Claude Code ile veri panoları oluşturun',
    description:
    ...
    lead: 'Ajanınıza neyi göstereceğini ve nasıl hissettirmesi gerektiğini söyleyin. Marketing AX grafik desenlerini, düzen sistemini ve görsel dili sağlar, böylece varsayılan stilli bir bileşen yığını değil, tutarlı ve sunulabilir bir pano elde edersiniz.',
    heroImageAlt:
      'Soldaki ham sayıların sağda temiz bir grafik ve KPI kartı panosuna aktığını gösteren editöryel illüstrasyon',
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Marketing AX, metriklerinizin sade dildeki bir tanımını ajanınızın HTML olarak işlediği stillendirilmiş bir panoya dönüştürür — deponuzda sürümlenir, her yere barındırılabilir, koltuk başı BI aboneliği olmadan.',
    stepsTitle: 'Marketing AX ile panolar nasıl çalışır',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'Marketing AX grafik ve düzen şablonları sunar, böylece trendler çizgi grafiğe, dökümler çubuklara ve oranlar doğru görsele dönüşür — uyumsuz varsayılanlar yerine baştan sona tutarlı tipografi ve boşluk.',
    ...
    tableTitle: 'Marketing AX ile panolar, eski yönteme karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'Marketing AX ile',
    ...
    galleryTitle: 'İnsanların Marketing AX ile oluşturduğu panolar',
    galleryLead:
    ...
    faqTitle: 'Pano SSS',
    faq: [
      { q: 'Tableau veya Looker gibi bir BI aracına ihtiyacım var mı?', a: 'Hayır. Marketing AX panoları kodlama ajanınızın içinde HTML olarak işler. Metrikleri tarif eder ve verinize yönlendirirsiniz; lisanslanacak ya da öğrenilecek ayrı bir BI platformu yoktur.' },
    ...
    ctaBody:
      'Depoya yıldız verin, Marketing AX’ı kurun ve metriklerinizi her yere barındırabileceğiniz bir panoya dönüştürün — zaten kullandığınız ajanda.',
  },
  slides: {
    title: 'Marketing AX + Claude Code ile sunum desteleri oluşturun',
    description:
      'Bir taslağı, herhangi bir sunum uygulaması açmadan tasarlanmış, markaya uygun bir slayt destesine dönüştürün. Marketing AX kodlama ajanınıza deste şablonları ve bir görsel sistem verir, slaytları sunabileceğiniz, dışa aktarabileceğiniz veya paylaşabileceğiniz HTML olarak işler.',
    breadcrumb: 'Slaytlar',
    label: 'Kullanım örneği · Slaytlar',
    heading: 'Tasarlanmış görünen desteler, bir komutla yazılır',
    lead: 'Ajanınıza bir taslak ve bir ton verin. Marketing AX bir deste şablonu ve görsel sistem uygular, böylece her slayt yerleştirilir, dizilir ve markaya uygundur — boş bir arka plandaki madde listesi değil.',
    heroImageAlt:
      'Soldaki bir taslağın sağda bir dizi tasarlanmış sunum slaytına dönüştüğünü gösteren editöryel illüstrasyon',
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Marketing AX bir taslağı ajanınızın tek bir oturumda işlediği tasarlanmış bir HTML destesine dönüştürür — tarayıcıda sunun, PDF veya PPTX olarak dışa aktarın ve kaynağı deponuzda tutun.',
    stepsTitle: 'Marketing AX ile desteler nasıl çalışır',
    steps: [
      ...
      { title: 'Bir deste stili seçin', body: 'Marketing AX deste şablonları sunar — editöryel, İsviçre-uluslararası, koyu teknik ve daha fazlası. Ajan birini uygular, böylece tipografi, ızgara ve vurgular her slayt boyunca tutarlı kalır.', imageAlt: 'Birkaç deste stili seçeneğinin yan yana dizildiğini gösteren illüstrasyon' },
    ...
    tableTitle: 'Marketing AX ile desteler, eski yönteme karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'Marketing AX ile',
    ...
    galleryTitle: 'İnsanların Marketing AX ile oluşturduğu desteler',
    galleryLead:
    ...
    faq: [
      { q: 'PowerPoint ya da Keynote’a ihtiyacım var mı?', a: 'Hayır. Marketing AX desteleri kodlama ajanınızın içinde HTML olarak işler ve PDF veya PPTX olarak dışa aktarabilir. Tarayıcıdan sunarsınız ya da bir dosya teslim edersiniz — kurmak için herhangi bir sunum uygulaması gerekmez.' },
    ...
    ctaBody:
      'Depoya yıldız verin, Marketing AX’ı kurun ve taslağınızı tasarlanmış bir desteye dönüştürün — zaten kullandığınız ajanda.',
  },
  image: {
    title: 'Marketing AX + Claude Code ile markaya uygun grafikler oluşturun',
    description:
    ...
    lead: 'İhtiyacınız olan kartı ya da kapağı tarif edin. Marketing AX onu gerçek yazı, ızgara ve marka renklerinizle düzenler — sonra bir tasarım uygulamasıyla ya da genel bir şablonla boğuşmak yerine, görsel olarak dışa aktarabileceğiniz HTML olarak işler.',
    heroImageAlt:
      'Bir komutun bir dizi yerleştirilmiş sosyal kart ve makale kapağına dönüştüğünü gösteren editöryel illüstrasyon',
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Marketing AX bir komutu, ajanınızın HTML olarak işleyip PNG’ye dışa aktardığı dizilmiş, markaya uygun bir grafiğe dönüştürür — yinelenebilir, sürümlenebilir ve koltuk başı tasarım araçlarından arınmış.',
    stepsTitle: 'Marketing AX ile grafikler nasıl çalışır',
    steps: [
      ...
      { title: 'Marka sistemini uygulayın', body: 'Marketing AX renklerinizi, yazınızı ve boşluklarınızı yeniden kullanılabilir bir tasarım sisteminden çeker, böylece her kart tek seferlik görünmek yerine markanızın geri kalanıyla eşleşir.', imageAlt: 'Marka renkleri ve yazının bir kart düzenine uygulandığını gösteren illüstrasyon' },
    ...
    tableTitle: 'Marketing AX ile grafikler, eski yönteme karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'Marketing AX ile',
    ...
    galleryTitle: 'İnsanların Marketing AX ile oluşturduğu grafikler',
    galleryLead:
    ...
    faqTitle: 'Görsel SSS',
    faq: [
      { q: 'Bu, Midjourney gibi bir yapay zekâ görsel üreticisi mi?', a: 'Hayır. Marketing AX grafikleri gerçek düzen ve tipografiyle düzenler — başlığınız, markanız, tam boyutlar — ve PNG olarak dışa aktardığınız HTML olarak işler. Bu, piksel üretimi değil, tasarım düzenlemesidir.' },
    ...
    ctaBody:
      'Depoya yıldız verin, Marketing AX’ı kurun ve bir komutu markaya uygun bir grafiğe dönüştürün — zaten kullandığınız ajanda.',
  },
  video: {
    title: 'Marketing AX + Claude Code ile hareketli grafikler ve kısa video oluşturun',
    description:
    ...
    lead: 'İstediğiniz anı tarif edin — bir başlık açılışı, bir veri animasyonu, bir logo kapanışı. Marketing AX hareketli kareleri marka sisteminizle düzenler ve videoya işler, hareketli grafik paketi gerekmez.',
    heroImageAlt:
      'Bir senaryonun bir dizi hareketli video karesine dönüştüğünü gösteren editöryel illüstrasyon',
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Marketing AX bir senaryoyu, ajanınızın kısa biçimli videoya işlediği hareketli, markaya uygun karelere dönüştürür — HTML’den düzenlenir, deponuzda sürümlenir, öğrenilecek bir zaman çizelgesi düzenleyicisi olmadan.',
    stepsTitle: 'Marketing AX ile hareket nasıl çalışır',
    steps: [
    ...
    tableTitle: 'Marketing AX ile hareket, eski yönteme karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'Marketing AX ile',
    ...
    galleryTitle: 'İnsanların Marketing AX ile oluşturduğu hareket',
    galleryLead:
    ...
    faqTitle: 'Video SSS',
    faq: [
      { q: 'After Effects ya da bir hareketli grafik paketine ihtiyacım var mı?', a: 'Hayır. Marketing AX hareketli kareleri HTML’de düzenler ve kodlama ajanınızın içinde videoya işler. Öğrenilecek ya da lisanslanacak bir zaman çizelgesi düzenleyicisi yoktur.' },
    ...
    ctaBody:
      'Depoya yıldız verin, Marketing AX’ı kurun ve bir senaryoyu harekete dönüştürün — zaten kullandığınız ajanda.',
  },
  designSystem: {
    title: 'Marketing AX + Claude Code ile bir tasarım sistemi kurun ve uygulayın',
    description:
    ...
    lead: 'Markanızı bir kez tanımlayın, Marketing AX onu her çıktıya taşısın — prototipler, desteler, panolar, grafikler. Sistem, deponuzda ajanın okuduğu bir DESIGN.md olarak yaşar, böylece tutarlılık elle değil, otomatiktir.',
    heroImageAlt:
      'Tek bir tasarım sisteminin markaya uygun birçok çıktıya ışıdığını gösteren editöryel illüstrasyon',
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Marketing AX markanızı, ajanınızın her çıktıya uyguladığı taşınabilir bir tasarım sistemi olarak yakalar — deponuzda bir kez tanımlanır, her yerde uygulanır, onu denetleyen merkezi bir tasarım aracı olmadan.',
    stepsTitle: 'Marketing AX ile tasarım sistemleri nasıl çalışır',
    steps: [
      { title: 'Sistemi yakalayın', body: 'Markanızı tarif edin — renkler, yazı, boşluk, ses — ya da çıkarması için ajanı mevcut bir siteye yönlendirin. Marketing AX bunu projenizde yaşayan bir DESIGN.md içine yazar.', imageAlt: 'Bir markanın tek bir tasarım sistemi dosyasına yakalandığını gösteren illüstrasyon' },
      { title: 'Kanıtlanmış bir temelden başlayın', body: 'Marketing AX 140’tan fazla referans tasarım sistemi sunar — Apple ve Linear’dan editöryel ve brütaliste. Boş bir sayfadan başlamak yerine markanıza yakın olan birini çatallayın.', imageAlt: 'Bir referans tasarım sistemleri galerisinin gezildiğini gösteren illüstrasyon' },
    ...
    tableTitle: 'Marketing AX ile tasarım sistemleri, eski yönteme karşı',
    tableColCapability: 'İhtiyacınız olan',
    tableColWithOd: 'Marketing AX ile',
    ...
    galleryTitle: 'Marketing AX’daki tasarım sistemleri',
    galleryLead:
    ...
    faq: [
      { q: 'Buradaki tasarım sistemi tam olarak nedir?', a: 'Deponuzda renkleri, yazıyı, boşluğu, bileşenleri ve sesi yakalayan bir DESIGN.md dosyası. Her Marketing AX becerisi onu okur, böylece markanız ajanın ürettiği her şeye otomatik olarak uygulanır.' },
      { q: 'Sıfırdan başlamak zorunda mıyım?', a: 'Hayır. Marketing AX çatallayabileceğiniz 140’tan fazla referans tasarım sistemi sunar — Apple ve Linear’dan editöryel ve brütaliste — sonra markanıza uyarlarsınız.' },
    ...
    ctaBody:
      'Depoya yıldız verin, Marketing AX’ı kurun ve ajanınıza her yerde uygulayacağı tek bir marka verin — zaten kullandığınız ajanda.',
  },
  roleSoloBuilder: {
    title: 'Tek kişilik geliştiriciler ve bağımsız hackerlar için Marketing AX',
    description:
      'Tek kişilik bir ekip gibi ürün çıkarın. Marketing AX, kodlama agent’ınızı girişiminizin tasarım yarısına dönüştürür — prototipler, açılış sayfaları, panolar ve marka görselleri, hepsi tek bir komutla, hepsi markaya uygun, hepsi deponuzda.',
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Marketing AX, tek kişilik bir kurucunun hiç sahip olmadığı tasarım departmanıdır: ürününüzün ihtiyaç duyduğu her yüzeyde komuttan ürüne, tek bir markayla, sıfır devir teslimle ve ek araç olmadan.',
    stepsTitle: 'Tek kişilik bir geliştirici Marketing AX’ı nasıl kullanır',
    steps: [
      {
    ...
    tableTitle: 'Marketing AX ile tek başına inşa etmek vs. zor yoldan yapmak',
    ...
    galleryTitle: 'Marketing AX ile tek başına inşa edildi',
    galleryLead:
    ...
    ctaBody:
      'Depoya yıldız verin, Marketing AX’ı kurun ve tek bir agent’ın tasarım ekibiniz olmasına izin verin — zaten kullandığınız agent’ta.',
  },
  roleDesigner: {
    title: 'Tasarımcılar için Marketing AX',
    description:
      'Zamanınızı zahmete değil, zevke harcayın. Marketing AX, agent’ınızın tekrar eden üretim işini — varyantlar, durumlar, tam tasarım sistemleri — üstlenmesini sağlar; siz görünümü yönetir ve son sözü söylersiniz.',
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Marketing AX, hiç yorulmayan üretim asistanıdır: tasarım sistemini siz tanımlar ve zevki siz belirlersiniz; agent gerisini üretir, sisteme uygun, deponuzun içinde.',
    stepsTitle: 'Bir tasarımcı Marketing AX’ı nasıl kullanır',
    steps: [
      {
    ...
    tableTitle: 'Marketing AX ile tasarlamak vs. el yordamı',
    tableColCapability: 'Neye ihtiyacınız var',
    tableColWithOd: 'Marketing AX ile',
    ...
    galleryTitle: 'Marketing AX ile yönetildi',
    galleryLead:
    ...
    ctaBody:
      'Depoya yıldız verin, Marketing AX’ı kurun ve siz zevki belirlerken üretimi agent yapsın — zaten kullandığınız agent’ta.',
  },
  roleEngineering: {
    title: 'Mühendisler için Marketing AX',
    description:
      'Tasarım devir teslimini atlayın. Marketing AX, bir DESIGN.md’yi kodlama agent’ınızın doğrudan yazdığı gerçek bir ön uca dönüştürür — sisteme uygun arayüz, prototipler ve panolar, depoda, Figma gidiş dönüşü olmadan.',
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Marketing AX, tasarım sistemini makine tarafından okunabilir kılarak tasarımcı-mühendis boşluğunu kapatır: kodunuzu yazan aynı agent sistemi uygular ve gerçek arayüzü işler.',
    stepsTitle: 'Bir mühendis Marketing AX’ı nasıl kullanır',
    steps: [
      {
    ...
    tableTitle: 'Marketing AX ile ön uç vs. devir teslim yolu',
    tableColCapability: 'Neye ihtiyacınız var',
    tableColWithOd: 'Marketing AX ile',
    ...
    galleryTitle: 'Mühendisler tarafından Marketing AX ile inşa edildi',
    galleryLead:
    ...
    ctaBody:
      'Depoya yıldız verin, Marketing AX’ı kurun ve bir DESIGN.md’yi ön uca dönüştürün — zaten kullandığınız agent’ta.',
  },
  roleProductManagers: {
    title: 'Ürün yöneticileri için Marketing AX',
    description:
      'Bir fikri iletmek için tasarım kapasitesini beklemeyi bırakın. Marketing AX, bir ürün yöneticisinin bir komutu tıklanabilir bir prototipe ya da tel çerçeveye dönüştürmesini sağlar — paydaşları hizalamak ve ekibi bilgilendirmek için, tasarım talebi açmadan.',
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Marketing AX, bir ürün yöneticisine fikirleri somutlaştırmanın tasarımsız bir yolunu sunar: hizalama ve bilgilendirme için komuttan prototipe, ekibin tasarım bütçesini harcamadan.',
    stepsTitle: 'Bir ürün yöneticisi Marketing AX’ı nasıl kullanır',
    steps: [
      {
        title: 'Akışı anlatın',
    ...
    tableTitle: 'Marketing AX ile ürün yöneticiliği vs. tasarımı beklemek',
    tableColCapability: 'Neye ihtiyacınız var',
    tableColWithOd: 'Marketing AX ile',
    ...
    galleryTitle: 'Ürün yöneticileri tarafından Marketing AX ile prototiplendi',
    galleryLead:
    ...
    ctaBody:
      'Depoya yıldız verin, Marketing AX’ı kurun ve bir sonraki spesifikasyonunuzu insanların tıklayabileceği bir şeye dönüştürün — zaten kullandığınız agent’ta.',
  },
  roleMarketing: {
    title: 'Pazarlama ekipleri için Marketing AX',
    description:
      'Kampanyaları içerik hızında çıkarın. Marketing AX, agent’ınızın bir komuttan açılış sayfaları, sosyal kartlar ve kampanya görselleri üretmesini sağlar — markaya uygun, talep üzerine, tasarım kuyruğuna girmeden.',
    ...
    tldrTitle: 'Tek cümlede',
    tldrBody:
      'Marketing AX, pazarlama için her zaman açık tasarım kaynağıdır: açılış sayfaları ve sosyal için komuttan içeriğe, markaya uygun, böylece kampanyalar metin yazdığınız hızda yayına alınır.',
    stepsTitle: 'Bir pazarlama ekibi Marketing AX’ı nasıl kullanır',
    steps: [
      {
    ...
    tableTitle: 'Marketing AX ile pazarlama vs. her zamanki telaş',
    tableColCapability: 'Neye ihtiyacınız var',
    tableColWithOd: 'Marketing AX ile',
    tableColWithout: 'Bugün onsuz',
    tableRows: [
    ...
    galleryTitle: 'Pazarlama tarafından Marketing AX ile yayına alındı',
    galleryLead:
    ...
    ctaBody:
      'Depoya yıldız verin, Marketing AX’ı kurun ve brief’leri markaya uygun içeriklere dönüştürün — zaten kullandığınız agent’ta.',
  },
};
