...
export const PL: SolutionLocaleCopy = {
  prototype: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Wieloekranowy prototyp aplikacji w układzie kafelków' },
      { thumb: "example-qiaomu-wizard", caption: "Przepływ onboardingu HR" },
      { thumb: "example-skill-mengto-landing", caption: "Strona docelowa produktu" },
      { thumb: "example-style-claymorphism", caption: "Webowy prototyp w miękkim stylu" },
    ],
  ...
  dashboard: {
    ...
    features: [
      { title: "Analityka produktu", body: "Aktywni użytkownicy, lejki, retencja — metryki, którymi żyje zespół produktowy.", thumb: "example-qiaomu-dashboard" },
      { title: "Metryki repo i dev", body: "Gwiazdki, PR-y, kondycja CI — dashboardy inżynierskie z Twoich własnych danych.", thumb: "example-m3-ops-dashboard" },
      { title: "Raporty finansowe", body: "Przychód, spalanie gotówki, runway rozłożone w udostępnialny raport.", thumb: "example-trading-analysis-dashboard-template" },
      ...
      { title: "Social i marketing", body: "Wydajność kanałów i śledzenie kampanii w jednym widoku.", thumb: "example-social-media-matrix-tracker-template" },
      { title: "Raporty dziedzinowe", body: "Ustrukturyzowane raporty dla dowolnej dziedziny — od klinicznej po tradingową.", thumb: "example-promax-health-dashboard" },
    ],
    ...
    gallery: [
      { thumb: "example-impeccable-insight-dashboard", caption: "Raport danych" },
      { thumb: "example-live-artifact", caption: "Dashboard operacji na żywo" },
  ...
  image: {
    ...
    features: [
      { title: "Karty społecznościowe", body: "Karty na X / Twitter skomponowane z Twoim nagłówkiem i marką.", thumb: "example-html-ppt-xhs-pastel-card" },
      { title: "Okładki artykułów", body: "Redakcyjne, magazynowe okładki do postów i newsletterów.", thumb: "example-html-ppt-zhangzara-retro-zine" },
      { title: "Karty Xiaohongshu", body: "Karty w stylu RedNote dostrojone do tego feedu.", thumb: "example-html-ppt-xhs-white-editorial" },
      { title: "Grafiki hero", body: "Płynne, gradientowe wizualizacje hero do stron i launchy.", thumb: "example-frame-liquid-bg-hero" },
      { title: "Karuzele", body: "Wieloslajdowe karuzele społecznościowe, które pozostają spójne między ramkami.", thumb: "example-html-ppt-xhs-white-editorial" },
    ...
    gallery: [
      ...
      { thumb: "example-image-poster", caption: "Plakat w stylu magazynowym" },
  ...
  video: {
    ...
    features: [
      ...
      { title: "Zestawy klatek ruchu", body: "Wielokrotne animowane klatki, które komponujesz w klip.", thumb: "example-frame-glitch-title" },
  ...
  roleSoloBuilder: {
    ...
    features: [
      { title: 'Strony docelowe', body: 'Strony marketingowe i SaaS, klikalne i działające na żywo.', thumb: 'example-qiaomu-landing' },
      { title: 'Prototypy produktu', body: 'Wieloekranowe aplikacje webowe do weryfikacji pomysłu.', thumb: 'example-web-prototype' },
      { title: 'Pulpity', body: 'Widoki metryk i panele administracyjne dla Twojego produktu.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Grafika marki', body: 'Okładki i plakaty pasujące do Twojej marki.', thumb: 'example-image-poster' },
      { title: 'Przepływy mobilne', body: 'Ekrany aplikacji, gdy wychodzisz poza web.', thumb: 'example-mobile-app' },
      { title: 'Karty społecznościowe', body: 'Karty premierowe i aktualizacyjne dla każdego kanału.', thumb: 'example-html-ppt-xhs-pastel-card' },
    ],
    ...
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: 'Strona docelowa SaaS' },
      { thumb: 'example-web-prototype', caption: 'Prototyp produktu' },
      { thumb: 'example-qiaomu-dashboard', caption: 'Pulpit produktu' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: 'Premierowa karta społecznościowa' },
    ],
    exampleHref: '/plugins/templates/',
  ...
  roleDesigner: {
    ...
    features: [
      { title: 'Układy redakcyjne', body: 'Kierowane artystycznie kompozycje oparte na siatce.', thumb: 'example-skill-swiss-design' },
      { title: 'Okładki artykułów', body: 'Okładki i materiały w stylu magazynowym.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
      { title: 'Plakaty', body: 'Odważne plakaty typograficzne zgodne z marką.', thumb: 'example-image-poster' },
      { title: 'Zestawy społecznościowe', body: 'Spójne wieloklatkowe karuzele.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: 'Ekrany aplikacji', body: 'Ekrany mobilne i webowe o wysokiej wierności.', thumb: 'example-mobile-app' },
      { title: 'Pulpity', body: 'Interfejs danych, który respektuje Twój system.', thumb: 'example-qiaomu-dashboard' },
    ],
    ...
    gallery: [
      { thumb: 'example-skill-swiss-design', caption: 'Układ redakcyjny' },
      { thumb: 'example-html-ppt-zhangzara-retro-zine', caption: 'Okładka magazynowa' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: 'Karuzela społecznościowa' },
      { thumb: 'example-image-poster', caption: 'Plakat typograficzny' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Przeglądaj szablony',
  ...
  roleEngineering: {
    ...
    features: [
      ...
      { title: 'Pulpity deweloperskie', body: 'Pulpity repozytorium, CI i metryk.', thumb: 'example-m3-ops-dashboard' },
      { title: 'Raporty danych', body: 'Ustrukturyzowane raporty z Twoich danych.', thumb: 'example-impeccable-insight-dashboard' },
      { title: 'Pulpity administracyjne', body: 'Narzędzia wewnętrzne i widoki administracyjne.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Strony docelowe', body: 'Strony marketingowe bez czekania na projekt.', thumb: 'example-qiaomu-landing' },
    ...
    gallery: [
      ...
      { thumb: 'example-m3-ops-dashboard', caption: 'Pulpit deweloperski' },
      { thumb: 'example-impeccable-insight-dashboard', caption: 'Raport danych' },
  ...
  roleProductManagers: {
    ...
    features: [
      ...
      { title: 'Przepływy onboardingu', body: 'Powitanie → konfiguracja → pierwsze uruchomienie.', thumb: 'example-qiaomu-wizard' },
      { title: 'Tablice i przepływy', body: 'Interfejsy Kanban i procesów do specyfikacji.', thumb: 'example-kanban-board' },
      { title: 'Pulpity', body: 'Widoki metryk, by ująć problem w ramy.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Prototypy webowe', body: 'Wieloekranowe przepływy webowe do przeglądu.', thumb: 'example-web-prototype' },
      { title: 'Widoki trendów', body: 'Migawki 30-dniowe i trendowe dla kontekstu.', thumb: 'example-trading-analysis-dashboard-template' },
    ],
    ...
    gallery: [
      ...
      { thumb: 'example-qiaomu-wizard', caption: 'Przepływ onboardingu' },
  ...
  roleMarketing: {
    ...
    features: [
      { title: 'Strony docelowe', body: 'Strony kampanijne i produktowe, gotowe do wdrożenia.', thumb: 'example-qiaomu-landing' },
      { title: 'Karty społecznościowe', body: 'Karty X / Twitter zgodne z marką.', thumb: 'example-html-ppt-xhs-pastel-card' },
      { title: 'Karuzele', body: 'Wieloslajdowe zestawy społecznościowe, spójne.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: 'Plakaty', body: 'Plakaty z ogłoszeniami i na wydarzenia.', thumb: 'example-image-poster' },
      { title: 'Okładki artykułów', body: 'Okładki blogów i newsletterów.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
    ...
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: 'Strona docelowa kampanii' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: 'Karta społecznościowa' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: 'Karuzela społecznościowa' },
      { thumb: 'example-image-poster', caption: 'Plakat z ogłoszeniem' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Przeglądaj szablony',
