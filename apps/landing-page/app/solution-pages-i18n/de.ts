...
export const DE: SolutionLocaleCopy = {
  aiWireframeGenerator: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Mehrseitiger App-Prototyp in Kachelansicht' },
      { thumb: 'example-qiaomu-wizard', caption: 'HR-Onboarding-Flow' },
      { thumb: 'example-skill-mengto-landing', caption: 'Produkt-Landing-Layout' },
      { thumb: 'example-style-claymorphism', caption: 'Web-Wireframe im weichen Stil' },
    ],
  ...
  aiUiGenerator: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Mehrseitiger App-Prototyp in Kachelansicht' },
      { thumb: 'example-qiaomu-wizard', caption: 'HR-Onboarding-Flow' },
      { thumb: 'example-skill-mengto-landing', caption: 'Produkt-Landing-UI' },
      { thumb: 'example-style-claymorphism', caption: 'Web-UI im weichen Stil' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Vorlagen durchsuchen',
  ...
  designToCode: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Mehrseitiger App-Prototyp in Kachelansicht' },
      { thumb: 'example-qiaomu-wizard', caption: 'HR-Onboarding-Flow' },
      { thumb: 'example-skill-mengto-landing', caption: 'Produkt-Landing im Code' },
      { thumb: 'example-style-claymorphism', caption: 'Web-Build im weichen Stil' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Vorlagen durchsuchen',
  ...
  aiLandingPageGenerator: {
    ...
    gallery: [
      { thumb: 'example-skill-mengto-landing', caption: 'Produkt-Launch-Seite' },
      { thumb: 'example-qiaomu-landing', caption: 'SaaS-Marketing-Seite' },
      { thumb: 'example-qiaomu-coming-soon', caption: 'Warteliste-Erfassungsflow' },
      { thumb: 'example-style-claymorphism', caption: 'Landing-Layout im weichen Stil' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Vorlagen durchsuchen',
  ...
  figmaToCode: {
    ...
    gallery: [
      ...
      { thumb: 'example-skill-mengto-landing', caption: 'Landing-Frame im Code' },
      { thumb: 'example-style-claymorphism', caption: 'Web-Build im weichen Stil' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Vorlagen durchsuchen',
  ...
  screenshotToCode: {
    ...
    gallery: [
      ...
      { thumb: 'example-skill-mengto-landing', caption: 'Landing-Screenshot im Code' },
      { thumb: 'example-style-claymorphism', caption: 'Web-Build im weichen Stil' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Vorlagen durchsuchen',
  ...
  aiPrototypeGenerator: {
    ...
    gallery: [
      ...
      { thumb: 'example-style-claymorphism', caption: 'Web-Prototyp im weichen Stil' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Vorlagen durchsuchen',
  ...
  prototype: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Mehrseitiger App-Prototyp in Kachelansicht' },
      { thumb: "example-qiaomu-wizard", caption: "HR-Onboarding-Flow" },
      { thumb: "example-skill-mengto-landing", caption: "Produkt-Landingpage" },
      { thumb: "example-style-claymorphism", caption: "Web-Prototyp im weichen Stil" },
    ],
    exampleHref: '/plugins/templates/',
  ...
  dashboard: {
    ...
    features: [
      { title: "Produktanalysen", body: "Aktive Nutzer, Funnels, Retention — die Kennzahlen, in denen ein Produktteam lebt.", thumb: "example-qiaomu-dashboard" },
      { title: "Repo- & Dev-Kennzahlen", body: "Sterne, PRs, CI-Status — Engineering-Dashboards aus deinen eigenen Daten.", thumb: "example-m3-ops-dashboard" },
      { title: "Finanzberichte", body: "Umsatz, Burn, Runway als teilbarer Bericht angeordnet.", thumb: "example-trading-analysis-dashboard-template" },
      ...
      { title: "Social & Marketing", body: "Kanal-Performance und Kampagnen-Tracking in einer Ansicht.", thumb: "example-social-media-matrix-tracker-template" },
      { title: "Fachberichte", body: "Strukturierte Berichte für jedes Feld — von klinisch bis Trading.", thumb: "example-promax-health-dashboard" },
    ],
    ...
    gallery: [
      { thumb: "example-impeccable-insight-dashboard", caption: "Datenbericht" },
      { thumb: "example-live-artifact", caption: "Live-Betriebs-Dashboard" },
  ...
  image: {
    ...
    features: [
      { title: "Social-Cards", body: "X- / Twitter-Cards, komponiert mit deiner Schlagzeile und Marke.", thumb: "example-html-ppt-xhs-pastel-card" },
      { title: "Artikel-Cover", body: "Redaktionelle Cover im Magazin-Stil für Beiträge und Newsletter.", thumb: "example-html-ppt-zhangzara-retro-zine" },
      { title: "Xiaohongshu-Cards", body: "Cards im RedNote-Stil, auf diesen Feed abgestimmt.", thumb: "example-html-ppt-xhs-white-editorial" },
      { title: "Hero-Grafiken", body: "Flüssige Gradient-Hero-Visuals für Websites und Launches.", thumb: "example-frame-liquid-bg-hero" },
      { title: "Karussells", body: "Social-Karussells aus mehreren Slides, die über alle Frames einheitlich bleiben.", thumb: "example-html-ppt-xhs-white-editorial" },
    ...
    gallery: [
      ...
      { thumb: "example-image-poster", caption: "Poster im Magazin-Stil" },
  ...
  video: {
    ...
    features: [
      ...
      { title: "Motion-Frame-Sets", body: "Wiederverwendbare animierte Frames, die du zu einem Clip zusammensetzt.", thumb: "example-frame-glitch-title" },
  ...
  roleSoloBuilder: {
    ...
    features: [
      { title: 'Landingpages', body: 'Marketing- und SaaS-Landings, klickbar und live.', thumb: 'example-qiaomu-landing' },
      { title: 'Produktprototypen', body: 'Mehrseitige Web-Apps zur Validierung der Idee.', thumb: 'example-web-prototype' },
      { title: 'Dashboards', body: 'Kennzahlen- und Admin-Ansichten für dein Produkt.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Brand-Grafiken', body: 'Cover und Poster passend zu deiner Marke.', thumb: 'example-image-poster' },
      { title: 'Mobile Flows', body: 'App-Screens, wenn du über das Web hinausgehst.', thumb: 'example-mobile-app' },
      { title: 'Social-Cards', body: 'Launch- und Update-Cards für jeden Kanal.', thumb: 'example-html-ppt-xhs-pastel-card' },
    ],
    ...
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: 'SaaS-Landingpage' },
      { thumb: 'example-web-prototype', caption: 'Produktprototyp' },
      { thumb: 'example-qiaomu-dashboard', caption: 'Produkt-Dashboard' },
  ...
  roleDesigner: {
    ...
    features: [
      { title: 'Redaktionelle Layouts', body: 'Art-Directed, rasterbasierte Kompositionen.', thumb: 'example-skill-swiss-design' },
      { title: 'Artikel-Cover', body: 'Cover und Aufmacher im Magazinstil.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
      { title: 'Poster', body: 'Markante typografische Poster, markenkonform.', thumb: 'example-image-poster' },
      { title: 'Social-Sets', body: 'Konsistente mehrteilige Carousels.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: 'App-Screens', body: 'Hochauflösende Mobile- und Web-Screens.', thumb: 'example-mobile-app' },
      { title: 'Dashboards', body: 'Daten-UI, die dein System respektiert.', thumb: 'example-qiaomu-dashboard' },
    ],
    ...
    gallery: [
      { thumb: 'example-skill-swiss-design', caption: 'Redaktionelles Layout' },
      { thumb: 'example-html-ppt-zhangzara-retro-zine', caption: 'Magazin-Cover' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: 'Social-Carousel' },
      { thumb: 'example-image-poster', caption: 'Typografisches Poster' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Vorlagen durchsuchen',
  ...
  roleEngineering: {
    ...
    features: [
      ...
      { title: 'Dev-Dashboards', body: 'Repo-, CI- und Kennzahlen-Dashboards.', thumb: 'example-m3-ops-dashboard' },
      { title: 'Datenreports', body: 'Strukturierte Reports aus deinen Daten.', thumb: 'example-impeccable-insight-dashboard' },
      { title: 'Admin-Dashboards', body: 'Interne Tools und Admin-Ansichten.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Landingpages', body: 'Marketing-Seiten, ohne aufs Design zu warten.', thumb: 'example-qiaomu-landing' },
    ...
    gallery: [
      ...
      { thumb: 'example-impeccable-insight-dashboard', caption: 'Datenreport' },
  ...
  roleProductManagers: {
    ...
    features: [
      ...
      { title: 'Onboarding-Flows', body: 'Willkommen → Einrichtung → erster Lauf.', thumb: 'example-qiaomu-wizard' },
      { title: 'Boards & Workflows', body: 'Kanban- und Prozess-UIs für Specs.', thumb: 'example-kanban-board' },
      { title: 'Dashboards', body: 'Kennzahlenansichten, um das Problem zu rahmen.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Web-Prototypen', body: 'Mehrseitige Web-Flows zum Reviewen.', thumb: 'example-web-prototype' },
      { title: 'Trend-Ansichten', body: '30-Tage- und Trend-Snapshots für Kontext.', thumb: 'example-trading-analysis-dashboard-template' },
    ],
  ...
  roleMarketing: {
    ...
    features: [
      { title: 'Landingpages', body: 'Kampagnen- und Produkt-Landings, deploybar.', thumb: 'example-qiaomu-landing' },
      { title: 'Social-Cards', body: 'X- / Twitter-Cards, markenkonform.', thumb: 'example-html-ppt-xhs-pastel-card' },
      { title: 'Carousels', body: 'Mehrteilige Social-Sets, konsistent.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: 'Poster', body: 'Ankündigungs- und Event-Poster.', thumb: 'example-image-poster' },
      { title: 'Artikel-Cover', body: 'Blog- und Newsletter-Cover.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
    ...
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: 'Kampagnen-Landingpage' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: 'Social-Card' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: 'Social-Carousel' },
      { thumb: 'example-image-poster', caption: 'Ankündigungsposter' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Vorlagen durchsuchen',
