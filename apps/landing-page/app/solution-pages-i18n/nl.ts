...
export const NL: SolutionLocaleCopy = {
  prototype: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Multi-scherm app-prototype in tegelweergave' },
      { thumb: "example-qiaomu-wizard", caption: "HR-onboardingflow" },
      { thumb: "example-skill-mengto-landing", caption: "Productlandingspagina" },
      { thumb: "example-style-claymorphism", caption: "Web-prototype in zachte stijl" },
    ],
  ...
  dashboard: {
    ...
    features: [
      { title: "Productanalyse", body: "Actieve gebruikers, funnels, retentie — de metrics waar een productteam in leeft.", thumb: "example-qiaomu-dashboard" },
      { title: "Repo- en dev-metrics", body: "Sterren, PR’s, CI-gezondheid — engineeringdashboards uit je eigen data.", thumb: "example-m3-ops-dashboard" },
      { title: "Financiële rapporten", body: "Omzet, burn, runway uitgewerkt als een deelbaar rapport.", thumb: "example-trading-analysis-dashboard-template" },
      ...
      { title: "Social en marketing", body: "Kanaalprestaties en campagnetracking in één overzicht.", thumb: "example-social-media-matrix-tracker-template" },
      { title: "Domeinrapporten", body: "Gestructureerde rapporten voor elk vakgebied — van klinisch tot trading.", thumb: "example-promax-health-dashboard" },
    ],
    ...
    gallery: [
      { thumb: "example-impeccable-insight-dashboard", caption: "Datarapport" },
  ...
  image: {
    ...
    features: [
      { title: "Socialkaarten", body: "X / Twitter-kaarten samengesteld met jouw kop en merk.", thumb: "example-html-ppt-xhs-pastel-card" },
      { title: "Artikelomslagen", body: "Redactionele, magazineachtige omslagen voor posts en nieuwsbrieven.", thumb: "example-html-ppt-zhangzara-retro-zine" },
      { title: "Xiaohongshu-kaarten", body: "Kaarten in RedNote-stijl afgestemd op die feed.", thumb: "example-html-ppt-xhs-white-editorial" },
      { title: "Hero-graphics", body: "Vloeiende, gradiënt hero-beelden voor sites en launches.", thumb: "example-frame-liquid-bg-hero" },
      { title: "Carrousels", body: "Socialcarrousels met meerdere slides die consistent blijven over frames.", thumb: "example-html-ppt-xhs-white-editorial" },
    ...
    gallery: [
      ...
      { thumb: "example-image-poster", caption: "Poster in magazinestijl" },
  ...
  video: {
    ...
    features: [
      ...
      { title: "Motion-framesets", body: "Herbruikbare geanimeerde frames die je samenstelt tot een clip.", thumb: "example-frame-glitch-title" },
  ...
  roleSoloBuilder: {
    ...
    features: [
      { title: 'Landingspaginas', body: 'Marketing- en SaaS-landings, klikbaar en live.', thumb: 'example-qiaomu-landing' },
      { title: 'Productprototypes', body: 'Webapps met meerdere schermen om het idee te valideren.', thumb: 'example-web-prototype' },
      { title: 'Dashboards', body: 'Statistiek- en adminweergaven voor je product.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Merkgraphics', body: 'Covers en posters die bij je merk passen.', thumb: 'example-image-poster' },
      { title: 'Mobiele flows', body: 'Appschermen wanneer je verder gaat dan het web.', thumb: 'example-mobile-app' },
      { title: 'Socialkaarten', body: 'Lancerings- en updatekaarten voor elk kanaal.', thumb: 'example-html-ppt-xhs-pastel-card' },
    ],
    ...
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: 'SaaS-landingspagina' },
      { thumb: 'example-web-prototype', caption: 'Productprototype' },
      { thumb: 'example-qiaomu-dashboard', caption: 'Productdashboard' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: 'Socialkaart voor lancering' },
    ],
    exampleHref: '/plugins/templates/',
  ...
  roleDesigner: {
    ...
    features: [
      { title: 'Redactionele layouts', body: 'Art-directed, gridgedreven composities.', thumb: 'example-skill-swiss-design' },
      { title: 'Artikelcovers', body: 'Covers en features in magazinestijl.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
      { title: 'Posters', body: 'Gedurfde typografische posters op merk.', thumb: 'example-image-poster' },
      { title: 'Socialsets', body: 'Consistente carrousels met meerdere frames.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: 'Appschermen', body: 'Hifi mobiele en webschermen.', thumb: 'example-mobile-app' },
      { title: 'Dashboards', body: 'Data-UI die jouw systeem respecteert.', thumb: 'example-qiaomu-dashboard' },
    ],
    ...
    gallery: [
      { thumb: 'example-skill-swiss-design', caption: 'Redactionele layout' },
      { thumb: 'example-html-ppt-zhangzara-retro-zine', caption: 'Magazinecover' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: 'Socialcarrousel' },
      { thumb: 'example-image-poster', caption: 'Typografische poster' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Bekijk templates',
  ...
  roleEngineering: {
    ...
    features: [
      ...
      { title: 'Dev-dashboards', body: 'Repo-, CI- en statistiekdashboards.', thumb: 'example-m3-ops-dashboard' },
      { title: 'Datarapporten', body: 'Gestructureerde rapporten vanuit je data.', thumb: 'example-impeccable-insight-dashboard' },
      { title: 'Admin-dashboards', body: 'Interne tools en adminweergaven.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Landingspaginas', body: 'Marketingpaginas zonder op ontwerp te wachten.', thumb: 'example-qiaomu-landing' },
  ...
  roleProductManagers: {
    ...
    features: [
      ...
      { title: 'Onboardingflows', body: 'Welkom → setup → eerste keer.', thumb: 'example-qiaomu-wizard' },
      { title: 'Borden & workflows', body: 'Kanban- en proces-UIs voor specs.', thumb: 'example-kanban-board' },
      { title: 'Dashboards', body: 'Statistiekweergaven om het probleem te kaderen.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Webprototypes', body: 'Webflows met meerdere schermen om te reviewen.', thumb: 'example-web-prototype' },
      { title: 'Trendweergaven', body: 'Snapshots van 30 dagen en trends voor context.', thumb: 'example-trading-analysis-dashboard-template' },
    ],
    ...
    gallery: [
      ...
      { thumb: 'example-qiaomu-wizard', caption: 'Onboardingflow' },
  ...
  roleMarketing: {
    ...
    features: [
      { title: 'Landingspaginas', body: 'Campagne- en productlandings, deploybaar.', thumb: 'example-qiaomu-landing' },
      { title: 'Socialkaarten', body: 'X / Twitter-kaarten op merk.', thumb: 'example-html-ppt-xhs-pastel-card' },
      { title: 'Carrousels', body: 'Socialsets met meerdere slides, consistent.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: 'Posters', body: 'Aankondigings- en evenementenposters.', thumb: 'example-image-poster' },
      { title: 'Artikelcovers', body: 'Blog- en nieuwsbriefcovers.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
    ...
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: 'Campagnelandingspagina' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: 'Socialkaart' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: 'Socialcarrousel' },
      { thumb: 'example-image-poster', caption: 'Aankondigingsposter' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Bekijk templates',
