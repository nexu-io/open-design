...
export const NL: SolutionLocaleCopy = {
  prototype: {
    title: 'Bouw interactieve prototypes met Marketing AX + Claude Code',
    description:
      'Verander een prompt in een aanklikbaar prototype met meerdere schermen zonder je terminal te verlaten. Marketing AX geeft je coding agent de ontwerpvaardigheden, sjablonen en het designsysteem om echte prototypes te maken die je in een browser kunt openen.',
    ...
    tldrBody:
      'Marketing AX is de ontwerplaag voor de coding agent die je al gebruikt. Voor prototyping betekent dat: van een idee van één alinea naar een navigeerbaar, gestileerd prototype in één sessie — geen ontwerptool, geen exportstap, geen overdrachtskloof.',
    stepsTitle: 'Hoe prototyping werkt met Marketing AX',
    steps: [
      {
        title: 'Beschrijf de flow',
        body: 'Vertel je agent in gewone taal wat je bouwt — “een onboardingflow met een welkomstscherm, een abonnementskiezer en een bevestiging.” Marketing AX laadt de prototypevaardigheid, zodat de agent weet dat hij schermen moet maken, niet één pagina.',
        imageAlt:
      ...
      },
      {
        ...
        body: 'De agent past een designsysteem en prototypesjablonen uit Marketing AX toe, zodat elk scherm typografie, witruimte en componenten deelt in plaats van op een ruwe schets te lijken. Je krijgt een samenhangende set schermen, geen losse mockups.',
        imageAlt:
    ...
    tableTitle: 'Prototyping met Marketing AX versus de oude manier',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met Marketing AX',
    ...
    galleryTitle: 'Prototypes die mensen bouwden met Marketing AX',
    galleryLead:
    ...
    faq: [
      {
        q: 'Heb ik een ontwerptool als Figma nodig om te prototypen met Marketing AX?',
        a: 'Nee. Marketing AX draait binnen je coding agent en rendert prototypes naar HTML. Je beschrijft de flow in taal; de agent maakt de schermen. Er is geen aparte canvastool om te leren of voor te betalen.',
      },
      {
      ...
      },
      {
        ...
        a: 'Marketing AX werkt met Claude Code, Codex, Cursor Agent, Gemini CLI en een tiental andere eigen adapters. Je gebruikt je eigen providersleutels; er wordt niets voor je gehost.',
      },
      {
    ...
    ctaBody:
      'Geef de repo een ster, installeer Marketing AX en verander je volgende “wat als” in iets dat je kunt aanklikken — in de agent die je al gebruikt.',
  },
  dashboard: {
    title: 'Genereer datadashboards met Marketing AX + Claude Code',
    description:
    ...
    lead: 'Vertel je agent wat hij moet tonen en hoe het moet aanvoelen. Marketing AX levert de grafiekpatronen, het indelingssysteem en de visuele taal, zodat je een samenhangend, presentabel dashboard krijgt — geen muur van standaard gestileerde widgets.',
    heroImageAlt:
    ...
    tldrTitle: 'In één zin',
    tldrBody:
      'Marketing AX verandert een specificatie van je metrics in gewone taal in een gestileerd dashboard dat je agent naar HTML rendert — geversioneerd in je repo, overal te hosten, zonder BI-abonnement per seat.',
    stepsTitle: 'Hoe dashboards werken met Marketing AX',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'Marketing AX levert grafiek- en indelingssjablonen, zodat trends lijngrafieken worden, uitsplitsingen staven en verhoudingen het juiste beeld — consistente typografie en witruimte overal in plaats van niet-passende standaarden.',
    ...
    tableTitle: 'Dashboards met Marketing AX versus de oude manier',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met Marketing AX',
    ...
    galleryTitle: 'Dashboards die mensen bouwden met Marketing AX',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Nee. Marketing AX rendert dashboards naar HTML binnen je coding agent. Je beschrijft de metrics en wijst hem naar je data; er is geen apart BI-platform om te licentiëren of te leren.',
      },
      {
    ...
    ctaBody:
      'Geef de repo een ster, installeer Marketing AX en verander je metrics in een dashboard dat je overal kunt hosten — in de agent die je al gebruikt.',
  },
  slides: {
    title: 'Genereer presentatiedecks met Marketing AX + Claude Code',
    description:
      'Verander een outline in een ontworpen, on-brand slidedeck zonder een presentatie-app te openen. Marketing AX geeft je coding agent decksjablonen en een visueel systeem, en rendert slides naar HTML die je kunt presenteren, exporteren of delen.',
    breadcrumb: 'Slides',
    label: 'Toepassing · Slides',
    heading: 'Decks die ontworpen ogen, geschreven door een prompt',
    lead: 'Geef je agent een outline en een toon. Marketing AX past een decksjabloon en visueel systeem toe, zodat elke slide opgemaakt, gezet en on-brand is — geen opsomming op een lege achtergrond.',
    heroImageAlt:
      'Redactionele illustratie van een outline links die verandert in een reeks ontworpen presentatieslides rechts',
    tldrTitle: 'In één zin',
    tldrBody:
      'Marketing AX verandert een outline in een ontworpen HTML-deck dat je agent in één sessie rendert — presenteer het in de browser, exporteer naar PDF of PPTX, en houd de bron in je repo.',
    stepsTitle: 'Hoe decks werken met Marketing AX',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'Marketing AX levert decksjablonen — redactioneel, Zwitsers-internationaal, donker technisch en meer. De agent past er één toe, zodat typografie, raster en accenten over elke slide consistent blijven.',
    ...
    tableTitle: 'Decks met Marketing AX versus de oude manier',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met Marketing AX',
    ...
    galleryTitle: 'Decks die mensen bouwden met Marketing AX',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Nee. Marketing AX rendert decks naar HTML binnen je coding agent en kan exporteren naar PDF of PPTX. Je presenteert vanuit de browser of draagt een bestand over — er is geen presentatie-app nodig om het te bouwen.',
      },
      {
    ...
    ctaBody:
      'Geef de repo een ster, installeer Marketing AX en verander je outline in een ontworpen deck — in de agent die je al gebruikt.',
  },
  image: {
    title: 'Genereer on-brand graphics met Marketing AX + Claude Code',
    description:
    ...
    lead: 'Beschrijf de kaart of omslag die je nodig hebt. Marketing AX stelt hem samen met echte typografie, raster en jouw merkkleuren — en rendert vervolgens naar HTML die je als afbeelding kunt exporteren, in plaats van te worstelen met een ontwerp-app of een generiek sjabloon.',
    heroImageAlt:
      'Redactionele illustratie van een prompt die verandert in een set opgemaakte socialkaarten en artikelomslagen',
    tldrTitle: 'In één zin',
    tldrBody:
      'Marketing AX verandert een prompt in een gezette, on-brand graphic die je agent naar HTML rendert en naar PNG exporteert — herhaalbaar, geversioneerd en vrij van ontwerptools per seat.',
    stepsTitle: 'Hoe graphics werken met Marketing AX',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'Marketing AX haalt je kleuren, typografie en witruimte uit een herbruikbaar designsysteem, zodat elke kaart bij de rest van je merk past in plaats van eenmalig te ogen.',
    ...
    tableTitle: 'Graphics met Marketing AX versus de oude manier',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met Marketing AX',
    ...
    galleryTitle: 'Graphics die mensen bouwden met Marketing AX',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Nee. Marketing AX stelt graphics samen met echte opmaak en typografie — jouw kop, jouw merk, exacte afmetingen — en rendert naar HTML die je als PNG exporteert. Het is ontwerpcompositie, geen pixelgeneratie.',
      },
      {
    ...
    ctaBody:
      'Geef de repo een ster, installeer Marketing AX en verander een prompt in een on-brand graphic — in de agent die je al gebruikt.',
  },
  video: {
    title: 'Genereer motion graphics en korte video met Marketing AX + Claude Code',
    description:
    ...
    lead: 'Beschrijf het moment dat je wilt — een titelonthulling, een data-animatie, een logo-outro. Marketing AX stelt geanimeerde frames samen met jouw merksysteem en rendert ze naar video, zonder dat er een motion-graphics-suite nodig is.',
    heroImageAlt:
      'Redactionele illustratie van een script dat verandert in een reeks geanimeerde videoframes',
    tldrTitle: 'In één zin',
    tldrBody:
      'Marketing AX verandert een script in geanimeerde, on-brand frames die je agent naar korte video rendert — samengesteld uit HTML, geversioneerd in je repo, zonder tijdlijneditor om te leren.',
    stepsTitle: 'Hoe motion werkt met Marketing AX',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'Marketing AX levert framesjablonen — cinematische light leaks, glitch-titels, logo-outro’s — en past jouw kleuren en typografie toe, zodat de beweging doelbewust en on-brand oogt.',
    ...
    tableTitle: 'Motion met Marketing AX versus de oude manier',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met Marketing AX',
    ...
    galleryTitle: 'Motion die mensen bouwden met Marketing AX',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Nee. Marketing AX stelt geanimeerde frames samen in HTML en rendert ze naar video binnen je coding agent. Er is geen tijdlijneditor om te leren of te licentiëren.',
      },
      {
    ...
    ctaBody:
      'Geef de repo een ster, installeer Marketing AX en verander een script in motion — in de agent die je al gebruikt.',
  },
  designSystem: {
    title: 'Bouw en pas een designsysteem toe met Marketing AX + Claude Code',
    description:
    ...
    lead: 'Definieer je merk één keer en Marketing AX draagt het mee naar elke uitvoer — prototypes, decks, dashboards, graphics. Het systeem leeft in je repo als een DESIGN.md die de agent leest, zodat consistentie automatisch is, niet handmatig.',
    heroImageAlt:
      'Redactionele illustratie van één designsysteem dat uitstraalt naar vele on-brand artefacten',
    tldrTitle: 'In één zin',
    tldrBody:
      'Marketing AX vangt je merk als een draagbaar designsysteem dat je agent toepast op elk artefact — één keer gedefinieerd in je repo, overal afgedwongen, zonder een centrale ontwerptool die de poort bewaakt.',
    stepsTitle: 'Hoe designsystemen werken met Marketing AX',
    steps: [
      {
        title: 'Vang het systeem',
        body: 'Beschrijf je merk — kleuren, typografie, witruimte, stem — of wijs de agent naar een bestaande site om het te extraheren. Marketing AX schrijft het in een DESIGN.md die in je project leeft.',
        imageAlt: 'Illustratie van een merk dat wordt gevangen in één designsysteembestand',
      },
      {
        title: 'Begin vanuit een bewezen basis',
        body: 'Marketing AX levert 140+ referentiedesignsystemen — van Apple en Linear tot redactioneel en brutalistisch. Fork er een dicht bij je merk in plaats van te beginnen met een lege pagina.',
    ...
    tableTitle: 'Designsystemen met Marketing AX versus de oude manier',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met Marketing AX',
    ...
    galleryTitle: 'Designsystemen in Marketing AX',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Een DESIGN.md-bestand in je repo dat kleuren, typografie, witruimte, componenten en stem vangt. Elke Marketing AX-vaardigheid leest het, zodat je merk automatisch wordt toegepast op alles wat de agent produceert.',
      },
      {
        q: 'Moet ik vanaf nul beginnen?',
        a: 'Nee. Marketing AX levert 140+ referentiedesignsystemen die je kunt forken — van Apple en Linear tot redactioneel en brutalistisch — en daarna aan je merk aanpassen.',
      },
      {
    ...
    ctaBody:
      'Geef de repo een ster, installeer Marketing AX en geef je agent één merk om overal toe te passen — in de agent die je al gebruikt.',
  },
  roleSoloBuilder: {
    title: 'Marketing AX voor solobouwers & indie hackers',
    description:
      'Lever als een team van één. Marketing AX verandert je coding agent in de ontwerphelft van je startup — prototypes, landingspaginas, dashboards en merkvisuals, allemaal vanuit een prompt, allemaal op merk, allemaal in je repo.',
    ...
    tldrTitle: 'In één zin',
    tldrBody:
      'Marketing AX is de ontwerpafdeling die een solo-oprichter nooit had: van prompt naar artefact op elk oppervlak dat je product nodig heeft, op één merk, zonder overdracht en zonder extra tools.',
    stepsTitle: 'Hoe een solobouwer Marketing AX gebruikt',
    steps: [
      {
    ...
    tableTitle: 'Solo bouwen met Marketing AX vs het op de moeilijke manier doen',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met Marketing AX',
    ...
    galleryTitle: 'Solo gebouwd met Marketing AX',
    galleryLead:
    ...
    ctaBody:
      'Geef de repo een ster, installeer Marketing AX en laat één agent je ontwerpteam zijn — in de agent die je al gebruikt.',
  },
  roleDesigner: {
    title: 'Marketing AX voor ontwerpers',
    description:
      'Besteed je tijd aan smaak, niet aan sleurwerk. Marketing AX laat je agent het repetitieve productiewerk afhandelen — varianten, statussen, complete ontwerpsystemen — terwijl jij de look stuurt en het laatste woord houdt.',
    ...
    tldrTitle: 'In één zin',
    tldrBody:
      'Marketing AX is de productieassistent die nooit moe wordt: jij definieert het ontwerpsysteem en bepaalt de smaak; de agent genereert de rest, op systeem, in je repo.',
    stepsTitle: 'Hoe een ontwerper Marketing AX gebruikt',
    steps: [
      {
    ...
    tableTitle: 'Ontwerpen met Marketing AX vs de handmatige manier',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met Marketing AX',
    ...
    galleryTitle: 'Gestuurd met Marketing AX',
    galleryLead:
    ...
    ctaBody:
      'Geef de repo een ster, installeer Marketing AX en laat de agent de productie afhandelen terwijl jij de smaak bepaalt — in de agent die je al gebruikt.',
  },
  roleEngineering: {
    title: 'Marketing AX voor engineers',
    description:
      'Sla de ontwerpoverdracht over. Marketing AX verandert een DESIGN.md in echte front-end die je coding agent rechtstreeks schrijft — op-systeem UI, prototypes en dashboards, in de repo, zonder Figma-heen-en-weer.',
    ...
    tldrTitle: 'In één zin',
    tldrBody:
      'Marketing AX dicht de kloof tussen ontwerper en engineer door het ontwerpsysteem machineleesbaar te maken: dezelfde agent die je code schrijft, past het systeem toe en rendert echte UI.',
    stepsTitle: 'Hoe een engineer Marketing AX gebruikt',
    steps: [
      {
    ...
    tableTitle: 'Front-end met Marketing AX vs de overdrachtsmanier',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met Marketing AX',
    ...
    galleryTitle: 'Gebouwd door engineers met Marketing AX',
    galleryLead:
    ...
    ctaBody:
      'Geef de repo een ster, installeer Marketing AX en verander een DESIGN.md in front-end — in de agent die je al gebruikt.',
  },
  roleProductManagers: {
    title: 'Marketing AX voor productmanagers',
    description:
      'Wacht niet meer op ontwerpcapaciteit om een idee over te brengen. Marketing AX laat een PM een prompt veranderen in een klikbaar prototype of wireframe — om stakeholders op één lijn te brengen en het team te briefen, zonder ontwerpticket.',
    ...
    tldrTitle: 'In één zin',
    tldrBody:
      'Marketing AX geeft een PM een ontwerpvrije manier om ideeën tastbaar te maken: van prompt naar prototype voor afstemming en briefings, zonder het ontwerpbudget van het team uit te geven.',
    stepsTitle: 'Hoe een PM Marketing AX gebruikt',
    steps: [
      {
        title: 'Beschrijf de flow',
    ...
    tableTitle: 'PM-werk met Marketing AX vs wachten op ontwerp',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met Marketing AX',
    ...
    galleryTitle: 'Geprototypeerd door PMs met Marketing AX',
    galleryLead:
    ...
    ctaBody:
      'Geef de repo een ster, installeer Marketing AX en verander je volgende spec in iets waar mensen op kunnen klikken — in de agent die je al gebruikt.',
  },
  roleMarketing: {
    title: 'Marketing AX voor marketingteams',
    description:
      'Lever campagnes op contentsnelheid. Marketing AX laat je agent landingspaginas, socialkaarten en campagnevisuals produceren vanuit een prompt — op merk, op aanvraag, zonder ontwerp in de wachtrij te zetten.',
    ...
    tldrTitle: 'In één zin',
    tldrBody:
      'Marketing AX is de altijd-beschikbare ontwerpresource voor marketing: van prompt naar asset voor landingspaginas en social, op merk, zodat campagnes worden geleverd op de snelheid waarmee je tekst schrijft.',
    stepsTitle: 'Hoe een marketingteam Marketing AX gebruikt',
    steps: [
      {
    ...
    tableTitle: 'Marketing met Marketing AX vs de gebruikelijke ren',
    tableColCapability: 'Wat je nodig hebt',
    tableColWithOd: 'Met Marketing AX',
    tableColWithout: 'Zonder het vandaag',
    tableRows: [
    ...
    galleryTitle: 'Geleverd door marketing met Marketing AX',
    galleryLead:
    ...
    ctaBody:
      'Geef de repo een ster, installeer Marketing AX en verander briefs in assets op merk — in de agent die je al gebruikt.',
  },
};
