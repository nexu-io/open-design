...
export const FR: SolutionLocaleCopy = {
  aiWireframeGenerator: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Prototype d\'app multi-écrans en mosaïque' },
      { thumb: 'example-qiaomu-wizard', caption: 'Parcours d’onboarding RH' },
      { thumb: 'example-skill-mengto-landing', caption: 'Disposition d’atterrissage produit' },
      { thumb: 'example-style-claymorphism', caption: 'Wireframe web au style doux' },
    ],
  ...
  aiUiGenerator: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Prototype d\'app multi-écrans en mosaïque' },
      { thumb: 'example-qiaomu-wizard', caption: 'Parcours d’onboarding RH' },
      { thumb: 'example-skill-mengto-landing', caption: 'UI d’atterrissage produit' },
      { thumb: 'example-style-claymorphism', caption: 'UI web au style doux' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Parcourir les modèles',
  ...
  designToCode: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Prototype d\'app multi-écrans en mosaïque' },
      { thumb: 'example-qiaomu-wizard', caption: 'Parcours d’onboarding RH' },
      { thumb: 'example-skill-mengto-landing', caption: 'Atterrissage produit en code' },
      { thumb: 'example-style-claymorphism', caption: 'Build web au style doux' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Parcourir les modèles',
  ...
  aiLandingPageGenerator: {
    ...
    gallery: [
      { thumb: 'example-skill-mengto-landing', caption: 'Page de lancement produit' },
      { thumb: 'example-qiaomu-landing', caption: 'Page marketing SaaS' },
      { thumb: 'example-qiaomu-coming-soon', caption: 'Parcours de capture de liste d’attente' },
      { thumb: 'example-style-claymorphism', caption: 'Landing au style doux' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Parcourir les modèles',
  ...
  figmaToCode: {
    ...
    gallery: [
      ...
      { thumb: 'example-skill-mengto-landing', caption: 'Frame de landing en code' },
      { thumb: 'example-style-claymorphism', caption: 'Build web au style doux' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Parcourir les modèles',
  ...
  screenshotToCode: {
    ...
    gallery: [
      ...
      { thumb: 'example-skill-mengto-landing', caption: 'Capture de landing en code' },
      { thumb: 'example-style-claymorphism', caption: 'Build web au style doux' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Parcourir les modèles',
  ...
  aiPrototypeGenerator: {
    ...
    gallery: [
      ...
      { thumb: 'example-style-claymorphism', caption: 'Prototype web au style doux' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Parcourir les modèles',
  ...
  prototype: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Prototype d\'app multi-écrans en mosaïque' },
      { thumb: "example-qiaomu-wizard", caption: "Parcours d’onboarding RH" },
      { thumb: "example-skill-mengto-landing", caption: "Page d’atterrissage produit" },
      { thumb: "example-style-claymorphism", caption: "Prototype web au style doux" },
    ],
    exampleHref: '/plugins/templates/',
  ...
  dashboard: {
    ...
    features: [
      { title: "Analytique produit", body: "Utilisateurs actifs, entonnoirs, rétention — les indicateurs où vit une équipe produit.", thumb: "example-qiaomu-dashboard" },
      { title: "Indicateurs dépôt et dev", body: "Étoiles, PR, santé du CI — des tableaux de bord d’ingénierie à partir de vos propres données.", thumb: "example-m3-ops-dashboard" },
      { title: "Rapports financiers", body: "Revenu, burn, runway disposés en un rapport partageable.", thumb: "example-trading-analysis-dashboard-template" },
      ...
      { title: "Social et marketing", body: "Performance des canaux et suivi des campagnes en une seule vue.", thumb: "example-social-media-matrix-tracker-template" },
      { title: "Rapports métier", body: "Des rapports structurés pour tout domaine — du clinique au trading.", thumb: "example-promax-health-dashboard" },
    ],
    ...
    gallery: [
      { thumb: "example-impeccable-insight-dashboard", caption: "Rapport de données" },
      { thumb: "example-live-artifact", caption: "Tableau de bord des opérations en direct" },
  ...
  image: {
    ...
    features: [
      { title: "Cartes sociales", body: "Des cartes X / Twitter composées avec votre titre et votre marque.", thumb: "example-html-ppt-xhs-pastel-card" },
      { title: "Couvertures d’articles", body: "Des couvertures éditoriales, style magazine, pour billets et newsletters.", thumb: "example-html-ppt-zhangzara-retro-zine" },
      { title: "Cartes Xiaohongshu", body: "Des cartes style RedNote calibrées pour ce fil.", thumb: "example-html-ppt-xhs-white-editorial" },
      ...
      { title: "Carrousels", body: "Des carrousels sociaux multi-diapositives qui restent cohérents d’un cadre à l’autre.", thumb: "example-html-ppt-xhs-white-editorial" },
    ...
    gallery: [
      ...
      { thumb: "example-image-poster", caption: "Affiche style magazine" },
  ...
  video: {
    ...
    features: [
      ...
      { title: "Sets de cadres animés", body: "Des cadres animés réutilisables que vous assemblez en un clip.", thumb: "example-frame-glitch-title" },
  ...
  roleSoloBuilder: {
    ...
    features: [
      { title: 'Landing pages', body: 'Landings marketing et SaaS, cliquables et en ligne.', thumb: 'example-qiaomu-landing' },
      { title: 'Prototypes produit', body: 'Applications web multi-écrans pour valider l’idée.', thumb: 'example-web-prototype' },
      { title: 'Tableaux de bord', body: 'Vues de métriques et d’admin pour votre produit.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Graphismes de marque', body: 'Couvertures et affiches assorties à votre marque.', thumb: 'example-image-poster' },
      { title: 'Parcours mobiles', body: 'Écrans d’app quand vous allez au-delà du web.', thumb: 'example-mobile-app' },
      { title: 'Cartes sociales', body: 'Cartes de lancement et de mise à jour pour chaque canal.', thumb: 'example-html-ppt-xhs-pastel-card' },
    ],
    ...
    gallery: [
      ...
      { thumb: 'example-qiaomu-dashboard', caption: 'Tableau de bord produit' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: 'Carte sociale de lancement' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Parcourir les modèles',
  ...
  roleDesigner: {
    ...
    features: [
      { title: 'Mises en page éditoriales', body: 'Compositions dirigées artistiquement, pilotées par la grille.', thumb: 'example-skill-swiss-design' },
      { title: 'Couvertures d’articles', body: 'Couvertures et reportages façon magazine.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
      { title: 'Affiches', body: 'Affiches typographiques fortes, dans la charte.', thumb: 'example-image-poster' },
      { title: 'Sets sociaux', body: 'Carrousels multi-cadres cohérents.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: 'Écrans d’app', body: 'Écrans mobiles et web haute fidélité.', thumb: 'example-mobile-app' },
      { title: 'Tableaux de bord', body: 'UI de données qui respecte votre système.', thumb: 'example-qiaomu-dashboard' },
    ],
    ...
    gallery: [
      { thumb: 'example-skill-swiss-design', caption: 'Mise en page éditoriale' },
      { thumb: 'example-html-ppt-zhangzara-retro-zine', caption: 'Couverture de magazine' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: 'Carrousel social' },
      { thumb: 'example-image-poster', caption: 'Affiche typographique' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Parcourir les modèles',
  ...
  roleEngineering: {
    ...
    features: [
      ...
      { title: 'Tableaux de bord dev', body: 'Tableaux de bord de dépôt, CI et métriques.', thumb: 'example-m3-ops-dashboard' },
      { title: 'Rapports de données', body: 'Rapports structurés à partir de vos données.', thumb: 'example-impeccable-insight-dashboard' },
      { title: 'Tableaux de bord admin', body: 'Outils internes et vues d’admin.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Landing pages', body: 'Pages marketing sans attendre le design.', thumb: 'example-qiaomu-landing' },
    ...
    gallery: [
      ...
      { thumb: 'example-m3-ops-dashboard', caption: 'Tableau de bord dev' },
      { thumb: 'example-impeccable-insight-dashboard', caption: 'Rapport de données' },
  ...
  roleProductManagers: {
    ...
    features: [
      ...
      { title: 'Parcours d’onboarding', body: 'Bienvenue → configuration → premier lancement.', thumb: 'example-qiaomu-wizard' },
      { title: 'Tableaux & workflows', body: 'UI Kanban et de processus pour les specs.', thumb: 'example-kanban-board' },
      { title: 'Tableaux de bord', body: 'Vues de métriques pour cadrer le problème.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Prototypes web', body: 'Parcours web multi-écrans à relire.', thumb: 'example-web-prototype' },
      { title: 'Vues de tendances', body: 'Instantanés sur 30 jours et de tendance pour le contexte.', thumb: 'example-trading-analysis-dashboard-template' },
    ],
    ...
    gallery: [
      ...
      { thumb: 'example-qiaomu-wizard', caption: 'Parcours d’onboarding' },
  ...
  roleMarketing: {
    ...
    features: [
      { title: 'Landing pages', body: 'Landings de campagne et de produit, déployables.', thumb: 'example-qiaomu-landing' },
      { title: 'Cartes sociales', body: 'Cartes X / Twitter dans la charte.', thumb: 'example-html-ppt-xhs-pastel-card' },
      { title: 'Carrousels', body: 'Jeux sociaux multi-diapos, cohérents.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: 'Affiches', body: 'Affiches d’annonce et d’événement.', thumb: 'example-image-poster' },
      { title: 'Couvertures d’articles', body: 'Couvertures de blog et de newsletter.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
    ...
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: 'Landing page de campagne' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: 'Carte sociale' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: 'Carrousel social' },
      { thumb: 'example-image-poster', caption: 'Affiche d’annonce' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Parcourir les modèles',
