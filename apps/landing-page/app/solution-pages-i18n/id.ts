...
export const ID: SolutionLocaleCopy = {
  prototype: {
    title: 'Bangun prototipe interaktif dengan OpenDesign + Claude Code',
    description:
      'Ubah sebuah prompt menjadi prototipe multi-layar yang bisa diklik tanpa keluar dari terminal Anda. OpenDesign memberi coding agent Anda keterampilan desain, templat, dan sistem desain untuk menghasilkan prototipe nyata yang bisa Anda buka di browser.',
    ...
    tldrBody:
      'OpenDesign adalah lapisan desain untuk coding agent yang sudah Anda pakai. Untuk pembuatan prototipe, itu berarti beranjak dari ide satu paragraf menjadi prototipe bergaya yang bisa dinavigasi dalam satu sesi — tanpa alat desain, tanpa langkah ekspor, tanpa celah serah terima.',
    stepsTitle: 'Cara kerja pembuatan prototipe dengan OpenDesign',
    steps: [
      {
        title: 'Jelaskan alurnya',
        body: 'Beri tahu agent apa yang Anda bangun dengan bahasa biasa — “alur onboarding dengan layar sambutan, pemilih paket, dan konfirmasi”. OpenDesign memuat keterampilan prototipe sehingga agent tahu harus menghasilkan layar, bukan satu halaman.',
        imageAlt:
      ...
      },
      {
        ...
        body: 'Agent menerapkan sistem desain dan templat prototipe dari OpenDesign, sehingga setiap layar berbagi tipografi, jarak, dan komponen alih-alih terlihat seperti draf kasar. Anda mendapatkan satu set layar yang koheren, bukan mockup yang terpisah-pisah.',
        imageAlt:
    ...
    tableTitle: 'Pembuatan prototipe dengan OpenDesign vs. cara lama',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan OpenDesign',
    ...
    galleryTitle: 'Prototipe yang dibangun orang dengan OpenDesign',
    galleryLead:
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Prototipe aplikasi multi-layar bergaya ubin' },
      { thumb: "example-qiaomu-wizard", caption: "Alur onboarding HR" },
      { thumb: "example-skill-mengto-landing", caption: "Halaman arahan produk" },
      { thumb: "example-style-claymorphism", caption: "Prototipe web bergaya lembut" },
    ],
    ...
    faq: [
      {
        q: 'Apakah saya butuh alat desain seperti Figma untuk membuat prototipe dengan OpenDesign?',
        a: 'Tidak. OpenDesign berjalan di dalam coding agent Anda dan merender prototipe ke HTML. Anda menjelaskan alur dengan bahasa; agent menghasilkan layar. Tidak ada alat kanvas terpisah untuk dipelajari atau dibayar.',
      },
      {
      ...
      },
      {
        ...
        a: 'OpenDesign bekerja dengan Claude Code, Codex, Cursor Agent, Gemini CLI, dan belasan adapter resmi lainnya. Anda membawa kunci penyedia Anda sendiri; tidak ada yang dihosting untuk Anda.',
      },
      {
    ...
    ctaBody:
      'Beri bintang pada repo, pasang OpenDesign, dan ubah “bagaimana jika” Anda berikutnya menjadi sesuatu yang bisa Anda klik — di agent yang sudah Anda pakai.',
  },
  dashboard: {
    title: 'Hasilkan dashboard data dengan OpenDesign + Claude Code',
    description:
    ...
    lead: 'Beri tahu agent apa yang harus ditampilkan dan bagaimana seharusnya terasa. OpenDesign menyediakan pola grafik, sistem tata letak, dan bahasa visual sehingga Anda mendapatkan dashboard yang koheren dan layak presentasi — bukan tembok widget bergaya bawaan.',
    heroImageAlt:
    ...
    tldrTitle: 'Dalam satu kalimat',
    tldrBody:
      'OpenDesign mengubah spesifikasi metrik Anda dalam bahasa biasa menjadi dashboard bergaya yang dirender agent ke HTML — diversikan di repo Anda, bisa dihosting di mana saja, tanpa langganan BI per kursi.',
    stepsTitle: 'Cara kerja dashboard dengan OpenDesign',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'OpenDesign menyertakan templat grafik dan tata letak, sehingga tren menjadi grafik garis, rincian menjadi batang, dan rasio menjadi visual yang tepat — tipografi dan jarak yang konsisten di seluruh bagian alih-alih bawaan yang tak serasi.',
    ...
    tableTitle: 'Dashboard dengan OpenDesign vs. cara lama',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan OpenDesign',
    ...
    features: [
      { title: "Analitik produk", body: "Pengguna aktif, funnel, retensi — metrik yang menjadi keseharian tim produk.", thumb: "example-qiaomu-dashboard" },
      { title: "Metrik repo dan dev", body: "Bintang, PR, kesehatan CI — dashboard rekayasa dari data Anda sendiri.", thumb: "example-m3-ops-dashboard" },
      { title: "Laporan keuangan", body: "Pendapatan, burn, runway ditata sebagai laporan yang bisa dibagikan.", thumb: "example-trading-analysis-dashboard-template" },
      { title: "Operasi langsung", body: "Metrik real-time yang menyegar saat data dasarnya bergerak.", thumb: "example-live-dashboard" },
      { title: "Sosial dan pemasaran", body: "Kinerja kanal dan pelacakan kampanye dalam satu tampilan.", thumb: "example-social-media-matrix-tracker-template" },
      { title: "Laporan bidang", body: "Laporan terstruktur untuk bidang apa pun — dari klinis hingga trading.", thumb: "example-promax-health-dashboard" },
    ],
    galleryTitle: 'Dashboard yang dibangun orang dengan OpenDesign',
    galleryLead:
    ...
    gallery: [
      { thumb: "example-impeccable-insight-dashboard", caption: "Laporan data" },
      { thumb: "example-live-artifact", caption: "Dashboard operasi langsung" },
    ...
    faq: [
      {
        ...
        a: 'Tidak. OpenDesign merender dashboard ke HTML di dalam coding agent Anda. Anda menjelaskan metrik dan mengarahkannya ke data Anda; tidak ada platform BI terpisah untuk dilisensikan atau dipelajari.',
      },
      {
    ...
    ctaBody:
      'Beri bintang pada repo, pasang OpenDesign, dan ubah metrik Anda menjadi dashboard yang bisa Anda hosting di mana saja — di agent yang sudah Anda pakai.',
  },
  slides: {
    title: 'Hasilkan dek presentasi dengan OpenDesign + Claude Code',
    description:
      'Ubah sebuah kerangka menjadi dek slide yang dirancang dan sesuai merek tanpa membuka aplikasi presentasi. OpenDesign memberi coding agent Anda templat dek dan sistem visual, merender slide ke HTML yang bisa Anda presentasikan, ekspor, atau bagikan.',
    breadcrumb: 'Slide',
    label: 'Kasus penggunaan · Slide',
    heading: 'Dek yang terlihat dirancang, ditulis oleh sebuah prompt',
    lead: 'Serahkan kerangka dan nada kepada agent Anda. OpenDesign menerapkan templat dek dan sistem visual sehingga setiap slide tertata, terketik, dan sesuai merek — bukan daftar poin pada latar kosong.',
    heroImageAlt:
    ...
    tldrTitle: 'Dalam satu kalimat',
    tldrBody:
      'OpenDesign mengubah kerangka menjadi dek HTML yang dirancang dan dirender agent dalam satu sesi — presentasikan di browser, ekspor ke PDF atau PPTX, dan simpan sumbernya di repo Anda.',
    stepsTitle: 'Cara kerja dek dengan OpenDesign',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'OpenDesign menyertakan templat dek — editorial, Swiss-internasional, teknis gelap, dan lainnya. Agent menerapkan salah satunya sehingga tipografi, kisi, dan aksen tetap konsisten di setiap slide.',
    ...
    tableTitle: 'Dek dengan OpenDesign vs. cara lama',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan OpenDesign',
    ...
    galleryTitle: 'Dek yang dibangun orang dengan OpenDesign',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Tidak. OpenDesign merender dek ke HTML di dalam coding agent Anda dan bisa mengekspor ke PDF atau PPTX. Anda presentasikan dari browser atau serahkan sebuah berkas — tanpa aplikasi presentasi untuk membangunnya.',
      },
      {
    ...
    ctaBody:
      'Beri bintang pada repo, pasang OpenDesign, dan ubah kerangka Anda menjadi dek yang dirancang — di agent yang sudah Anda pakai.',
  },
  image: {
    title: 'Hasilkan grafik sesuai merek dengan OpenDesign + Claude Code',
    description:
    ...
    lead: 'Jelaskan kartu atau sampul yang Anda perlukan. OpenDesign menyusunnya dengan tipe, kisi, dan warna merek Anda yang nyata — lalu merender ke HTML yang bisa Anda ekspor sebagai gambar, alih-alih bergumul dengan aplikasi desain atau templat generik.',
    heroImageAlt:
    ...
    tldrTitle: 'Dalam satu kalimat',
    tldrBody:
      'OpenDesign mengubah sebuah prompt menjadi grafik yang terketik dan sesuai merek yang dirender agent ke HTML dan diekspor ke PNG — bisa diulang, diversikan, dan bebas dari alat desain per kursi.',
    stepsTitle: 'Cara kerja grafik dengan OpenDesign',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'OpenDesign menarik warna, tipe, dan jarak Anda dari sistem desain yang dapat dipakai ulang, sehingga setiap kartu cocok dengan sisa merek Anda alih-alih terlihat seperti sekali pakai.',
    ...
    tableTitle: 'Grafik dengan OpenDesign vs. cara lama',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan OpenDesign',
    ...
    features: [
      { title: "Kartu sosial", body: "Kartu X / Twitter disusun dengan judul dan merek Anda.", thumb: "example-html-ppt-xhs-pastel-card" },
      { title: "Sampul artikel", body: "Sampul editorial bergaya majalah untuk posting dan newsletter.", thumb: "example-html-ppt-zhangzara-retro-zine" },
      { title: "Kartu Xiaohongshu", body: "Kartu bergaya RedNote yang disetel untuk feed tersebut.", thumb: "example-html-ppt-xhs-white-editorial" },
      { title: "Grafik hero", body: "Visual hero cair bergradien untuk situs dan peluncuran.", thumb: "example-frame-liquid-bg-hero" },
      { title: "Korsel", body: "Korsel sosial multi-slide yang tetap konsisten antar bingkai.", thumb: "example-html-ppt-xhs-white-editorial" },
    ...
    galleryTitle: 'Grafik yang dibangun orang dengan OpenDesign',
    galleryLead:
    ...
    gallery: [
      ...
      { thumb: "example-image-poster", caption: "Poster bergaya majalah" },
    ...
    faq: [
      {
        ...
        a: 'Tidak. OpenDesign menyusun grafik dengan tata letak dan tipografi nyata — judul Anda, merek Anda, dimensi persis — dan merender ke HTML yang Anda ekspor sebagai PNG. Ini komposisi desain, bukan pembuatan piksel.',
      },
      {
    ...
    ctaBody:
      'Beri bintang pada repo, pasang OpenDesign, dan ubah sebuah prompt menjadi grafik sesuai merek — di agent yang sudah Anda pakai.',
  },
  video: {
    title: 'Hasilkan grafik gerak dan video pendek dengan OpenDesign + Claude Code',
    description:
    ...
    lead: 'Jelaskan momen yang Anda inginkan — sebuah penyingkapan judul, animasi data, outro logo. OpenDesign menyusun bingkai beranimasi dengan sistem merek Anda dan merendernya ke video, tanpa perlu suite grafik gerak.',
    heroImageAlt:
      'Ilustrasi bergaya editorial tentang sebuah naskah yang berubah menjadi rangkaian bingkai video beranimasi',
    tldrTitle: 'Dalam satu kalimat',
    tldrBody:
      'OpenDesign mengubah sebuah naskah menjadi bingkai beranimasi yang sesuai merek yang dirender agent ke video format pendek — disusun dari HTML, diversikan di repo Anda, tanpa editor linimasa untuk dipelajari.',
    stepsTitle: 'Cara kerja gerak dengan OpenDesign',
    steps: [
      {
      ...
      },
      {
        ...
        body: 'OpenDesign menyediakan templat bingkai — light leak sinematik, judul glitch, outro logo — dan menerapkan warna serta tipe Anda, sehingga geraknya terlihat disengaja dan sesuai merek.',
    ...
    tableTitle: 'Gerak dengan OpenDesign vs. cara lama',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan OpenDesign',
    ...
    features: [
      ...
      { title: "Set bingkai gerak", body: "Bingkai beranimasi yang dapat dipakai ulang yang Anda susun menjadi klip.", thumb: "example-frame-glitch-title" },
    ...
    galleryTitle: 'Gerak yang dibangun orang dengan OpenDesign',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Tidak. OpenDesign menyusun bingkai beranimasi dalam HTML dan merendernya ke video di dalam coding agent Anda. Tidak ada editor linimasa untuk dipelajari atau dilisensikan.',
      },
      {
    ...
    ctaBody:
      'Beri bintang pada repo, pasang OpenDesign, dan ubah sebuah naskah menjadi gerak — di agent yang sudah Anda pakai.',
  },
  designSystem: {
    title: 'Bangun dan terapkan sistem desain dengan OpenDesign + Claude Code',
    description:
    ...
    lead: 'Definisikan merek Anda sekali dan OpenDesign membawanya ke setiap keluaran — prototipe, dek, dashboard, grafik. Sistem hidup di repo Anda sebagai DESIGN.md yang dibaca agent, sehingga konsistensi bersifat otomatis, bukan manual.',
    heroImageAlt:
      'Ilustrasi bergaya editorial tentang sebuah sistem desain tunggal yang memancar menjadi banyak artefak sesuai merek',
    tldrTitle: 'Dalam satu kalimat',
    tldrBody:
      'OpenDesign menangkap merek Anda sebagai sistem desain portabel yang diterapkan agent ke setiap artefak — didefinisikan sekali di repo Anda, ditegakkan di mana-mana, tanpa alat desain pusat yang menjaganya.',
    stepsTitle: 'Cara kerja sistem desain dengan OpenDesign',
    steps: [
      {
        title: 'Tangkap sistemnya',
        body: 'Jelaskan merek Anda — warna, tipe, jarak, suara — atau arahkan agent ke situs yang ada untuk mengekstraknya. OpenDesign menuliskannya ke dalam DESIGN.md yang hidup di proyek Anda.',
        imageAlt: 'Ilustrasi sebuah merek yang ditangkap ke dalam satu berkas sistem desain',
      },
      {
        title: 'Mulai dari basis yang terbukti',
        body: 'OpenDesign menyertakan 140+ sistem desain referensi — dari Apple dan Linear hingga editorial dan brutalis. Fork salah satu yang dekat dengan merek Anda alih-alih mulai dari halaman kosong.',
    ...
    tableTitle: 'Sistem desain dengan OpenDesign vs. cara lama',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan OpenDesign',
    ...
    galleryTitle: 'Sistem desain di OpenDesign',
    galleryLead:
    ...
    faq: [
      {
        ...
        a: 'Sebuah berkas DESIGN.md di repo Anda yang menangkap warna, tipe, jarak, komponen, dan suara. Setiap keterampilan OpenDesign membacanya, sehingga merek Anda diterapkan otomatis ke apa pun yang dihasilkan agent.',
      },
      {
        q: 'Apakah saya harus mulai dari nol?',
        a: 'Tidak. OpenDesign menyertakan 140+ sistem desain referensi yang bisa Anda fork — dari Apple dan Linear hingga editorial dan brutalis — lalu sesuaikan dengan merek Anda.',
      },
      {
    ...
    ctaBody:
      'Beri bintang pada repo, pasang OpenDesign, dan beri agent Anda satu merek untuk diterapkan di mana-mana — di agent yang sudah Anda pakai.',
  },
  roleSoloBuilder: {
    title: 'OpenDesign untuk solo builder & indie hacker',
    description:
      'Rilis layaknya satu tim, padahal seorang diri. OpenDesign mengubah coding agent Anda menjadi separuh sisi desain dari startup Anda — prototipe, halaman arahan, dasbor, dan visual merek, semuanya dari satu prompt, semuanya sesuai merek, semuanya di dalam repo Anda.',
    ...
    tldrTitle: 'Dalam satu kalimat',
    tldrBody:
      'OpenDesign adalah departemen desain yang tidak pernah dimiliki seorang founder tunggal: dari prompt menjadi artefak di setiap permukaan yang dibutuhkan produk Anda, dalam satu merek, tanpa serah terima dan tanpa alat tambahan.',
    stepsTitle: 'Cara solo builder memakai OpenDesign',
    steps: [
      {
    ...
    tableTitle: 'Membangun seorang diri dengan OpenDesign vs cara yang berat',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan OpenDesign',
    ...
    features: [
      { title: 'Halaman arahan', body: 'Halaman arahan pemasaran dan SaaS, dapat diklik dan tayang.', thumb: 'example-qiaomu-landing' },
      { title: 'Prototipe produk', body: 'Aplikasi web multilayar untuk memvalidasi ide.', thumb: 'example-web-prototype' },
      { title: 'Dasbor', body: 'Tampilan metrik dan admin untuk produk Anda.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Grafis merek', body: 'Sampul dan poster yang selaras dengan merek Anda.', thumb: 'example-image-poster' },
      { title: 'Alur seluler', body: 'Layar aplikasi saat Anda melangkah di luar web.', thumb: 'example-mobile-app' },
      { title: 'Kartu sosial', body: 'Kartu peluncuran dan pembaruan untuk setiap kanal.', thumb: 'example-html-ppt-xhs-pastel-card' },
    ],
    galleryTitle: 'Dibangun seorang diri dengan OpenDesign',
    galleryLead:
    ...
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: 'Halaman arahan SaaS' },
      { thumb: 'example-web-prototype', caption: 'Prototipe produk' },
      { thumb: 'example-qiaomu-dashboard', caption: 'Dasbor produk' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: 'Kartu sosial peluncuran' },
    ],
    exampleHref: '/plugins/templates/',
    ...
    ctaBody:
      'Beri bintang pada repo, pasang OpenDesign, dan biarkan satu agent menjadi tim desain Anda — di dalam agent yang sudah Anda pakai.',
  },
  roleDesigner: {
    title: 'OpenDesign untuk desainer',
    description:
      'Habiskan waktu Anda untuk selera, bukan kerja melelahkan. OpenDesign membiarkan agent Anda menangani pekerjaan produksi berulang — varian, status, sistem desain lengkap — sementara Anda mengarahkan tampilan dan memegang keputusan akhir.',
    breadcrumb: 'Desainer',
    ...
    tldrTitle: 'Dalam satu kalimat',
    tldrBody:
      'OpenDesign adalah asisten produksi yang tak pernah lelah: Anda mendefinisikan sistem desain dan menentukan seleranya; agent menghasilkan sisanya, sesuai sistem, di dalam repo Anda.',
    stepsTitle: 'Cara desainer memakai OpenDesign',
    steps: [
      {
    ...
    tableTitle: 'Mendesain dengan OpenDesign vs cara manual',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan OpenDesign',
    ...
    features: [
      { title: 'Tata letak editorial', body: 'Komposisi berbasis grid dengan arahan seni.', thumb: 'example-skill-swiss-design' },
      { title: 'Sampul artikel', body: 'Sampul dan fitur bergaya majalah.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
      { title: 'Poster', body: 'Poster tipografi berani yang sesuai merek.', thumb: 'example-image-poster' },
      { title: 'Set sosial', body: 'Korsel multibingkai yang konsisten.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: 'Layar aplikasi', body: 'Layar seluler dan web berfidelitas tinggi.', thumb: 'example-mobile-app' },
      { title: 'Dasbor', body: 'Antarmuka data yang menghormati sistem Anda.', thumb: 'example-qiaomu-dashboard' },
    ],
    galleryTitle: 'Diarahkan dengan OpenDesign',
    galleryLead:
    ...
    gallery: [
      { thumb: 'example-skill-swiss-design', caption: 'Tata letak editorial' },
      { thumb: 'example-html-ppt-zhangzara-retro-zine', caption: 'Sampul majalah' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: 'Korsel sosial' },
      { thumb: 'example-image-poster', caption: 'Poster tipografi' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Jelajahi templat',
    ...
    ctaBody:
      'Beri bintang pada repo, pasang OpenDesign, dan biarkan agent menangani produksi sementara Anda menentukan seleranya — di dalam agent yang sudah Anda pakai.',
  },
  roleEngineering: {
    title: 'OpenDesign untuk engineer',
    description:
      'Lewati serah terima desain. OpenDesign mengubah sebuah DESIGN.md menjadi front-end nyata yang ditulis langsung oleh coding agent Anda — UI sesuai sistem, prototipe, dan dasbor, di dalam repo, tanpa bolak-balik ke Figma.',
    breadcrumb: 'Teknik',
    label: 'Untuk · Teknik',
    ...
    tldrTitle: 'Dalam satu kalimat',
    tldrBody:
      'OpenDesign menutup jurang dari desainer ke engineer dengan membuat sistem desain dapat dibaca mesin: agent yang sama yang menulis kode Anda menerapkan sistem dan merender UI nyata.',
    stepsTitle: 'Cara engineer memakai OpenDesign',
    steps: [
      {
    ...
    tableTitle: 'Front-end dengan OpenDesign vs cara serah terima',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan OpenDesign',
    ...
    features: [
      ...
      { title: 'Dasbor dev', body: 'Dasbor repo, CI, dan metrik.', thumb: 'example-m3-ops-dashboard' },
      { title: 'Laporan data', body: 'Laporan terstruktur dari data Anda.', thumb: 'example-impeccable-insight-dashboard' },
      { title: 'Dasbor admin', body: 'Alat internal dan tampilan admin.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Halaman arahan', body: 'Halaman pemasaran tanpa menunggu desain.', thumb: 'example-qiaomu-landing' },
      { title: 'Kanban / papan', body: 'Antarmuka alur kerja internal.', thumb: 'example-kanban-board' },
    ],
    galleryTitle: 'Dibangun oleh engineer dengan OpenDesign',
    galleryLead:
    ...
    gallery: [
      ...
      { thumb: 'example-m3-ops-dashboard', caption: 'Dasbor dev' },
      { thumb: 'example-impeccable-insight-dashboard', caption: 'Laporan data' },
    ...
    ctaBody:
      'Beri bintang pada repo, pasang OpenDesign, dan ubah sebuah DESIGN.md menjadi front-end — di dalam agent yang sudah Anda pakai.',
  },
  roleProductManagers: {
    title: 'OpenDesign untuk product manager',
    description:
      'Berhenti menunggu kapasitas desain untuk mengomunikasikan sebuah ide. OpenDesign memungkinkan seorang PM mengubah sebuah prompt menjadi prototipe yang dapat diklik atau wireframe — untuk menyelaraskan pemangku kepentingan dan memberi brief ke tim, tanpa tiket desain.',
    ...
    tldrTitle: 'Dalam satu kalimat',
    tldrBody:
      'OpenDesign memberi PM cara tanpa desain untuk membuat ide menjadi nyata: dari prompt ke prototipe untuk penyelarasan dan brief, tanpa menghabiskan anggaran desain tim.',
    stepsTitle: 'Cara seorang PM memakai OpenDesign',
    steps: [
      {
        title: 'Jelaskan alurnya',
    ...
    tableTitle: 'Kerja PM dengan OpenDesign vs menunggu desain',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan OpenDesign',
    ...
    features: [
      ...
      { title: 'Alur onboarding', body: 'Sambutan → penyiapan → jalan pertama.', thumb: 'example-qiaomu-wizard' },
      { title: 'Papan & alur kerja', body: 'Antarmuka Kanban dan proses untuk spesifikasi.', thumb: 'example-kanban-board' },
      { title: 'Dasbor', body: 'Tampilan metrik untuk membingkai masalah.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Prototipe web', body: 'Alur web multilayar untuk ditinjau.', thumb: 'example-web-prototype' },
      { title: 'Tampilan tren', body: 'Cuplikan 30 hari dan tren untuk konteks.', thumb: 'example-trading-analysis-dashboard-template' },
    ],
    galleryTitle: 'Diprototipekan oleh PM dengan OpenDesign',
    galleryLead:
    ...
    gallery: [
      ...
      { thumb: 'example-qiaomu-wizard', caption: 'Alur onboarding' },
    ...
    ctaBody:
      'Beri bintang pada repo, pasang OpenDesign, dan ubah spesifikasi Anda berikutnya menjadi sesuatu yang bisa diklik orang — di dalam agent yang sudah Anda pakai.',
  },
  roleMarketing: {
    title: 'OpenDesign untuk tim pemasaran',
    description:
      'Rilis kampanye secepat konten. OpenDesign memungkinkan agent Anda menghasilkan halaman arahan, kartu sosial, dan visual kampanye dari sebuah prompt — sesuai merek, sesuai permintaan, tanpa mengantre desain.',
    ...
    tldrTitle: 'Dalam satu kalimat',
    tldrBody:
      'OpenDesign adalah sumber daya desain yang selalu siap untuk pemasaran: dari prompt ke aset untuk halaman arahan dan media sosial, sesuai merek, sehingga kampanye dirilis secepat Anda menulis naskah.',
    stepsTitle: 'Cara tim pemasaran memakai OpenDesign',
    steps: [
      {
    ...
    tableTitle: 'Pemasaran dengan OpenDesign vs kalang kabut seperti biasa',
    tableColCapability: 'Yang Anda butuhkan',
    tableColWithOd: 'Dengan OpenDesign',
    tableColWithout: 'Tanpa itu saat ini',
    tableRows: [
    ...
    features: [
      { title: 'Halaman arahan', body: 'Halaman arahan kampanye dan produk, dapat dideploy.', thumb: 'example-qiaomu-landing' },
      { title: 'Kartu sosial', body: 'Kartu X / Twitter sesuai merek.', thumb: 'example-html-ppt-xhs-pastel-card' },
      { title: 'Korsel', body: 'Set sosial multislide, konsisten.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: 'Poster', body: 'Poster pengumuman dan acara.', thumb: 'example-image-poster' },
      { title: 'Sampul artikel', body: 'Sampul blog dan buletin.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
      { title: 'Halaman web', body: 'Microsite dan halaman kampanye.', thumb: 'example-web-prototype' },
    ],
    galleryTitle: 'Dirilis oleh pemasaran dengan OpenDesign',
    galleryLead:
    ...
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: 'Halaman arahan kampanye' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: 'Kartu sosial' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: 'Korsel sosial' },
      { thumb: 'example-image-poster', caption: 'Poster pengumuman' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Jelajahi templat',
    ...
    ctaBody:
      'Beri bintang pada repo, pasang OpenDesign, dan ubah brief menjadi aset yang sesuai merek — di dalam agent yang sudah Anda pakai.',
  },
};
