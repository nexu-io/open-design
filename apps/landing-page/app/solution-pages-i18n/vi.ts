...
export const VI: SolutionLocaleCopy = {
  prototype: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Bản mẫu ứng dụng đa màn hình dạng ô xếp' },
      { thumb: "example-qiaomu-wizard", caption: "Luồng onboarding nhân sự" },
      { thumb: "example-skill-mengto-landing", caption: "Trang đích sản phẩm" },
      { thumb: "example-style-claymorphism", caption: "Nguyên mẫu web phong cách mềm mại" },
    ],
  ...
  dashboard: {
    ...
    features: [
      { title: "Phân tích sản phẩm", body: "Người dùng hoạt động, phễu, giữ chân — các chỉ số mà một đội sản phẩm sống cùng.", thumb: "example-qiaomu-dashboard" },
      { title: "Chỉ số repo và dev", body: "Sao, PR, sức khỏe CI — dashboard kỹ thuật từ dữ liệu của riêng bạn.", thumb: "example-m3-ops-dashboard" },
      { title: "Báo cáo tài chính", body: "Doanh thu, mức đốt vốn, đường băng được bố trí thành một báo cáo chia sẻ được.", thumb: "example-trading-analysis-dashboard-template" },
      { title: "Vận hành trực tiếp", body: "Chỉ số thời gian thực làm mới khi dữ liệu nền thay đổi.", thumb: "example-live-dashboard" },
      { title: "Mạng xã hội và tiếp thị", body: "Hiệu suất kênh và theo dõi chiến dịch trong một khung nhìn.", thumb: "example-social-media-matrix-tracker-template" },
      { title: "Báo cáo theo lĩnh vực", body: "Báo cáo có cấu trúc cho bất kỳ ngành nào — từ lâm sàng đến giao dịch.", thumb: "example-promax-health-dashboard" },
    ],
    ...
    gallery: [
      { thumb: "example-impeccable-insight-dashboard", caption: "Báo cáo dữ liệu" },
      { thumb: "example-live-artifact", caption: "Dashboard vận hành trực tiếp" },
  ...
  image: {
    ...
    features: [
      { title: "Thẻ mạng xã hội", body: "Thẻ X / Twitter được dựng với tiêu đề và thương hiệu của bạn.", thumb: "example-html-ppt-xhs-pastel-card" },
      { title: "Ảnh bìa bài viết", body: "Ảnh bìa kiểu biên tập, kiểu tạp chí cho bài đăng và bản tin.", thumb: "example-html-ppt-zhangzara-retro-zine" },
      { title: "Thẻ Xiaohongshu", body: "Thẻ kiểu RedNote được tinh chỉnh cho feed đó.", thumb: "example-html-ppt-xhs-white-editorial" },
      { title: "Đồ họa hero", body: "Hình hero kiểu lỏng, gradient cho website và buổi ra mắt.", thumb: "example-frame-liquid-bg-hero" },
      { title: "Carousel", body: "Carousel mạng xã hội nhiều slide giữ nhất quán qua các khung.", thumb: "example-html-ppt-xhs-white-editorial" },
    ...
    gallery: [
      ...
      { thumb: "example-image-poster", caption: "Poster kiểu tạp chí" },
  ...
  video: {
    ...
    features: [
      ...
      { title: "Bộ khung hình chuyển động", body: "Các khung hình động tái sử dụng được mà bạn dựng thành một đoạn clip.", thumb: "example-frame-glitch-title" },
  ...
  roleSoloBuilder: {
    ...
    features: [
      { title: 'Trang đích', body: 'Trang đích tiếp thị và SaaS, có thể nhấp qua lại và chạy thật.', thumb: 'example-qiaomu-landing' },
      { title: 'Prototype sản phẩm', body: 'Ứng dụng web nhiều màn hình để kiểm chứng ý tưởng.', thumb: 'example-web-prototype' },
      { title: 'Dashboard', body: 'Các góc nhìn chỉ số và quản trị cho sản phẩm của bạn.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Đồ họa thương hiệu', body: 'Ảnh bìa và poster khớp với thương hiệu của bạn.', thumb: 'example-image-poster' },
      { title: 'Luồng di động', body: 'Các màn hình ứng dụng khi bạn vượt ra ngoài web.', thumb: 'example-mobile-app' },
      { title: 'Thẻ mạng xã hội', body: 'Thẻ ra mắt và cập nhật cho mọi kênh.', thumb: 'example-html-ppt-xhs-pastel-card' },
    ],
    ...
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: 'Trang đích SaaS' },
      { thumb: 'example-web-prototype', caption: 'Prototype sản phẩm' },
      { thumb: 'example-qiaomu-dashboard', caption: 'Dashboard sản phẩm' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: 'Thẻ mạng xã hội ra mắt' },
    ],
    exampleHref: '/plugins/templates/',
  ...
  roleDesigner: {
    ...
    features: [
      { title: 'Bố cục biên tập', body: 'Bố cục được chỉ đạo nghệ thuật, dựa trên lưới.', thumb: 'example-skill-swiss-design' },
      { title: 'Bìa bài viết', body: 'Bìa và bài đặc sắc theo phong cách tạp chí.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
      { title: 'Poster', body: 'Poster kiểu chữ táo bạo, đúng thương hiệu.', thumb: 'example-image-poster' },
      { title: 'Bộ mạng xã hội', body: 'Carousel nhiều khung nhất quán.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: 'Màn hình ứng dụng', body: 'Màn hình di động và web độ trung thực cao.', thumb: 'example-mobile-app' },
      { title: 'Dashboard', body: 'Giao diện dữ liệu tôn trọng hệ thống của bạn.', thumb: 'example-qiaomu-dashboard' },
    ],
    ...
    gallery: [
      { thumb: 'example-skill-swiss-design', caption: 'Bố cục biên tập' },
      { thumb: 'example-html-ppt-zhangzara-retro-zine', caption: 'Bìa tạp chí' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: 'Carousel mạng xã hội' },
      { thumb: 'example-image-poster', caption: 'Poster kiểu chữ' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Duyệt mẫu',
  ...
  roleEngineering: {
    ...
    features: [
      ...
      { title: 'Dashboard cho lập trình viên', body: 'Dashboard repo, CI và chỉ số.', thumb: 'example-m3-ops-dashboard' },
      { title: 'Báo cáo dữ liệu', body: 'Báo cáo có cấu trúc từ dữ liệu của bạn.', thumb: 'example-impeccable-insight-dashboard' },
      { title: 'Dashboard quản trị', body: 'Công cụ nội bộ và góc nhìn quản trị.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Trang đích', body: 'Trang tiếp thị mà không cần chờ thiết kế.', thumb: 'example-qiaomu-landing' },
    ...
    gallery: [
      ...
      { thumb: 'example-m3-ops-dashboard', caption: 'Dashboard cho lập trình viên' },
      { thumb: 'example-impeccable-insight-dashboard', caption: 'Báo cáo dữ liệu' },
  ...
  roleProductManagers: {
    ...
    features: [
      ...
      { title: 'Luồng onboarding', body: 'Chào mừng → thiết lập → lần chạy đầu tiên.', thumb: 'example-qiaomu-wizard' },
      { title: 'Bảng & quy trình', body: 'Giao diện Kanban và quy trình cho các đặc tả.', thumb: 'example-kanban-board' },
      { title: 'Dashboard', body: 'Góc nhìn chỉ số để định khung vấn đề.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Prototype web', body: 'Luồng web nhiều màn hình để review.', thumb: 'example-web-prototype' },
      { title: 'Góc nhìn xu hướng', body: 'Ảnh chụp 30 ngày và xu hướng để có bối cảnh.', thumb: 'example-trading-analysis-dashboard-template' },
    ],
    ...
    gallery: [
      ...
      { thumb: 'example-qiaomu-wizard', caption: 'Luồng onboarding' },
  ...
  roleMarketing: {
    ...
    features: [
      { title: 'Trang đích', body: 'Trang đích chiến dịch và sản phẩm, có thể triển khai.', thumb: 'example-qiaomu-landing' },
      { title: 'Thẻ mạng xã hội', body: 'Thẻ X / Twitter đúng thương hiệu.', thumb: 'example-html-ppt-xhs-pastel-card' },
      { title: 'Carousel', body: 'Bộ mạng xã hội nhiều slide, nhất quán.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: 'Poster', body: 'Poster thông báo và sự kiện.', thumb: 'example-image-poster' },
      { title: 'Bìa bài viết', body: 'Bìa blog và bản tin.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
    ...
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: 'Trang đích chiến dịch' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: 'Thẻ mạng xã hội' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: 'Carousel mạng xã hội' },
      { thumb: 'example-image-poster', caption: 'Poster thông báo' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Duyệt mẫu',
