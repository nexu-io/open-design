...
export const ZH: SolutionLocaleCopy = {
  aiWireframeGenerator: {
    ...
    features: [
      ...
      { title: 'SaaS 落地页', body: '营销与 SaaS 落地布局，可线框、可上样式、可上线。', thumb: 'example-qiaomu-landing' },
      { title: '引导与表单', body: '多步引导、注册、表单流程，层级清晰。', thumb: 'example-qiaomu-wizard' },
      { title: '任意视觉风格', body: '先低保真，再把连贯风格贯穿到底——编辑感、柔和或张扬。', thumb: 'example-gamified-app' },
      { title: '落地与转化', body: 'Hero、定价、waitlist 布局，第一版就接线且贴品牌。', thumb: 'example-skill-mengto-landing' },
    ],
    galleryTitle: '用 OpenDesign 做出来的线框',
    galleryLead:
      '每一个都始于一句提示、渲染成可编辑可点击的产物。挑一个接近你想法的模板，描述你的变体，agent 帮你改——从线框到可上线代码。',
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: '多屏平铺 App 原型' },
      { thumb: 'example-qiaomu-wizard', caption: 'HR 引导流程' },
      { thumb: 'example-skill-mengto-landing', caption: '产品落地布局' },
      { thumb: 'example-style-claymorphism', caption: '柔和风格 web 线框' },
    ],
  ...
  aiUiGenerator: {
    ...
    features: [
      ...
      { title: 'SaaS 与营销页', body: '落地、定价、营销 UI，可生成、可换主题、可上线。', thumb: 'example-qiaomu-landing' },
      { title: '表单与流程', body: '多步表单、引导、登录流程，层级清晰、状态完整。', thumb: 'example-qiaomu-wizard' },
      { title: '设计系统', body: '生成尊重共享设计系统的 UI——token、组件、间距。', thumb: 'example-gamified-app' },
      { title: '任意视觉风格', body: '编辑感、柔和或张扬——把一种连贯风格贯穿到底。', thumb: 'example-skill-mengto-landing' },
    ],
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: '多屏平铺 App 原型' },
      { thumb: 'example-qiaomu-wizard', caption: 'HR 引导流程' },
      { thumb: 'example-skill-mengto-landing', caption: '产品落地 UI' },
      { thumb: 'example-style-claymorphism', caption: '柔和风格 web UI' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: '浏览模板',
  ...
  designToCode: {
    ...
    features: [
      ...
      { title: 'UI 转生产', body: '把生成的 UI 变成响应式、真实状态的生产代码。', thumb: 'example-qiaomu-landing' },
      { title: '落地页', body: 'Hero、定价、waitlist 区块转成干净、贴品牌的代码。', thumb: 'example-skill-mengto-landing' },
      { title: '表单与流程', body: '多步表单和引导接上真实校验与状态。', thumb: 'example-qiaomu-wizard' },
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: '多屏平铺 App 原型' },
      { thumb: 'example-qiaomu-wizard', caption: 'HR 引导流程' },
      { thumb: 'example-skill-mengto-landing', caption: '代码里的产品落地' },
      { thumb: 'example-style-claymorphism', caption: '柔和风格 web 构建' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: '浏览模板',
    faqTitle: '设计转代码常见问题',
  ...
  aiLandingPageGenerator: {
    ...
    featuresTitle: '你能生成什么',
    features: [
      { title: '产品发布页', body: '首屏、功能、定价、候补表单——一次生成连贯页面，再继续改成上线代码。', thumb: 'example-skill-mengto-landing' },
      { title: 'SaaS 营销页', body: '功能与定价布局，可生成、可换主题、可上线到你自己的域名。', thumb: 'example-qiaomu-landing' },
      { title: '候补与预告页', body: '目标明确的收集页，带可用表单和清晰行动按钮。', thumb: 'example-qiaomu-coming-soon' },
    ...
    gallery: [
      { thumb: 'example-skill-mengto-landing', caption: '产品发布页' },
      { thumb: 'example-qiaomu-landing', caption: 'SaaS 营销页' },
      { thumb: 'example-qiaomu-coming-soon', caption: '候补名单收集流程' },
      { thumb: 'example-style-claymorphism', caption: '柔和风格落地布局' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: '浏览模板',
  ...
  figmaToCode: {
    ...
    features: [
      ...
      { title: 'Figma 转 React / HTML', body: '把 frame 变成你已经在用的技术栈里响应式、真实状态的代码。', thumb: 'example-qiaomu-landing' },
      { title: '整屏与流程', body: '把多屏流程作为一组转换，共享组件、结构一致。', thumb: 'example-mobile-app' },
      { title: '落地页', body: 'hero、定价、waitlist frame 转成干净、贴品牌的代码。', thumb: 'example-skill-mengto-landing' },
      { title: '表单与流程', body: '多步表单和引导接上真实校验与状态。', thumb: 'example-qiaomu-wizard' },
    ...
    gallery: [
      ...
      { thumb: 'example-skill-mengto-landing', caption: '代码里的落地 frame' },
      { thumb: 'example-style-claymorphism', caption: '柔和风格 web 构建' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: '浏览模板',
  ...
  screenshotToCode: {
    ...
    features: [
      ...
      { title: '网站截图', body: '把你截下的落地或营销页重建成响应式代码。', thumb: 'example-qiaomu-landing' },
      { title: '设计截图', body: '交一张设计或 mockup 的截图，拿回可上线代码。', thumb: 'example-skill-mengto-landing' },
      { title: '表单与流程', body: '从截图重建一个表单或多步流程，带真实校验。', thumb: 'example-qiaomu-wizard' },
    ...
    gallery: [
      ...
      { thumb: 'example-skill-mengto-landing', caption: '代码里的落地截图' },
      { thumb: 'example-style-claymorphism', caption: '柔和风格 web 构建' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: '浏览模板',
  ...
  aiPrototypeGenerator: {
    ...
    features: [
      ...
      { title: 'SaaS 与落地流程', body: '营销到注册的流程，可原型、可上样式、可上线。', thumb: 'example-qiaomu-landing' },
      { title: '引导与表单', body: '多步引导和表单流程，层级清晰、状态完整。', thumb: 'example-qiaomu-wizard' },
      { title: '可交互概念', body: '快速拿出一个可点击概念，再把同一份产物带到生产。', thumb: 'example-gamified-app' },
      { title: '任意视觉风格', body: '编辑感、柔和或张扬——把一种连贯风格贯穿每个屏幕。', thumb: 'example-skill-mengto-landing' },
    ],
    ...
    gallery: [
      ...
      { thumb: 'example-style-claymorphism', caption: '柔和风格 web 原型' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: '浏览模板',
  ...
  prototype: {
    ...
    features: [
      ...
      { title: '落地页', body: '能点击、能上线的营销页和 SaaS 落地页。', thumb: 'example-qiaomu-landing' },
      { title: '任意视觉风格', body: '编辑风、柔和风、粗野主义——原型从头到尾保持一致风格。', thumb: 'example-skill-swiss-design' },
      { title: '等候名单与定价', body: '转化页——等候名单、定价表——接好线、贴合品牌。', thumb: 'example-qiaomu-coming-soon' },
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: '多屏平铺 App 原型' },
      { thumb: "example-qiaomu-wizard", caption: "HR 入职流程" },
      { thumb: "example-skill-mengto-landing", caption: "产品落地页" },
      { thumb: "example-style-claymorphism", caption: "柔和风 Web 原型" },
    ],
    exampleHref: '/plugins/templates/',
  ...
  dashboard: {
    ...
    features: [
      { title: "产品分析", body: "活跃、漏斗、留存——产品团队天天看的指标。", thumb: "example-qiaomu-dashboard" },
      { title: "仓库与研发指标", body: "Star、PR、CI 健康度——用你自己的数据做研发看板。", thumb: "example-m3-ops-dashboard" },
      { title: "财务报告", body: "收入、消耗、跑道，排成可分享的报告。", thumb: "example-trading-analysis-dashboard-template" },
      { title: "实时运营", body: "随底层数据变动而刷新的实时指标。", thumb: "example-live-dashboard" },
      { title: "社交与营销", body: "渠道表现和投放追踪汇于一屏。", thumb: "example-social-media-matrix-tracker-template" },
      { title: "领域报告", body: "任意领域的结构化报告——从临床到交易。", thumb: "example-promax-health-dashboard" },
    ],
    galleryTitle: '别人用 OpenDesign 做出来的看板',
    galleryLead: '下面是从 prompt + 数据源渲染出的真实看板。挑一个接近你的，描述你要盯的指标。',
    gallery: [
      { thumb: "example-impeccable-insight-dashboard", caption: "数据报告" },
      { thumb: "example-live-artifact", caption: "实时运营看板" },
  ...
  image: {
    ...
    features: [
      { title: "社交卡片", body: "用你的标题和品牌组合的 X / Twitter 卡片。", thumb: "example-html-ppt-xhs-pastel-card" },
      { title: "文章封面", body: "杂志编辑风的文章和 newsletter 封面。", thumb: "example-html-ppt-zhangzara-retro-zine" },
      { title: "小红书卡片", body: "为小红书 feed 调过的卡片样式。", thumb: "example-html-ppt-xhs-white-editorial" },
      { title: "Hero 主视觉", body: "液态、渐变的 hero 视觉，用于站点和发布。", thumb: "example-frame-liquid-bg-hero" },
      { title: "轮播图", body: "多图社交轮播，每帧之间保持一致。", thumb: "example-html-ppt-xhs-white-editorial" },
    ...
    gallery: [
      ...
      { thumb: "example-image-poster", caption: "杂志风海报" },
  ...
  video: {
    ...
    features: [
      ...
      { title: "动效帧组", body: "可复用的动画帧，组合成一段片子。", thumb: "example-frame-glitch-title" },
  ...
  roleSoloBuilder: {
    ...
    features: [
      { title: '落地页', body: '营销和 SaaS 落地页，能点击、能上线。', thumb: 'example-qiaomu-landing' },
      { title: '产品原型', body: '多屏 Web 应用，验证想法。', thumb: 'example-web-prototype' },
      { title: '看板', body: '产品的指标和后台视图。', thumb: 'example-qiaomu-dashboard' },
      { title: '品牌图', body: '贴合品牌的封面和海报。', thumb: 'example-image-poster' },
      { title: '移动流程', body: '走出 Web 时的应用屏幕。', thumb: 'example-mobile-app' },
      { title: '社交卡', body: '各渠道的发布和更新卡片。', thumb: 'example-html-ppt-xhs-pastel-card' },
    ],
    galleryTitle: '别人用 OpenDesign 单干做出来的',
    galleryLead: '一人创业需要的每个界面，都从一句 prompt 来。挑一个接近你下一步的，描述它。',
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: 'SaaS 落地页' },
      { thumb: 'example-web-prototype', caption: '产品原型' },
      { thumb: 'example-qiaomu-dashboard', caption: '产品看板' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: '发布社交卡' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: '浏览模板',
    faqTitle: '独立开发者常见问题',
  ...
  roleDesigner: {
    ...
    features: [
      { title: '编辑风版面', body: '艺术指导过的、网格驱动的版式。', thumb: 'example-skill-swiss-design' },
      { title: '文章封面', body: '杂志风的封面和特写。', thumb: 'example-html-ppt-zhangzara-retro-zine' },
      { title: '海报', body: '贴合品牌的醒目排版海报。', thumb: 'example-image-poster' },
      { title: '社交套图', body: '一致的多帧轮播。', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: '应用屏幕', body: '高保真的移动和 Web 屏幕。', thumb: 'example-mobile-app' },
      { title: '看板', body: '尊重你系统的数据 UI。', thumb: 'example-qiaomu-dashboard' },
    ],
    galleryTitle: '别人用 OpenDesign 指挥出来的',
    galleryLead: 'agent 从指挥渲染出的高保真、贴合系统的作品。挑一个接近你风格的，打磨它。',
    gallery: [
      { thumb: 'example-skill-swiss-design', caption: '编辑风版面' },
      { thumb: 'example-html-ppt-zhangzara-retro-zine', caption: '杂志封面' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: '社交轮播' },
      { thumb: 'example-image-poster', caption: '排版海报' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: '浏览模板',
    faqTitle: '设计师常见问题',
  ...
  roleEngineering: {
    ...
    features: [
      ...
      { title: '研发看板', body: '仓库、CI 和指标看板。', thumb: 'example-m3-ops-dashboard' },
      { title: '数据报告', body: '从你的数据出结构化报告。', thumb: 'example-impeccable-insight-dashboard' },
      { title: '后台看板', body: '内部工具和后台视图。', thumb: 'example-qiaomu-dashboard' },
      { title: '落地页', body: '不等设计的营销页。', thumb: 'example-qiaomu-landing' },
    ...
    gallery: [
      ...
      { thumb: 'example-m3-ops-dashboard', caption: '研发看板' },
      { thumb: 'example-impeccable-insight-dashboard', caption: '数据报告' },
  ...
  roleProductManagers: {
    ...
    features: [
      ...
      { title: '入职流程', body: '欢迎 → 设置 → 首次使用。', thumb: 'example-qiaomu-wizard' },
      { title: '看板与工作流', body: '用于规格的 Kanban 和流程 UI。', thumb: 'example-kanban-board' },
      { title: '看板', body: '用来框定问题的指标视图。', thumb: 'example-qiaomu-dashboard' },
      { title: 'Web 原型', body: '可评审的多屏 Web 流程。', thumb: 'example-web-prototype' },
      { title: '趋势视图', body: '近 30 天和趋势快照做背景。', thumb: 'example-trading-analysis-dashboard-template' },
    ],
    ...
    gallery: [
      ...
      { thumb: 'example-qiaomu-wizard', caption: '入职流程' },
  ...
  roleMarketing: {
    ...
    features: [
      { title: '落地页', body: 'campaign 和产品落地页，可部署。', thumb: 'example-qiaomu-landing' },
      { title: '社交卡', body: '贴合品牌的 X / Twitter 卡片。', thumb: 'example-html-ppt-xhs-pastel-card' },
      { title: '轮播', body: '一致的多图社交套图。', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: '海报', body: '公告和活动海报。', thumb: 'example-image-poster' },
      { title: '文章封面', body: '博客和 newsletter 封面。', thumb: 'example-html-ppt-zhangzara-retro-zine' },
    ...
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: 'campaign 落地页' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: '社交卡' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: '社交轮播' },
      { thumb: 'example-image-poster', caption: '公告海报' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: '浏览模板',
    faqTitle: '市场常见问题',
