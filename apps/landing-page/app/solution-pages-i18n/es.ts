...
export const ES: SolutionLocaleCopy = {
  aiWireframeGenerator: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Prototipo de app multipantalla en mosaico' },
      { thumb: 'example-qiaomu-wizard', caption: 'Flujo de onboarding de RR. HH.' },
      { thumb: 'example-skill-mengto-landing', caption: 'Diseño de aterrizaje de producto' },
  ...
  aiUiGenerator: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Prototipo de app multipantalla en mosaico' },
      { thumb: 'example-qiaomu-wizard', caption: 'Flujo de onboarding de RR. HH.' },
      { thumb: 'example-skill-mengto-landing', caption: 'UI de aterrizaje de producto' },
  ...
  designToCode: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Prototipo de app multipantalla en mosaico' },
      { thumb: 'example-qiaomu-wizard', caption: 'Flujo de onboarding de RR. HH.' },
      { thumb: 'example-skill-mengto-landing', caption: 'Aterrizaje de producto en código' },
      { thumb: 'example-style-claymorphism', caption: 'Construcción web de estilo suave' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Explorar plantillas',
  ...
  aiLandingPageGenerator: {
    ...
    gallery: [
      { thumb: 'example-skill-mengto-landing', caption: 'Página de lanzamiento de producto' },
      { thumb: 'example-qiaomu-landing', caption: 'Página de marketing SaaS' },
      { thumb: 'example-qiaomu-coming-soon', caption: 'Flujo de captación de lista de espera' },
      { thumb: 'example-style-claymorphism', caption: 'Diseño de aterrizaje de estilo suave' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Explorar plantillas',
  ...
  figmaToCode: {
    ...
    gallery: [
      ...
      { thumb: 'example-skill-mengto-landing', caption: 'Marco de aterrizaje en código' },
      { thumb: 'example-style-claymorphism', caption: 'Construcción web de estilo suave' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Explorar plantillas',
  ...
  screenshotToCode: {
    ...
    gallery: [
      ...
      { thumb: 'example-skill-mengto-landing', caption: 'Captura de aterrizaje en código' },
      { thumb: 'example-style-claymorphism', caption: 'Construcción web de estilo suave' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Explorar plantillas',
  ...
  aiPrototypeGenerator: {
    ...
    gallery: [
      ...
      { thumb: 'example-style-claymorphism', caption: 'Prototipo web de estilo suave' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Explorar plantillas',
  ...
  prototype: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Prototipo de app multipantalla en mosaico' },
      { thumb: "example-qiaomu-wizard", caption: "Flujo de onboarding de RR. HH." },
      { thumb: "example-skill-mengto-landing", caption: "Página de aterrizaje de producto" },
      { thumb: "example-style-claymorphism", caption: "Prototipo web de estilo suave" },
    ],
    exampleHref: '/plugins/templates/',
  ...
  dashboard: {
    ...
    features: [
      { title: "Analítica de producto", body: "Usuarios activos, embudos, retención — las métricas en las que vive un equipo de producto.", thumb: "example-qiaomu-dashboard" },
      { title: "Métricas de repositorio y desarrollo", body: "Estrellas, PR, salud de CI — paneles de ingeniería con tus propios datos.", thumb: "example-m3-ops-dashboard" },
      { title: "Informes financieros", body: "Ingresos, gasto y margen de operación dispuestos como un informe para compartir.", thumb: "example-trading-analysis-dashboard-template" },
      ...
      { title: "Redes y marketing", body: "Rendimiento de canales y seguimiento de campañas en una sola vista.", thumb: "example-social-media-matrix-tracker-template" },
      { title: "Informes por sector", body: "Informes estructurados para cualquier ámbito — de lo clínico al trading.", thumb: "example-promax-health-dashboard" },
    ],
    ...
    gallery: [
      { thumb: "example-impeccable-insight-dashboard", caption: "Informe de datos" },
      { thumb: "example-live-artifact", caption: "Panel de operaciones en vivo" },
  ...
  image: {
    ...
    features: [
      { title: "Tarjetas para redes", body: "Tarjetas de X / Twitter compuestas con tu titular y tu marca.", thumb: "example-html-ppt-xhs-pastel-card" },
      { title: "Portadas de artículos", body: "Portadas editoriales, estilo revista, para publicaciones y boletines.", thumb: "example-html-ppt-zhangzara-retro-zine" },
      { title: "Tarjetas de Xiaohongshu", body: "Tarjetas estilo RedNote afinadas para ese feed.", thumb: "example-html-ppt-xhs-white-editorial" },
      ...
      { title: "Carruseles", body: "Carruseles para redes de varias diapositivas que se mantienen consistentes entre cuadros.", thumb: "example-html-ppt-xhs-white-editorial" },
    ...
    gallery: [
      ...
      { thumb: "example-image-poster", caption: "Cartel estilo revista" },
  ...
  video: {
    ...
    features: [
      ...
      { title: "Conjuntos de cuadros de movimiento", body: "Cuadros animados reutilizables que compones en un clip.", thumb: "example-frame-glitch-title" },
  ...
  roleSoloBuilder: {
    ...
    features: [
      { title: 'Landing pages', body: 'Landings de marketing y SaaS, navegables y en vivo.', thumb: 'example-qiaomu-landing' },
      { title: 'Prototipos de producto', body: 'Apps web multipantalla para validar la idea.', thumb: 'example-web-prototype' },
      { title: 'Dashboards', body: 'Métricas y vistas de administración para tu producto.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Gráficos de marca', body: 'Portadas y pósters que encajan con tu marca.', thumb: 'example-image-poster' },
      { title: 'Flujos móviles', body: 'Pantallas de app cuando vas más allá de la web.', thumb: 'example-mobile-app' },
      { title: 'Tarjetas para redes', body: 'Tarjetas de lanzamiento y novedades para cada canal.', thumb: 'example-html-ppt-xhs-pastel-card' },
    ],
    ...
    gallery: [
      ...
      { thumb: 'example-qiaomu-dashboard', caption: 'Dashboard de producto' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: 'Tarjeta de lanzamiento para redes' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Explorar plantillas',
  ...
  roleDesigner: {
    ...
    features: [
      { title: 'Maquetas editoriales', body: 'Composiciones con dirección de arte, guiadas por rejilla.', thumb: 'example-skill-swiss-design' },
      { title: 'Portadas de artículo', body: 'Portadas y reportajes estilo revista.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
      { title: 'Pósters', body: 'Pósters tipográficos contundentes dentro de la marca.', thumb: 'example-image-poster' },
      { title: 'Sets para redes', body: 'Carruseles multipantalla coherentes.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: 'Pantallas de app', body: 'Pantallas móviles y web de alta fidelidad.', thumb: 'example-mobile-app' },
      { title: 'Dashboards', body: 'Interfaces de datos que respetan tu sistema.', thumb: 'example-qiaomu-dashboard' },
    ],
    ...
    gallery: [
      { thumb: 'example-skill-swiss-design', caption: 'Maqueta editorial' },
      { thumb: 'example-html-ppt-zhangzara-retro-zine', caption: 'Portada de revista' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: 'Carrusel para redes' },
      { thumb: 'example-image-poster', caption: 'Póster tipográfico' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Explorar plantillas',
  ...
  roleEngineering: {
    ...
    features: [
      ...
      { title: 'Dashboards de desarrollo', body: 'Dashboards de repositorio, CI y métricas.', thumb: 'example-m3-ops-dashboard' },
      { title: 'Informes de datos', body: 'Informes estructurados a partir de tus datos.', thumb: 'example-impeccable-insight-dashboard' },
      { title: 'Dashboards de administración', body: 'Herramientas internas y vistas de administración.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Landing pages', body: 'Páginas de marketing sin esperar a diseño.', thumb: 'example-qiaomu-landing' },
    ...
    gallery: [
      ...
      { thumb: 'example-m3-ops-dashboard', caption: 'Dashboard de desarrollo' },
      { thumb: 'example-impeccable-insight-dashboard', caption: 'Informe de datos' },
  ...
  roleProductManagers: {
    ...
    features: [
      ...
      { title: 'Flujos de onboarding', body: 'Bienvenida → configuración → primer uso.', thumb: 'example-qiaomu-wizard' },
      { title: 'Tableros y flujos de trabajo', body: 'Kanban e interfaces de proceso para especificaciones.', thumb: 'example-kanban-board' },
      { title: 'Dashboards', body: 'Vistas de métricas para enmarcar el problema.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Prototipos web', body: 'Flujos web multipantalla para revisar.', thumb: 'example-web-prototype' },
      { title: 'Vistas de tendencias', body: 'Instantáneas de 30 días y de tendencias para dar contexto.', thumb: 'example-trading-analysis-dashboard-template' },
    ],
    ...
    gallery: [
      ...
      { thumb: 'example-qiaomu-wizard', caption: 'Flujo de onboarding' },
  ...
  roleMarketing: {
    ...
    features: [
      { title: 'Landing pages', body: 'Landings de campaña y producto, desplegables.', thumb: 'example-qiaomu-landing' },
      { title: 'Tarjetas para redes', body: 'Tarjetas de X / Twitter dentro de la marca.', thumb: 'example-html-ppt-xhs-pastel-card' },
      { title: 'Carruseles', body: 'Sets multidiapositiva para redes, coherentes.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: 'Pósters', body: 'Pósters de anuncio y de evento.', thumb: 'example-image-poster' },
      { title: 'Portadas de artículo', body: 'Portadas para blog y newsletter.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
    ...
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: 'Landing page de campaña' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: 'Tarjeta para redes' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: 'Carrusel para redes' },
      { thumb: 'example-image-poster', caption: 'Póster de anuncio' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Explorar plantillas',
