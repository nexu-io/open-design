...
export const EN: SolutionLocaleCopy = {
  aiWireframeGenerator: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Tiled multi-screen app prototype' },
      { thumb: 'example-qiaomu-wizard', caption: 'HR onboarding flow' },
      { thumb: 'example-skill-mengto-landing', caption: 'Product landing layout' },
      { thumb: 'example-style-claymorphism', caption: 'Soft-style web wireframe' },
    ],
  ...
  aiUiGenerator: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Tiled multi-screen app prototype' },
      { thumb: 'example-qiaomu-wizard', caption: 'HR onboarding flow' },
      { thumb: 'example-skill-mengto-landing', caption: 'Product landing UI' },
      { thumb: 'example-style-claymorphism', caption: 'Soft-style web UI' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Browse templates',
  ...
  designToCode: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Tiled multi-screen app prototype' },
      { thumb: 'example-qiaomu-wizard', caption: 'HR onboarding flow' },
      { thumb: 'example-skill-mengto-landing', caption: 'Product landing in code' },
      { thumb: 'example-style-claymorphism', caption: 'Soft-style web build' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Browse templates',
  ...
  aiLandingPageGenerator: {
    ...
    gallery: [
      { thumb: 'example-skill-mengto-landing', caption: 'Product launch page' },
      { thumb: 'example-qiaomu-landing', caption: 'SaaS marketing page' },
      { thumb: 'example-qiaomu-coming-soon', caption: 'Waitlist capture flow' },
      { thumb: 'example-style-claymorphism', caption: 'Soft-style landing layout' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Browse templates',
  ...
  figmaToCode: {
    ...
    gallery: [
      ...
      { thumb: 'example-skill-mengto-landing', caption: 'Landing frame in code' },
      { thumb: 'example-style-claymorphism', caption: 'Soft-style web build' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Browse templates',
  ...
  screenshotToCode: {
    ...
    gallery: [
      ...
      { thumb: 'example-skill-mengto-landing', caption: 'Landing screenshot in code' },
      { thumb: 'example-style-claymorphism', caption: 'Soft-style web build' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Browse templates',
  ...
  aiPrototypeGenerator: {
    ...
    gallery: [
      ...
      { thumb: 'example-style-claymorphism', caption: 'Soft-style web prototype' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Browse templates',
  ...
  prototype: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: 'Tiled multi-screen app prototype' },
      { thumb: "example-qiaomu-wizard", caption: "HR onboarding flow" },
      { thumb: "example-skill-mengto-landing", caption: "Product landing page" },
      { thumb: "example-style-claymorphism", caption: "Soft-style web prototype" },
    ],
    exampleHref: '/plugins/templates/',
  ...
  dashboard: {
    ...
    features: [
      { title: "Product analytics", body: "Active users, funnels, retention — the metrics a product team lives in.", thumb: "example-qiaomu-dashboard" },
      { title: "Repo & dev metrics", body: "Stars, PRs, CI health — engineering dashboards from your own data.", thumb: "example-m3-ops-dashboard" },
      { title: "Finance reports", body: "Revenue, burn, runway laid out as a shareable report.", thumb: "example-trading-analysis-dashboard-template" },
      { title: "Live operations", body: "Real-time metrics that refresh as the underlying data moves.", thumb: "example-live-dashboard" },
      { title: "Social & marketing", body: "Channel performance and campaign tracking in one view.", thumb: "example-social-media-matrix-tracker-template" },
      { title: "Domain reports", body: "Structured reports for any field — from clinical to trading.", thumb: "example-promax-health-dashboard" },
    ],
    ...
    gallery: [
      { thumb: "example-impeccable-insight-dashboard", caption: "Data report" },
      { thumb: "example-live-artifact", caption: "Live ops dashboard" },
  ...
  image: {
    ...
    features: [
      { title: "Social cards", body: "X / Twitter cards composed with your headline and brand.", thumb: "example-html-ppt-xhs-pastel-card" },
      { title: "Article covers", body: "Editorial, magazine-style covers for posts and newsletters.", thumb: "example-html-ppt-zhangzara-retro-zine" },
      { title: "Xiaohongshu cards", body: "RedNote-style cards tuned for that feed.", thumb: "example-html-ppt-xhs-white-editorial" },
      { title: "Hero graphics", body: "Liquid, gradient hero visuals for sites and launches.", thumb: "example-frame-liquid-bg-hero" },
      { title: "Carousels", body: "Multi-slide social carousels that stay consistent across frames.", thumb: "example-html-ppt-xhs-white-editorial" },
    ...
    gallery: [
      ...
      { thumb: "example-image-poster", caption: "Magazine-style poster" },
  ...
  video: {
    ...
    features: [
      ...
      { title: "Motion frame sets", body: "Reusable animated frames you compose into a clip.", thumb: "example-frame-glitch-title" },
  ...
  roleSoloBuilder: {
    ...
    features: [
      { title: 'Landing pages', body: 'Marketing and SaaS landings, click-through and live.', thumb: 'example-qiaomu-landing' },
      { title: 'Product prototypes', body: 'Multi-screen web apps to validate the idea.', thumb: 'example-web-prototype' },
      { title: 'Dashboards', body: 'Metrics and admin views for your product.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Brand graphics', body: 'Covers and posters that match your brand.', thumb: 'example-image-poster' },
      { title: 'Mobile flows', body: 'App screens when you go beyond the web.', thumb: 'example-mobile-app' },
      { title: 'Social cards', body: 'Launch and update cards for every channel.', thumb: 'example-html-ppt-xhs-pastel-card' },
    ],
    ...
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: 'SaaS landing page' },
      { thumb: 'example-web-prototype', caption: 'Product prototype' },
      { thumb: 'example-qiaomu-dashboard', caption: 'Product dashboard' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: 'Launch social card' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Browse templates',
  ...
  roleDesigner: {
    ...
    features: [
      { title: 'Editorial layouts', body: 'Art-directed, grid-driven compositions.', thumb: 'example-skill-swiss-design' },
      { title: 'Article covers', body: 'Magazine-style covers and features.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
      { title: 'Posters', body: 'Bold typographic posters on brand.', thumb: 'example-image-poster' },
      { title: 'Social sets', body: 'Consistent multi-frame carousels.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: 'App screens', body: 'High-fidelity mobile and web screens.', thumb: 'example-mobile-app' },
      { title: 'Dashboards', body: 'Data UI that respects your system.', thumb: 'example-qiaomu-dashboard' },
    ],
    ...
    gallery: [
      { thumb: 'example-skill-swiss-design', caption: 'Editorial layout' },
      { thumb: 'example-html-ppt-zhangzara-retro-zine', caption: 'Magazine cover' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: 'Social carousel' },
      { thumb: 'example-image-poster', caption: 'Typographic poster' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Browse templates',
  ...
  roleEngineering: {
    ...
    features: [
      ...
      { title: 'Dev dashboards', body: 'Repo, CI and metrics dashboards.', thumb: 'example-m3-ops-dashboard' },
      { title: 'Data reports', body: 'Structured reports from your data.', thumb: 'example-impeccable-insight-dashboard' },
      { title: 'Admin dashboards', body: 'Internal tools and admin views.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Landing pages', body: 'Marketing pages without waiting on design.', thumb: 'example-qiaomu-landing' },
    ...
    gallery: [
      ...
      { thumb: 'example-m3-ops-dashboard', caption: 'Dev dashboard' },
      { thumb: 'example-impeccable-insight-dashboard', caption: 'Data report' },
  ...
  roleProductManagers: {
    ...
    features: [
      ...
      { title: 'Onboarding flows', body: 'Welcome → setup → first run.', thumb: 'example-qiaomu-wizard' },
      { title: 'Boards & workflows', body: 'Kanban and process UIs for specs.', thumb: 'example-kanban-board' },
      { title: 'Dashboards', body: 'Metric views to frame the problem.', thumb: 'example-qiaomu-dashboard' },
      { title: 'Web prototypes', body: 'Multi-screen web flows to review.', thumb: 'example-web-prototype' },
      { title: 'Trend views', body: '30-day and trend snapshots for context.', thumb: 'example-trading-analysis-dashboard-template' },
    ],
    ...
    gallery: [
      ...
      { thumb: 'example-qiaomu-wizard', caption: 'Onboarding flow' },
  ...
  roleMarketing: {
    ...
    features: [
      { title: 'Landing pages', body: 'Campaign and product landings, deployable.', thumb: 'example-qiaomu-landing' },
      { title: 'Social cards', body: 'X / Twitter cards on brand.', thumb: 'example-html-ppt-xhs-pastel-card' },
      { title: 'Carousels', body: 'Multi-slide social sets, consistent.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: 'Posters', body: 'Announcement and event posters.', thumb: 'example-image-poster' },
      { title: 'Article covers', body: 'Blog and newsletter covers.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
    ...
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: 'Campaign landing page' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: 'Social card' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: 'Social carousel' },
      { thumb: 'example-image-poster', caption: 'Announcement poster' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: 'Browse templates',
