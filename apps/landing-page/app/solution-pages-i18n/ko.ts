...
export const KO: SolutionLocaleCopy = {
  aiWireframeGenerator: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: '멀티 스크린 타일형 앱 프로토타입' },
      { thumb: 'example-qiaomu-wizard', caption: '인사 온보딩 플로우' },
      { thumb: 'example-skill-mengto-landing', caption: '제품 랜딩 레이아웃' },
      { thumb: 'example-style-claymorphism', caption: '소프트 스타일 웹 와이어프레임' },
    ],
  ...
  aiUiGenerator: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: '멀티 스크린 타일형 앱 프로토타입' },
      { thumb: 'example-qiaomu-wizard', caption: '인사 온보딩 플로우' },
      { thumb: 'example-skill-mengto-landing', caption: '제품 랜딩 UI' },
      { thumb: 'example-style-claymorphism', caption: '소프트 스타일 웹 UI' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: '템플릿 둘러보기',
  ...
  designToCode: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: '멀티 스크린 타일형 앱 프로토타입' },
      { thumb: 'example-qiaomu-wizard', caption: '인사 온보딩 플로우' },
      { thumb: 'example-skill-mengto-landing', caption: '코드로 만든 제품 랜딩' },
      { thumb: 'example-style-claymorphism', caption: '소프트 스타일 웹 빌드' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: '템플릿 둘러보기',
  ...
  aiLandingPageGenerator: {
    ...
    gallery: [
      { thumb: 'example-skill-mengto-landing', caption: '제품 출시 페이지' },
      { thumb: 'example-qiaomu-landing', caption: 'SaaS 마케팅 페이지' },
      { thumb: 'example-qiaomu-coming-soon', caption: '대기자 명단 수집 플로우' },
      { thumb: 'example-style-claymorphism', caption: '소프트 스타일 랜딩 레이아웃' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: '템플릿 둘러보기',
  ...
  figmaToCode: {
    ...
    gallery: [
      ...
      { thumb: 'example-skill-mengto-landing', caption: '코드로 만든 랜딩 프레임' },
      { thumb: 'example-style-claymorphism', caption: '소프트 스타일 웹 빌드' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: '템플릿 둘러보기',
  ...
  screenshotToCode: {
    ...
    gallery: [
      ...
      { thumb: 'example-skill-mengto-landing', caption: '랜딩 스크린샷을 코드로' },
      { thumb: 'example-style-claymorphism', caption: '부드러운 스타일의 웹 빌드' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: '템플릿 둘러보기',
  ...
  aiPrototypeGenerator: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: '멀티 스크린 타일형 앱 프로토타입' },
      { thumb: 'example-qiaomu-wizard', caption: 'HR 온보딩 플로우' },
      { thumb: 'example-mobile-app', caption: '모바일 앱 프로토타입' },
      { thumb: 'example-style-claymorphism', caption: '부드러운 스타일의 웹 프로토타입' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: '템플릿 둘러보기',
  ...
  prototype: {
    ...
    gallery: [
      { thumb: 'example-huashu-ios-tiled-prototype', caption: '멀티 스크린 타일형 앱 프로토타입' },
      { thumb: "example-qiaomu-wizard", caption: "인사 온보딩 플로우" },
      { thumb: "example-skill-mengto-landing", caption: "제품 랜딩 페이지" },
      { thumb: "example-style-claymorphism", caption: "소프트 스타일 웹 프로토타입" },
    ],
    exampleHref: '/plugins/templates/',
  ...
  dashboard: {
    ...
    features: [
      { title: "제품 분석", body: "활성 사용자, 퍼널, 리텐션 — 제품 팀이 늘 들여다보는 지표.", thumb: "example-qiaomu-dashboard" },
      { title: "리포지토리와 개발 지표", body: "스타, PR, CI 상태 — 자신의 데이터로 만든 엔지니어링 대시보드.", thumb: "example-m3-ops-dashboard" },
      { title: "재무 리포트", body: "매출, 번, 런웨이를 공유 가능한 리포트로 배치.", thumb: "example-trading-analysis-dashboard-template" },
      { title: "실시간 운영", body: "기반 데이터가 움직이는 대로 새로고침되는 실시간 지표.", thumb: "example-live-dashboard" },
      { title: "소셜과 마케팅", body: "채널 성과와 캠페인 추적을 한 화면에.", thumb: "example-social-media-matrix-tracker-template" },
      { title: "도메인 리포트", body: "어떤 분야든 구조화된 리포트 — 임상부터 트레이딩까지.", thumb: "example-promax-health-dashboard" },
    ],
    galleryTitle: '사람들이 OpenDesign으로 만든 대시보드',
    galleryLead:
      '프롬프트와 데이터 소스로 렌더링된 진짜 대시보드. 자신에게 가까운 것에서 시작해 추적하는 지표를 설명하세요.',
    gallery: [
      { thumb: "example-impeccable-insight-dashboard", caption: "데이터 리포트" },
      { thumb: "example-live-artifact", caption: "실시간 운영 대시보드" },
  ...
  image: {
    ...
    featuresTitle: '만들 수 있는 것',
    features: [
      { title: "소셜 카드", body: "당신의 헤드라인과 브랜드로 구성된 X / Twitter 카드.", thumb: "example-html-ppt-xhs-pastel-card" },
      { title: "아티클 커버", body: "글과 뉴스레터를 위한 에디토리얼 매거진 스타일 커버.", thumb: "example-html-ppt-zhangzara-retro-zine" },
      { title: "Xiaohongshu 카드", body: "그 피드에 맞춰 조정된 RedNote 스타일 카드.", thumb: "example-html-ppt-xhs-white-editorial" },
      { title: "히어로 그래픽", body: "사이트와 런칭을 위한 리퀴드, 그라데이션 히어로 비주얼.", thumb: "example-frame-liquid-bg-hero" },
      { title: "캐러셀", body: "프레임 간 일관성을 유지하는 다중 슬라이드 소셜 캐러셀.", thumb: "example-html-ppt-xhs-white-editorial" },
    ...
    gallery: [
      ...
      { thumb: "example-image-poster", caption: "매거진 스타일 포스터" },
  ...
  video: {
    ...
    features: [
      ...
      { title: "모션 프레임 세트", body: "클립으로 구성하는 재사용 가능한 애니메이션 프레임.", thumb: "example-frame-glitch-title" },
  ...
  roleSoloBuilder: {
    ...
    features: [
      { title: '랜딩 페이지', body: '마케팅과 SaaS 랜딩, 클릭 가능하고 라이브.', thumb: 'example-qiaomu-landing' },
      { title: '제품 프로토타입', body: '아이디어를 검증하는 멀티 스크린 웹 앱.', thumb: 'example-web-prototype' },
      { title: '대시보드', body: '당신 제품의 지표와 관리 뷰.', thumb: 'example-qiaomu-dashboard' },
      { title: '브랜드 그래픽', body: '브랜드에 맞는 커버와 포스터.', thumb: 'example-image-poster' },
      { title: '모바일 플로우', body: '웹을 넘어설 때의 앱 화면.', thumb: 'example-mobile-app' },
      { title: '소셜 카드', body: '모든 채널을 위한 출시·업데이트 카드.', thumb: 'example-html-ppt-xhs-pastel-card' },
    ],
    galleryTitle: 'OpenDesign으로 혼자 만든 것',
    galleryLead:
      '1인 스타트업에 필요한 모든 영역을, 프롬프트 한 줄로. 다음 행보에 가까운 것을 골라 설명해 보세요.',
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: 'SaaS 랜딩 페이지' },
      { thumb: 'example-web-prototype', caption: '제품 프로토타입' },
      { thumb: 'example-qiaomu-dashboard', caption: '제품 대시보드' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: '출시용 소셜 카드' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: '템플릿 둘러보기',
    faqTitle: '솔로 빌더 FAQ',
  ...
  roleDesigner: {
    ...
    features: [
      { title: '에디토리얼 레이아웃', body: '아트 디렉팅된 그리드 기반 구성.', thumb: 'example-skill-swiss-design' },
      { title: '아티클 커버', body: '매거진 스타일의 커버와 피처.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
      { title: '포스터', body: '브랜드에 맞는 과감한 타이포그래피 포스터.', thumb: 'example-image-poster' },
      { title: '소셜 세트', body: '일관된 멀티 프레임 캐러셀.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: '앱 화면', body: '고충실도 모바일·웹 화면.', thumb: 'example-mobile-app' },
      { title: '대시보드', body: '당신의 시스템을 존중하는 데이터 UI.', thumb: 'example-qiaomu-dashboard' },
    ],
    galleryTitle: 'OpenDesign으로 디렉팅한 것',
    galleryLead:
      '디렉팅으로부터 에이전트가 만들어낸, 시스템에 맞는 고충실도 작업. 당신의 스타일에 가까운 것을 골라 다듬어 보세요.',
    gallery: [
      { thumb: 'example-skill-swiss-design', caption: '에디토리얼 레이아웃' },
      { thumb: 'example-html-ppt-zhangzara-retro-zine', caption: '매거진 커버' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: '소셜 캐러셀' },
      { thumb: 'example-image-poster', caption: '타이포그래피 포스터' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: '템플릿 둘러보기',
    faqTitle: '디자이너 FAQ',
  ...
  roleEngineering: {
    ...
    features: [
      ...
      { title: '개발 대시보드', body: '저장소, CI, 지표 대시보드.', thumb: 'example-m3-ops-dashboard' },
      { title: '데이터 리포트', body: '당신의 데이터로부터의 구조화된 리포트.', thumb: 'example-impeccable-insight-dashboard' },
      { title: '관리 대시보드', body: '내부 도구와 관리 뷰.', thumb: 'example-qiaomu-dashboard' },
      { title: '랜딩 페이지', body: '디자인을 기다리지 않는 마케팅 페이지.', thumb: 'example-qiaomu-landing' },
    ...
    gallery: [
      ...
      { thumb: 'example-m3-ops-dashboard', caption: '개발 대시보드' },
      { thumb: 'example-impeccable-insight-dashboard', caption: '데이터 리포트' },
  ...
  roleProductManagers: {
    ...
    features: [
      ...
      { title: '온보딩 플로우', body: '환영 → 설정 → 첫 실행.', thumb: 'example-qiaomu-wizard' },
      { title: '보드와 워크플로우', body: '스펙을 위한 Kanban과 프로세스 UI.', thumb: 'example-kanban-board' },
      { title: '대시보드', body: '문제를 틀 짓는 지표 뷰.', thumb: 'example-qiaomu-dashboard' },
      { title: '웹 프로토타입', body: '리뷰용 멀티 스크린 웹 플로우.', thumb: 'example-web-prototype' },
      { title: '트렌드 뷰', body: '맥락을 위한 30일·트렌드 스냅샷.', thumb: 'example-trading-analysis-dashboard-template' },
    ],
    ...
    gallery: [
      ...
      { thumb: 'example-qiaomu-wizard', caption: '온보딩 플로우' },
  ...
  roleMarketing: {
    ...
    features: [
      { title: '랜딩 페이지', body: '캠페인과 제품 랜딩, 배포 가능.', thumb: 'example-qiaomu-landing' },
      { title: '소셜 카드', body: '브랜드에 맞는 X / Twitter 카드.', thumb: 'example-html-ppt-xhs-pastel-card' },
      { title: '캐러셀', body: '일관된 멀티 슬라이드 소셜 세트.', thumb: 'example-html-ppt-xhs-white-editorial' },
      { title: '포스터', body: '공지와 이벤트 포스터.', thumb: 'example-image-poster' },
      { title: '아티클 커버', body: '블로그와 뉴스레터 커버.', thumb: 'example-html-ppt-zhangzara-retro-zine' },
    ...
    gallery: [
      { thumb: 'example-qiaomu-landing', caption: '캠페인 랜딩 페이지' },
      { thumb: 'example-html-ppt-xhs-pastel-card', caption: '소셜 카드' },
      { thumb: 'example-html-ppt-xhs-white-editorial', caption: '소셜 캐러셀' },
      { thumb: 'example-image-poster', caption: '공지 포스터' },
    ],
    exampleHref: '/plugins/templates/',
    exampleLinkLabel: '템플릿 둘러보기',
    faqTitle: '마케팅 FAQ',
