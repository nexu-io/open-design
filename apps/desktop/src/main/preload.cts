...
const OPEN_DESIGN_HOST_GLOBAL: typeof import('@marketing-ax/host').OPEN_DESIGN_HOST_GLOBAL = '__od__';
const OPEN_DESIGN_HOST_VERSION: typeof import('@marketing-ax/host').OPEN_DESIGN_HOST_VERSION = 2;
