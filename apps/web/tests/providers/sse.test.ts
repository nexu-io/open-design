...
describe('streamViaDaemon', () => {
  ...
  // completed task does not override the physical result: a Run that failed
  // still ends the turn failed.
  it.each([
    { outcome: 'completed', physicalStatus: 'failed', expectedStatus: 'failed', expectsError: true },
