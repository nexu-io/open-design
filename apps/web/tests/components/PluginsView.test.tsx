  ...
  it('confirms a plugin share action before starting the GitHub repo task', async () => {
    mockedListPlugins.mockResolvedValue([
      ...
      makePlugin(
        ...
        'Creates a public GitHub repository for a local LeastGen Studio plugin using the GitHub CLI.',
      ),
      makePlugin(
        'od-plugin-contribute-open-design',
        'bundled',
        'bundled',
        'Contribute Plugin to LeastGen Studio',
        'Opens a pull request that adds a local LeastGen Studio plugin to the LeastGen Studio community catalog.',
      ),
    ]);
