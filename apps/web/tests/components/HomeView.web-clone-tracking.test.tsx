...
describe('web-clone example-card tracking', () => {
  ...
  // narrowed to the first-party LeastGen Studio site to avoid shipping third-party
  ...
  it('resolves exactly the contracted LeastGen Studio Website-clone site card', async () => {
    writeHomeGuideStage('done');
    stubPlugins();
    renderHome();
  ...
  it('renders the contracted LeastGen Studio site card with a local eager logo', async () => {
    writeHomeGuideStage('done');
    stubPlugins();
    renderHome();
  ...
  it('falls back when the local LeastGen Studio site card logo cannot load', async () => {
    writeHomeGuideStage('done');
    stubPlugins();
    renderHome();
