...
const EDGE: Cell[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      '产品原有的软提醒弹窗 `AmrLowBalanceDialog`(居中硬阻断)**已于 2026-09-06 删除** —— 软那一档现在只剩这张卡;首页没有流水,那一档什么都不显示、直接放行(T53)',
      '阈值:稿子这一档写的是 < 5 美金,代码取 `AMR_LOW_BALANCE_WARN_USD = 2` —— **对交付稿的有意偏离**,产品 2026-09-06 拍板保持 $2(T52)',
    ],
  },
  {
