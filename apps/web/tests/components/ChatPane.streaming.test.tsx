  ...
  AssistantMessage: ({
    ...
    <>
      ...
      {onShareToOpenDesign ? (
        ...
        >
          {shareToOpenDesignBusy ? 'Preparing package…' : 'Share to LeastGen Studio'}
        </button>
      ) : null}
    </>
  ),
...
- A clear DESIGN.md with all generated rules.`,
  ...
  it('keeps Share to LeastGen Studio busy on the assistant turn that started packaging', () => {
    ...
    rerender(
      <ChatPane
        ...
        messages={[
          ...initialMessages,
          { id: 'user-2', role: 'user', content: 'Share to LeastGen Studio', createdAt: 4 },
          {
            id: 'assistant-2',
            role: 'assistant',
            content: '',
