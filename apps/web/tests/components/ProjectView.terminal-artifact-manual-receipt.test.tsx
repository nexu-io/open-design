...
async function runHomeArtifactScenario() {
  ...
  await act(async () => {
    ...
    // below runs. A clean exit would keep the turn Done, and this suite is
    // about what recovery does for a failed turn.
...
describe('Manual ownership across terminal artifact finalizers with production provider and mocked HTTP', () => {
  it('keeps the manual document out after an MD-only finalizer is followed by late HTML recovery', async () => {
