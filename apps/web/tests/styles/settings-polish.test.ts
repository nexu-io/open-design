...
const primitivesCss = readFileSync(new URL('../../src/styles/primitives.css', import.meta.url), 'utf8').replace(/\r\n/g, '\n');
const mentionHomeCss = readFileSync(new URL('../../src/styles/workspace/mention-home.css', import.meta.url), 'utf8').replace(/\r\n/g, '\n');
