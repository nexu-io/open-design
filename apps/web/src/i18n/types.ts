...
export interface Dict {
  ...
  'ds.manager.cardAria': string;
  'ds.manager.eyebrow': string;
  'ds.manager.yourSystems': string;
  'ds.manager.userFilterAria': string;
  'ds.manager.userFilter.all': string;
  'ds.manager.userFilter.published': string;
  'ds.manager.userFilter.draft': string;
  'ds.manager.create.title': string;
  'ds.manager.create.hint': string;
  'ds.manager.create.action': string;
  'ds.manager.userEmpty': string;
  'ds.manager.row.youUpdated': string;
  'ds.manager.row.justNow': string;
  'ds.manager.row.edit': string;
  'ds.manager.row.makeDefault': string;
  'ds.manager.row.published': string;
  'ds.manager.row.draft': string;
  'ds.manager.row.openAria': string;
  'ds.manager.row.deleteAria': string;
  'ds.manager.row.deleteConfirm': string;
  'ds.manager.templates.aria': string;
  'ds.manager.templates.eyebrow': string;
  'ds.manager.templates.heading': string;
  'ds.manager.templates.empty': string;
  'ds.manager.privateNote': string;
  'ds.manager.library.aria': string;
  'ds.manager.library.eyebrow': string;
  'ds.manager.library.heading': string;
  'ds.manager.card.edit': string;
  'ds.manager.card.open': string;
  ...
  // Automations page (/automations) — TasksView + NewAutomationModal
  'automations.eyebrow': string;
  'automations.title': string;
  'automations.lede': string;
  'automations.metricsAria': string;
  'automations.metric.active': string;
  'automations.metric.paused': string;
  'automations.metric.templates': string;
  'automations.new': string;

  'automations.yours.aria': string;
  'automations.yours.title': string;
  'automations.yours.loading': string;
  'automations.empty.title': string;
  'automations.empty.body': string;

  'automations.row.targetNew': string;
  'automations.row.run': string;
  'automations.row.runTitle': string;
  'automations.row.history': string;
  'automations.row.hideHistory': string;
  'automations.row.edit': string;
  'automations.row.pause': string;
  'automations.row.resume': string;
  'automations.row.delete': string;
  'automations.row.deleteTitle': string;
  'automations.row.deleteConfirm': string;
  'automations.row.lastRun': string;
  'automations.row.openResult': string;

  'automations.schedule.hourly': string;
  'automations.schedule.daily': string;
  'automations.schedule.weekdays': string;
  'automations.schedule.weekly': string;
  'automations.schedule.paused': string;
  'automations.schedule.manualOnly': string;
  'automations.schedule.scheduled': string;
  'automations.schedule.next': string;

  'automations.history.aria': string;
  'automations.history.loading': string;
  'automations.history.empty': string;
  'automations.history.head': string;
  'automations.history.latest': string;
  'automations.history.crystallize': string;
  'automations.history.crystallizing': string;
  'automations.history.crystallizeTitle': string;
  'automations.history.openConversation': string;
  'automations.history.durationInProgress': string;

  'automations.status.succeeded': string;
  'automations.status.failed': string;
  'automations.status.running': string;
  'automations.status.queued': string;
  'automations.status.canceled': string;

  'automations.ingest.aria': string;
  'automations.ingest.title': string;
  'automations.ingest.sub': string;
  'automations.ingest.recent': string;
  'automations.ingest.field.template': string;
  'automations.ingest.field.source': string;
  'automations.ingest.field.compression': string;
  'automations.ingest.field.connector': string;
  'automations.ingest.field.title': string;
  'automations.ingest.field.sourceRef': string;
  'automations.ingest.field.content': string;
  'automations.ingest.anyConnector': string;
  'automations.ingest.placeholderTitle': string;
  'automations.ingest.placeholderSourceRef': string;
  'automations.ingest.placeholderContent': string;
  'automations.ingest.empty': string;
  'automations.ingest.recentAria': string;
  'automations.ingest.action.ingest': string;
  'automations.ingest.action.ingesting': string;
  'automations.ingest.error.empty': string;
  'automations.ingest.recentMeta': string;

  'automations.source.connector': string;
  'automations.source.url': string;
  'automations.source.repo': string;
  'automations.source.artifact': string;
  'automations.source.chat': string;
  'automations.source.upload': string;

  'automations.compression.balanced': string;
  'automations.compression.aggressive': string;
  'automations.compression.off': string;

  'automations.proposals.aria': string;
  'automations.proposals.title': string;
  'automations.proposals.sub': string;
  'automations.proposals.pending': string;
  'automations.proposals.apply': string;
  'automations.proposals.reject': string;
  'automations.proposals.rejectReason': string;
  'automations.proposals.target.memory': string;
  'automations.proposals.target.designSystem': string;
  'automations.proposals.target.skill': string;
  'automations.proposals.target.template': string;
  'automations.proposals.action.create': string;
  'automations.proposals.action.update': string;
  'automations.proposals.action.merge': string;
  'automations.proposals.action.move': string;
  'automations.proposals.action.delete': string;
  'automations.proposals.action.promote': string;

  'automations.templates.aria': string;
  'automations.templates.title': string;
  'automations.templates.sub': string;
  'automations.templates.filtersAria': string;
  'automations.templates.countMeta': string;
  'automations.templates.emptyTitle': string;
  'automations.templates.emptyHint': string;
  'automations.templates.useTemplate': string;
  'automations.templates.kind.orbit': string;
  'automations.templates.kind.liveArtifact': string;
  'automations.templates.kind.automation': string;
  'automations.templates.filter.all': string;
  'automations.templates.filter.orbit': string;
  'automations.templates.filter.liveArtifact': string;
  'automations.templates.filter.memory': string;
  'automations.templates.filter.designSystem': string;
  'automations.templates.filter.skills': string;
  'automations.templates.filter.connectors': string;
  'automations.templates.filter.compression': string;
  'automations.templates.filter.release': string;
  'automations.templates.filter.quality': string;

  'automations.static.memoryRefresh.title': string;
  'automations.static.memoryRefresh.description': string;
  'automations.static.memoryRefresh.defaultName': string;
  'automations.static.designSystemRefresh.title': string;
  'automations.static.designSystemRefresh.description': string;
  'automations.static.designSystemRefresh.defaultName': string;
  'automations.static.liveArtifactRegistry.title': string;
  'automations.static.liveArtifactRegistry.description': string;
  'automations.static.liveArtifactRegistry.defaultName': string;
  'automations.static.orbitDashboard.title': string;
  'automations.static.orbitDashboard.description': string;
  'automations.static.orbitDashboard.defaultName': string;
  'automations.static.releaseNotes.title': string;
  'automations.static.releaseNotes.description': string;
  'automations.static.releaseNotes.defaultName': string;
  'automations.static.qualityRegressionWatch.title': string;
  'automations.static.qualityRegressionWatch.description': string;
  'automations.static.qualityRegressionWatch.defaultName': string;

  'automations.fallback.orbitDaily.title': string;
  'automations.fallback.orbitDaily.description': string;
  'automations.fallback.orbitDaily.defaultName': string;
  'automations.fallback.liveStatusBoard.title': string;
  'automations.fallback.liveStatusBoard.description': string;
  'automations.fallback.liveStatusBoard.defaultName': string;

  'automations.modal.ariaEdit': string;
  'automations.modal.ariaNew': string;
  'automations.modal.placeholderTitle': string;
  'automations.modal.useTemplate': string;
  'automations.modal.close': string;
  'automations.modal.promptPlaceholder': string;
  'automations.modal.mention.aria': string;
  'automations.modal.mention.tabsAria': string;
  'automations.modal.mention.tab.all': string;
  'automations.modal.mention.tab.skills': string;
  'automations.modal.mention.tab.plugins': string;
  'automations.modal.mention.tab.mcp': string;
  'automations.modal.mention.tab.connectors': string;
  'automations.modal.mention.empty': string;
  'automations.modal.mention.noResults': string;
  'automations.modal.mention.section.skills': string;
  'automations.modal.mention.section.plugins': string;
  'automations.modal.mention.section.mcp': string;
  'automations.modal.mention.section.connectors': string;
  'automations.modal.selected.aria': string;
  'automations.modal.selected.remove': string;
  'automations.modal.selected.skill': string;
  'automations.modal.selected.plugin': string;
  'automations.modal.selected.mcp': string;
  'automations.modal.selected.connector': string;
  'automations.modal.selected.connectorWith': string;
  'automations.modal.error.title': string;
  'automations.modal.error.prompt': string;
  'automations.modal.cancel': string;
  'automations.modal.create': string;
  'automations.modal.creating': string;
  'automations.modal.save': string;
  'automations.modal.saving': string;
  'automations.modal.project.newEachRun': string;
  'automations.modal.project.newEachRunHint': string;
  'automations.modal.project.existing': string;
  'automations.modal.schedule.kind.hourly': string;
  'automations.modal.schedule.kind.daily': string;
  'automations.modal.schedule.kind.weekdays': string;
  'automations.modal.schedule.kind.weekly': string;
  'automations.modal.schedule.minute': string;
  'automations.modal.schedule.time': string;
  'automations.modal.schedule.timezone': string;
  'automations.modal.schedule.weekdayAria': string;
  'automations.modal.schedule.done': string;
}
