...
export interface Dict {
  ...
  'manualEdit.fill': string;
  'manualEdit.stroke': string;
  'manualEdit.order': string;
  'manualEdit.corners': string;
  'manualEdit.rotate': string;
  'manualEdit.shadow': string;
  'manualEdit.shadowNone': string;
  'manualEdit.sendBackward': string;
  'manualEdit.bringForward': string;
  'manualEdit.toFront': string;
  'manualEdit.toBack': string;
  'manualEdit.alignLeft': string;
  'manualEdit.alignCenterH': string;
  'manualEdit.alignRight': string;
  'manualEdit.alignTop': string;
  'manualEdit.alignCenterV': string;
  'manualEdit.alignBottom': string;
  'manualEdit.distributeH': string;
  'manualEdit.distributeV': string;
  'manualEdit.drawingTools': string;
  'manualEdit.toolSelect': string;
  'manualEdit.toolRect': string;
  'manualEdit.toolCircle': string;
  'manualEdit.toolText': string;
  'manualEdit.toolLine': string;
  'manualEdit.toolImage': string;
