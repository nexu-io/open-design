...
export interface Dict {
  ...
  'settings.modelSourceLocalConfig': string;
  ...
  'settings.modelPickerCliFallbackHint': string;
  'settings.modelPickerLocalConfigLiveHint': string;
  'settings.modelPickerLocalConfigFallbackHint': string;
  'settings.modelPickerUnsupportedCustomHint': string;
  'settings.modelPickerUnsupportedConfiguredHint': string;
  'settings.modelRefreshTitle': string;
