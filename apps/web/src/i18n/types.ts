...
export type Locale = 'en' | 'de' | 'zh-CN' | 'zh-TW' | 'pt-BR' | 'es-ES' | 'ru' | 'fa' | 'ar' | 'he' | 'ja' | 'ko' | 'pl' | 'hu' | 'fr' | 'uk';

export const LOCALES: Locale[] = ['en', 'de', 'zh-CN', 'zh-TW', 'pt-BR', 'es-ES', 'ru', 'fa', 'ar', 'he', 'ja', 'ko', 'pl', 'hu', 'fr', 'uk'];
