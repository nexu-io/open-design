...
export interface Dict {
  ...
  'chat.runError.title.auth': string;
  'chat.runError.title.balance': string;
  'chat.runError.title.connectionDropped': string;
  'chat.runError.title.rateLimit': string;
  'chat.runError.title.modelUnavailable': string;
  'chat.runError.title.promptTooLarge': string;
  'chat.runError.title.agentUnavailable': string;
  'chat.runError.title.processExit': string;
  'chat.runError.title.generic': string;
  'chat.runError.description.auth': string;
  'chat.runError.description.rateLimit': string;
  'chat.runError.description.useOfficialAgent': string;
  'chat.runError.description.rateLimitUseOfficialAgent': string;
  'chat.runError.description.upstreamUseOfficialAgent': string;
  'chat.runError.description.genericUseOfficialAgent': string;
  'chat.runError.description.promptTooLarge': string;
  'chat.runError.description.agentUnavailable': string;
  'chat.runError.description.processExit': string;
  'chat.runError.description.generic': string;
  'chat.runError.useOfficialAgentCta': string;
  'chat.runError.rawLabel': string;
  'chat.runError.rawExpand': string;
  'chat.runError.rawCollapse': string;
