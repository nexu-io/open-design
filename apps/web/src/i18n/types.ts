...
export interface Dict {
  ...
  'plugins.detail.copyPluginId': string;
  'plugins.detail.copyShareLink': string;
  'plugins.detail.copyMarkdownBadge': string;
  'plugins.detail.openSourceGithub': string;
  'plugins.detail.openSource': string;
  'plugins.detail.openHomepage': string;
  'plugins.detail.openMarketplace': string;
  'plugins.detail.sharePlugin': string;
  'plugins.detail.whatItProduces': string;
  'plugins.detail.exampleOutputsAria': string;
  'plugins.detail.openExampleNewTab': string;
  'plugins.detail.detailsAria': string;
  'plugins.detail.closeDetails': string;
  'plugins.detail.closeEsc': string;
  'plugins.detail.by': string;
  'plugins.detail.homepage': string;
  'plugins.detail.openIssueGithub': string;
  'plugins.detail.openContributePage': string;
  'plugins.detail.namedAuthorAvatar': string;
  'plugins.detail.authorAvatar': string;
  'plugins.detail.spec': string;
  'plugins.detail.designSpecOnly': string;
  'plugins.detail.pluginInfo': string;
  'plugins.detail.loadFailed': string;
  'plugins.detail.loading': string;
  'plugins.detail.applyFailed': string;
  'plugins.detail.trustMeta': string;
  'plugins.detail.sourceMeta': string;
  'plugins.detail.capabilities': string;
  'plugins.detail.capabilitiesNoneBefore': string;
  'plugins.detail.capabilitiesNoneAfter': string;
  'plugins.detail.connectors': string;
  'plugins.detail.required': string;
  'plugins.detail.optional': string;
  'plugins.detail.previewFrameTitle': string;
  'plugins.detail.examples': string;
  'plugins.detail.mayAskYou': string;
  'plugins.detail.persistsAt': string;
  'plugins.detail.useThisPlugin': string;
  'plugins.detail.appliedRedirected': string;
  'plugins.meta.author': string;
  'plugins.meta.about': string;
  'plugins.meta.exampleQuery': string;
  'plugins.meta.exampleQueryHint': string;
  'plugins.meta.inputs': string;
  'plugins.meta.inputsHint': string;
  'plugins.meta.requiredBadge': string;
  'plugins.meta.examplePrefix': string;
  'plugins.meta.defaultPrefix': string;
  'plugins.meta.contextBundles': string;
  'plugins.meta.contextBundlesHint': string;
  'plugins.meta.primaryBadge': string;
  'plugins.meta.craft': string;
  'plugins.meta.atoms': string;
  'plugins.meta.assets': string;
  'plugins.meta.mcpServers': string;
  'plugins.meta.claudePlugins': string;
  'plugins.meta.workflow': string;
  'plugins.meta.workflowHint': string;
  'plugins.meta.repeatBadge': string;
  'plugins.meta.onFailurePrefix': string;
  'plugins.meta.untilPrefix': string;
  'plugins.meta.genuiSurfaces': string;
  'plugins.meta.genuiSurfacesHint': string;
  'plugins.meta.capabilitiesHint': string;
  'plugins.meta.source': string;
  'plugins.meta.origin': string;
  'plugins.meta.path': string;
  'plugins.meta.version': string;
  'plugins.meta.trust': string;
  'plugins.meta.pinnedRef': string;
  'plugins.meta.marketplaceId': string;
  'plugins.meta.license': string;
  'plugins.meta.installed': string;
  'plugins.home.title': string;
  'plugins.home.subtitle': string;
  'plugins.home.empty': string;
  'plugins.home.browseRegistry': string;
  'plugins.home.count': string;
  'plugins.home.loading': string;
  'plugins.home.filtersAria': string;
  'plugins.home.modeAria': string;
  'plugins.home.featured': string;
  'plugins.home.catalogCount': string;
  'plugins.home.clearFilters': string;
  'plugins.home.noFilterMatches': string;
  'plugins.home.categoryFilterAria': string;
  'plugins.home.subcategoryFilterAria': string;
  'plugins.home.allInFacet': string;
  'plugins.home.searchPlaceholder': string;
  'plugins.home.searchAria': string;
  'plugins.home.clearSearchAria': string;
  'plugins.home.contributeTitle': string;
  'plugins.home.contributeBody': string;
  'plugins.home.starterPrefix': string;
  'plugins.home.createPlugin': string;
  'plugins.home.facet.import': string;
  'plugins.home.facet.create': string;
  'plugins.home.facet.export': string;
  'plugins.home.facet.share': string;
  'plugins.home.facet.deploy': string;
  'plugins.home.facet.refine': string;
  'plugins.home.facet.extend': string;
  'plugins.home.facet.fromFigma': string;
  'plugins.home.facet.fromGithub': string;
  'plugins.home.facet.fromCode': string;
  'plugins.home.facet.fromUrl': string;
  'plugins.home.facet.fromScreenshot': string;
  'plugins.home.facet.fromPdf': string;
  'plugins.home.facet.fromPptx': string;
  'plugins.home.facet.prototype': string;
  'plugins.home.facet.deck': string;
  'plugins.home.facet.designSystem': string;
  'plugins.home.facet.image': string;
  'plugins.home.facet.video': string;
  'plugins.home.facet.audio': string;
  'plugins.home.facet.publicLink': string;
  'plugins.home.facet.githubPr': string;
  'plugins.home.facet.pluginAuthoring': string;
  'plugins.home.starter.import': string;
  'plugins.home.starter.create': string;
  'plugins.home.starter.export': string;
  'plugins.home.starter.share': string;
  'plugins.home.starter.deploy': string;
  'plugins.home.starter.refine': string;
  'plugins.home.starter.extend': string;
  'plugins.card.details': string;
  'plugins.card.detailsAria': string;
  'plugins.card.use': string;
  'plugins.card.applying': string;
  'plugins.card.chooseUseAria': string;
  'plugins.card.useOptionsAria': string;
  'plugins.card.useWithQuery': string;
  'plugins.card.shareAria': string;
  'plugins.card.publish': string;
  'plugins.card.publishStarting': string;
  'plugins.card.publishAria': string;
  'plugins.card.publishTitle': string;
  'plugins.card.contribute': string;
  'plugins.card.contributeStarting': string;
  'plugins.card.contributeAria': string;
  'plugins.card.contributeTitle': string;
  'plugins.view.kicker': string;
  'plugins.view.title': string;
  'plugins.view.lede': string;
  'plugins.view.createPlugin': string;
  'plugins.view.importPlugin': string;
  'plugins.view.agentContext': string;
  'plugins.view.summaryAria': string;
  'plugins.view.statInstalled': string;
  'plugins.view.statAvailable': string;
  'plugins.view.statSources': string;
  'plugins.view.tabsAria': string;
  'plugins.view.tabInstalled': string;
  'plugins.view.tabInstalledHint': string;
  'plugins.view.tabAvailable': string;
  'plugins.view.tabAvailableHint': string;
  'plugins.view.tabSources': string;
  'plugins.view.tabSourcesHint': string;
  'plugins.view.tabTeam': string;
  'plugins.view.tabTeamHint': string;
  'plugins.view.loading': string;
  'plugins.view.installedTitle': string;
  'plugins.view.installedSubtitle': string;
  'plugins.view.installedEmpty': string;
  'plugins.view.sharePublishEyebrow': string;
  'plugins.view.sharePublishTitle': string;
  'plugins.view.sharePublishDescription': string;
  'plugins.view.sharePublishConfirm': string;
  'plugins.view.sharePublishStepProject': string;
  'plugins.view.shareStepCopySource': string;
  'plugins.view.sharePublishStepRun': string;
  'plugins.view.shareContributeEyebrow': string;
  'plugins.view.shareContributeTitle': string;
  'plugins.view.shareContributeDescription': string;
  'plugins.view.shareContributeConfirm': string;
  'plugins.view.shareContributeStepProject': string;
  'plugins.view.shareContributeStepRun': string;
  'plugins.view.shareConfirmAria': string;
  'plugins.view.actionPlugin': string;
  'plugins.view.forPlugin': string;
  'plugins.view.closeShareConfirmation': string;
  'plugins.view.shareWhatStarts': string;
  'plugins.view.shareSourcePlugin': string;
  'plugins.view.shareFactPlugin': string;
  'plugins.view.shareFactCopiedTo': string;
  'plugins.view.shareFactTrust': string;
  'plugins.view.shareActionPrompt': string;
  'plugins.view.starting': string;
  'plugins.view.warningCount': string;
  'plugins.view.installLog': string;
  'plugins.view.availableTitle': string;
  'plugins.view.availableSubtitle': string;
  'plugins.view.availableFiltersAria': string;
  'plugins.view.availableSearchAria': string;
  'plugins.view.availableSearchPlaceholder': string;
  'plugins.view.availableClearSearch': string;
  'plugins.view.clearSearch': string;
  'plugins.view.source': string;
  'plugins.view.allSources': string;
  'plugins.view.availableEmptyInstalledRemoved': string;
  'plugins.view.availableNoFilterMatches': string;
  'plugins.view.availableEmptyAddSource': string;
  'plugins.view.installing': string;
  'plugins.view.closeAvailableDetails': string;
  'plugins.view.about': string;
  'plugins.view.noDescription': string;
  'plugins.view.catalog': string;
  'plugins.view.catalogUrl': string;
  'plugins.view.license': string;
  'plugins.view.publisher': string;
  'plugins.view.homepage': string;
  'plugins.view.metadata': string;
  'plugins.view.tags': string;
  'plugins.view.sourcesTitle': string;
  'plugins.view.sourcesSubtitle': string;
  'plugins.view.sourceUrl': string;
  'plugins.view.defaultTrust': string;
  'plugins.view.addingSource': string;
  'plugins.view.addSource': string;
  'plugins.view.sourcesEmpty': string;
  'plugins.view.sourcePluginCount': string;
  'plugins.view.catalogVersion': string;
  'plugins.view.trustForSource': string;
  'plugins.view.refreshing': string;
  'plugins.view.refresh': string;
  'plugins.view.removing': string;
  'plugins.view.remove': string;
  'plugins.view.userPlugins': string;
  'plugins.view.importTitle': string;
  'plugins.view.closeImportDialog': string;
  'plugins.view.importSourceAria': string;
  'plugins.view.importFromGithub': string;
  'plugins.view.importFromGithubBody': string;
  'plugins.view.importUploadZip': string;
  'plugins.view.importUploadZipBody': string;
  'plugins.view.importUploadFolder': string;
  'plugins.view.importUploadFolderBody': string;
  'plugins.view.importSourceLabel': string;
  'plugins.view.importing': string;
  'plugins.view.import': string;
  'plugins.view.importSourceHelpBefore': string;
  'plugins.view.importSourceHelpAfter': string;
  'plugins.view.importZipBody': string;
  'plugins.view.noZipSelected': string;
  'plugins.view.importFolderBody': string;
  'plugins.view.folderFilesSelected': string;
  'plugins.view.noFolderSelected': string;
  'plugins.view.importFooter': string;
  'plugins.view.teamTitle': string;
  'plugins.view.teamBody': string;
  'pluginLoop.title': string;
  'pluginLoop.subtitle': string;
  'pluginLoop.activePlugin': string;
  'pluginLoop.clearActivePlugin': string;
  'pluginLoop.contextItemsResolved': string;
  'pluginLoop.placeholderActive': string;
  'pluginLoop.placeholderDefault': string;
  'pluginLoop.pressEnterToRun': string;
  'pluginLoop.typeSomethingToRun': string;
  'pluginLoop.run': string;
  'pluginLoop.plugins': string;
  'pluginLoop.installedCount': string;
  'pluginLoop.loadingPlugins': string;
  'pluginLoop.emptyNoPlugins': string;
  'pluginLoop.byAuthor': string;
  'pluginLoop.viewSource': string;
  'pluginLoop.reloadExampleQuery': string;
  'pluginLoop.useExampleQuery': string;
  'pluginLoop.pluginActive': string;
  'pluginLoop.usePlugin': string;
  'homeHero.title': string;
  'homeHero.subtitle': string;
  'homeHero.placeholderContext': string;
  'homeHero.placeholderDefault': string;
  'homeHero.mentionPlugins': string;
  'homeHero.mentionSkills': string;
  'homeHero.mentionMcp': string;
  'homeHero.contextResultsAria': string;
  'homeHero.contextSurfacesAria': string;
  'homeHero.loadingContext': string;
  'homeHero.noResults': string;
  'homeHero.searchHint': string;
  'homeHero.parameters': string;
  'homeHero.attachFiles': string;
  'homeHero.keyboardRun': string;
  'homeHero.keyboardNewLine': string;
  'homeHero.run': string;
  ...
  'homeHero.chip.fromFigmaHint': string;
  'homeHero.chip.fromFolderHint': string;
  'homeHero.chip.fromTemplateHint': string;
  ...
  'workspaceTabs.aria': string;
  'workspaceTabs.openWorkspaces': string;
  'workspaceTabs.showHiddenTabs': string;
  ...
  'paletteTweaks.aria': string;
  'paletteTweaks.title': string;
  'paletteTweaks.subtitle': string;
  'paletteTweaks.original': string;
  'paletteTweaks.coral': string;
  'paletteTweaks.electric': string;
  'paletteTweaks.acidForest': string;
  'paletteTweaks.risograph': string;
  'paletteTweaks.monoNoir': string;
  'context.emptyPluginContext': string;
  'context.kindSkill': string;
  'context.kindDesign': string;
  'context.kindCraft': string;
  'context.kindAsset': string;
  'context.kindMcp': string;
  'context.kindClaude': string;
  'context.kindAtom': string;
  'context.kindPlugin': string;
  'context.kindUnknown': string;
  'context.removeAria': string;
  'project.finalize.finalizing': string;
  'project.finalize.cancelAria': string;
  'project.finalize.package': string;
  'project.finalize.stale': string;
  'project.finalize.again': string;
  ...
  'settings.skillsFilterSource': string;
  'settings.skillsFilterType': string;
  'settings.skillsFilterCategory': string;
  'settings.skillsSourceUser': string;
  'settings.skillsSourceBuiltIn': string;
  'settings.skillsCollapse': string;
  'settings.skillsExpand': string;
  'settings.skillsCategoryTitle': string;
  'settings.skillsUserImported': string;
  'settings.skillsBuiltinEditWarning': string;
  'settings.skillsNamePlaceholder': string;
  'settings.skillsTriggersPlaceholder': string;
  'settings.skillsDescriptionPlaceholder': string;
  'settings.skillsBodyPlaceholder': string;
  ...
  'useEverywhere.dialogAria': string;
  'useEverywhere.kicker': string;
  'useEverywhere.title': string;
  'useEverywhere.subtitle': string;
  'useEverywhere.closeAria': string;
  'useEverywhere.tabsAria': string;
  'useEverywhere.handoffTitle': string;
  'useEverywhere.handoffBody': string;
  ...
  'useEverywhere.section.overview.bullet.cli': string;
  'useEverywhere.section.overview.bullet.mcp': string;
  'useEverywhere.section.overview.bullet.http': string;
  'useEverywhere.section.overview.bullet.skills': string;
  'useEverywhere.section.overview.bullet.artifacts': string;
  'useEverywhere.section.overview.snippet.start': string;
  'useEverywhere.section.overview.snippet.health': string;
  'useEverywhere.section.overview.snippet.ingest': string;
  ...
  'useEverywhere.section.cli.bullet.boot': string;
  'useEverywhere.section.cli.bullet.media': string;
  'useEverywhere.section.cli.bullet.run': string;
  'useEverywhere.section.cli.bullet.plugins': string;
  'useEverywhere.section.cli.bullet.registry': string;
  'useEverywhere.section.cli.bullet.doctor': string;
  'useEverywhere.section.cli.snippet.media': string;
  'useEverywhere.section.cli.snippet.run': string;
  'useEverywhere.section.cli.snippet.inventory': string;
  'useEverywhere.section.cli.snippet.seeded': string;
  'useEverywhere.section.cli.snippet.doctor': string;
  ...
  'useEverywhere.section.mcp.bullet.stdio': string;
  'useEverywhere.section.mcp.bullet.autodiscover': string;
  'useEverywhere.section.mcp.bullet.daemonUrl': string;
  'useEverywhere.section.mcp.bullet.dataDir': string;
  'useEverywhere.section.mcp.snippet.generic': string;
  'useEverywhere.section.mcp.snippet.installInfo': string;
  'useEverywhere.section.mcp.snippet.liveArtifacts': string;
  ...
  'useEverywhere.section.http.bullet.health': string;
  'useEverywhere.section.http.bullet.registries': string;
  'useEverywhere.section.http.bullet.projects': string;
  'useEverywhere.section.http.bullet.chat': string;
  'useEverywhere.section.http.bullet.plugins': string;
  'useEverywhere.section.http.bullet.agents': string;
  'useEverywhere.section.http.snippet.skills': string;
  'useEverywhere.section.http.snippet.project': string;
  'useEverywhere.section.http.snippet.stream': string;
  ...
  'useEverywhere.section.skills.bullet.discovery': string;
  'useEverywhere.section.skills.bullet.symlink': string;
  'useEverywhere.section.skills.bullet.declare': string;
  'useEverywhere.section.skills.bullet.headless': string;
  'useEverywhere.section.skills.bullet.seed': string;
  'useEverywhere.section.skills.snippet.minimal': string;
  'useEverywhere.section.skills.snippet.symlink': string;
  'useEverywhere.section.skills.snippet.list': string;
  'useEverywhere.section.skills.snippet.fixture': string;
  ...
  'newproj.importFolderPathEmpty': string;
  'newproj.importFolderFailed': string;
  ...
  'newproj.deleteTemplateNamed': string;
  ...
  'marketplace.emptyBeforeCommand': string;
  'marketplace.emptyAfterCommand': string;
  'marketplace.trustMeta': string;
  'marketplace.catalogsTitle': string;
  'marketplace.catalogsEmptyBeforeCommand': string;
  ...
  'integrations.comingSoon': string;
  'integrations.skillsTitle': string;
  'integrations.skillsBody': string;

  // Routines
  'routines.title': string;
  'routines.newRoutine': string;
  'routines.schedule': string;
  'routines.scheduleHourlyTab': string;
  'routines.scheduleDailyTab': string;
  'routines.scheduleWeekdaysTab': string;
  'routines.scheduleWeeklyTab': string;
  'routines.minuteOfEveryHour': string;
  'routines.time': string;
  'routines.timezone': string;
  'routines.scheduleHourlyDescription': string;
  'routines.scheduleDailyDescription': string;
  'routines.scheduleWeekdaysDescription': string;
  'routines.scheduleWeeklyDescription': string;
  'routines.weekdaySunShort': string;
  'routines.weekdayMonShort': string;
  'routines.weekdayTueShort': string;
  'routines.weekdayWedShort': string;
  'routines.weekdayThuShort': string;
  'routines.weekdayFriShort': string;
  'routines.weekdaySatShort': string;
  'routines.weekdaySun': string;
  'routines.weekdayMon': string;
  'routines.weekdayTue': string;
  'routines.weekdayWed': string;
  'routines.weekdayThu': string;
  'routines.weekdayFri': string;
  'routines.weekdaySat': string;
  'routines.loadingRuns': string;
  'routines.noRunsYet': string;
  'routines.triggerManual': string;
  'routines.triggerScheduled': string;
  'routines.openProjectTitle': string;
  'routines.openProject': string;
  'routines.pickProjectToReuse': string;
  'routines.updateFailed': string;
  'routines.createFailed': string;
  'routines.runFailed': string;
  'routines.deleteFailed': string;
  'routines.deleteConfirm': string;
  'routines.name': string;
  'routines.namePlaceholder': string;
  'routines.prompt': string;
  'routines.promptPlaceholder': string;
  'routines.project': string;
  'routines.createNewProjectEachRun': string;
  'routines.createNewProjectEachRunHint': string;
  'routines.reuseExistingProject': string;
  'routines.reuseExistingProjectHint': string;
  'routines.pickProject': string;
  'routines.saving': string;
  'routines.creating': string;
  'routines.emptyTitle': string;
  'routines.emptyBodyBefore': string;
  'routines.emptyBodyAfter': string;
  'routines.targetExistingProject': string;
  'routines.targetNewProjectEachRun': string;
  'routines.nextLabel': string;
  'routines.lastLabel': string;
  'routines.paused': string;
  'routines.runNow': string;
  'routines.pause': string;
  'routines.resume': string;
  'routines.hideHistory': string;
  'routines.history': string;
  'routines.deleteRoutineTitle': string;
  'routines.statusQueued': string;
  'routines.statusRunning': string;
  'routines.statusSucceeded': string;
  'routines.statusFailed': string;
  'routines.statusCanceled': string;
  ...
  'chat.tools.mcpSearchPlaceholder': string;
  'chat.tools.mcpSearchAria': string;
  'chat.tools.mcpNoServers': string;
  'chat.tools.mcpNoResults': string;
  'chat.tools.configured': string;
  'chat.tools.templates': string;
  'chat.tools.mcpInsertHint': string;
  'chat.tools.mcpAddTemplateTitle': string;
  'chat.tools.manageMcp': string;
  'chat.tools.skillsSearchPlaceholder': string;
  'chat.tools.skillsSearchAria': string;
  'chat.tools.skillsEmpty': string;
  'chat.tools.skillsNoResults': string;
  'chat.conversationsTitle': string;

  // GenUI inbox
  'genuiInbox.title': string;
  'genuiInbox.refresh': string;
  'genuiInbox.empty': string;
  'genuiInbox.respondedBy': string;
  'genuiInbox.revoke': string;
  'genuiInbox.status.pending': string;
  'genuiInbox.status.resolved': string;
  'genuiInbox.status.timeout': string;
  'genuiInbox.status.invalidated': string;

  // Tasks / automation preview
  'tasks.filter.all': string;
  'tasks.filter.scheduled': string;
  'tasks.filter.running': string;
  'tasks.filter.done': string;
  'tasks.orbit.title': string;
  'tasks.orbit.statusDaily': string;
  'tasks.orbit.statusPaused': string;
  'tasks.orbit.metaScheduled': string;
  'tasks.orbit.metaEnable': string;
  'tasks.orbit.previewLive': string;
  'tasks.orbit.previewNone': string;
  'tasks.orbit.triggerDaily': string;
  'tasks.orbit.triggerManual': string;
  'tasks.orbit.pattern': string;
  'tasks.orbit.runtime': string;
  'tasks.orbit.output': string;
  'tasks.orbit.artifactMetaEnabled': string;
  'tasks.orbit.artifactMetaPaused': string;
  'tasks.orbit.artifactBodyTitle': string;
  'tasks.orbit.artifactBodyChecked': string;
  'tasks.orbit.artifactBodyHighlights': string;
  'tasks.kicker': string;
  'tasks.title': string;
  ...
  'tasks.primitive.orbit.manual': string;
  ...
  'chat.plugins.sourceAria': string;
  'chat.plugins.official': string;
  'chat.plugins.mine': string;
  'chat.plugins.officialTitle': string;
  'chat.plugins.mineTitle': string;
  'chat.plugins.emptyInstalled': string;
  'chat.plugins.emptyNoResults': string;
  'chat.plugins.emptyNoAvailable': string;
  'chat.mentionSurfacesAria': string;
  'chat.mentionSearchHint': string;
  'chat.mentionUseMcp': string;
  ...
  'fileViewer.picker': string;
  'fileViewer.pickerTitle': string;
  'fileViewer.pods': string;
  'fileViewer.podsTitle': string;
  'fileViewer.inspect': string;
  'fileViewer.closeInspect': string;
  'fileViewer.closeInspectHint': string;
  'fileViewer.inspectColors': string;
  'fileViewer.inspectTypography': string;
  'fileViewer.inspectSpacingShape': string;
  'fileViewer.inspectAncestorClicked': string;
  'fileViewer.inspectAncestorNoAnnotationBefore': string;
  'fileViewer.inspectAncestorNoAnnotationAfter': string;
  'fileViewer.inspectAncestorInstead': string;
  'fileViewer.inspectNoTargetsBefore': string;
  'fileViewer.inspectNoTargetsAfter': string;
  'fileViewer.inspectClickBefore': string;
  'fileViewer.inspectClickAfter': string;
  'fileViewer.inspectActionInspect': string;
  'fileViewer.inspectActionComment': string;
  'fileViewer.inspectActionTune': string;
  'fileViewer.inspectActionLeaveComment': string;
  ...
  'liveArtifact.refresh.eventCreated': string;
  'liveArtifact.refresh.eventUpdated': string;
  'liveArtifact.refresh.eventDeleted': string;
