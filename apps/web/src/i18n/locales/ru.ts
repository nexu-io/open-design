...
export const ru: Dict = {
  ...
  'chat.runError.description.useOfficialAgent': 'Выбранный агент не вошел в систему. Используйте официальный агент Open Design для более стабильного и выгодного запуска или повторите попытку с текущим агентом.',
  'chat.runError.description.rateLimitUseOfficialAgent': 'Текущая модель или провайдер достигли лимита квоты или частоты запросов. Повторите попытку позже или используйте агент Open Design для более стабильного и выгодного запуска.',
  'chat.runError.description.upstreamUseOfficialAgent': 'Провайдер модели временно недоступен. Повторите попытку позже или используйте агент Open Design для более стабильного и выгодного запуска.',
  'chat.runError.description.genericUseOfficialAgent': 'Не удалось выполнить задачу. Повторите попытку позже или используйте агент Open Design для более стабильного и выгодного запуска.',
