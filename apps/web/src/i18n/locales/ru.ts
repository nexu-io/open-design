...
export const ru: Dict = {
  ...
  'settings.agentInventoryTitle': 'Установлено в {client}',
  'settings.agentInventoryRefresh': 'Обновить',
  'settings.agentInventoryLoading': 'Загрузка установленных MCP-серверов и навыков…',
  'settings.agentInventoryError': 'Не удалось загрузить инвентарь этой CLI ({error}).',
  'settings.agentInventoryUnsupported': 'Определение инвентаря для {client} пока недоступно.',
  'settings.agentInventoryUnavailable': 'Конфигурация {client} не обнаружена.',
  'settings.agentInventoryEmpty': 'Для {client} не обнаружены установленные MCP-серверы или навыки.',
  'settings.agentInventoryMcpServers': 'MCP-серверы',
  'settings.agentInventorySkills': 'Навыки',
  'settings.agentInventoryNoMcpServers': 'MCP-серверы не обнаружены.',
  'settings.agentInventoryNoSkills': 'Навыки не обнаружены.',
  'settings.agentInventorySourceUser': 'Пользователь',
