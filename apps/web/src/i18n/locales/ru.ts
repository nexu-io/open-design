...
export const ru: Dict = {
  ...
  'chat.dsExtractUser': "Извлечь дизайн-систему из {source}",
  'chat.dsExtractRunning': "Извлекаем дизайн-систему…",
  'chat.dsExtractDone': "{name} извлечена — все модули готовы.",
  'chat.dsNextStepsTitle': "Следующие шаги",
  'chat.dsMoreToggle': "Больше оптимизаций",
  ...
  'ds.fullSystemLabel': 'Полная система {name}',
