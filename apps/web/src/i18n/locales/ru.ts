...
export const ru: Dict = {
  ...
  'settings.mediaProviderConnectionConnected': "Подключено",
  'settings.mediaProviderConnectionDisconnected': "Не подключено",
  'settings.mediaProviderConnectionConnectedTitle': "Локальный вход Codex CLI работает",
  'settings.mediaProviderConnectionDisconnectedTitle': "Локальный вход Codex CLI не обнаружен",
  'settings.mediaProviderConnectionConnectedNote': "Локальный вход Codex CLI работает",
  'settings.mediaProviderConnectionDisconnectedNote': "Войдите через локальный Codex CLI, чтобы использовать этого провайдера",
  ...
  'settings.projectLocationsManualPlaceholder': "Введите путь к папке",
  'settings.projectLocationsBrowseFolders': "Обзор папок",
  'settings.projectLocationsBrowserDialogLabel': "Выберите расположение проекта",
  'settings.projectLocationsBrowserTitle': "Выберите папку",
  'settings.projectLocationsBrowserLoading': "Загрузка папок...",
  'settings.projectLocationsBrowserParentFolder': "Родительская папка",
  'settings.projectLocationsBrowserUseFolder': "Использовать эту папку",
  'settings.projectLocationsBrowserLoadError': "Не удалось загрузить папки. Введите путь к папке вручную.",
  'settings.projectLocationsBrowserEmpty': "Здесь нет вложенных папок.",
  ...
  'ds.contentsLabel': "Содержание",
  'ds.contentsAriaLabel': "Содержание дизайн-системы",
