...
export const tr: Dict = {
  ...
  'settings.desktopHint': 'Configure desktop app behavior.',
  'settings.autoLaunch': 'Start at Login',
  'settings.autoLaunchHint': 'Automatically start Open Design when you log in.',
  'settings.network': 'Network',
  'settings.networkHint': 'Configure how the daemon binds to network interfaces.',
  'settings.networkRequiresDaemon': 'Connect to a running daemon to configure network settings.',
  'settings.networkWarning': 'Network exposure enabled',
  'settings.networkWarningHint': 'The daemon is accessible from your network. Enable API key authentication and set an IP allowlist.',
  'settings.bindHost': 'Bind Address',
  'settings.bindHostHint': '127.0.0.1 = localhost only. 0.0.0.0 = all network interfaces.',
  'settings.port': 'Port',
  'settings.portHint': 'TCP port the daemon listens on. Default: 7456.',
  'settings.allowedHosts': 'Allowed Hosts',
  'settings.allowedHostsHint': 'Comma-separated IPs or CIDR ranges allowed to connect. Empty = all.',
  'settings.apiKeys': 'API Keys',
  'settings.apiKeysHint': 'Keys required for non-local connections when network exposure is on.',
  'settings.revoke': 'Revoke',
  'settings.newApiKey': 'New API Key',
  'settings.newApiKeyHint': 'Copy this key now. It will not be shown again.',
  'settings.keyLabel': 'Label (optional)',
