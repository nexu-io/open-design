...
export const tr: Dict = {
  ...
  'chat.amrCard.switchBody': 'Marketing AX\'ın resmi AMR model hizmetine geçin — API anahtarı yapılandırması gerekmez. Oturum açma, yetkilendirme ve bakiye yükleme sonrası bu çalıştırma otomatik olarak yeniden denenir.',
  ...
  'settings.onboardingCreateBody': 'İstediğiniz siteyi, uygulamayı, sunumu, görseli veya videoyu tanımlayın. Marketing AX bir proje oluşturacak ve çalışmayı düzenlenebilir tutacak.',
  ...
  'settings.agentInstall.pathHint': 'Bir CLI\'yi npm veya Homebrew ile kurduysan ancak hâlâ kurulu değil olarak görünüyorsa, aracın bin dizininin Marketing AX daemon\'unun devraldığı PATH içinde olduğundan emin ol (macOS\'te Terminal ve GUI uygulamalarının PATH\'i farklı olabilir). QUICKSTART.md içindeki "Local agent CLI and PATH" bölümüne bak.',
  'settings.agentInstall.stepOpenLinks': 'Tercih ettiğin ajan için Yükle veya Dokümanlar bağlantısını aç.',
  'settings.agentInstall.stepAuth': 'Marketing AX\'a dönmeden önce sağlayıcı CLI\'sinde kimlik doğrulaması yap (oturum aç veya API kimlik bilgileri ekle).',
  ...
  'settings.amrCloud': 'Marketing AX AMR',
  ...
  'settings.mcpServerHint': 'Marketing AX\'ı kodlama ajanınız için MCP sunucusu olarak yayınlayın.',
  ...
  'settings.privacyHint': 'Marketing AX ekibiyle hangi veriler paylaşılır',
  'settings.privacyConsentKicker': 'Marketing AX\'ı geliştirmemize yardımcı olun',
  'settings.privacyConsentLead': 'Marketing AX, geliştirmemize yardımcı olmak için kullanım verilerini ekibimizle paylaşabilir. Buna şunlar dahildir:',
  ...
  'settings.mcpHint': 'Kodlama agent\'larının (Cursor, Claude Code, VS Code…) Marketing AX projelerinizi doğrudan okumasına izin verin.',
  'settings.mcpDaemonError': 'Kurulum yollarını çözümlemek için yerel daemon\'a ulaşılamadı ({error}). Marketing AX\'ın çalıştığından emin olun, ardından bu paneli yeniden açın.',
  'settings.mcpBuildDaemon': 'Önce daemon\'ı derleyin.',
  'settings.mcpNodeMissing': 'Node ikili dosyası eksik.',
  'settings.mcpBuildHint': 'apps/daemon/dist/cli.js eksik. `pnpm --filter @marketing-ax/daemon build` komutunu çalıştırın ve yenileyin.',
  ...
  'settings.mcpCapabilityDefault': 'Marketing AX\'da açık olan projeyi ve dosyayı varsayılan olarak kullanın; böylece hangi tasarım olduğunu yeniden belirtmeden "bunu uygulamamda oluştur" diyebilirsiniz.',
  'settings.mcpRunningNote': 'MCP araç çağrılarının başarılı olması için Marketing AX\'ın çalışıyor olması gerekir. Kodlama agent\'ınızı Marketing AX\'ı açmadan önce başlattıysanız, canlı daemon\'a ulaşabilmesi için agent\'ı yeniden başlatın.',
  ...
  'entry.discordAria': 'Marketing AX Discord\'una katılın',
  'entry.discordAriaWithOnline': 'Marketing AX Discord\'una katılın - {online}',
  ...
  'entry.navBrands': 'Markalar',
  'entry.navIntegrations': 'Entegrasyonlar',
  'brands.empty': 'Henüz kayıtlı marka yok.',
  'brands.back': 'Geri',
  'brands.core': 'Marka özü',
  'brands.loadFailed': 'Bu marka yüklenemedi.',
  'brands.pageTitle': 'Markalar',
  'brands.pageSubtitle': 'Her markanın bağlamını ve tasarım sistemini kaydedin, ardından projeler oluşturun.',
  'brands.sectionContext': 'Marka bağlamı',
  'brands.sectionDesignSystem': 'Tasarım sistemi',
  'brands.sectionDocs': 'Bilgi dokümanları',
  'brands.docsHint': 'Marka özü ve her kanalın uzmanlık dokümanı (.md) run’lara enjekte edilir. Görüntülemek için bir doküman seçin.',
  'brands.fieldTagline': 'Slogan',
  'brands.fieldWebsite': 'Web sitesi',
  'brands.fieldAudience': 'Ana kitle',
  'brands.fieldKeyMessage': 'Anahtar mesaj',
  'brands.fieldAvoid': 'Kaçınılması gerekenler',
  'brands.fieldChannels': 'Kanallar',
  'brands.palette': 'Renk paleti',
  'brands.typography': 'Tipografi',
  'brands.voiceTone': 'Ses ve ton',
  'brands.coreDocLabel': 'Marka özü',
  'brands.projectCount': '{n} proje',
  'brands.paletteChannelMeta': '{c} renk · {n} kanal kayıtlı',
  'brands.newButton': '+ Yeni marka',
  'brands.newTitle': 'Yeni marka',
  'brands.newFieldTitle': 'Ad',
  'brands.newFieldId': 'ID',
  'brands.newFieldIdHint': 'Addan otomatik önerilir — küçük harf, rakam ve tire.',
  'brands.newSubmit': 'Oluştur',
  'brands.newDuplicateId': 'Bu ID’ye sahip bir marka zaten var.',
  'brands.newFailed': 'Marka oluşturulamadı.',
  'brands.edit': 'Düzenle',
  'brands.save': 'Kaydet',
  'brands.cancel': 'İptal',
  'brands.saveFailed': 'Değişiklikler kaydedilemedi.',
  'brands.fieldSubtitle': 'Alt başlık',
  'brands.fieldToneLabel': 'Ton etiketi',
  'brands.fieldTypographyFamily': 'Yazı tipi ailesi',
  'brands.fieldTypographyRoles': 'Yazı tipi rolleri',
  'brands.fieldTypographyWeights': 'Yazı tipi kalınlıkları',
  'brands.fieldNeutralPalette': 'Nötr palet',
  'brands.fieldCommaHint': 'Birden fazla değeri virgülle ayırın.',
  'brands.docEdit': 'Dokümanı düzenle',
  'brands.docSaveFailed': 'Doküman kaydedilemedi.',
  'brands.channelAdd': '+ Kanal',
  'brands.channelAddKey': 'Anahtar',
  'brands.channelAddKeyHint': 'Küçük harf, rakam ve tire — prompt enjeksiyon anahtarı olarak kullanılır.',
  'brands.channelAddLabel': 'Etiket',
  'brands.channelAddDesignSystem': 'Tasarım sistemi',
  'brands.channelAddSubmit': 'Ekle',
  'brands.channelAddFailed': 'Kanal eklenemedi.',
  'brands.channelRemove': 'Kanalı kaldır',
  'brands.channelRemoveConfirm': '{key} kanalı kaldırılsın mı? Uzmanlık dokümanı da silinecek.',
  'brands.channelRemoveFailed': 'Kanal kaldırılamadı.',
  'brands.uploadIcon': 'Simge yükle',
  'brands.uploadLogo': 'Logo yükle',
  'brands.uploadFailed': 'Görsel yüklenemedi.',
  'brands.uploadTooLarge': 'Dosya çok büyük.',
  'brands.deleteZone': 'Tehlike bölgesi',
  'brands.delete': 'Markayı sil',
  'brands.deleteConfirm': '{title} markası silinsin mi? Bu işlem geri alınamaz.',
  'brands.deleteBlocked': 'Bu markayı kullanan {n} proje var. Önce o projeleri silin.',
  'brands.deleteFailed': 'Marka silinemedi.',
  ...
  'homeHero.chip.brazeIam': 'Braze IAM',
  'homeHero.chip.naverBlog': 'Naver Blog',
  'homeHero.chip.cardnewsInstagram': 'Card News',
  ...
  'homeHero.chip.brazeIamHint': 'Author a Braze Custom-HTML in-app message: interview → plan → confirm → A/B HTML variants.',
  'homeHero.chip.naverBlogHint': 'Author a Naver SmartEditor blog post: interview → research → plan → confirm → paste-ready HTML.',
  'homeHero.chip.cardnewsInstagramHint': 'Author an Instagram card-news set: topic → interview → plan confirm → 1080×1350 PNG cards + caption.',
  'homeHero.chip.createPluginHint': 'Yeniden kullanılabilir bir Marketing AX plugin\'i oluşturun ve Plugin\'lerim\'e ekleyin.',
  ...
  'handoff.promptIntro': 'Bu yerel Marketing AX proje klasöründen devam edin:',
  ...
  'pluginsHome.subtitle': 'Bu çalışma zamanıyla birlikte gelen, kullanıma hazır Marketing AX iş akışları. Başlangıç istemi yüklemek için birini seçin veya daha fazlası için kayıt defterine göz atın.',
  ...
  'pluginsHome.emptyCatalog': 'Katalog boş. Paketlenmiş eklentiler Marketing AX ile birlikte gelir ve buraya otomatik olarak görünmelidir — bu durum devam ederse daemon\'u yeniden başlatmayı deneyin.',
  ...
  'pluginCard.contributeAria': '{title} öğesini Marketing AX\'a katkı olarak ekle',
  'pluginCard.contributeTitle': 'Plugin\'i pull request ile Marketing AX\'a katkı olarak ekle',
  ...
  'integrations.lede': 'Harici sistemleri bağlayın, MCP araçlarını agent döngünüze dahil edin ve Marketing AX\'ı diğer IDE\'ler, betikler ve otomasyonlardan kullanın.',
  ...
  'mcpClient.daemonError': 'Yerel daemon\'a ulaşılamadı. Marketing AX\'ın çalıştığından emin olun, ardından bu paneli yeniden açın.',
  'mcpClient.saveFailed': 'Kaydetme başarısız oldu. Daemon\'ın çalıştığını kontrol edip tekrar deneyin.',
  'useEverywhere.modalAria': 'Marketing AX\'ı her yerde kullanın',
  'useEverywhere.modalTitle': 'Marketing AX\'ı her yerde kullanın',
  'useEverywhere.modalSubtitle': 'Marketing AX\'ı herhangi bir IDE\'ye, Agent\'a veya betiğe bırakın — CLI, HTTP, MCP ve Beceriler. Her şeyi kurmak için "Bir agent için kılavuzu kopyala"yı kullanın ve Claude Code, Codex, Cursor, openclaw veya hermes\'e yapıştırın.',
  ...
  'useEverywhere.section.overview.heading': 'Marketing AX, agent\'ınızın çalıştığı her yerde çalışır',
  'useEverywhere.section.overview.intro': 'Marketing AX bir pencereden fazlasıdır — yerel ayrıcalıklı bir daemon (`od`) ile birlikte bir Beceriler + Tasarım Sistemleri + Atoms kayıt defteridir. Makinenizde çalışmaya başladığında, herhangi bir kod agent\'ı (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, kendi betiğiniz) dört değiştirilebilir yüzey aracılığıyla üretimleri yönetebilir, projeleri inceleyebilir ve tasarım çıktıları üretebilir.',
  'useEverywhere.section.overview.bullet1': 'CLI — başsız betikler, CI ve kabuk otomasyonu için `od <command>`.',
  'useEverywhere.section.overview.bullet2': 'MCP sunucusu — Marketing AX\'ı bir Model Context Protocol sunucusu olarak bağlar, böylece MCP destekli herhangi bir agent becerileri listeleyebilir, senaryoları çalıştırabilir ve çıktıları okuyabilir.',
  ...
  'useEverywhere.section.overview.bullet4': 'Beceriler — PATH\'inizde zaten bulunan herhangi bir agent\'ın Marketing AX olmadan çağırabileceği eklenebilir `SKILL.md` paketleri (Claude uyumlu).',
  ...
  'useEverywhere.section.cli.heading': 'Marketing AX\'ı herhangi bir kabuktan yönetin',
  ...
  'useEverywhere.section.mcp.heading': 'Marketing AX\'ı herhangi bir kodlama agent\'ına MCP sunucusu olarak sun',
  'useEverywhere.section.mcp.intro': 'Marketing AX, MCP destekli herhangi bir istemcinin — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — Marketing AX araçlarını (becerileri listele, önizlemeleri oluştur, medya üret, eklentileri çalıştır) manuel olarak kabuk açmadan keşfetmesini sağlayan bir Model Context Protocol sunucusu (`od mcp`) ile gelir. Daemon, her büyük istemci için `GET /api/mcp/install-info` aracılığıyla yapıştırmaya hazır bir kurulum parçacığı yayınlar.',
  ...
  'useEverywhere.section.mcp.bullet4': '`MAX_DATA_DIR` değerini sabitler, böylece oluşturulan MCP süreci daemon\'ın zaten kullandığı yere yazar (paketlenmiş macOS uygulama paketlerinde EPERM\'i önler).',
  ...
  'useEverywhere.section.mcp.footer': 'Marketing AX uygulamasında, JSON\'u elle düzenlemek yerine istemciye özel bir kurulum komutu (Cursor, Claude Code, Antigravity, VS Code) kopyalamak için Ayarlar → Entegrasyonlar\'ı açın.',
  ...
  'useEverywhere.section.http.footer': 'Her istek/yanıt için saf TypeScript türleri `@marketing-ax/contracts` içinde bulunur — bir oluşturucu bağlamadan tam otomatik tamamlama için bunları betiğinize aktarın.',
  'useEverywhere.section.skills.tab': 'Skill\'ler ve başsız',
  'useEverywhere.section.skills.heading': 'Herhangi bir agent için eklenebilir Beceriler — Marketing AX çalışmıyor olsa bile',
  'useEverywhere.section.skills.intro': 'Bir Beceri, Claude uyumlu bir `SKILL.md` (YAML ön bilgisi + gövde) içeren bir dizindir. Marketing AX, formatı `od:` ad alanıyla (`mode`, `preview`, `design_system`, `inputs`, …) genişletir, böylece aynı çıktı hem Marketing AX içinde hem de Claude Code, Codex, openclaw veya hermes gibi sade bir agent tarafından kullanılabilir. Keşif, projelerin kendi becerilerini geçersiz kılabilmesi için bir öncelik zincirini izler.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude uyumlu ön bilgi + Marketing AX ekstraları)',
  ...
  'entry.githubStarAria': 'Marketing AX’a GitHub üzerinde yıldız ver',
  ...
  'newproj.locationDefault': 'Marketing AX projeleri',
  ...
  'ds.detailLoadFailed': 'Bu tasarım sistemi yüklenemedi.',
  'ds.back': 'Geri',
  'ds.detailLoading': 'Tasarım sistemi yükleniyor…',
  'ds.detailLoadingHint': 'İnceleme çalışma alanı açılıyor.',
  ...
  'socialShare.openDesignSection': 'Marketing AX\'ı paylaş',
  'socialShare.openDesignTitle': 'GitHub\'da Marketing AX',
  'socialShare.openDesignText': 'Marketing AX; tasarım yapıtları oluşturmak, düzenlemek, dağıtmak ve devretmek için açık kaynaklı bir çalışma alanıdır.',
  'socialShare.openDesignCopyText': '{text}\n{url}',
  'socialShare.projectSection': 'SOSYAL PAYLAŞIM',
  'socialShare.projectTitle': '{title} · Marketing AX',
  'socialShare.projectText': 'Marketing AX ile oluşturuldu: {title}. Dağıtılan yapıtı görüntüleyin ve depoya yıldız verin: {repo}',
  'socialShare.projectCopyText': 'Marketing AX ile oluşturuldu: {title}\n{url}\nMarketing AX deposu: {repo}',
  ...
  'chat.activeFilePlaceholder': 'Marketing AX\'dan {file} dosyasını değiştirmesini isteyin...',
  ...
  'chat.mode.design.solves': 'Marketing AX’ın dosya üretmesini, workspace’i güncellemesini veya brief’i çok modlu deliverable’lara dönüştürmesini istediğinizde kullanın.',
  ...
  'preview.shareTextDefault': 'Marketing AX şablonu: {title}',
  ...
  'preview.errorBody': 'Örnek HTML\'i alınamadı. Marketing AX\'ın çalıştığından emin olup tekrar deneyin.',
  ...
  'fileViewer.openFolder': 'Proje klasörünü aç',
  'fileViewer.openFolderFailed': 'Proje klasörü açılamadı.',
  'fileViewer.openFolderWebFallback': 'Klasör tarayıcıdan açılamaz. Yol:',
  'fileViewer.copyCaption': 'Açıklamayı kopyala',
  'fileViewer.copyCaptionDone': 'Açıklama panoya kopyalandı',
  'fileViewer.copyCaptionFailed': 'Açıklama kopyalanamadı.',
  ...
  'assistant.shareToOpenDesign': 'Marketing AX\'a paylaş',
  ...
  'pet.tabBuiltInHint': 'Marketing AX ile gelen seçili dostlar — birini seç ve sahiplen.',
  ...
  'pet.codexBundledTitle': 'Marketing AX ile birlikte gelir — indirme gerekmez.',
  ...
  'settings.projectLocationsDescription': 'Birden fazla Marketing AX proje klasörü içerebilen çalışma tabanları ekleyin. Yeni projeler seçilen tabanın içinde bir klasör olarak kaydedilir.',
  ...
  'settings.defaultRouter.title': 'Varsayılan yönlendirici',
  'settings.defaultRouter.description': 'Hiçbir tetikleyiciyle eşleşmeyen serbest istemleri işleyen yönlendirici eklentisi.',
  'settings.defaultRouter.builtin': 'Yerleşik (Default design router)',
  ...
  'settings.memoryStarterProjectDesc': 'Marketing AX v0.5 — sohbet odaklı tasarım editörü',
  ...
  'updater.availableBody': 'Marketing AX {version} mevcut. Yükleyici açılmadan önce indirilecek.',
  ...
  'updater.installerOpenBody': 'Yükleyici açık. Güncellemeyi tamamlayabilmeniz için Marketing AX kapatılıyor.',
  ...
  'updater.payloadReadyGeneric': 'A new Marketing AX update is ready. Marketing AX will close and restart automatically.',
  'updater.payloadReadyVersion': 'Marketing AX {version} is ready. Marketing AX will close and restart automatically.',
  'updater.quitButton': 'Marketing AX’dan çık',
  'updater.quitFailedBody': 'Yükleyici açık, ancak Marketing AX kapatılamadı. Uygulamayı değiştirmeden önce Marketing AX’dan çıkın.',
  'updater.quitFailedTitle': 'Çıkılamadı',
  'updater.quitting': 'Çıkılıyor...',
  'updater.ready': 'Güncelleme hazır',
  'updater.readyGeneric': 'Yeni bir sürüm hazır. Marketing AX kapanıp yükleyiciyi açacak.',
  'updater.readyVersion': 'Marketing AX {version} hazır. Marketing AX kapanıp yükleyiciyi açacak.',
  ...
  'dsManager.createBody': 'Marketing AX\'a markanızı, ürününüzü, kodunuzu, varlıklarınızı ve tasarım referanslarınızı öğretin.',
  ...
  'settings.customInstructionsDesc': 'Marketing AX\'ın her sohbette izlediği sabit yönergeler. Bunlar kayıtlı bellekler değildir; gerçekler, tercihler ve proje bağlamı için Bellek\'i kullanın.',
  ...
  // Braze IAM panel
  'braze.title': 'Braze IAM',
  'braze.eyebrow': 'In-app message authoring',
  'braze.lede': 'Monitor and manage Braze in-app message creative work for the selected project.',
  'braze.loading': 'Loading',
  'braze.error': 'Failed to load Braze messages',
  'braze.emptyTitle': 'No Braze messages yet',
  'braze.emptyBody': 'Start a Braze IAM session from the chat to create your first message.',
  'braze.pickProject': 'Select a project',
  'braze.pickProjectLabel': 'Project',
  'braze.messageCount': '{n} message',
  'braze.variantCount': '{n} variant',
  'braze.updatedAt': 'Updated {when}',
  'braze.openDetail': 'Open message detail',
  'braze.closeDetail': 'Close detail',
  'braze.deleteAria': 'Delete message',
  'braze.deleteTitle': 'Delete this Braze message',
  'braze.deleteConfirm': 'Delete this message? All variants and plan data will be removed.',
  'braze.deleting': 'Deleting…',
  'braze.planSummaryTitle': 'Summary',
  'braze.planEmphasisTitle': 'Emphasis',
  'braze.planTargetingTitle': 'Targeting',
  'braze.planCtaTitle': 'CTA',
  'braze.planVariantsTitle': 'Plan variants',
  'braze.variantsTitle': 'Produced variants',
  'braze.variantOpenAria': 'Open variant in viewer',
  'braze.awaitingAnswerHint': 'Awaiting your answer in the Questions tab',
  'braze.status.interviewing': 'Interviewing',
  'braze.status.plan_draft': 'Plan draft',
  'braze.status.plan_confirmed': 'Plan confirmed',
  'braze.status.producing': 'Producing',
