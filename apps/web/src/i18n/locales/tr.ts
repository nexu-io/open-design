...
export const tr: Dict = {
  ...
  'permission.approve.once': 'Approve',
  'permission.approve.session': 'Approve for this session',
  'permission.approve.always': 'Always approve',
  'permission.deny': 'Deny',
  'permission.expiresIn': 'Auto-denies in {s}s',
  'permission.expired': 'Timed out — denied',
  'permission.resolvedApproved': 'Approved: {choice}',
  'permission.resolvedDenied': 'Denied',
  'permission.sending': 'Sending…',
  'permission.notFound': 'This run no longer exists.',
  'permission.conflict': 'Already answered.',
  'permission.error': "Couldn't send your answer. Try again.",
