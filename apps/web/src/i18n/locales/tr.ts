...
export const tr: Dict = {
  ...
  'settings.agentInventoryTitle': '{client} içinde yüklü',
  'settings.agentInventoryRefresh': 'Yenile',
  'settings.agentInventoryLoading': 'Yüklü MCP sunucuları ve yetenekler yükleniyor…',
  'settings.agentInventoryError': 'Bu CLI envanteri yüklenemedi ({error}).',
  'settings.agentInventoryUnsupported': '{client} için envanter algılama henüz kullanılamıyor.',
  'settings.agentInventoryUnavailable': '{client} yapılandırması algılanmadı.',
  'settings.agentInventoryEmpty': '{client} için yüklü MCP sunucusu veya yetenek algılanmadı.',
  'settings.agentInventoryMcpServers': 'MCP sunucuları',
  'settings.agentInventorySkills': 'Yetenekler',
  'settings.agentInventoryNoMcpServers': 'MCP sunucusu algılanmadı.',
  'settings.agentInventoryNoSkills': 'Yetenek algılanmadı.',
  'settings.agentInventorySourceUser': 'Kullanıcı',
