...
export const tr: Dict = {
  ...
  'settings.onboardingConnectTitle': 'Bir çalışma ortamı seçin',
  ...
  'settings.onboardingLocalTitle': 'Yerel kodlama ajanı',
  'settings.onboardingLocalBody': 'Claude Code, Codex, Cursor, Gemini veya OpenCode gibi sisteminizde yüklü bir CLI aracını kullanın.',
  'settings.onboardingLocalAction': 'CLI ayarlarını aç',
  'settings.onboardingCliScanHint': 'Bu işlem genellikle 5-10 saniye sürer.',
  'settings.onboardingByokTitle': 'Kendi anahtarınızı getirin (BYOK)',
  'settings.onboardingByokBody': 'Kendi yapay zeka model sağlayıcı kimlik bilgilerinizi kullanın.',
  ...
  'settings.onboardingDesignIntroGenerateTitle': 'Mevcut çalışmalardan üretin',
  ...
  'settings.onboardingDesignIntroReuseTitle': 'Gelecek çalışmalarda yeniden kullanın',
  'settings.onboardingDesignIntroReuseBody': 'Gelecekteki prototipler, sunumlar ve diğer içerikler mevcut yazı tiplerinizi, boşluklarınızı, logo stilinizi ve renk tonunuzu referans alabilir.',
  'settings.onboardingDesignIntroSkipTitle': 'Şimdilik isteğe bağlı',
  'settings.onboardingDesignIntroSkipBody': 'Bir tasarım sistemi oluşturmadan başlamak istiyorsanız bu adımı atlayın.',
  'settings.onboardingGithubTitle': 'GitHub\'dan İçe Aktar',
  'settings.onboardingGithubBody': 'Bir ön uç (frontend) deposu kullanın.',
  'settings.onboardingUploadTitle': 'Yerel dosyaları yükleyin',
  'settings.onboardingUploadBody': 'Proje dosyaları, ekran görüntüleri, CSS, belgeler veya varlıklar ekleyin.',
  'settings.onboardingPromptTitle': 'İstemden üretin',
  'settings.onboardingPromptBody': 'Ürünü veya markayı açıklayın.',
  'settings.onboardingProfileTitle': 'Hakkınızda',
  'settings.onboardingProfileBody': 'Daha iyi varsayılanlar için isteğe bağlı detaylar.',
  'settings.onboardingRoleLabel': 'Rolünüz',
  'settings.onboardingOrgSizeLabel': 'Kuruluş ölçeği',
  'settings.onboardingUseCaseLabel': 'Kullanım alanı',
  ...
  'settings.onboardingOrgSolo': 'Tek tabanca / kişisel (1)',
  ...
  'settings.onboardingOrgMidMarket': 'Orta ölçekli şirket (201-1000)',
  ...
  'settings.onboardingRoleMarketing': '📣 Pazarlamacı',
  'settings.onboardingRoleGrowth': '📈 Büyüme yöneticisi',
  'settings.onboardingRoleOps': '⚙️ Operasyonlar',
  ...
  'settings.onboardingUseAds': '📣 Reklamlar / sosyal içerikler',
  'settings.onboardingUseDashboard': '📊 Kontrol panelleri / dahili araçlar',
  'settings.onboardingUseDeck': '🖥️ Sunum / slayt destesi',
  'settings.onboardingUseMarketing': '📈 Pazarlama / büyüme',
  'settings.onboardingUseEngineering': '🤝 Yazılım teslimi',
  'settings.onboardingUseAgency': '💼 Ajans / müşteri projeleri',
  ...
  'settings.onboardingSourceCommunity': '💬 Tasarım / Yapay Zeka topluluğu',
  'settings.onboardingSourceYoutube': '▶️ YouTube',
  'settings.onboardingSourceBlog': '📰 Blog veya bülten',
  'settings.onboardingSourceAiTool': '✨ Yapay Zeka aracı tavsiyesi',
  'settings.onboardingSourceSearch': '🔍 Arama motoru',
  ...
  'homeWorkingDir.trigger': 'Çalışma klasörü seç',
  'homeWorkingDir.pick': 'Klasör seç',
  'homeWorkingDir.replace': 'Çalışma klasörünü değiştir',
  'homeWorkingDir.recent': 'Son klasörler',
  'homeWorkingDir.recentEmpty': 'Son klasör bulunamadı',
  'homeWorkingDir.clear': 'Çalışma klasörünü kaldır',
  'homeWorkingDir.hint': 'Ajanın bu yerel klasörü okumasına izin ver (Tasarım Dosyalarına aktarılmaz)',
  'homeWorkingDir.missing': 'Bu çalışma klasörü artık mevcut değil — başka bir tane seçin',
  'homeWorkingDir.applyFailed': 'Çalışma klasörü ayarlanamadı — klasör artık mevcut olmayabilir',
  ...
  'workspace.searchFilesPlaceholder': 'Dosyaları ara…',
  'workspace.openTabs': 'Sekmeleri aç',
  'workspace.openFile': 'Dosya aç',
  'workspace.noFilesMatch': 'Eşleşen dosya bulunamadı',
  'workspace.allFiles': 'Tümü',
  'workspace.createNew': 'Yeni oluştur',
  'workspace.tabOpen': 'Aç',
  'workspace.sideChatContextBanner': 'Mevcut konuşmadan entegre edilmiş bağlam',
  'workspace.sideChatDefaultTitle': 'Yan sohbet',
  'workspace.newTerminal': 'Yeni Terminal',
  'workspace.newTerminalDescription': 'Proje dizininde yeni bir sekmede kabuk açın',
  ...
  'automations.tpl.ingestSourceMemoryTree.desc': 'Yüklenen dosyaları, URL\'leri, depoları, bağlayıcıları, yapıları veya sohbet içeriklerini incelenebilir bellek düğümlerine dönüştürür.',
  'automations.tpl.extractDesignSystem.title': 'Tasarım sistemini çıkar',
  'automations.tpl.extractDesignSystem.desc': 'Marka belgelerinden, ekran görüntülerinden, depolardan, bağlayıcılardan, web sitelerinden veya güçlü yapılardan bir DESIGN.md taslağı oluşturur.',
  'automations.tpl.crystallizeRunIntoSkill.title': 'Başarılı çalışmayı beceriye dönüştür',
  'automations.tpl.crystallizeRunIntoSkill.desc': 'Tamamlanmış bir çalışmayı taslak bir SKILL.md dosyasına, örneklere ve takip eden test yönergelerine dönüştürür.',
  'automations.tpl.connectorDigestDesignContext.title': 'Bağlayıcı özetini tasarım bağlamına aktar',
  'automations.tpl.connectorDigestDesignContext.desc': 'Güvenilir bağlayıcı güncellemelerini belleğe ve yapıya hazır tasarım bağlamına çeker.',
  'automations.tpl.compressProjectContext.title': 'Proje bağlamını sıkıştır',
  'automations.tpl.compressProjectContext.desc': 'Aşırı büyük kaynak paketlerini ve bellek düğümlerini kompakt, izlenebilir bağlama dönüştürür.',
  'automations.tpl.promoteArtifactStyle.title': 'Yapı stilini tasarım sistemine taşı',
  'automations.tpl.promoteArtifactStyle.desc': 'Güçlü bir yapıdan yeniden kullanılabilir görsel kuralları çıkararak bir tasarım sistemi varyantına dönüştürür.',
