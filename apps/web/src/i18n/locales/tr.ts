...
export const tr: Dict = {
  ...
  'settings.desktopHint': 'Masaüstü uygulaması davranışını yapılandırın.',
  'settings.autoLaunch': 'Girişte başlat',
  'settings.autoLaunchHint': 'Open Design\'ı oturum açıldığında otomatik başlat.',
  'settings.network': 'Ağ',
  'settings.networkHint': 'Daemon\'un ağ arayüzlerine nasıl bağlanacağını yapılandırın.',
  'settings.networkRequiresDaemon': 'Ağ ayarlarını değiştirmek için çalışan bir daemon\'a bağlanın.',
  'settings.networkWarning': 'Ağ maruziyeti etkin',
  'settings.networkWarningHint': 'Daemon ağınızdan erişilebilir. API anahtarı kimlik doğrulamasını etkinleştirin ve bir IP izin listesi ayarlayın.',
  'settings.bindHost': 'Bağlanma adresi',
  'settings.bindHostHint': '127.0.0.1 = yalnızca localhost. 0.0.0.0 = tüm ağ arayüzleri.',
  'settings.port': 'Bağlantı noktası',
  'settings.portHint': 'Daemon\'un dinlediği TCP bağlantı noktası. Varsayılan: 7456.',
  'settings.allowedHosts': 'İzin verilen ana bilgisayarlar',
  'settings.allowedHostsHint': 'Bağlanmasına izin verilen virgülle ayrılmış IP\'ler veya CIDR aralıkları. Boş = tümü.',
  'settings.apiKeys': 'API Anahtarları',
  'settings.apiKeysHint': 'Ağ maruziyeti açıkken yerel olmayan bağlantılar için gerekli anahtarlar.',
  'settings.revoke': 'İptal et',
  'settings.newApiKey': 'Yeni API Anahtarı',
  'settings.newApiKeyHint': 'Bu anahtarı şimdi kopyalayın. Bir daha gösterilmeyecek.',
  'settings.keyLabel': 'Etiket (isteğe bağlı)',
  'settings.generateKey': 'Oluştur',
  'settings.networkKeyRequired': 'Ağ erişimi bir API anahtarı gerektirir',
  'settings.networkKeyRequiredHint': 'Tüm arayüzlere bağlamak daemon\'u ağa açar. Güvenlik için bir API anahtarı oluşturulacak.',
  'settings.generateAndSwitch': 'Anahtar Oluştur ve Geç',
  'settings.networkNoKeysWarning': 'API anahtarı olmadan yeniden başlatılamaz',
  'settings.networkNoKeysWarningHint': 'Daemon ağa açıkken en az bir API anahtarı gereklidir. Yeniden başlatmadan önce yukarıdan bir anahtar oluşturun.',
  'settings.networkRestartHint': 'Bağlanma adresi, bağlantı noktası veya izin verilen ana bilgisayarlar değişiklikleri daemon\'un yeniden başlatılmasını gerektirir.',
  'settings.restartDaemon': "Daemon'u yeniden başlat",
  'settings.restartingDaemon': 'Yeniden başlatılıyor…',
  'settings.restartFailed': 'Yeniden başlatma başarısız oldu. Manuel olarak deneyin.',
  'settings.networkSaveError': 'Kaydetme başarısız. Girdinizi kontrol edin ve tekrar deneyin.',
  'settings.networkLoadError': 'Ağ ayarları yüklenemedi.',
  'settings.mcpInstructionGemini': 'Bu JSON dosyasını {path} ile birleştirin.',
  ...
  'settings.mcpKeysRevoke': 'İptal et',
