...
export const tr: Dict = {
  ...
  'chat.dsExtractUser': "{source} kaynağından tasarım sistemini çıkar",
  'chat.dsExtractRunning': "Tasarım sistemi çıkarılıyor…",
  'chat.dsExtractDone': "{name} çıkarıldı — tüm modüller hazır.",
  'chat.dsNextStepsTitle': "Sonraki adımlar",
  'chat.dsMoreToggle': "Daha fazla iyileştirme",
  ...
  'ds.fullSystemLabel': '{name} tam sistemi',
