...
export const tr: Dict = {
  ...
  'newproj.importClaudeZip': 'Claude Design ZIP’ini içe aktar',
  ...
  'pet.tabBuiltIn': 'Dahili',
  'pet.tabBuiltInHint': 'Open Design ile gelen seçili dostlar — birini seç ve sahiplenin.',
  'pet.builtInEmpty': 'Hazır evcil dostlar şu an kullanılamıyor. Arka plan servisi tekrar çevrimiçi olduğunda Topluluk sekmesini yenileyin.',
  'pet.tabCustom': 'Özel',
  'pet.tabCustomHint': 'İsim, biçim, renk veya sprite\'ını kendiniz belirleyin.',
  'pet.tabCommunity': 'Topluluk',
  'pet.tabCommunityHint': 'Codex\'te yumurtadan çıkan dostlar — sahiplen ya da yapay zekâ ile yeni bir tane üretin.',
  'pet.tabsAria': 'Evcil dost kaynağı',
  'pet.subtitle': 'Çalışma alanının üstünde süzülen küçük bir dost edinin.',
  'pet.navTitle': 'Evcil Dostlar',
  'pet.navHint': 'Sahiplen veya özelleştir',
  'pet.adopt': 'Sahiplen',
  'pet.adoptedBadge': 'Sahiplenildi',
  'pet.adoptCallout': 'Bir evcil dost sahiplenin',
  ...
  'pet.customHint': 'Bir ad, simge ve vurgu rengi seçin — panel anında güncellenir.',
  ...
  'pet.spriteAria': '{name} — taşımak için sürükleyin, sohbet için tıklayın',
  'pet.spriteTitle': '{name} merhaba diyor! Sohbet için tıklayın.',
  'pet.railAria': 'Evcil dost seçici',
  'pet.railTitle': 'Evcil Dostlar',
  'pet.railHint': 'Çalışma alanının üstünde süzülecek bir yoldaş seçin.',
  'pet.railExpand': 'Seçiciyi göster',
  'pet.railCollapse': 'Seçiciyi daralt',
  'pet.railHide': 'Evcil dost seçiciyi gizle',
  'pet.railShow': 'Evcil dost seçiciyi göster',
  'pet.railCustomFlavor': 'Kendi dostunuz — isim, simge ve renk.',
  'pet.railCustomize': 'Özelleştir…',
  'pet.composerTitle': 'Evcil Dostlar — uyandır, sakla veya seç',
  'pet.composerMenuTitle': 'Evcil Dostlar',
  'pet.composerMenuHint': 'ipucu: değiştirmek için /pet yazın',
  'pet.composerOpenSettings': 'Ayarlardan özelleştir',
  'pet.welcomeTeaserTitle': 'Bir evcil dost sahiplenin',
  ...
  'pet.imageHintIdle': 'PNG, JPG, WebP, GIF veya SVG. Spritesheet? Yatay bir şerit yükleyin ve frame sayısını ayarlayın.',
  'pet.imageHintActive': 'Sprite gösteriliyor. Frame sayısını > 1 yaparak yatay spritesheeti hareket ettirin.',
  ...
  'pet.atlasAdoptFullTitle': 'Tüm satırları koruyun; böylece evcil dost üzerine gelmeye, sürükleme yönüne ve uzun boşta kalmaya tepki verir.',
  'pet.atlasAdoptRowTitle': 'Yalnızca vurgulanan satırı tek döngülü bir şerite kesin.',
  'pet.atlasActiveHint': 'Animasyonlu atlas etkin — evcil dost etkileşiminize (üzerine gelme, sürükleme, boşta kalma) göre bir satır seçer.',
  ...
  'pet.hatchTitle': 'AI ile yeni evcil dost kuluçkala',
  ...
  'pet.hatchConcept': 'Evcil dost konsepti (opsiyonel)',
  'pet.hatchConceptPlaceholder': 'örn. rahat bir kazak giyen küçük piksel-art shiba',
  'pet.hatchCopy': 'İstemi kopyala',
  'pet.hatchCopied': 'Kopyalandı!',
  'pet.hatchFoot': 'Yetenek, evcil dostunuzu kaydettiğinde geri dönüp "Codex sprite\'ı içe aktar" düğmesine basın.',
  'pet.slashPopoverAria': 'Slash komutları',
  'pet.slashPopoverTitle': 'Komutlar',
  'pet.slashPopoverHint': '↑↓ gez · enter seç · esc kapat',
  'pet.slashPet': 'Evcil dost aç/kapat, evlat edin veya ayarları aç.',
  'pet.slashPetWake': 'Yüzen evcil dostu uyandır.',
  'pet.slashPetTuck': 'Evcil dostu şimdilik sakla.',
  'pet.slashHatch': 'hatch-pet yeteneği ile bir Codex peti üretin.',
  'pet.slashHatchArg': '<konsept>',
  'pet.codexTitle': 'Yeni kuluçkalananlar',
  'pet.codexSubtitle': 'hatch-pet yeteneğinin paketlediği petler tek tıkla evlat edinmek için burada görünür.',
  'pet.codexSubtitleWithDir': 'hatch-pet paketleri için {dir} taranıyor.',
  'pet.codexEmpty': 'Henüz kuluçkalanan evcil dost yok. Sohbette /hatch yazarak bir tane üretin.',
  'pet.codexLoading': 'Kuluçkalanan evcil dostlar aranıyor…',
  'pet.codexRefresh': 'Yenile',
  'pet.codexAdopt': 'Sahiplen',
  'pet.codexAdopting': 'Evlat ediniyor…',
  'pet.communitySync': 'Topluluk evcil dostlarını indir',
  'pet.communitySyncing': 'İndiriliyor…',
  'pet.communitySyncTitle': 'Codex Pet Share + j20 Hatchery üzerindeki en yeni evcil dostları ~/.codex/pets/ altına eşitle.',
  'pet.communitySyncDone': '{wrote} yeni evcil dost eşitlendi (toplam {total}).',
  'pet.communitySyncFailed': 'Eşitleme başarısız: {error}',
  'pet.codexBundled': 'Dahili',
