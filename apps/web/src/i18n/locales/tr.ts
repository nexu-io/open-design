...
export const tr: Dict = {
  ...
  'fanout.title': 'Fan out to multiple CLIs',
  'fanout.popoverTitle': 'Pick CLIs',
  'fanout.selectAll': 'Select all',
  'fanout.confirmN': 'Send to {n}',
  'fanout.confirmHint': 'Pick 2 or more',

  'fanout.installAnother': 'Install another CLI to fan out',
  'fanout.installAnotherHint': 'Fan-out needs 2+ installed local CLIs',
  'fanout.usePlaybook': 'Use super-system playbook',
  'fanout.usePlaybookHint': 'Threads the 14-video PATTERNS.md into each agents system prompt',
  'compare.suggestWinner': 'Suggest winner',
  'compare.suggestWinnerHint': 'Rank siblings with a small synthesizer model',
  'compare.researchLink': 'Where this comes from',

  'chat.importUrlTitle': 'Import website URL',
  'chat.importUrlAria': 'Import a URL as a reference attachment',
  'chat.importUrlPrompt': 'URL to import:',
  'chat.importUrlFailed': 'Could not import that URL.',
  'entry.navComponents': 'Components',
  'components.title': 'Component browser',
  'components.empty': 'No components extracted yet.',
  'components.copySelector': 'Copy selector',
  'entry.navCompare': 'Compare',
  'compare.title': 'Compare fan-out runs',
  'compare.empty': 'No fan-out groups yet. Pick 2+ CLIs in the chat composer and send a brief.',
  'compare.groupHeader': 'Brief',
  'compare.openGroup': 'Open',
  'compare.markWinner': 'Pick winner',
  'compare.winnerBadge': 'Winner',
  'designSystemChips.label': 'Design system',
  'designSystemChips.none': 'None',
  'designSystemChips.cleared': 'Cleared',
