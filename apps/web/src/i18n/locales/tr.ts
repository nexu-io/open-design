...
export const tr: Dict = {
  ...
  'settings.updatePreviewLabel': 'Güncelleme önizlemesi',
  'settings.updatePreviewActual': 'Gerçek geliştirme durumu',
  'settings.updatePreviewIdle': 'Denetlenmedi',
  'settings.updatePreviewChecking': 'Denetleniyor',
  'settings.updatePreviewUpToDate': 'En son sürüm',
  'settings.updatePreviewAvailable': 'Yeni sürüm',
  'settings.updatePreviewDownloading': 'İndiriliyor',
  'settings.updatePreviewDownloaded': 'Kuruluma hazır',
  'settings.updatePreviewInstalling': 'Kuruluyor',
  'settings.updatePreviewError': 'Denetim başarısız',
  'settings.updatePreviewUnsupported': 'Desteklenmiyor',
