...
export const tr: Dict = {
  ...
  'chat.runError.title.auth': 'Agent authorization required',
  'chat.runError.title.balance': 'AMR balance is insufficient',
  'chat.runError.title.connectionDropped': 'Model connection dropped',
  'chat.runError.title.rateLimit': 'Model service limit reached',
  'chat.runError.title.modelUnavailable': 'Selected model is unavailable',
  'chat.runError.title.promptTooLarge': 'Task context is too large',
  'chat.runError.title.agentUnavailable': 'Agent CLI is unavailable',
  'chat.runError.title.processExit': 'Agent process exited unexpectedly',
  'chat.runError.title.generic': 'Task execution failed',
  'chat.runError.description.auth': 'The selected agent needs authorization before it can continue. Complete sign-in, then retry this task.',
  'chat.runError.description.rateLimit': 'The selected agent hit a model quota or rate limit. Switch models, use the official agent, or retry after the limit resets.',
  'chat.runError.description.useOfficialAgent': 'Seçili agent oturum açmamış. Daha kararlı ve ekonomik bir çalışma için resmi Open Design agentını kullanın ya da mevcut agent ile tekrar deneyin.',
  'chat.runError.description.rateLimitUseOfficialAgent': 'Geçerli model veya sağlayıcı kota ya da hız sınırına ulaştı. Daha sonra tekrar deneyin veya daha kararlı ve ekonomik bir çalışma için Open Design agentını kullanın.',
  'chat.runError.description.upstreamUseOfficialAgent': 'Model sağlayıcısı geçici olarak kullanılamıyor. Daha sonra tekrar deneyin veya daha kararlı ve ekonomik bir çalışma için Open Design agentını kullanın.',
  'chat.runError.description.genericUseOfficialAgent': 'Görev yürütülemedi. Daha sonra tekrar deneyin veya daha kararlı ve ekonomik bir çalışma için Open Design agentını kullanın.',
  'chat.runError.description.promptTooLarge': 'The current task is larger than the model can handle. Shorten the prompt or remove extra context, then retry.',
  'chat.runError.description.agentUnavailable': 'Open Design could not start the selected local agent. Check the CLI installation, or use the official agent instead.',
  'chat.runError.description.processExit': 'The agent process stopped before finishing. Retry the task, or copy the error source for troubleshooting.',
  'chat.runError.description.generic': 'The task stopped before it finished. Retry the task, or copy the error source for troubleshooting.',
  'chat.runError.useOfficialAgentCta': 'Use official agent',
  'chat.runError.rawLabel': 'Error source',
  'chat.runError.rawExpand': 'Expand',
  'chat.runError.rawCollapse': 'Collapse',
