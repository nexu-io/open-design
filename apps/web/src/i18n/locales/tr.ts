...
export const tr: Dict = {
  ...
  'settings.onboardingAmrCloudUpcomingSkills': 'Çok sayıda beceri',
  ...
  'settings.onboardingRecommended': 'Tavsiye edilen',
  'settings.onboardingAmrCloudOfficialBadge': 'Resmi',
  'settings.onboardingLocalTitle': 'Yerel kodlama aracısı',
  ...
  'settings.onboardingDesignIntroGenerateTitle': 'Mevcut işten oluştur',
  'settings.onboardingDesignIntroGenerateBody': 'Tasarım sisteminizi GitHub\'dan veya yerel kod depolarından, Figma dosyalarından, görsellerden ve diğer içerik varlıklarından yükleyin.',
  'settings.onboardingDesignIntroReuseTitle': 'Gelecekteki çalışmalarda yeniden kullanın',
  'settings.onboardingDesignIntroReuseBody': 'Gelecekteki prototipler, slaytlar ve diğer içerikler mevcut yazı tiplerinize, aralıklarınıza, logo stilinize ve renk tonunuza referans verebilir.',
  ...
  'settings.onboardingGithubBody': 'Bir ön uç deposu kullanın.',
  ...
  'settings.onboardingPromptTitle': 'İstemden oluştur',
  'settings.onboardingPromptBody': 'Ürünü veya markayı açıklayın.',
  'settings.onboardingProfileTitle': 'Profiliniz',
  'settings.onboardingProfileBody': 'Daha iyi varsayılanlar için isteğe bağlı ayrıntılar.',
  'settings.onboardingRoleLabel': 'Rolünüz',
  'settings.onboardingOrgSizeLabel': 'Organizasyon boyutu',
  'settings.onboardingUseCaseLabel': 'Kullanım örneği',
  'settings.onboardingSourceLabel': 'Bizi nereden duydunuz?',
  'settings.onboardingSelectPlaceholder': 'Birini seç',
  'settings.onboardingSelectMultiplePlaceholder': 'Bir veya daha fazlasını seçin',
  'settings.onboardingOrgSolo': 'Tek kişilik / kişisel (1)',
  'settings.onboardingOrgTeam': 'Küçük takım (2-10)',
  'settings.onboardingOrgStartup': 'Girişim / KOBİ (11-50)',
  'settings.onboardingOrgGrowth': 'Büyümekte olan şirket (51-200)',
  'settings.onboardingOrgMidMarket': 'Orta pazar (201-1000)',
  ...
  'settings.onboardingUsePrototype': '📱 Prototip / uygulama kullanıcı arayüzü',
  'settings.onboardingUseLanding': '🌐 Açılış sayfaları',
  'settings.onboardingUseAds': '📣 Reklam / sosyal içerik',
  'settings.onboardingUseDashboard': '📊 Gösterge tabloları / dahili araçlar',
  'settings.onboardingUseDeck': '🖥️ Sunum / deste',
  'settings.onboardingUseMarketing': '📈 Pazarlama / büyüme',
  'settings.onboardingUseEngineering': '🤝 Mühendislik devri',
  'settings.onboardingUseAgency': '💼 Ajans / müşteri çalışması',
  'settings.onboardingSourceGithub': '🐙 GitHub',
  'settings.onboardingSourceFriend': '👥 Arkadaşınız veya iş arkadaşınız',
  ...
  'settings.onboardingSourceAiTool': '✨ AI araç önerisi',
  'settings.onboardingSourceSearch': '🔍 Ara',
  'settings.onboardingSourceEvent': '🎤 Etkinlik veya topluluk',
  'settings.onboardingBack': 'Geri',
  'settings.onboardingContinue': 'Devam et',
  'settings.onboardingFinish': 'Kurulumu tamamla',
  ...
  'settings.cliEnvClaudeApiKey': 'Claude CLI API anahtarı',
  'settings.cliEnvCodexHome': 'Codex ana dizini',
  'settings.cliEnvCodexBin': 'Codex çalıştırılabilir dosya yolu',
  'settings.cliEnvCodexBaseUrl': 'Codex/OpenAI proxy temel URL\'si',
  'settings.cliEnvCodexApiKey': 'Codex/OpenAI CLI API anahtarı',
  ...
  'settings.memoryHint': 'Sohbetlerden otomatik olarak çıkarılan kişisel bilgiler',
  ...
  'settings.memoryDescription': 'Sohbetlerinizden otomatik olarak çıkarılan bilgiler ve tercihleriniz. Markdown dosyaları olarak kaydedilir ve her sohbete dahil edilir.',
  ...
  'settings.memoryName': 'İsim',
  'settings.memoryDesc': 'Tek satırlık açıklama',
  'settings.memoryBody': 'Bellek içeriği (Markdown desteklenir)',
  'settings.memoryBodyHint': 'Önce kuralın kendisini yazın; ardından Neden ve Nasıl uygulanacağına dair satırlar ekleyin.',
  ...
  'updater.installingRestart': 'Yükleniyor ve yeniden başlatılıyor...',
  'updater.openInstaller': 'Güncellemeyi yükle',
  'updater.opening': 'Yükleyici açılıyor...',
  'updater.payloadReadyGeneric': 'Yeni bir Open Design güncellemesi hazır. Open Design otomatik olarak kapanacak ve yeniden başlayacaktır.',
  'updater.payloadReadyVersion': 'Open Design {version} hazır. Open Design otomatik olarak kapanacak ve yeniden başlayacaktır.',
  ...
  'newsletter.placeholder': 'sen@studio.com',
  ...
  'settings.memoryModelInlineHintCli': 'İsteğe bağlı. Bellek çıkarıcı bu sağlayıcıda bir env-var veya medya sağlayıcısı API anahtarı kullanır; burada bir modeli sabitlemek yalnızca otomatik seçimi geçersiz kılar.',
  'settings.memoryModelInlineHintCliConstrained': 'İsteğe bağlı. Bellek {provider} sağlayıcısını arayacaktır; bu sağlayıcı için bir env-var veya medya sağlayıcısı API anahtarı gerekir veya geçersiz kılmak için aşağıdan bir model seçin.',
  'settings.memoryModelInlineHintByok': 'İsteğe bağlı. Aynı sağlayıcıdaki sohbet API anahtarınızı yeniden kullanır — farklı (genellikle daha ucuz) bir model seçmek yalnızca istek gövdesini değiştirir.',
  ...
  'automations.crystallizeFailed': 'Kristalleştirme başarısız oldu: {error}',
  'automations.crystallizePartialSuccess': 'Kristalleştirme öneriler oluşturdu, ancak Otomasyonlar öneri listesini yenileyemedi. Görünür önerileri inceleyin veya yenilemeyi deneyin.',
  'automations.crystallizeRefreshFailed': 'Kristalleştirme tamamlandı, ancak Otomasyonlar önerileri yenileyemedi. Tekrar çalıştırmadan önce yenilemeyi deneyin.',
  'automations.crystallizeNoProposals': 'Kristalleştirme tamamlandı, ancak hiçbir öneri döndürülmedi. Yenilemeyi deneyin veya çalıştırma ayrıntılarını kontrol edin.',
