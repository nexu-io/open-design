...
export const tr: Dict = {
  ...
  'settings.mediaProviderConnectionConnected': "Bağlı",
  'settings.mediaProviderConnectionDisconnected': "Bağlı değil",
  'settings.mediaProviderConnectionConnectedTitle': "Yerel Codex CLI oturumu çalışıyor",
  'settings.mediaProviderConnectionDisconnectedTitle': "Yerel Codex CLI oturumu algılanmadı",
  'settings.mediaProviderConnectionConnectedNote': "Yerel Codex CLI oturumu çalışıyor",
  'settings.mediaProviderConnectionDisconnectedNote': "Bu sağlayıcıyı kullanmak için yerel Codex CLI ile oturum açın",
  ...
  'settings.projectLocationsManualPlaceholder': "Klasör yolu girin",
  'settings.projectLocationsBrowseFolders': "Klasörlere göz at",
  'settings.projectLocationsBrowserDialogLabel': "Proje konumu seç",
  'settings.projectLocationsBrowserTitle': "Klasör seç",
  'settings.projectLocationsBrowserLoading': "Klasörler yükleniyor...",
  'settings.projectLocationsBrowserParentFolder': "Üst klasör",
  'settings.projectLocationsBrowserUseFolder': "Bu klasörü kullan",
  'settings.projectLocationsBrowserLoadError': "Klasörler yüklenemedi. Klasör yolunu elle girin.",
  'settings.projectLocationsBrowserEmpty': "Burada alt klasör yok.",
  ...
  'ds.contentsLabel': "İçindekiler",
  'ds.contentsAriaLabel': "Tasarım sistemi içindekileri",
