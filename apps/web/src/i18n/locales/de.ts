...
export const de: Dict = {
  ...
  'settings.azureNativeImageInput': 'Bildeingabe für diese Azure-Bereitstellung aktivieren',
  'settings.azureNativeImageInputHint': 'Aktivieren Sie dies nur, wenn die ausgewählte Azure-Bereitstellung Bildeingaben unterstützt. Reine Textbereitstellungen sollten es deaktiviert lassen.',
