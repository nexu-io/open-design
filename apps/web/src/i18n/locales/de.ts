...
export const de: Dict = {
  ...
  'chat.dsExtractUser': "Designsystem aus {source} extrahieren",
  'chat.dsExtractRunning': "Designsystem wird extrahiert…",
  'chat.dsExtractDone': "{name} extrahiert — alle Module sind bereit.",
  'chat.dsNextStepsTitle': "Nächste Schritte",
  'chat.dsMoreToggle': "Weitere Optimierungen",
