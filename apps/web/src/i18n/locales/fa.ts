...
export const fa: Dict = {
  ...
  'fileViewer.commentSync.backfillFailedBody': "نظرات موجود هنوز همگام‌سازی نشده‌اند؛ بازدیدکنندگان فعلاً آن‌ها را نمی‌بینند.",
  'fileViewer.commentSync.backfillTerminalBody': "برخی از نظرات موجود با صفحه اشتراک‌گذاری همگام نشدند و به‌طور خودکار دوباره تلاش نمی‌شود. پیوند اشتراک‌گذاری همچنان در دسترس است.",
  'fileViewer.commentSync.backfillRetryingBody': "نظرهای موجود هنوز همگام‌سازی نشده‌اند، بنابراین بازدیدکنندگان فعلاً آن‌ها را نمی‌بینند. تلاش مجدد خودکار در حال انجام است.",
  'fileViewer.commentSync.backfillReopenedPendingBody': "دیدگاه‌های پیوند اشتراک‌گذاری دوباره فعال‌شده در حال همگام‌سازی هستند. دیدگاه‌های حذف‌شده یا حل‌شده ممکن است همچنان در صفحه اشتراک‌گذاری دیده شوند.",
  'fileViewer.commentSync.backfillReopenedRetryingBody': "همگام‌سازی نظرها کامل نشده است. صفحهٔ اشتراک‌گذاری ممکن است هنوز نظرهای رسیدگی‌شده را نشان دهد.",
  'fileViewer.commentSync.backfillReopenedTerminalBody': "همگام‌سازی دیدگاه‌ها هنوز کامل نشده است. دیدگاه‌های حذف‌شده یا حل‌شده ممکن است همچنان در صفحه اشتراک‌گذاری دیده شوند. تلاش خودکار متوقف شده است؛ پیوند اشتراک‌گذاری همچنان در دسترس است.",
  'fileViewer.commentSync.backfillPendingBody': "نظرات موجود در حال همگام‌سازی هستند. بازدیدکنندگان ممکن است هنوز آن‌ها را نبینند.",
  'fileViewer.commentSync.backfillPendingCountBody': "همگام‌سازی نظرات موجود · {count}",
  "fileViewer.commentSync.reopenSyncBusy": "در حال همگام‌سازی نظرات…",
  'fileViewer.commentSync.alignFailedBody': "همسان‌سازی نظرات کامل نشده است؛ ممکن است برخی نظرات نمایش داده نشوند.",
  'fileViewer.shareGuide.title': "پیوند را به اشتراک بگذارید تا بازخورد بگیرید",
  'fileViewer.shareGuide.description': "پیوند را به اشتراک بگذارید تا نظرات را مستقیم جمع‌آوری کنید. چند بازخورد را انتخاب کنید و به Agent بسپارید تا یکی‌یکی پردازش کند.",
  'fileViewer.shareGuide.tryShare': "اشتراک‌گذاری را امتحان کنید",
  'fileViewer.shareGuide.neverShowAgain': "دیگر نمایش نده",
  'fileViewer.shareGuide.close': "بستن راهنمای ویژگی جدید",
  ...
  'designs.deletedShareRetrying': "پروژه حذف شد. در حال توقف پیوند اشتراک‌گذاری '{filePath}'…",
  'designs.deletedShareFailed': "پروژه حذف شد. توقف پیوند اشتراک‌گذاری '{filePath}' ناموفق بود و ممکن است همچنان در دسترس باشد.",
  'designs.deletedShareRetry': "تلاش دوباره",
  ...
  'chat.comments.expandBody': 'نمایش بیشتر',
  'chat.comments.collapseBody': 'نمایش کمتر',
  ...
  'fileViewer.jsxModuleBody': 'فقط فایل‌های HTML مستقل قابل اشتراک‌گذاری هستند. ابتدا این مؤلفه را به‌صورت HTML خروجی بگیرید.',
  ...
  "fileViewer.shareUpdateHint": "فایل تغییرات جدیدی دارد. بازدیدکنندگان هنوز نسخهٔ قبلی را می‌بینند.",
  ...
  'fileViewer.signInToShareDescription': "برای ساخت پیوند اشتراک‌گذاری و دعوت دیگران به مشاهده و نظر دادن، وارد Open Design شوید.",
  ...
  "fileViewer.shareUpdateUncertain": "نتیجه به‌روزرسانی نامشخص است. محتوای پیوند عمومی ممکن است تغییر کرده باشد. پیش از تلاش دوباره پیوند را بررسی کنید یا اشتراک‌گذاری را متوقف کنید.",
  "fileViewer.shareUpdateRetry": "تلاش مجدد",
  ...
  "chat.artifact.shareStatusUnknown": "وضعیت نامشخص",
  "chat.artifact.published": "به‌اشتراک‌گذاشته‌شده",
