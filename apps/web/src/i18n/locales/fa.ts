...
export const fa: Dict = {
  ...
  'fileViewer.cloudflareWorkersScriptName': 'نام اسکریپت',
  'fileViewer.cloudflareWorkersCompatibilityDate': 'تاریخ سازگاری',
  'fileViewer.cloudflareWorkersBindings': 'Bindings',
  'fileViewer.cloudflareWorkersAddBinding': 'افزودن binding',
  'fileViewer.cloudflareWorkersRemoveBinding': 'حذف',
  'fileViewer.cloudflareWorkersBindingName': 'نام binding',
  'fileViewer.cloudflareWorkersBindingBucketName': 'نام باکت',
  'fileViewer.cloudflareWorkersBindingDatabaseId': 'شناسه پایگاه داده',
  'fileViewer.cloudflareWorkersBindingDatabaseName': 'نام پایگاه داده (در صورت نبود ایجاد کن)',
  'fileViewer.cloudflareWorkersBindingDatabaseNameHint': 'برای ایجاد پایگاه داده D1 با این نام هنگام استقرار، ID را خالی بگذارید',
  'fileViewer.cloudflareWorkersBindingR2CreateHint': 'اگر bucket وجود نداشته باشد به‌صورت خودکار ایجاد می‌شود',
  'fileViewer.cloudflareWorkersCustomDomain': 'دامنه سفارشی',
  'fileViewer.cloudflareWorkersCustomDomainZone': 'ناحیه',
  'fileViewer.cloudflareWorkersCustomDomainHostname': 'نام میزبان',
  'fileViewer.cloudflareWorkersScopeD1Write': 'نوشتن D1',
  'fileViewer.cloudflareWorkersScopeR2Write': 'نوشتن ذخیره‌سازی R2',
  'fileViewer.cloudflareWorkersBindingsEmpty': 'هنوز bindings وجود ندارد.',
  'fileViewer.cloudflareWorkersCapabilities': 'قابلیت‌ها',
  'fileViewer.cloudflareWorkersCapabilitiesLoading': 'در حال بارگذاری…',
  'fileViewer.cloudflareWorkersCapabilitiesLoadFailed': 'بارگذاری قابلیت‌ها ممکن نشد.',
  'fileViewer.cloudflareWorkersCapabilitiesRefresh': 'بازخوانی',
  'fileViewer.cloudflareWorkersCapabilitiesEmpty': 'تنظیمات را ذخیره کنید تا قابلیت‌ها بررسی شوند.',
  'fileViewer.cloudflareWorkersEnabled': 'فعال',
  'fileViewer.cloudflareWorkersDisabled': 'غیرفعال',
  'fileViewer.cloudflareWorkersWorkers': 'Workers',
  'fileViewer.cloudflareWorkersSubdomain': 'زیردامنه Workers Dev',
  'fileViewer.cloudflareWorkersR2': 'R2',
  'fileViewer.cloudflareWorkersD1': 'D1',
  'fileViewer.cloudflareWorkersAccess': 'Access',
  'fileViewer.cloudflareWorkersAccessEnabled': 'خصوصی (Cloudflare Access)',
  'fileViewer.cloudflareWorkersAccessNotAvailable': 'Cloudflare Access با این اعتبارنامه در دسترس نیست',
  'fileViewer.cloudflareWorkersAccessRule': 'چه کسی می‌تواند این استقرار را باز کند',
  'fileViewer.cloudflareWorkersAccessRuleEmails': 'ایمیل‌های مشخص',
  'fileViewer.cloudflareWorkersAccessRuleEmailDomain': 'دامنه ایمیل',
  'fileViewer.cloudflareWorkersAccessRuleSelf': 'فقط من',
  'fileViewer.cloudflareWorkersAccessRulePolicy': 'سیاست Access موجود',
  ...
  'fileViewer.cloudflareWorkersAccessPolicyIdPlaceholder': 'UUID سیاست Access',
  'fileViewer.cloudflareWorkersAccessProtected': 'محافظت‌شده توسط Cloudflare Access',
  'fileViewer.cloudflareWorkersAccessRuleRequired': 'پیش از استقرار با Cloudflare Access دست‌کم یک ایمیل، یک دامنهٔ ایمیل یا شناسهٔ سیاست Access اضافه کنید.',
  'fileViewer.cloudflareWorkersBindingIncomplete': 'هر اتصال به یک نام و یک باکت یا پایگاه داده نیاز دارد.',
  'fileViewer.cloudflareWorkersReasonR2NotEnabled': 'R2 برای این حساب فعال نیست.',
  'fileViewer.cloudflareWorkersReasonAccessNotEnabled': 'Cloudflare Access برای این حساب فعال نیست.',
  'fileViewer.cloudflareWorkersReasonNoPermission': 'توکن API برای این عملیات مجوز ندارد.',
  'fileViewer.cloudflareWorkersReasonUnknown': 'ناشناخته',
  'fileViewer.cloudflareWorkersOauthCredentialMode': 'روش اعتبارسنجی',
  'fileViewer.cloudflareWorkersOauthCredentialModeToken': 'توکن API',
  'fileViewer.cloudflareWorkersOauthCredentialModeOauth': 'ورود با Cloudflare',
  'fileViewer.cloudflareWorkersOauthClientId': 'شناسه مشتری',
  'fileViewer.cloudflareWorkersOauthRedirectUri': 'URI بازگشت',
  'fileViewer.cloudflareWorkersOauthScopes': 'دامنه‌ها',
  'fileViewer.cloudflareWorkersOauthScopeZoneRead': 'خواندن ناحیه',
  'fileViewer.cloudflareWorkersOauthScopeAccessWrite': 'نوشتن برنامه‌های Access',
  'fileViewer.cloudflareWorkersOauthScopeD1Read': 'خواندن D1',
  'fileViewer.cloudflareWorkersOauthScopeR2Read': 'خواندن ذخیره‌سازی R2',
  'fileViewer.cloudflareWorkersOauthConnect': 'اتصال به Cloudflare',
  'fileViewer.cloudflareWorkersOauthOpening': 'در حال باز کردن Cloudflare…',
  'fileViewer.cloudflareWorkersOauthConnected': 'متصل',
  'fileViewer.cloudflareWorkersOauthConnectFailed': 'شروع ورود به Cloudflare ممکن نشد.',
  'fileViewer.cloudflareWorkersOpenSite': 'باز کردن سایت مستقرشده',
  'fileViewer.cloudflareOAuthSignIn': 'ورود با Cloudflare',
  'fileViewer.cloudflareOAuthOpening': 'در حال باز کردن مرورگر…',
  'fileViewer.cloudflareOAuthAwaiting': 'در انتظار مجوز Cloudflare…',
  'fileViewer.cloudflareOAuthNotConnected': 'متصل نیست',
  'fileViewer.cloudflareOAuthBound': 'متصل به حساب {accountId}',
  'fileViewer.cloudflareOAuthExpiresIn': 'توکن تا {minutes} دقیقه دیگر منقضی می‌شود',
  'fileViewer.cloudflareOAuthGrantedScopes': 'دامنه‌های اعطاشده: {scope}',
  'fileViewer.cloudflareOAuthExpired': 'توکن منقضی شده است. دوباره وارد شوید.',
  'fileViewer.cloudflareOAuthReconnect': 'اتصال مجدد',
  'fileViewer.cloudflareOAuthDisconnect': 'قطع اتصال',
  'fileViewer.cloudflareOAuthDisconnecting': 'در حال قطع اتصال…',
  'fileViewer.cloudflareOAuthRefresh': 'بازخوانی وضعیت',
  'fileViewer.cloudflareOAuthOpenManually': 'باز کردن دستی صفحه مجوز',
