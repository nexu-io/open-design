...
export const fa: Dict = {
  ...
  'chat.runNotice.title.fiveHourLimit': 'سقف استفاده ۵ ساعته مدل پر شده است',
  'chat.runNotice.title.queued': 'تقاضا زیاد است — کار در صف قرار گرفت',
  ...
  'chat.runNotice.fiveHourLimitMessage': 'مدل {model} به سقف استفاده ۵ ساعته رسیده است. در {retryAt} دوباره در دسترس خواهد بود. هزینه‌ای برای این درخواست کسر نشد.',
  'chat.runNotice.queuedMessage': 'در حال حاضر کاربران زیادی از این مدل استفاده می‌کنند. کار شما در صف قرار گرفت و در نوبت خودکار شروع می‌شود؛ نیازی به ارسال دوباره نیست.',
