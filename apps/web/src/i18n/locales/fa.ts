...
export const fa: Dict = {
  ...
  'fileViewer.commentSync.backfillFailedTitle': "اشتراک منتشر شد",
  ...
  'fileViewer.commentSync.backfillRetryingBody': "نظرات موجود هنوز همگام‌سازی نشده‌اند؛ بازدیدکنندگان فعلاً آن‌ها را نمی‌بینند. تلاش مجدد به‌طور خودکار در پس‌زمینه انجام می‌شود.",
  ...
  'fileViewer.commentSync.backfillReopenedRetryingBody': "همگام‌سازی دیدگاه‌ها هنوز کامل نشده است. دیدگاه‌های حذف‌شده یا حل‌شده ممکن است همچنان در صفحه اشتراک‌گذاری دیده شوند. تلاش دوباره به‌طور خودکار در پس‌زمینه انجام می‌شود.",
