...
export const fa: Dict = {
  ...
  'chat.amrCard.switchBody': 'به سرویس رسمی مدل AMR از Marketing AX سوئیچ کنید — بدون نیاز به تنظیم کلید API. پس از ورود، اعطای دسترسی و شارژ، این اجرا به‌طور خودکار دوباره انجام می‌شود.',
  ...
  'settings.onboardingCreateBody': 'سایت، اپلیکیشن، ارائه، تصویر یا ویدیویی را که می‌خواهید توصیف کنید. Marketing AX یک پروژه می‌سازد و کار را قابل ویرایش نگه می‌دارد.',
  ...
  'settings.agentInstall.stepAuth': 'قبل از بازگشت به Marketing AX، در CLI ارائه‌دهنده احراز هویت کنید (ورود یا افزودن اطلاعات API).',
  ...
  'settings.mcpServerHint': 'Marketing AX را به‌عنوان سرور MCP برای عامل برنامه‌نویسی خود در دسترس قرار دهید.',
  ...
  'settings.privacyHint': 'چه داده‌هایی با تیم Marketing AX به اشتراک گذاشته می‌شود',
  'settings.privacyConsentKicker': 'به ما در بهبود Marketing AX کمک کنید',
  'settings.privacyConsentLead': 'Marketing AX می‌تواند داده‌های استفاده را با تیم ما به اشتراک بگذارد تا به بهبود کمک کند. این شامل موارد زیر است:',
  ...
  'settings.mcpHint': 'به Agentهای کدنویسی (Cursor، Claude Code، VS Code…) اجازه دهید پروژه‌های Marketing AX شما را مستقیماً بخوانند.',
  'settings.mcpDaemonError': 'امکان دسترسی به daemon محلی برای تعیین مسیرهای نصب وجود نداشت ({error}). مطمئن شوید که Marketing AX در حال اجراست، سپس این پنل را دوباره باز کنید.',
  'settings.mcpBuildDaemon': 'ابتدا daemon را بسازید.',
  'settings.mcpNodeMissing': 'باینری Node یافت نشد.',
  'settings.mcpBuildHint': 'apps/daemon/dist/cli.js یافت نشد. دستور `pnpm --filter @marketing-ax/daemon build` را اجرا کنید و صفحه را تازه‌سازی کنید.',
  ...
  'settings.mcpCapabilityDefault': 'به‌صورت پیش‌فرض از پروژه و فایلی که در Marketing AX باز کرده‌اید استفاده می‌کند، بنابراین می‌توانید بگویید «این را در اپ من بساز» بدون اینکه دوباره مشخص کنید کدام طراحی.',
  'settings.mcpRunningNote': 'برای موفقیت فراخوانی‌های ابزار MCP، Marketing AX باید در حال اجرا باشد. اگر Agent کدنویسی خود را پیش از باز کردن Marketing AX راه‌اندازی کرده‌اید، Agent را راه‌اندازی مجدد کنید تا بتواند به daemon زنده دسترسی پیدا کند.',
  ...
  'entry.navBrands': 'برندها',
  'entry.navIntegrations': 'یکپارچه‌سازی‌ها',
  'brands.empty': 'هنوز هیچ برندی ثبت نشده است.',
  'brands.back': 'بازگشت',
  'brands.core': 'هسته برند',
  'brands.loadFailed': 'بارگذاری این برند ممکن نشد.',
  'brands.pageTitle': 'برندها',
  'brands.pageSubtitle': 'زمینه و سیستم طراحی هر برند را ثبت کنید، سپس پروژه‌ها را ایجاد کنید.',
  'brands.sectionContext': 'زمینه برند',
  'brands.sectionDesignSystem': 'سیستم طراحی',
  'brands.sectionDocs': 'اسناد دانش',
  'brands.docsHint': 'هسته برند و سند فنی (.md) هر کانال در اجراها تزریق می‌شود. سندی را برای مشاهده انتخاب کنید.',
  'brands.fieldTagline': 'شعار',
  'brands.fieldWebsite': 'وب‌سایت',
  'brands.fieldAudience': 'مخاطب اصلی',
  'brands.fieldKeyMessage': 'پیام کلیدی',
  'brands.fieldAvoid': 'اجتناب',
  'brands.fieldChannels': 'کانال‌ها',
  'brands.palette': 'پالت رنگ',
  'brands.typography': 'تایپوگرافی',
  'brands.voiceTone': 'صدا و لحن',
  'brands.coreDocLabel': 'هسته برند',
  'brands.projectCount': '{n} پروژه',
  'brands.paletteChannelMeta': '{c} رنگ · {n} کانال ثبت‌شده',
  'brands.newButton': '+ برند جدید',
  'brands.newTitle': 'برند جدید',
  'brands.newFieldTitle': 'نام',
  'brands.newFieldId': 'شناسه',
  'brands.newFieldIdHint': 'از روی نام پیشنهاد می‌شود — حروف کوچک لاتین، اعداد و خط تیره.',
  'brands.newSubmit': 'ایجاد',
  'brands.newDuplicateId': 'برندی با این شناسه از قبل وجود دارد.',
  'brands.newFailed': 'ایجاد برند ممکن نشد.',
  'brands.edit': 'ویرایش',
  'brands.save': 'ذخیره',
  'brands.cancel': 'لغو',
  'brands.saveFailed': 'ذخیره تغییرات ممکن نشد.',
  'brands.fieldSubtitle': 'زیرعنوان',
  'brands.fieldToneLabel': 'برچسب لحن',
  'brands.fieldTypographyFamily': 'خانواده فونت',
  'brands.fieldTypographyRoles': 'نقش‌های فونت',
  'brands.fieldTypographyWeights': 'وزن‌های فونت',
  'brands.fieldNeutralPalette': 'پالت خنثی',
  'brands.fieldCommaHint': 'مقادیر متعدد را با ویرگول جدا کنید.',
  'brands.docEdit': 'ویرایش سند',
  'brands.docSaveFailed': 'ذخیره سند ممکن نشد.',
  'brands.channelAdd': '+ کانال',
  'brands.channelAddKey': 'کلید',
  'brands.channelAddKeyHint': 'حروف کوچک لاتین، اعداد و خط تیره — به‌عنوان کلید تزریق در پرامپت استفاده می‌شود.',
  'brands.channelAddLabel': 'برچسب',
  'brands.channelAddDesignSystem': 'سیستم طراحی',
  'brands.channelAddSubmit': 'افزودن',
  'brands.channelAddFailed': 'افزودن کانال ممکن نشد.',
  'brands.channelRemove': 'حذف کانال',
  'brands.channelRemoveConfirm': 'کانال {key} حذف شود؟ سند فنی آن نیز حذف خواهد شد.',
  'brands.channelRemoveFailed': 'حذف کانال ممکن نشد.',
  'brands.uploadIcon': 'بارگذاری آیکون',
  'brands.uploadLogo': 'بارگذاری لوگو',
  'brands.uploadFailed': 'بارگذاری تصویر ممکن نشد.',
  'brands.uploadTooLarge': 'حجم فایل بیش از حد بزرگ است.',
  'brands.deleteZone': 'منطقه خطر',
  'brands.delete': 'حذف برند',
  'brands.deleteConfirm': 'برند {title} حذف شود؟ این کار قابل بازگشت نیست.',
  'brands.deleteBlocked': '{n} پروژه از این برند استفاده می‌کنند. ابتدا آن پروژه‌ها را حذف کنید.',
  'brands.deleteFailed': 'حذف برند ممکن نشد.',
  ...
  'homeHero.chip.createPluginHint': 'یک افزونه قابل استفاده مجدد Marketing AX بسازید و آن را به افزونه‌های من اضافه کنید.',
  ...
  'handoff.promptIntro': 'ادامه از این پوشه محلی پروژه Marketing AX:',
  ...
  'pluginsHome.subtitle': 'گردش‌کارهای آماده Marketing AX که همراه این runtime ارائه شده‌اند. یکی را برای بارگذاری یک پرامپت شروع انتخاب کنید، یا برای موارد بیشتر در رجیستری بگردید.',
  ...
  'pluginsHome.emptyCatalog': 'کاتالوگ خالی است. پلاگین‌های همراه با Marketing AX ارائه می‌شوند و باید به‌صورت خودکار اینجا نمایش داده شوند — اگر این مشکل ادامه داشت، daemon را مجدداً راه‌اندازی کنید.',
  ...
  'pluginCard.contributeAria': 'مشارکت {title} در Marketing AX',
  'pluginCard.contributeTitle': 'مشارکت افزونه در Marketing AX با یک PR',
  ...
  'integrations.lede': 'سیستم‌های خارجی را متصل کنید، ابزارهای MCP را به حلقه Agent خود بیاورید و از Marketing AX در سایر IDEها، اسکریپت‌ها و خودکارسازی‌ها استفاده کنید.',
  ...
  'mcpClient.daemonError': 'دسترسی به daemon محلی ممکن نشد. مطمئن شوید Marketing AX در حال اجراست، سپس این پنل را دوباره باز کنید.',
  'mcpClient.saveFailed': 'ذخیره ناموفق بود. بررسی کنید که daemon در حال اجرا باشد و دوباره تلاش کنید.',
  'useEverywhere.modalAria': 'استفاده از Marketing AX در همه‌جا',
  'useEverywhere.modalTitle': 'استفاده از Marketing AX در همه‌جا',
  'useEverywhere.modalSubtitle': 'Marketing AX را در هر IDE، Agent یا اسکریپتی بگنجانید — CLI، HTTP، MCP و Skills. از «Copy guide for an agent» استفاده کنید و آن را در Claude Code، Codex، Cursor، openclaw یا hermes جای‌گذاری کنید تا همه‌چیز راه‌اندازی شود.',
  ...
  'useEverywhere.section.overview.heading': 'Marketing AX هر جا که Agent شما کار کند، کار می‌کند',
  'useEverywhere.section.overview.intro': 'Marketing AX چیزی فراتر از یک پنجره است — یک daemon محلیِ دارای دسترسی ویژه (`od`) به‌علاوه یک رجیستری از Skills + Design-Systems + Atoms است. به‌محض اینکه روی دستگاه شما در حال اجرا باشد، هر code agent (Claude Code، Codex، Cursor، OpenCode/openclaw، Hermes، یا اسکریپت خودتان) می‌تواند تولیدها را هدایت کند، پروژه‌ها را بررسی کند و از طریق چهار سطح قابل‌تعویض، آثار طراحی تولید کند.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` برای اسکریپت‌های headless، CI و اتوماسیون shell.',
  'useEverywhere.section.overview.bullet2': 'سرور MCP — Marketing AX را به‌عنوان یک سرور Model Context Protocol سیم‌کشی می‌کند تا هر Agent سازگار با MCP بتواند skillها را فهرست کند، سناریوها را اجرا کند و آثار را بخواند.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — بسته‌های آمادهٔ `SKILL.md` (سازگار با Claude) که هر Agent موجود در PATH شما می‌تواند بدون نیاز به Marketing AX اصلاً فراخوانی‌شان کند.',
  ...
  'useEverywhere.section.cli.heading': 'کنترل Marketing AX از هر shell',
  ...
  'useEverywhere.section.mcp.heading': 'در معرض قرار دادن Marketing AX به‌عنوان یک سرور MCP برای هر Agent کدنویسی',
  'useEverywhere.section.mcp.intro': 'Marketing AX با یک سرور Model Context Protocol (`od mcp`) ارائه می‌شود که به هر کلاینت سازگار با MCP — Cursor، Claude Code، Antigravity، VS Code Copilot Chat، openclaw، hermes — اجازه می‌دهد ابزارهای Marketing AX را کشف کند (فهرست‌کردن skillها، رندر پیش‌نمایش‌ها، تولید رسانه، اجرای پلاگین‌ها) بدون نیاز به اجرای دستی در shell. این daemon برای هر کلاینت اصلی یک قطعهٔ نصب آمادهٔ جای‌گذاری را از طریق `GET /api/mcp/install-info` منتشر می‌کند.',
  ...
  'useEverywhere.section.mcp.bullet4': '`MAX_DATA_DIR` را پین می‌کند تا فرایند MCP ایجادشده در همان مکانی بنویسد که daemon از پیش استفاده می‌کند (از EPERM در باندل‌های اپلیکیشن بسته‌بندی‌شده macOS جلوگیری می‌کند).',
  ...
  'useEverywhere.section.mcp.footer': 'در اپلیکیشن Marketing AX، به Settings ← Integrations بروید تا یک دستور نصب مخصوص کلاینت (Cursor، Claude Code، Antigravity، VS Code) را کپی کنید، به‌جای ویرایش دستی JSON.',
  ...
  'useEverywhere.section.http.footer': 'تایپ‌های خالص TypeScript برای هر درخواست/پاسخ در `@marketing-ax/contracts` قرار دارند — آن‌ها را در اسکریپت خود import کنید تا بدون سیم‌کشی یک generator، تکمیل خودکار کامل داشته باشید.',
  'useEverywhere.section.skills.tab': 'مهارت‌ها و حالت بدون رابط',
  'useEverywhere.section.skills.heading': 'Skillهای آمادهٔ استفاده برای هر Agent — حتی بدون اجرای Marketing AX',
  'useEverywhere.section.skills.intro': 'یک Skill دایرکتوری‌ای است با یک `SKILL.md` سازگار با Claude (فرانت‌متر YAML + بدنه). Marketing AX این فرمت را با namespace به نام `od:` گسترش می‌دهد (`mode`، `preview`، `design_system`، `inputs`، …) تا همان اثر هم درون Marketing AX و هم توسط یک Agent معمولی مانند Claude Code، Codex، openclaw یا hermes قابل‌استفاده باشد. کشف از یک زنجیرهٔ اولویت پیروی می‌کند تا پروژه‌ها بتوانند skillهای خود را بازنویسی کنند.',
  ...
  'useEverywhere.section.skills.snippet1': 'حداقل SKILL.md (front matter سازگار با Claude + افزوده‌های Marketing AX)',
  ...
  'entry.githubStarAria': 'به Marketing AX در GitHub ستاره بدهید',
  ...
  'newproj.locationDefault': 'پروژه‌های Marketing AX',
  ...
  'ds.detailLoadFailed': 'بارگذاری این سیستم طراحی ممکن نشد.',
  'ds.back': 'بازگشت',
  'ds.detailLoading': 'در حال بارگذاری سیستم طراحی…',
  'ds.detailLoadingHint': 'در حال باز کردن فضای بازبینی.',
  ...
  'socialShare.openDesignSection': 'اشتراک‌گذاری Marketing AX',
  'socialShare.openDesignTitle': 'Marketing AX در GitHub',
  'socialShare.openDesignText': 'Marketing AX یک فضای کاری متن‌باز برای ساخت، ویرایش، استقرار و تحویل آرتیفکت‌های طراحی است.',
  ...
  'socialShare.projectText': 'ساخته‌شده با Marketing AX: {title}. آرتیفکت مستقرشده را ببینید و به مخزن ستاره بدهید: {repo}',
  'socialShare.projectCopyText': 'ساخته‌شده با Marketing AX: {title}\n{url}\nمخزن Marketing AX: {repo}',
  ...
  'chat.activeFilePlaceholder': 'از Marketing AX بخواهید {file} را تغییر دهد...',
  ...
  'chat.mode.design.solves': 'وقتی می خواهید Marketing AX فایل بسازد، workspace را به روز کند یا brief را به خروجی های چندرسانه ای قابل تحویل تبدیل کند استفاده کنید.',
  ...
  'preview.errorBody': 'دریافت HTML نمونه با خطا مواجه شد. مطمئن شوید Marketing AX در حال اجراست و دوباره تلاش کنید.',
  ...
  'designFiles.usefulInfoTip7': 'از Marketing AX راضی هستید؟ در GitHub به ما ستاره بدهید.',
  ...
  'fileViewer.openFolder': 'باز کردن پوشه پروژه',
  'fileViewer.openFolderFailed': 'باز کردن پوشه پروژه ممکن نشد.',
  'fileViewer.openFolderWebFallback': 'باز کردن پوشه از مرورگر ممکن نیست. مسیر:',
  'fileViewer.copyCaption': 'کپی کپشن',
  'fileViewer.copyCaptionDone': 'کپشن در کلیپ‌بورد کپی شد',
  'fileViewer.copyCaptionFailed': 'کپی کپشن ممکن نشد.',
  ...
  'assistant.shareToOpenDesign': 'اشتراک‌گذاری در Marketing AX',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه Marketing AX — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.codexBundledTitle': 'همراه Marketing AX ارائه می‌شود — نیازی به دانلود نیست.',
  ...
  'settings.projectLocationsDescription': 'پایه‌های کاری اضافه کنید که می‌توانند چند پوشهٔ پروژهٔ Marketing AX را در خود داشته باشند. پروژه‌های جدید به‌صورت یک پوشه داخل پایهٔ انتخاب‌شده ذخیره می‌شوند.',
  ...
  'settings.customInstructionsHint': 'دستورالعمل‌های ثابتی که Marketing AX باید در هر گفت‌وگو دنبال کند. حقایق، ترجیحات و زمینهٔ پروژه را به‌عنوان حافظه ذخیره کنید.',
  ...
  'settings.defaultRouter.title': 'مسیریاب پیش‌فرض',
  'settings.defaultRouter.description': 'افزونه مسیریاب برای درخواست‌های آزاد بدون تطبیق با هیچ تریگری.',
  'settings.defaultRouter.builtin': 'داخلی (Default design router)',
  ...
  'settings.memoryStarterProjectDesc': 'Marketing AX v0.5 — ویرایشگر طراحی مبتنی بر گفتگو',
  ...
  'updater.availableBody': 'Marketing AX {version} موجود است. پیش از باز شدن نصب‌کننده دانلود می‌شود.',
  ...
  'updater.installerOpenBody': 'نصب‌کننده باز است. Marketing AX در حال بسته شدن است تا بتوانید به‌روزرسانی را کامل کنید.',
  ...
  'updater.quitButton': 'بستن Marketing AX',
  'updater.quitFailedBody': 'نصب‌کننده باز است، اما Marketing AX بسته نشد. پیش از جایگزینی برنامه، Marketing AX را ببندید.',
  'updater.quitFailedTitle': 'امکان بستن نیست',
  'updater.quitting': 'در حال بستن...',
  'updater.ready': 'به‌روزرسانی آماده است',
  'updater.readyGeneric': 'نسخه جدید آماده است. Marketing AX بسته می‌شود و نصب‌کننده را باز می‌کند.',
  'updater.readyVersion': 'Marketing AX {version} آماده است. Marketing AX بسته می‌شود و نصب‌کننده را باز می‌کند.',
  ...
  'dsManager.createBody': 'برند، محصول، کد، دارایی‌ها و مراجع طراحی خود را به Marketing AX بیاموزید.',
  ...
  'settings.customInstructionsDesc': 'دستورالعمل‌های ثابتی که Marketing AX در هر گفت‌وگو از آن‌ها پیروی می‌کند. این‌ها حافظه ذخیره‌شده نیستند؛ برای واقعیت‌ها، ترجیحات و بافت پروژه از حافظه استفاده کنید.',
