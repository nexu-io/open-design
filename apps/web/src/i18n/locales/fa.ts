...
export const fa: Dict = {
  ...
  'settings.privacyConsentBannerFooter': 'تله‌متری اختیاری استفاده به‌صورت پیش‌فرض روشن است. می‌توانید هر زمان آن را در Settings ← Privacy خاموش کنید. تشخیص ایمنی و خرابی ممکن است همچنان ارسال شود.',
  ...
  'settings.privacySafety': 'تشخیص ایمنی و خرابی',
  'settings.privacySafetyHint': 'تشخیص‌های پاک‌سازی‌شدهٔ خطا و پایداری ممکن است حتی با خاموش بودن تله‌متری استفاده ارسال شوند. بدون دستور یا محتوای آرتیفکت.',
  ...
  'settings.privacyDataDeletionHint': 'شناسه ناشناس شما را تغییر می‌دهد و تله‌متری اختیاری استفاده را خاموش می‌کند. ردیابی‌های موجود طبق سیاست نگه‌داری ما به مرور حذف می‌شوند.',
