...
export const fa: Dict = {
  ...
  'pluginDetail.applyFailedWithReason': 'اعمال ناموفق بود: {error}',
  'pluginApply.inputsMissing': 'ورودی‌های الزامی افزونه وارد نشده‌اند: {fields}',
  'pluginApply.configurationInvalid': 'پیکربندی افزونه نامعتبر است. افزونه را دوباره نصب یا به‌روزرسانی کنید و دوباره امتحان کنید.',
  'pluginApply.resourceUnavailable': 'یکی از منابع الزامی افزونه در دسترس نیست. افزونه را دوباره نصب یا به‌روزرسانی کنید و دوباره امتحان کنید.',
  'pluginApply.genericFailure': 'افزونه اعمال نشد. دوباره امتحان کنید.',
  'pluginApply.workspaceContextIncomplete': 'اطلاعات فضای کاری کامل نیست. منتظر پایان همگام‌سازی بمانید و دوباره امتحان کنید.',
  'pluginApply.notFound': 'افزونه پیدا نشد.',
  'pluginApply.failedNamedWithReason': 'اعمال {plugin} ناموفق بود: {reason}',
