...
export const fa: Dict = {
  ...
  'settings.azureNativeImageInput': 'ورودی تصویر را برای این استقرار Azure فعال کنید',
  'settings.azureNativeImageInputHint': 'این گزینه را فقط زمانی روشن کنید که استقرار Azure انتخاب‌شده از ورودی تصویر پشتیبانی می‌کند. استقرارهای فقط متنی باید آن را خاموش بگذارند.',
