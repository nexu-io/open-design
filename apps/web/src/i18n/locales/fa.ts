...
export const fa: Dict = {
  ...
  'chat.dsExtractUser': "استخراج سیستم طراحی از {source}",
  'chat.dsExtractRunning': "در حال استخراج سیستم طراحی…",
  'chat.dsExtractDone': "{name} استخراج شد — همه ماژول‌ها آماده‌اند.",
  'chat.dsNextStepsTitle': "گام‌های بعدی",
  'chat.dsMoreToggle': "بهینه‌سازی‌های بیشتر",
  ...
  'ds.fullSystemLabel': 'سیستم کامل {name}',
