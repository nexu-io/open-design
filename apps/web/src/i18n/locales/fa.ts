...
export const fa: Dict = {
  ...
  'fileViewer.displayDevDeployAnonymousHint': 'کلید API را خالی بگذارید تا یک پیش‌نمایش عمومی سی‌روزه با لینک ادعا منتشر شود.',
  ...
  'fileViewer.displayDevShowBranding': 'نمایش برندینگ',
  'fileViewer.displayDevShowBrandingInherit': 'ارث‌بری',
  'fileViewer.displayDevShowBrandingShow': 'نمایش',
  'fileViewer.displayDevShowBrandingHide': 'پنهان کردن',
