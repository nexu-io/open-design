...
export const fa: Dict = {
  ...
  'chat.runError.title.modelDocumentUnsupported': 'این مدل اسناد را نمی‌پذیرد',
  ...
  'chat.runError.modelDocumentUnsupportedMessage': 'این مدل در Bedrock اسناد (PDF) را نمی‌پذیرد. به یک مدل Anthropic یا Amazon Nova تغییر دهید و دوباره تلاش کنید.',
  ...
  'settings.bedrockRegionLabel': 'منطقه AWS',
  'settings.bedrockAuthMode': 'احراز هویت',
