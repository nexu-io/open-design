...
export const fa: Dict = {
  ...
  'figma.import.dialogAria': 'ورود از Figma',
  'figma.import.notesPlaceholder': 'اختیاری: یادداشت‌هایی برای ساخت (مثلاً «آن را به یک لندینگ مارکتینگ تبدیل کن»)',
  'figma.import.submit': 'ورود و ساخت',
  'figma.import.colorsAria': 'توکن‌های رنگ',
  'figma.import.summaryFoot': 'پرامپت در کامپوزر آماده است — بررسی و ارسالش کن تا صفحه ساخته شود.',
  'figma.import.tabFile': 'بارگذاری .fig',
  'figma.import.dropHint': 'روی دستگاه شما رمزگشایی می‌شود — توکن‌ها، کامپوننت‌ها و دارایی‌ها. بدون حساب Figma.',
  'figma.import.urlHint': 'از طریق کانکتور Figma (OAuth) و جریان مهاجرت انجام می‌شود.',
  'figma.import.decoding': 'در حال رمزگشایی…',
  'figma.import.notFigError': 'این فایل .fig نیست. فایل Figma را به‌صورت .fig خروجی بگیر (File → Save local copy) و اینجا رها کن.',
  'figma.import.importedLabel': 'وارد شد',
  'figma.import.assetsOnlySuffix': ' (فقط دارایی‌ها — درخت گره‌ها رمزگشایی نشد)',
  'figma.import.statNodes': 'گره',
  'figma.import.statPages': 'صفحه',
  'figma.import.statFrames': 'فریم',
  'figma.import.statComponents': 'کامپوننت',
  'figma.import.statColors': 'رنگ',
  'figma.import.statFonts': 'فونت',
  'figma.import.statAssets': 'دارایی',
  'designFiles.library.label': 'وارد کردن از کتابخانه',
  'designFiles.library.title': 'وارد کردن از کتابخانه',
  'library.upload.title': 'بارگذاری به کتابخانه',
  'library.upload.closeAria': 'بستن بارگذاری',
  'library.upload.dropHint': 'تصاویر، فونت‌ها، متن، HTML و JSON / داده‌های طراحی · تا {maxMb} مگابایت برای هر فایل',
  'library.upload.uploading': 'در حال بارگذاری…',
  'library.upload.deduped': 'از قبل در کتابخانه است',
  'library.upload.added': 'افزوده شد',
  'library.upload.failed': 'ناموفق',
  'library.upload.empty': 'هنوز چیزی بارگذاری نشده',
  'library.upload.summaryAdded': '{count} افزوده شد',
  'library.upload.summaryFailed': '{count} ناموفق',
  'library.upload.done': 'انجام شد',
  ...
  'plugins.availableDetails.closeDialog': 'بستن جزئیات افزونهٔ موجود',
  ...
  'plugins.contextChipsEmpty': 'هیچ زمینهٔ افزونهٔ فعالی وجود ندارد.',
  'plugins.contextChipsRemove': 'حذف {kind} {label}',
  'plugins.import.kicker': 'افزونه‌های کاربر',
  'plugins.import.title': 'وارد کردن افزونه',
  'plugins.import.closeDialog': 'بستن گفتگوی ورود',
  'plugins.import.sourceTabs': 'منبع ورود',
  'plugins.import.tabGithub': 'از GitHub',
  'plugins.import.tabGithubBody': 'مسیرهای github:owner/repo را نصب می‌کند.',
  'plugins.import.tabZip': 'بارگذاری zip',
  'plugins.import.tabZipBody': 'آرشیو افزونه را بارگذاری می‌کند.',
  'plugins.import.tabFolder': 'بارگذاری پوشه',
  'plugins.import.tabFolderBody': 'پوشهٔ افزونه را بارگذاری می‌کند.',
  'plugins.import.sourceLabel': 'منبع GitHub، آرشیو یا مارکت‌پلیس',
  'plugins.import.sourceHelp': 'از {sourceSpec}، آرشیوهای HTTPS {archiveExts} یا نام افزونه‌های مارکت‌پلیس پشتیبانی می‌کند.',
  'plugins.import.submit': 'وارد کردن',
  'plugins.import.submitWorking': 'در حال ورود…',
  'plugins.import.zipBody': 'یک آرشیو .zip حاوی open-design.json، SKILL.md یا .claude-plugin/plugin.json انتخاب کنید.',
  'plugins.import.folderBody': 'پوشهٔ افزونه را انتخاب کنید. مسیرهای نسبی حفظ می‌شوند و در رجیستری افزونه‌های کاربر شما نصب می‌شوند.',
  'plugins.import.noZipSelected': 'هیچ zip انتخاب نشده',
  'plugins.import.noFolderSelected': 'هیچ پوشه‌ای انتخاب نشده',
  'plugins.import.filesSelected': 'فایل‌های انتخاب‌شده: {count}',
  'plugins.import.footerNote': 'افزونه‌های واردشده افزونه‌های کاربر هستند و جدا از افزونه‌های رسمی همراه ذخیره می‌شوند.',
  'plugins.filtersAria': 'فیلترهای افزونه',
  'plugins.previewHero.eyebrow': 'چه چیزی تولید می‌کند',
  'plugins.previewHero.outputsAria': 'خروجی‌های نمونه',
  'plugins.previewHero.openNewTabTitle': 'باز کردن این مثال در تب جدید',
  'plugins.previewHero.openLabel': 'باز کردن',
  ...
  'settings.sectionsAria': 'بخش‌های تنظیمات',
  ...
  'connectors.providerAria': 'ارائه‌دهندهٔ کانکتور',
  ...
  'newproj.scrollTypesLeft': 'اسکرول انواع پروژه به چپ',
  'newproj.scrollTypesRight': 'اسکرول انواع پروژه به راست',
  ...
  'chat.comments.annotationAria': 'یادداشت',
  'chat.comments.moveBox': 'جابجایی کادر نظر',
  ...
  'workspace.tabsChrome': 'برگه‌های فضای کاری',
  'workspace.tabsStrip': 'فضاهای کاری باز',
  ...
  'brand.fontsMissingTitle': 'فایل‌های فونت برند موجود نیستند',
  'brand.fontsMissingBody': 'پیش‌نمایش‌های تایپوگرافی تا زمان افزودن فایل‌های فونت برند از فونت‌های وب جایگزین استفاده می‌کنند.',
  'brand.fontsAddFiles': 'افزودن فایل‌های فونت برند',
  'brand.fontsKeepSubstitutes': 'نگه داشتن فونت‌های جایگزین',
