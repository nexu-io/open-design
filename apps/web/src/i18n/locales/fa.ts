...
export const fa: Dict = {
  ...
  'fileViewer.deployToDisplayDev': 'انتشار در display.dev',
  'fileViewer.redeployToDisplayDev': 'انتشار دوباره در display.dev',
  'fileViewer.deployingToDisplayDev': 'در حال انتشار در display.dev…',
  ...
  'fileViewer.displayDevApiKey': 'کلید API display.dev (اختیاری)',
  'fileViewer.displayDevApiKeyGetLink': 'دریافت کلید API display.dev',
  'fileViewer.displayDevApiKeyPlaceholder': 'sk_live...',
  'fileViewer.displayDevVisibilityUnchanged': 'حفظ نمایانی فعلی',
  'fileViewer.displayDevApiKeyBlankHint': 'برای انتشار ناشناس با URL سی‌روزه و لینک ادعا، خالی بگذارید.',
  'fileViewer.displayDevApiKeyClearHint': 'برای انتشار ناشناس، این فیلد را خالی کنید.',
  'fileViewer.displayDevDeploySubtitle': 'این پیش‌نمایش HTML را به یک URL قابل اشتراک در display.dev منتشر کنید.',
  'fileViewer.displayDevDeployAuthenticatedCreateHint': 'با تنظیمات دسترسی زیر در سازمان display.dev شما منتشر می‌شود.',
  'fileViewer.displayDevDeployAnonymousWithKeyHint': 'با کلید API دوباره منتشر کنید تا یک پیش‌نمایش مالکیت‌دار display.dev ساخته شود. پیش‌نمایش ناشناس موجود خودکار ادعا نمی‌شود.',
  'fileViewer.displayDevDeployOwnedHint': 'برای استقرار دوباره به کلید API نیاز است. تنظیمات دسترسی فعلی بدون تغییر می‌مانند، مگر اینکه آن‌ها را ویرایش کنید.',
  ...
  'fileViewer.displayDevVisibilityProvider': 'پیش‌فرض حساب',
  'fileViewer.displayDevVisibilityPublic': 'عمومی',
  'fileViewer.displayDevVisibilityCompany': 'شرکت',
  'fileViewer.displayDevVisibilityPrivate': 'خصوصی',
  'fileViewer.displayDevShareWith': 'اشتراک‌گذاری با',
  'fileViewer.displayDevShareWithPublicHint': 'اگر بعداً میزان دسترسی را تغییر دهید، گیرندگان ذخیره می‌مانند.',
  'fileViewer.displayDevShareWithPlaceholder': 'person@example.com, teammate@example.com',
  'fileViewer.displayDevClaimUrlLabel': 'URL ادعا',
  'fileViewer.displayDevClaimUrlMessage': 'این URL را ادعا کنید تا آن را دائمی نگه دارید و دسترسی را در display.dev مدیریت کنید.',
  'fileViewer.displayDevClaimUrlExpiresMessage': 'این URL را ادعا کنید تا آن را دائمی نگه دارید و دسترسی را در display.dev مدیریت کنید. انقضا: {date}.',
  ...
  'fileViewer.deploymentsLoadFailed': 'بارگذاری استقرارها ممکن نشد.',
  'fileViewer.displayDevAccessSettingsLoadFailed': 'تنظیمات دسترسی display.dev بارگذاری نشد.',
  'fileViewer.deploymentsLoadRetry': 'تلاش دوباره',
  ...
  'fileViewer.displayDevDeploymentReadyDescription': 'پیوند استقرار آماده است.',
