...
export const fa: Dict = {
  ...
  'settings.agentInventoryTitle': 'نصب‌شده در {client}',
  'settings.agentInventoryRefresh': 'بازخوانی',
  'settings.agentInventoryLoading': 'در حال بارگذاری سرورهای MCP و مهارت‌های نصب‌شده…',
  'settings.agentInventoryError': 'امکان بارگذاری موجودی این CLI وجود نداشت ({error}).',
  'settings.agentInventoryUnsupported': 'تشخیص موجودی برای {client} هنوز در دسترس نیست.',
  'settings.agentInventoryUnavailable': 'پیکربندی {client} شناسایی نشد.',
  'settings.agentInventoryEmpty': 'هیچ سرور MCP یا مهارت نصب‌شده‌ای برای {client} شناسایی نشد.',
  'settings.agentInventoryMcpServers': 'سرورهای MCP',
  'settings.agentInventorySkills': 'مهارت‌ها',
  'settings.agentInventoryNoMcpServers': 'هیچ سرور MCP شناسایی نشد.',
  'settings.agentInventoryNoSkills': 'هیچ مهارتی شناسایی نشد.',
  'settings.agentInventorySourceUser': 'کاربر',
