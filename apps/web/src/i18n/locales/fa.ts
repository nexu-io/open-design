...
export const fa: Dict = {
  ...
  'settings.updatePreviewLabel': 'پیش‌نمایش به‌روزرسانی',
  'settings.updatePreviewActual': 'وضعیت واقعی توسعه',
  'settings.updatePreviewIdle': 'بررسی نشده',
  'settings.updatePreviewChecking': 'در حال بررسی',
  'settings.updatePreviewUpToDate': 'آخرین نسخه',
  'settings.updatePreviewAvailable': 'نسخه جدید',
  'settings.updatePreviewDownloading': 'در حال دانلود',
  'settings.updatePreviewDownloaded': 'آماده نصب',
  'settings.updatePreviewInstalling': 'در حال نصب',
  'settings.updatePreviewError': 'بررسی ناموفق',
  'settings.updatePreviewUnsupported': 'پشتیبانی‌نشده',
