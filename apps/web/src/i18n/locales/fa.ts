...
export const fa: Dict = {
  ...
  'chat.runError.title.clientEnvironment': "این سرویس فعلاً در منطقه شما در دسترس نیست",
  ...
  'chat.runError.clientEnvironmentMessage': "منطقه‌ای که شبکه شما در آن قرار دارد فعلاً پشتیبانی نمی‌شود. شبکه را عوض کنید و دوباره تلاش کنید.",
