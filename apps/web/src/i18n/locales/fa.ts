...
export const fa: Dict = {
  ...
  'billing.codingPlanUnavailable': 'مصرف طرح در دسترس نیست',
  'billing.codingPlanWindowHours': 'بازه {count} ساعته',
  'billing.codingPlanWindowDays': 'بازه {count} روزه',
  'billing.codingPlanUsedPercent': '{percent}% مصرف‌شده',
  'billing.codingPlanRemainingAmount': '{amount} باقی‌مانده',
