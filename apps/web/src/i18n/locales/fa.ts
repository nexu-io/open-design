...
export const fa: Dict = {
  ...
  'fileViewer.shareGuide.title': "خروجی گرفته شد",
  'fileViewer.shareGuide.description': "پیوند را به اشتراک بگذارید و دیگران را برای مشاهده و ثبت نظر دعوت کنید.",
  'fileViewer.shareGuide.tryShare': "اشتراک‌گذاری",
  ...
  "fileViewer.shareUpdateSuccess": "پیوند به‌روزرسانی شد",
  "fileViewer.shareUpdateFailed": "به‌روزرسانی ناموفق بود. نسخه قبلی همچنان در دسترس است.",
