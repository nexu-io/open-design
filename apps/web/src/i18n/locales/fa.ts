...
export const fa: Dict = {
  ...
  'settings.orcaRouterConnectIntro': 'با حساب OrcaRouter خود وارد شوید یا یک کلید API موجود را بچسبانید. هر دو به حساب خودتان محاسبه میشود و هر زمان قابل لغو است.',
  'settings.orcaRouterNotConnected': 'متصل نیست.',
  'settings.orcaRouterConnected': 'به OrcaRouter متصل شد.',
  'settings.orcaRouterNeedsReauthTitle': 'باید دوباره به OrcaRouter وارد شوید.',
  'settings.orcaRouterNeedsReauth': 'OrcaRouter این اعتبارنامه را رد کرد. دوباره وارد شوید یا کلید API جدیدی بچسبانید.',
  'settings.orcaRouterScopeGranted': 'دامنه اعطاشده:',
  'settings.orcaRouterWaiting': 'در انتظار مجوز…',
  'settings.orcaRouterWaitingHint': 'OpenDesign در انتظار پاسخ است. بهمحض تأیید در مرورگر، این پنل به «متصل» تغییر میکند.',
  'settings.orcaRouterConnect': 'اتصال به OrcaRouter',
  'settings.orcaRouterReconnect': 'اتصال دوباره',
  'settings.orcaRouterReconnectHint': 'مجوز دوباره و جایگزینی کلید ذخیرهشده',
  'settings.orcaRouterConnecting': 'در حال اتصال…',
  'settings.orcaRouterOpeningBrowser': 'در حال بازکردن مرورگر…',
  'settings.orcaRouterCancel': 'لغو',
  'settings.orcaRouterDisconnect': 'قطع اتصال',
  'settings.orcaRouterDisconnecting': 'در حال قطع اتصال…',
  'settings.orcaRouterOpenManually': 'تب مرورگر باز نشد؟',
  'settings.orcaRouterOpenManuallyLink': 'بازکردن دستی صفحه مجوز',
  'settings.orcaRouterPasteHint': 'ممکن است OrcaRouter بهجای تغییر مسیر یک کد نمایش دهد. آن را اینجا بچسبانید:',
  'settings.orcaRouterPastePlaceholder': 'کد مجوز را بچسبانید',
  'settings.orcaRouterSubmitCode': 'ارسال کد',
  'settings.orcaRouterSubmitting': 'در حال ارسال…',
};
