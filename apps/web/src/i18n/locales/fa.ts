...
export const fa: Dict = {
  ...
  'chat.runError.description.useOfficialAgent': 'عامل انتخاب شده وارد سیستم نشده است. از عامل رسمی Open Design برای اجرای پایدارتر و به صرفه تر استفاده کنید، یا عامل فعلی را دوباره امتحان کنید.',
  'chat.runError.description.rateLimitUseOfficialAgent': 'مدل یا ارائه دهنده فعلی به سقف سهمیه یا محدودیت نرخ رسیده است. بعدا دوباره امتحان کنید، یا از عامل Open Design برای اجرای پایدارتر و به صرفه تر استفاده کنید.',
  'chat.runError.description.upstreamUseOfficialAgent': 'ارائه دهنده مدل موقتا در دسترس نیست. بعدا دوباره امتحان کنید، یا از عامل Open Design برای اجرای پایدارتر و به صرفه تر استفاده کنید.',
  'chat.runError.description.genericUseOfficialAgent': 'اجرای وظیفه شکست خورد. بعدا دوباره امتحان کنید، یا از عامل Open Design برای اجرای پایدارتر و به صرفه تر استفاده کنید.',
