...
export const fa: Dict = {
  ...
  'chat.mentionSectionParts': 'بخش‌ها',
  ...
  'scene3d.compile': 'کامپایل',
  'scene3d.compiling': 'در حال کامپایل…',
  'scene3d.recompile': 'کامپایل دوباره',
  'scene3d.verdict': 'نتیجه',
  'scene3d.verdictClean': 'کامپایل بدون خطا · {warnings} هشدار',
  'scene3d.verdictFailed': '{errors} خطا · {warnings} هشدار',
  'scene3d.neverCompiled': 'هرگز کامپایل نشده',
  'scene3d.parts': 'قطعات',
  'scene3d.noParts': 'هنوز قطعه‌ای نیست',
  'scene3d.issues': 'مشکل‌ها',
  'scene3d.noIssues': 'مشکلی نیست',
  'scene3d.assets': 'دارایی‌ها',
  'scene3d.noAssets': 'هنوز خروجی‌ای نیست',
  'scene3d.noProof': 'فریم شاهدی نیست — یک کامپایل اجرا کنید',
  'scene3d.frameAlt': 'فریم شاهد',
  'scene3d.frameSlider': 'فریم گردان',
  'scene3d.dragHint': 'برای چرخش بکشید',
  'scene3d.issuesStoredHint': 'برای جزئیات دوباره کامپایل کنید',
  'scene3d.meshCounts': '{verts}v / {faces}f',
  'scene3d.fixPrefix': 'رفع:',
  'scene3d.exportMenu': 'خروجی گرفتن',
  'scene3d.exportEmpty': 'هنوز چیزی کامپایل نشده است',
  'scene3d.exportAll': 'دانلود همه ({count} فایل)',
  'scene3d.exportAllScenes': 'همه صحنه‌ها',
  'scene3d.exportAllChip': 'همه',
  'scene3d.exportAllBusy': 'در حال آماده‌سازی آرشیو…',
  'scene3d.exportModels': 'مدل‌ها',
  ...
  'scene3d.kindProp': 'وسیله صحنه',
  'scene3d.kindKit': 'کیت',
  'scene3d.kindAnimation': 'انیمیشن',
  'scene3d.kindSprite': 'برگه اسپرایت',
  'scene3d.kindFlipbook': 'فلیپ‌بوک',
  'scene3d.kindVfx': 'جلوه‌های ویژه',
  'scene3d.kindSkybox': 'اسکای‌باکس',
  'scene3d.kindTexture': 'بافت',
  'scene3d.partsCount': '{count} قطعه',
  'scene3d.trisCount': '{count} مثلث',
  'scene3d.claimsProven': '{count} ادعای اثبات‌شده',
  'scene3d.blenderVersion': 'Blender {version}',
  'scene3d.scenes': 'صحنه‌ها',
  'scene3d.kitScenes': '{count} صحنه',
  'scene3d.kitStageTitle': 'نمایشگر کیت',
  'scene3d.kitTruncated': 'نمایش {count} صحنه نخست',
  'scene3d.backToKit': 'بازگشت به کیت',
  'homeHero.chip.scene3dChip': 'صحنه سه‌بعدی',
  'homeHero.chip.scene3dChipDesc': 'مدل‌ها، بافت‌ها، شیت اسپرایت و فلیپ‌بوک',
  'homeHero.chip.scene3dChipHint': 'دارایی سه‌بعدی را به‌صورت کد بنویسید و با Blender بدون رابط کامپایل کنید — شاهد گردان، بررسی قراردادها، خروجی GLB و USD.',
  'scene3d.replay': 'پخش دوباره',
  'scene3d.stop': 'توقف',
};
