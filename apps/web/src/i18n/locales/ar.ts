...
export const ar: Dict = {
  ...
  'chat.dsExtractUser': "استخراج نظام التصميم من {source}",
  'chat.dsExtractRunning': "جارٍ استخراج نظام التصميم…",
  'chat.dsExtractDone': "تم استخراج {name} — جميع الوحدات جاهزة.",
  'chat.dsNextStepsTitle': "الخطوات التالية",
  'chat.dsMoreToggle': "تحسينات إضافية",
