...
export const ar: Dict = {
  ...
  'settings.updatePreviewLabel': 'معاينة التحديث',
  'settings.updatePreviewActual': 'حالة التطوير الفعلية',
  'settings.updatePreviewIdle': 'لم يتم التحقق',
  'settings.updatePreviewChecking': 'جارٍ التحقق',
  'settings.updatePreviewUpToDate': 'أحدث إصدار',
  'settings.updatePreviewAvailable': 'إصدار جديد',
  'settings.updatePreviewDownloading': 'جارٍ التنزيل',
  'settings.updatePreviewDownloaded': 'جاهز للتثبيت',
  'settings.updatePreviewInstalling': 'جارٍ التثبيت',
  'settings.updatePreviewError': 'فشل التحقق',
  'settings.updatePreviewUnsupported': 'غير مدعوم',
