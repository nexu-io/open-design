...
export const pl: Dict = {
  ...
  'settings.agentInventoryTitle': 'Zainstalowane w {client}',
  'settings.agentInventoryRefresh': 'Odśwież',
  'settings.agentInventoryLoading': 'Ładowanie zainstalowanych serwerów MCP i umiejętności…',
  'settings.agentInventoryError': 'Nie udało się wczytać inwentarza tej CLI ({error}).',
  'settings.agentInventoryUnsupported': 'Wykrywanie inwentarza dla {client} nie jest jeszcze dostępne.',
  'settings.agentInventoryUnavailable': 'Nie wykryto konfiguracji {client}.',
  'settings.agentInventoryEmpty': 'Nie wykryto zainstalowanych serwerów MCP ani umiejętności dla {client}.',
  'settings.agentInventoryMcpServers': 'Serwery MCP',
  'settings.agentInventorySkills': 'Umiejętności',
  'settings.agentInventoryNoMcpServers': 'Nie wykryto serwerów MCP.',
  'settings.agentInventoryNoSkills': 'Nie wykryto umiejętności.',
  'settings.agentInventorySourceUser': 'Użytkownik',
