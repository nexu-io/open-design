...
export const pl: Dict = {
  ...
  'settings.azureNativeImageInput': 'Włącz wejście obrazów dla tego wdrożenia Azure',
  'settings.azureNativeImageInputHint': 'Włącz tę opcję tylko wtedy, gdy wybrane wdrożenie Azure obsługuje wejście obrazów. Wdrożenia wyłącznie tekstowe powinny pozostawić ją wyłączoną.',
