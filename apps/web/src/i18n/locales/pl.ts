...
export const pl: Dict = {
  ...
  'chat.runError.description.useOfficialAgent': 'Wybrany agent nie jest zalogowany. Użyj oficjalnego agenta Open Design, aby uruchomić zadanie stabilniej i korzystniej kosztowo, albo ponów próbę z obecnym agentem.',
  'chat.runError.description.rateLimitUseOfficialAgent': 'Bieżący model lub dostawca osiągnął limit kwoty albo częstotliwości. Spróbuj ponownie później albo użyj agenta Open Design, aby uruchomić zadanie stabilniej i korzystniej kosztowo.',
  'chat.runError.description.upstreamUseOfficialAgent': 'Dostawca modelu jest tymczasowo niedostępny. Spróbuj ponownie później albo użyj agenta Open Design, aby uruchomić zadanie stabilniej i korzystniej kosztowo.',
  'chat.runError.description.genericUseOfficialAgent': 'Wykonanie zadania nie powiodło się. Spróbuj ponownie później albo użyj agenta Open Design, aby uruchomić zadanie stabilniej i korzystniej kosztowo.',
