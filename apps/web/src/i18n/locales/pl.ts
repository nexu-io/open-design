...
export const pl: Dict = {
  ...
  'fileViewer.exportPdfServer': 'Eksportuj PDF — wysoka jakość',
  'fileViewer.exportPdfServerBusy': 'Eksportowanie PDF…',
  'fileViewer.exportPdfServerError': 'Błąd eksportu PDF',
