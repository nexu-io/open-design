...
export const en: Dict = {
  ...
  'settings.onboardingAmrTitle': "AMR Cloud",
  'settings.onboardingAmrBody': "Open Design's official Model Router.\nSupports mainstream models with token discounts.\nOne API for config; multimodal models, skills, connectors next.",
  'settings.onboardingAmrAction': "Continue with AMR Cloud",
  'settings.onboardingAmrWaitingTitle': "Waiting for AMR sign-in",
  'settings.onboardingAmrWaitingBody': "We opened a mock AMR login window. This mock will verify automatically in about 5 seconds, then continue setup.",
  'settings.onboardingAmrOpenAgain': "Open AMR again",
