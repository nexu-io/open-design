...
export const en: Dict = {
  ...
  'settings.onboardingCloudTitle': 'Welcome to OpenDesign',
  'settings.onboardingCloudBody': 'Turn your ideas into designs.',
  'settings.onboardingCloudSignIn': 'Sign in / Sign up',
  ...
  'fileViewer.cloudflareWorkersScriptName': 'Script name',
  'fileViewer.cloudflareWorkersCompatibilityDate': 'Compatibility date',
  'fileViewer.cloudflareWorkersBindings': 'Bindings',
  'fileViewer.cloudflareWorkersAddBinding': 'Add binding',
  'fileViewer.cloudflareWorkersRemoveBinding': 'Remove',
  'fileViewer.cloudflareWorkersBindingName': 'Binding name',
  'fileViewer.cloudflareWorkersBindingBucketName': 'Bucket name',
  'fileViewer.cloudflareWorkersBindingDatabaseId': 'Database ID',
  'fileViewer.cloudflareWorkersBindingDatabaseName': 'Database name (create if missing)',
  'fileViewer.cloudflareWorkersBindingDatabaseNameHint': 'Leave ID empty to create a D1 database by this name on deploy',
  'fileViewer.cloudflareWorkersBindingR2CreateHint': 'The bucket is created automatically if it does not exist',
  'fileViewer.cloudflareWorkersCustomDomain': 'Custom domain',
  'fileViewer.cloudflareWorkersCustomDomainZone': 'Zone',
  'fileViewer.cloudflareWorkersCustomDomainHostname': 'Hostname',
  'fileViewer.cloudflareWorkersScopeD1Write': 'D1 write',
  'fileViewer.cloudflareWorkersScopeR2Write': 'R2 storage write',
  'fileViewer.cloudflareWorkersBindingsEmpty': 'No bindings yet.',
  'fileViewer.cloudflareWorkersCapabilities': 'Capabilities',
  'fileViewer.cloudflareWorkersCapabilitiesLoading': 'Loading…',
  'fileViewer.cloudflareWorkersCapabilitiesLoadFailed': 'Could not load capabilities.',
  'fileViewer.cloudflareWorkersCapabilitiesRefresh': 'Refresh',
  'fileViewer.cloudflareWorkersCapabilitiesEmpty': 'Save your settings to check capabilities.',
  'fileViewer.cloudflareWorkersEnabled': 'Enabled',
  'fileViewer.cloudflareWorkersDisabled': 'Disabled',
  'fileViewer.cloudflareWorkersWorkers': 'Workers',
  'fileViewer.cloudflareWorkersSubdomain': 'Workers Dev subdomain',
  'fileViewer.cloudflareWorkersR2': 'R2',
  'fileViewer.cloudflareWorkersD1': 'D1',
  'fileViewer.cloudflareWorkersAccess': 'Access',
  'fileViewer.cloudflareWorkersAccessEnabled': 'Private (Cloudflare Access)',
  'fileViewer.cloudflareWorkersAccessNotAvailable': 'Cloudflare Access is not available with this credential',
  'fileViewer.cloudflareWorkersAccessRule': 'Who can open this deployment',
  'fileViewer.cloudflareWorkersAccessRuleEmails': 'Specific emails',
  'fileViewer.cloudflareWorkersAccessRuleEmailDomain': 'Email domain',
  'fileViewer.cloudflareWorkersAccessRuleSelf': 'Only me',
  'fileViewer.cloudflareWorkersAccessRulePolicy': 'Existing Access policy',
  ...
  'fileViewer.cloudflareWorkersAccessPolicyIdPlaceholder': 'Access policy UUID',
  'fileViewer.cloudflareWorkersAccessProtected': 'Protected by Cloudflare Access',
  'fileViewer.cloudflareWorkersAccessRuleRequired': 'Add at least one email, an email domain, or an Access policy ID before deploying with Cloudflare Access.',
  'fileViewer.cloudflareWorkersBindingIncomplete': 'Every binding needs a name and a bucket or database.',
  'fileViewer.cloudflareWorkersReasonR2NotEnabled': 'R2 is not enabled for this account.',
  'fileViewer.cloudflareWorkersReasonAccessNotEnabled': 'Cloudflare Access is not enabled for this account.',
  'fileViewer.cloudflareWorkersReasonNoPermission': 'The API token does not have permission for this action.',
  'fileViewer.cloudflareWorkersReasonUnknown': 'Unknown',
  'fileViewer.cloudflareWorkersOauthCredentialMode': 'Credential mode',
  'fileViewer.cloudflareWorkersOauthCredentialModeToken': 'API token',
  'fileViewer.cloudflareWorkersOauthCredentialModeOauth': 'Sign in with Cloudflare',
  'fileViewer.cloudflareWorkersOauthClientId': 'Client ID',
  'fileViewer.cloudflareWorkersOauthRedirectUri': 'Redirect URI',
  'fileViewer.cloudflareWorkersOauthScopes': 'Scopes',
  'fileViewer.cloudflareWorkersOauthScopeZoneRead': 'Zone read',
  'fileViewer.cloudflareWorkersOauthScopeAccessWrite': 'Access apps write',
  'fileViewer.cloudflareWorkersOauthScopeD1Read': 'D1 read',
  'fileViewer.cloudflareWorkersOauthScopeR2Read': 'R2 storage read',
  'fileViewer.cloudflareWorkersOauthConnect': 'Connect with Cloudflare',
  'fileViewer.cloudflareWorkersOauthOpening': 'Opening Cloudflare…',
  'fileViewer.cloudflareWorkersOauthConnected': 'Connected',
  'fileViewer.cloudflareWorkersOauthConnectFailed': 'Could not start Cloudflare sign-in.',
  'fileViewer.cloudflareWorkersOpenSite': 'Open deployed site',
  'fileViewer.cloudflareOAuthSignIn': 'Sign in with Cloudflare',
  'fileViewer.cloudflareOAuthOpening': 'Opening browser…',
  'fileViewer.cloudflareOAuthAwaiting': 'Waiting for Cloudflare authorization…',
  'fileViewer.cloudflareOAuthNotConnected': 'Not connected',
  'fileViewer.cloudflareOAuthBound': 'Bound to account {accountId}',
  'fileViewer.cloudflareOAuthExpiresIn': 'Token expires in {minutes} min',
  'fileViewer.cloudflareOAuthGrantedScopes': 'Granted scopes: {scope}',
  'fileViewer.cloudflareOAuthExpired': 'Token expired. Sign in again.',
  'fileViewer.cloudflareOAuthReconnect': 'Reconnect',
  'fileViewer.cloudflareOAuthDisconnect': 'Disconnect',
  'fileViewer.cloudflareOAuthDisconnecting': 'Disconnecting…',
  'fileViewer.cloudflareOAuthRefresh': 'Refresh status',
  'fileViewer.cloudflareOAuthOpenManually': 'Open the authorization page manually',
  ...
  'fileViewer.deployAccessUnverified': 'Deployed, but OpenDesign could not verify that Cloudflare Access is guarding this link. Check your Access settings before sharing it.',
