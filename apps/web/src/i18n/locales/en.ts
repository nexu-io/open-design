...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to Marketing AX\'s official AMR model service — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. Marketing AX will create a project and keep the work editable.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the Marketing AX daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to Marketing AX.',
  ...
  'settings.mcpServerHint': 'Expose Marketing AX as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the Marketing AX team',
  'settings.privacyConsentKicker': 'Help us improve Marketing AX',
  'settings.privacyConsentLead': 'Marketing AX can share usage data with our team to help us improve. This includes:',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your Marketing AX projects directly.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure Marketing AX is running, then reopen this panel.',
  'settings.mcpBuildDaemon': 'Build the daemon first.',
  'settings.mcpNodeMissing': 'Node binary is missing.',
  'settings.mcpBuildHint': 'apps/daemon/dist/cli.js is missing. Run `pnpm --filter @marketing-ax/daemon build` and refresh.',
  ...
  'settings.mcpCapabilityDefault': 'Default to the project and file you have open in Marketing AX, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote': 'Marketing AX must be running for MCP tool calls to succeed. If you started your coding agent before opening Marketing AX, restart the agent so it can reach the live daemon.',
  ...
  'entry.discordAria': 'Join the Marketing AX Discord',
  'entry.discordAriaWithOnline': 'Join the Marketing AX Discord - {online}',
  ...
  'brands.empty': 'No brands registered yet.',
  'brands.back': 'Back',
  'brands.core': 'Brand core',
  'brands.loadFailed': 'Could not load this brand.',
  'brands.pageTitle': 'Brands',
  'brands.pageSubtitle': 'Register each brand’s context and design system, then create projects.',
  'brands.sectionContext': 'Brand context',
  'brands.sectionDesignSystem': 'Design system',
  'brands.sectionDocs': 'Knowledge docs',
  'brands.docsHint': 'The brand core and each channel’s craft doc (.md) are injected into runs. Select a doc to view it.',
  'brands.fieldTagline': 'Tagline',
  'brands.fieldWebsite': 'Website',
  'brands.fieldAudience': 'Core audience',
  'brands.fieldKeyMessage': 'Key message',
  'brands.fieldAvoid': 'Avoid',
  'brands.fieldChannels': 'Channels',
  'brands.palette': 'Color palette',
  'brands.typography': 'Typography',
  'brands.voiceTone': 'Voice & tone',
  'brands.coreDocLabel': 'Brand core',
  'brands.projectCount': '{n} projects',
  'brands.paletteChannelMeta': '{c} colors · {n} channels registered',
  'brands.newButton': '+ New brand',
  'brands.newTitle': 'New brand',
  'brands.newFieldTitle': 'Name',
  'brands.newFieldId': 'ID',
  'brands.newFieldIdHint': 'Suggested from the name — lowercase letters, numbers, and hyphens.',
  'brands.newSubmit': 'Create',
  'brands.newDuplicateId': 'A brand with this ID already exists.',
  'brands.newFailed': 'Could not create the brand.',
  'brands.edit': 'Edit',
  'brands.save': 'Save',
  'brands.cancel': 'Cancel',
  'brands.saveFailed': 'Could not save changes.',
  'brands.fieldSubtitle': 'Subtitle',
  'brands.fieldToneLabel': 'Tone label',
  'brands.fieldTypographyFamily': 'Font family',
  'brands.fieldTypographyRoles': 'Font roles',
  'brands.fieldTypographyWeights': 'Font weights',
  'brands.fieldNeutralPalette': 'Neutral palette',
  'brands.fieldCommaHint': 'Separate multiple values with commas.',
  'brands.docEdit': 'Edit doc',
  'brands.docSaveFailed': 'Could not save the document.',
  'brands.channelAdd': '+ Channel',
  'brands.channelAddKey': 'Key',
  'brands.channelAddKeyHint': 'Lowercase letters, numbers, and hyphens — used as the prompt injection key.',
  'brands.channelAddLabel': 'Label',
  'brands.channelAddDesignSystem': 'Design system',
  'brands.channelAddSubmit': 'Add',
  'brands.channelAddFailed': 'Could not add the channel.',
  'brands.channelRemove': 'Remove channel',
  'brands.channelRemoveConfirm': 'Remove the {key} channel? Its craft doc will be deleted.',
  'brands.channelRemoveFailed': 'Could not remove the channel.',
  'brands.uploadIcon': 'Upload icon',
  'brands.uploadLogo': 'Upload logo',
  'brands.uploadFailed': 'Could not upload the image.',
  'brands.uploadTooLarge': 'The file is too large.',
  'brands.deleteZone': 'Danger zone',
  'brands.delete': 'Delete brand',
  'brands.deleteConfirm': 'Delete the {title} brand? This cannot be undone.',
  'brands.deleteBlocked': '{n} projects use this brand. Delete those projects first.',
  'brands.deleteFailed': 'Could not delete the brand.',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable Marketing AX plugin and add it to My plugins.',
  ...
  'handoff.promptIntro': 'Continue from this local Marketing AX project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. Marketing AX Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use Marketing AX workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with Marketing AX and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to Marketing AX',
  'pluginCard.contributeTitle': 'Contribute plugin to Marketing AX with a pull request',
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use Marketing AX from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure Marketing AX is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use Marketing AX everywhere',
  'useEverywhere.modalTitle': 'Use Marketing AX everywhere',
  'useEverywhere.modalSubtitle': 'Drop Marketing AX into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'Marketing AX works wherever your agent works',
  'useEverywhere.section.overview.intro': 'Marketing AX is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires Marketing AX as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without Marketing AX at all.',
  ...
  'useEverywhere.section.overview.footer': 'The daemon writes to `./.max/` (project-local) by default. Set `MAX_DATA_DIR=~/.open-design` to share data across projects.',
  'useEverywhere.section.cli.tab': 'CLI · od',
  'useEverywhere.section.cli.heading': 'Drive Marketing AX from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose Marketing AX as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'Marketing AX ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover Marketing AX tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.bullet4': 'Pins `MAX_DATA_DIR` so the spawned MCP process writes to the same place the daemon already uses (avoids EPERM in packaged macOS app bundles).',
  ...
  'useEverywhere.section.mcp.footer': 'In the Marketing AX app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  'useEverywhere.section.http.tab': 'HTTP API',
  'useEverywhere.section.http.heading': 'Same REST + SSE surface the web UI uses',
  'useEverywhere.section.http.intro': 'The local daemon serves an HTTP API at `http://127.0.0.1:7456` (port configurable). Every endpoint the web UI calls is also fair game for your scripts. Streaming endpoints (chat turns, project runs) emit Server-Sent Events with the contract types in `@marketing-ax/contracts`.',
  ...
  'useEverywhere.section.http.footer': 'Pure TypeScript types for every request/response live in `@marketing-ax/contracts` — import them in your script for full autocomplete without wiring a generator.',
  'useEverywhere.section.skills.tab': 'Skills & headless',
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without Marketing AX running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). Marketing AX extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside Marketing AX and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + Marketing AX extras)',
  ...
  'entry.githubStarAria': 'Star Marketing AX on GitHub',
  ...
  'newproj.locationDefault': 'Marketing AX projects',
  ...
  'ds.detailLoadFailed': 'Could not load this design system.',
  'ds.back': 'Back',
  'ds.detailLoading': 'Loading design system…',
  'ds.detailLoadingHint': 'Opening the review workspace.',
  ...
  'socialShare.openDesignSection': 'Share Marketing AX',
  'socialShare.openDesignTitle': 'Marketing AX on GitHub',
  'socialShare.openDesignText': 'Marketing AX is an open-source workspace for creating, editing, deploying, and handing off design artifacts.',
  'socialShare.openDesignCopyText': '{text}\n{url}',
  'socialShare.projectSection': 'SOCIAL SHARE',
  'socialShare.projectTitle': '{title} · Marketing AX',
  'socialShare.projectText': 'Built with Marketing AX: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with Marketing AX: {title}\n{url}\nMarketing AX repo: {repo}',
  ...
  'chat.activeFilePlaceholder': 'Ask Marketing AX to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want Marketing AX to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'preview.shareTextDefault': 'Marketing AX template: {title}',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure Marketing AX is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying Marketing AX? Star us on GitHub.',
  ...
  'fileViewer.openFolder': 'Open project folder',
  'fileViewer.openFolderFailed': 'Couldn\'t open the project folder.',
  'fileViewer.openFolderWebFallback': 'Folders can\'t be opened from the browser. Path:',
  'fileViewer.copyCaption': 'Copy caption',
  'fileViewer.copyCaptionDone': 'Caption copied to clipboard',
  'fileViewer.copyCaptionFailed': 'Couldn\'t copy the caption.',
  ...
  'assistant.shareToOpenDesign': 'Share to Marketing AX',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Marketing AX — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with Marketing AX — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple Marketing AX project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.defaultRouter.title': 'Default router',
  'settings.defaultRouter.description': 'Which router plugin handles free-form prompts that match no plugin trigger.',
  'settings.defaultRouter.builtin': 'Built-in (Default design router)',
  ...
  'settings.memoryStarterProjectDesc': 'Marketing AX v0.5 — chat-driven design editor',
  ...
  'updater.availableBody': 'Marketing AX {version} is available. It will download before the installer can open.',
  ...
  'updater.installerOpenBody': 'The installer is open. Marketing AX is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit Marketing AX',
  'updater.quitFailedBody': 'The installer is open, but Marketing AX could not quit. Quit Marketing AX before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. Marketing AX will close and open the installer.',
  'updater.readyVersion': 'Marketing AX {version} is ready. Marketing AX will close and open the installer.',
  ...
  'dsManager.createBody': 'Teach Marketing AX your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions Marketing AX follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
