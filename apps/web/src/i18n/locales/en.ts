...
export const en: Dict = {
  ...
  'settings.orcaRouterConnectIntro': 'Sign in with your OrcaRouter account, or paste an existing API key. Both are billed to your own account and revocable at any time.',
  'settings.orcaRouterNotConnected': 'Not connected.',
  'settings.orcaRouterConnected': 'Connected to OrcaRouter.',
  'settings.orcaRouterNeedsReauthTitle': 'OrcaRouter needs you to sign in again.',
  'settings.orcaRouterNeedsReauth': 'OrcaRouter rejected this credential. Sign in again or paste a new API key.',
  'settings.orcaRouterScopeGranted': 'Granted scope:',
  'settings.orcaRouterWaiting': 'Waiting for authorization…',
  'settings.orcaRouterWaitingHint': 'OpenDesign is listening for the callback. This panel switches to Connected as soon as you approve in your browser.',
  'settings.orcaRouterConnect': 'Connect with OrcaRouter',
  'settings.orcaRouterReconnect': 'Reconnect',
  'settings.orcaRouterReconnectHint': 'Re-authorize and replace the stored key',
  'settings.orcaRouterConnecting': 'Connecting…',
  'settings.orcaRouterOpeningBrowser': 'Opening browser…',
  'settings.orcaRouterCancel': 'Cancel',
  'settings.orcaRouterDisconnect': 'Disconnect',
  'settings.orcaRouterDisconnecting': 'Disconnecting…',
  'settings.orcaRouterOpenManually': 'Browser tab did not open?',
  'settings.orcaRouterOpenManuallyLink': 'Open the authorize page manually',
  'settings.orcaRouterPasteHint': 'OrcaRouter may show a code instead of redirecting. Paste it here:',
  'settings.orcaRouterPastePlaceholder': 'Paste authorization code',
  'settings.orcaRouterSubmitCode': 'Submit code',
  'settings.orcaRouterSubmitting': 'Submitting…',
};
