...
export const en: Dict = {
  ...
  'workspace.newCanvas': 'New Canvas',
  'workspace.newCanvasDescription': 'Arrange multiple artifacts on a freeform canvas to compare them side by side',
  'workspace.canvasAddArtifact': 'Add artifact',
