...
export const en: Dict = {
  ...
  'whatsNew.updatedTitle': 'What\'s new in Open Design {version}',
  'whatsNew.genericBody': 'Open Design has been updated with improvements and fixes. See the release notes for the details.',
