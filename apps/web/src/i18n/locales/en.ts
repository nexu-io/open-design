...
export const en: Dict = {
  ...
  'settings.welcomeTitle': 'Start with a result',
  'settings.welcomeSubtitle': 'Tell Open Design what you want, give it a little material, then generate a starter version with AMR credit.',
  ...
  'settings.onboardingStepConnect': 'Goal',
  'settings.onboardingStepDesignSystem': 'Generate',
  'settings.onboardingStepProfile': 'Material',
  ...
  'settings.onboardingGithubTitle': 'Paste website URL',
  'settings.onboardingGithubBody': 'Use a product, docs, or brand website.',
  'settings.onboardingUploadTitle': 'Upload files',
  'settings.onboardingUploadBody': 'Add screenshots, PPT, PDF, docs, or reference images.',
  'settings.onboardingPromptTitle': 'Write one sentence',
  'settings.onboardingPromptBody': 'Describe the product, brand, or result.',
