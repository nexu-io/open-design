...
export const en: Dict = {
  ...
  'settings.networkKeyRequired': 'Network access requires an API key',
  'settings.networkKeyRequiredHint': 'Binding to all interfaces exposes the daemon to your network. An API key will be generated for security.',
  'settings.generateAndSwitch': 'Generate Key & Switch',
  'settings.networkNoKeysWarning': 'Cannot restart without an API key',
  'settings.networkNoKeysWarningHint': 'At least one API key is required when the daemon is exposed to the network. Generate a key above before restarting.',
  ...
  'settings.restartingDaemon': 'Restarting…',
  'settings.restartFailed': 'Restart failed. Try again manually.',
