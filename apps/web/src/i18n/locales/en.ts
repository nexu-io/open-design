...
export const en: Dict = {
  ...
  'settings.agentInventoryTitle': 'Installed in {client}',
  'settings.agentInventoryRefresh': 'Refresh',
  'settings.agentInventoryLoading': 'Loading installed MCP servers and skills…',
  'settings.agentInventoryError': 'Could not load this CLI inventory ({error}).',
  'settings.agentInventoryUnsupported': 'Inventory detection for {client} is not available yet.',
  'settings.agentInventoryUnavailable': '{client} config was not detected.',
  'settings.agentInventoryEmpty': 'No installed MCP servers or skills were detected for {client}.',
  'settings.agentInventoryMcpServers': 'MCP servers',
  'settings.agentInventorySkills': 'Skills',
  'settings.agentInventoryNoMcpServers': 'No MCP servers detected.',
  'settings.agentInventoryNoSkills': 'No skills detected.',
  'settings.agentInventorySourceUser': 'User',
