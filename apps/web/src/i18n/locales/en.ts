...
export const en: Dict = {
  ...
  'chat.runError.description.useOfficialAgent': 'The selected agent is not signed in. Use the official Open Design agent for a more stable, cost-efficient run, or retry the current agent.',
  'chat.runError.description.rateLimitUseOfficialAgent': 'The current model or provider has hit a quota or rate limit. Retry later, or use the official Open Design agent for a more stable, cost-efficient run.',
  'chat.runError.description.upstreamUseOfficialAgent': 'The model provider is temporarily unavailable. Retry later, or use the official Open Design agent for a more stable, cost-efficient run.',
  'chat.runError.description.genericUseOfficialAgent': 'Task execution failed. Retry later, or use the official Open Design agent for a more stable, cost-efficient run.',
