...
export const en: Dict = {
  ...
  'assistant.compactionActiveTitle': 'Compacting context',
  'assistant.compactionActiveDetail': 'Preserving the task, decisions, and recent progress',
  'assistant.compactionCompletedTitle': 'Context compacted',
  'assistant.compactionFailedTitle': 'Context compaction failed',
