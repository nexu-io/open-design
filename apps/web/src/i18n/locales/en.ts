...
export const en: Dict = {
  ...
  'pagePatterns.title': 'Page patterns',
  'pagePatterns.lede': 'Pick a page-level pattern to preview or to start a new project from.',
  'pagePatterns.searchPlaceholder': 'Search page patterns…',
  'pagePatterns.categoryAll': 'All',
  'pagePatterns.category.auth': 'Auth',
  'pagePatterns.category.list': 'List',
  'pagePatterns.category.detail': 'Detail',
  'pagePatterns.category.dashboard': 'Dashboard',
  'pagePatterns.category.profile': 'Profile',
  'pagePatterns.category.landing': 'Landing',
  'pagePatterns.category.form': 'Form',
  'pagePatterns.category.error': 'Error',
  'pagePatterns.useAction': 'Use',
  'pagePatterns.previewAction': 'Preview',
  'pagePatterns.empty': 'No page patterns match your filters.',
