...
export const en: Dict = {
  ...
  'chat.mentionSectionParts': 'Parts',
  ...
  'scene3d.compile': 'Compile',
  'scene3d.compiling': 'Compiling…',
  'scene3d.recompile': 'Recompile',
  'scene3d.verdict': 'Verdict',
  'scene3d.verdictClean': 'Compiles clean · {warnings} warning(s)',
  'scene3d.verdictFailed': '{errors} error(s) · {warnings} warning(s)',
  'scene3d.neverCompiled': 'Never compiled',
  'scene3d.parts': 'Parts',
  'scene3d.noParts': 'No parts yet',
  'scene3d.issues': 'Issues',
  'scene3d.noIssues': 'No issues',
  'scene3d.assets': 'Assets',
  'scene3d.noAssets': 'No exports yet',
  'scene3d.noProof': 'No proof frames — run a compile',
  'scene3d.frameAlt': 'Proof frame',
  'scene3d.frameSlider': 'Turntable frame',
  'scene3d.dragHint': 'Drag to rotate',
  'scene3d.issuesStoredHint': 'Recompile for details',
  'scene3d.meshCounts': '{verts}v / {faces}f',
  'scene3d.fixPrefix': 'fix:',
  'scene3d.exportMenu': 'Export',
  'scene3d.exportEmpty': 'Nothing compiled yet',
  'scene3d.exportAll': 'Download all ({count} files)',
  'scene3d.exportAllScenes': 'All scenes',
  'scene3d.exportAllChip': 'ALL',
  'scene3d.exportAllBusy': 'Preparing archive…',
  'scene3d.exportModels': 'Models',
  'scene3d.formatGlb': 'glTF / GLB',
  'scene3d.formatUsd': 'OpenUSD',
  'scene3d.formatObj': 'OBJ',
  'scene3d.formatMinecraft': 'Minecraft model',
  'scene3d.formatImage': 'Proof frames',
  'scene3d.formatOther': 'Other files',
  'scene3d.kindScene': 'Scene',
  'scene3d.kindProp': 'Prop',
  'scene3d.kindKit': 'Kit',
  'scene3d.kindAnimation': 'Animation',
  'scene3d.kindSprite': 'Sprite sheet',
  'scene3d.kindFlipbook': 'Flipbook',
  'scene3d.kindVfx': 'VFX',
  'scene3d.kindSkybox': 'Skybox',
  'scene3d.kindTexture': 'Texture',
  'scene3d.partsCount': '{count} parts',
  'scene3d.trisCount': '{count} tris',
  'scene3d.claimsProven': '{count} claims proven',
  'scene3d.blenderVersion': 'Blender {version}',
  'scene3d.scenes': 'Scenes',
  'scene3d.kitScenes': '{count} scenes',
  'scene3d.kitStageTitle': 'Kit viewer',
  'scene3d.kitTruncated': 'Showing the first {count} scenes',
  'scene3d.backToKit': 'Back to kit',
  'homeHero.chip.scene3dChip': '3D scene',
  'homeHero.chip.scene3dChipDesc': 'Models, textures, sprite sheets & flipbooks',
  'homeHero.chip.scene3dChipHint': 'Author a 3D asset as code and compile it through headless Blender — turntable proofs, convention linting, GLB + USD export.',
  'scene3d.replay': 'Replay',
  'scene3d.stop': 'Stop',
