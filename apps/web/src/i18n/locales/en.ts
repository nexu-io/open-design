...
export const en: Dict = {
  ...
  'fileViewer.deployToDisplayDev': 'Deploy to display.dev',
  'fileViewer.redeployToDisplayDev': 'Redeploy to display.dev',
  'fileViewer.deployingToDisplayDev': 'Deploying to display.dev…',
  ...
  'fileViewer.displayDevApiKey': 'display.dev API key (optional)',
  'fileViewer.displayDevApiKeyGetLink': 'Get display.dev API key',
  'fileViewer.displayDevApiKeyPlaceholder': 'sk_live...',
  'fileViewer.displayDevVisibilityUnchanged': 'Keep current visibility',
  'fileViewer.displayDevShareWithPlaceholder': 'person@example.com, teammate@example.com',
  'fileViewer.displayDevApiKeyBlankHint': 'Leave blank to publish anonymously with a 30-day URL and claim link.',
  'fileViewer.displayDevApiKeyClearHint': 'Clear the field to publish anonymously instead.',
  'fileViewer.displayDevDeploySubtitle': 'Deploy this HTML preview to a shareable display.dev URL.',
  'fileViewer.displayDevDeployAuthenticatedCreateHint': 'Publishes to your display.dev organization using the access settings below.',
  'fileViewer.displayDevDeployAnonymousWithKeyHint': 'Redeploy with an API key to create an owned display.dev preview. The existing anonymous preview is not claimed automatically.',
  'fileViewer.displayDevDeployOwnedHint': 'An API key is required to redeploy. Existing access settings stay unchanged unless you edit them.',
  'fileViewer.displayDevArtifactName': 'Name',
  'fileViewer.displayDevArtifactNamePlaceholder': 'Leave blank to use the file name',
  'fileViewer.displayDevArtifactNameAuthenticatedPlaceholder': 'Leave blank to keep the current name',
  'fileViewer.displayDevVisibility': 'Visibility',
  'fileViewer.displayDevVisibilityProvider': 'Account default',
  'fileViewer.displayDevVisibilityPublic': 'Public',
  'fileViewer.displayDevVisibilityCompany': 'Company',
  'fileViewer.displayDevVisibilityPrivate': 'Private',
  'fileViewer.displayDevShareWith': 'Share with',
  'fileViewer.displayDevShareWithPublicHint': 'Recipients stay saved if you change visibility later.',
  'fileViewer.displayDevClaimUrlLabel': 'Claim URL',
  'fileViewer.displayDevClaimUrlMessage': 'Claim this URL to keep it permanently and manage access in display.dev.',
  'fileViewer.displayDevClaimUrlExpiresMessage': 'Claim this URL to keep it permanently and manage access in display.dev. Expires {date}.',
  ...
  'fileViewer.deploymentsLoadFailed': 'Could not load deployments.',
  'fileViewer.displayDevAccessSettingsLoadFailed': 'Could not load display.dev access settings.',
  ...
  'fileViewer.displayDevDeploymentReadyDescription': 'Deployment link is ready.',
