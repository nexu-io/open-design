...
export const en: Dict = {
  ...
  'waiteam.settingsEnabledDescription': 'When enabled, agent runs use the multi-agent team collaboration module (7 modes + capability-based role assignment). Uncheck to use OpenDesign\'s default single-agent design mode.',
