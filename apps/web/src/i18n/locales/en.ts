...
export const en: Dict = {
  ...
  'settings.bedrockProfileHint': 'Named profile from ~/.aws/config. Requires AWS CLI v2. For IAM Identity Center (SSO) profiles, use Sign in with AWS SSO when the session has expired.',
