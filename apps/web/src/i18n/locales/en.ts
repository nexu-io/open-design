...
export const en: Dict = {
  ...
  'pluginApply.inputsMissing': 'Missing required plugin inputs: {fields}',
  'pluginApply.configurationInvalid': 'Plugin configuration is invalid. Reinstall or update the plugin and try again.',
  'pluginApply.resourceUnavailable': 'A required plugin resource is unavailable. Reinstall or update the plugin and try again.',
  'pluginApply.genericFailure': 'The plugin could not be applied. Try again.',
  'pluginApply.workspaceContextIncomplete': 'Workspace context is incomplete. Wait for workspace sync to finish and try again.',
  'pluginApply.notFound': 'Plugin not found.',
  'pluginApply.failedNamedWithReason': 'Failed to apply {plugin}: {reason}',
