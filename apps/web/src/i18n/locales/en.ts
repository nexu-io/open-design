...
export const en: Dict = {
  ...
  'settings.updatePreviewLabel': 'Update preview',
  'settings.updatePreviewActual': 'Actual development state',
  'settings.updatePreviewIdle': 'Not checked',
  'settings.updatePreviewChecking': 'Checking',
  'settings.updatePreviewUpToDate': 'Latest version',
  'settings.updatePreviewAvailable': 'New version',
  'settings.updatePreviewDownloading': 'Downloading',
  'settings.updatePreviewDownloaded': 'Ready to install',
  'settings.updatePreviewInstalling': 'Installing',
  'settings.updatePreviewError': 'Check failed',
  'settings.updatePreviewUnsupported': 'Unsupported',
