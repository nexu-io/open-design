...
export const en: Dict = {
  ...
  'automations.tpl.ingestSourceMemoryTree.title': 'Ingest source into memory tree',
  'automations.tpl.ingestSourceMemoryTree.desc': 'Turn uploaded, URL, repo, connector, artifact, or chat content into reviewable memory nodes.',
  'automations.tpl.extractDesignSystem.title': 'Extract design system',
  'automations.tpl.extractDesignSystem.desc': 'Draft a DESIGN.md from brand docs, screenshots, repos, connectors, websites, or strong artifacts.',
  'automations.tpl.crystallizeRunIntoSkill.title': 'Crystallize successful run into skill',
  'automations.tpl.crystallizeRunIntoSkill.desc': 'Convert a completed run into a draft SKILL.md, examples, and follow-up test prompts.',
  'automations.tpl.connectorDigestDesignContext.title': 'Connector digest to design context',
  'automations.tpl.connectorDigestDesignContext.desc': 'Pull trusted connector updates into memory and artifact-ready design context.',
  'automations.tpl.compressProjectContext.title': 'Compress project context',
  'automations.tpl.compressProjectContext.desc': 'Rewrite oversized source packets and memory nodes into compact, traceable context.',
  'automations.tpl.promoteArtifactStyle.title': 'Promote artifact style',
  'automations.tpl.promoteArtifactStyle.desc': 'Extract reusable visual rules from a strong artifact into a design-system variant.',
