...
export const en: Dict = {
  ...
  'tasks.heading': 'Automations',
  'tasks.eyebrow': 'Scheduled agent sessions',
  'tasks.heroParagraph': 'Plan recurring conversations for project work, Orbit digests, and live artifacts.',
  'tasks.yourAutomations': 'Your automations',
  'tasks.empty.title': 'No automations yet',
  'tasks.empty.hint': 'Create one from a template or start with a blank schedule.',
  'tasks.ingestSource': 'Ingest source',
