...
export const en: Dict = {
  ...
  'ds.manager.cardAria': 'Design Systems',
  'ds.manager.eyebrow': 'Design Systems',
  'ds.manager.yourSystems': 'Your systems',
  'ds.manager.userFilterAria': 'Filter design systems',
  'ds.manager.userFilter.all': 'All',
  'ds.manager.userFilter.published': 'Published',
  'ds.manager.userFilter.draft': 'Draft',
  'ds.manager.create.title': 'Create new design system',
  'ds.manager.create.hint': 'Teach Open Design your brand, product, code, assets, and design references.',
  'ds.manager.create.action': 'Create',
  'ds.manager.userEmpty': 'No design systems yet. Create one from real product context, review the draft, then publish it for future projects.',
  'ds.manager.row.youUpdated': 'You · updated {date}',
  'ds.manager.row.justNow': 'just now',
  'ds.manager.row.edit': 'Edit',
  'ds.manager.row.makeDefault': 'Make default',
  'ds.manager.row.published': 'Published',
  'ds.manager.row.draft': 'Draft',
  'ds.manager.row.openAria': 'Open {title}',
  'ds.manager.row.deleteAria': 'Delete {title}',
  'ds.manager.row.deleteConfirm': 'Delete "{title}"? This removes the draft design system from this device.',
  'ds.manager.templates.aria': 'Templates',
  'ds.manager.templates.eyebrow': 'Templates',
  'ds.manager.templates.heading': 'Templates',
  'ds.manager.templates.empty': 'No templates yet. Create one from any generated project via Share once template publishing is enabled.',
  'ds.manager.privateNote': 'Only you can view these settings.',
  'ds.manager.library.aria': 'Built-in design systems',
  'ds.manager.library.eyebrow': 'Library',
  'ds.manager.library.heading': 'Built-in library',
  'ds.manager.card.edit': 'Edit',
  'ds.manager.card.open': 'Open',
  ...
  'automations.metricsAria': 'Automation summary',
  'automations.metric.active': 'Active',
  'automations.metric.paused': 'Paused',
  'automations.metric.templates': 'Templates',
  'automations.new': 'New automation',

  'automations.yours.aria': 'Your automations',
  'automations.yours.title': 'Your automations',
  'automations.yours.loading': 'Loading',
  'automations.empty.title': 'No automations yet',
  'automations.empty.body': 'Create one from a template or start with a blank schedule.',

  'automations.row.targetNew': 'New project each run',
  'automations.row.run': 'Run',
  'automations.row.runTitle': 'Run now and open the conversation',
  'automations.row.history': 'History',
  'automations.row.hideHistory': 'Hide history',
  'automations.row.edit': 'Edit',
  'automations.row.pause': 'Pause',
  'automations.row.resume': 'Resume',
  'automations.row.delete': 'Delete automation',
  'automations.row.deleteTitle': 'Delete this automation',
  'automations.row.deleteConfirm': 'Delete this automation? Past runs and their projects are kept.',
  'automations.row.lastRun': 'Last run {time}',
  'automations.row.openResult': 'Open result',

  'automations.schedule.hourly': 'Hourly at :{minute}',
  'automations.schedule.daily': 'Daily at {time} · {tz}',
  'automations.schedule.weekdays': 'Weekdays at {time} · {tz}',
  'automations.schedule.weekly': '{day} at {time} · {tz}',
  'automations.schedule.paused': 'Paused',
  'automations.schedule.manualOnly': 'Manual only',
  'automations.schedule.scheduled': 'Scheduled',
  'automations.schedule.next': 'Next {time}',

  'automations.history.aria': 'Automation run history',
  'automations.history.loading': 'Loading run history…',
  'automations.history.empty': 'No runs yet.',
  'automations.history.head': 'Run history',
  'automations.history.latest': 'Latest 10',
  'automations.history.crystallize': 'Crystallize',
  'automations.history.crystallizing': 'Crystallizing',
  'automations.history.crystallizeTitle': 'Draft skill and memory proposals from this run',
  'automations.history.openConversation': 'Open conversation',
  'automations.history.durationInProgress': 'In progress',
  ...
  'automations.status.canceled': 'Canceled',

  'automations.ingest.aria': 'Source ingestion',
  'automations.ingest.title': 'Ingest source',
  'automations.ingest.sub': 'Turn connector, repo, artifact, or chat context into reviewable evolution proposals.',
  'automations.ingest.recent': '{n} recent',
  'automations.ingest.field.template': 'Template',
  'automations.ingest.field.source': 'Source',
  'automations.ingest.field.compression': 'Compression',
  'automations.ingest.field.connector': 'Connector',
  'automations.ingest.field.title': 'Title',
  'automations.ingest.field.sourceRef': 'Source ref',
  'automations.ingest.field.content': 'Content',
  'automations.ingest.anyConnector': 'Any connected source',
  'automations.ingest.placeholderTitle': 'Decision, brand notes, workflow pattern...',
  'automations.ingest.placeholderSourceRef': 'URL, repo path, connector event id, artifact id...',
  'automations.ingest.placeholderContent': 'Paste the content to canonicalize into a source packet and proposals.',
  'automations.ingest.empty': 'No source packets yet.',
  'automations.ingest.recentAria': 'Recent source packets',
  'automations.ingest.action.ingest': 'Ingest',
  'automations.ingest.action.ingesting': 'Ingesting',
  'automations.ingest.error.empty': 'Paste source content before ingesting it.',
  'automations.ingest.recentMeta': '{kind} · {tokens} tokens',

  'automations.source.connector': 'Connector',
  'automations.source.url': 'URL',
  'automations.source.repo': 'Repo',
  'automations.source.artifact': 'Artifact',
  'automations.source.chat': 'Chat',
  'automations.source.upload': 'Upload',

  'automations.compression.balanced': 'Balanced',
  'automations.compression.aggressive': 'Aggressive',
  'automations.compression.off': 'Off',

  'automations.proposals.aria': 'Automation evolution proposals',
  'automations.proposals.title': 'Evolution proposals',
  'automations.proposals.sub': 'Review automation output before it changes memory, skills, or design systems.',
  'automations.proposals.pending': '{n} pending',
  'automations.proposals.apply': 'Apply',
  'automations.proposals.reject': 'Reject',
  'automations.proposals.rejectReason': 'Dismissed in Automations',
  'automations.proposals.target.memory': 'Memory',
  'automations.proposals.target.designSystem': 'Design system',
  'automations.proposals.target.skill': 'Skill',
  'automations.proposals.target.template': 'Automation template',
  'automations.proposals.action.create': 'Create',
  'automations.proposals.action.update': 'Update',
  'automations.proposals.action.merge': 'Merge',
  'automations.proposals.action.move': 'Move',
  'automations.proposals.action.delete': 'Delete',
  'automations.proposals.action.promote': 'Promote',

  'automations.templates.aria': 'Automation templates',
  'automations.templates.title': 'Templates',
  'automations.templates.sub': 'Orbit and live artifacts are templates inside the same automation flow.',
  'automations.templates.filtersAria': 'Template filters',
  'automations.templates.countMeta': '{shown} of {total}',
  'automations.templates.emptyTitle': 'No templates in this category yet.',
  'automations.templates.emptyHint': 'Try a different filter, or start from a blank automation.',
  'automations.templates.useTemplate': 'Use template',
  'automations.templates.kind.orbit': 'Orbit',
  'automations.templates.kind.liveArtifact': 'Live artifact',
  'automations.templates.kind.automation': 'Automation',
  'automations.templates.filter.all': 'All',
  'automations.templates.filter.orbit': 'Orbit',
  'automations.templates.filter.liveArtifact': 'Live artifacts',
  'automations.templates.filter.memory': 'Memory',
  'automations.templates.filter.designSystem': 'Design systems',
  'automations.templates.filter.skills': 'Skills',
  'automations.templates.filter.connectors': 'Connectors',
  'automations.templates.filter.compression': 'Compression',
  'automations.templates.filter.release': 'Release',
  'automations.templates.filter.quality': 'Quality',

  'automations.static.memoryRefresh.title': 'Refresh project memory from recent work.',
  'automations.static.memoryRefresh.description': 'Turns repeated decisions, preferences, and feedback into reusable memory updates.',
  'automations.static.memoryRefresh.defaultName': 'Memory refresh',
  'automations.static.designSystemRefresh.title': 'Update design systems from shipped artifacts.',
  'automations.static.designSystemRefresh.description': 'Finds reusable tokens, components, and rules across recent design work.',
  'automations.static.designSystemRefresh.defaultName': 'Design system maintainer',
  'automations.static.liveArtifactRegistry.title': 'Audit live artifacts and refresh stale versions.',
  'automations.static.liveArtifactRegistry.description': 'Keeps persistent dashboards, reports, and previews current instead of duplicating them.',
  'automations.static.liveArtifactRegistry.defaultName': 'Live artifact maintainer',
  'automations.static.orbitDashboard.title': 'Build a connector activity dashboard.',
  'automations.static.orbitDashboard.description': 'Aggregates selected connectors into an Orbit-style live dashboard.',
  'automations.static.orbitDashboard.defaultName': 'Connector activity dashboard',
  'automations.static.releaseNotes.title': 'Draft release notes from shipped design work.',
  'automations.static.releaseNotes.description': 'Connects merged PRs, artifacts, and product-facing changes into release notes.',
  'automations.static.releaseNotes.defaultName': 'Weekly release notes',
  'automations.static.qualityRegressionWatch.title': 'Watch for design and implementation regressions.',
  'automations.static.qualityRegressionWatch.description': 'Compares recent changes against benchmarks, traces, and accepted references.',
  'automations.static.qualityRegressionWatch.defaultName': 'Regression watch',

  'automations.fallback.orbitDaily.title': 'Daily connector digest.',
  'automations.fallback.orbitDaily.description': 'Refreshes a connector activity digest on a schedule.',
  'automations.fallback.orbitDaily.defaultName': 'Daily connector digest',
  'automations.fallback.liveStatusBoard.title': 'Keep a live status artifact fresh.',
  'automations.fallback.liveStatusBoard.description': 'Updates one persistent artifact instead of creating a new report each run.',
  'automations.fallback.liveStatusBoard.defaultName': 'Live status board',

  'automations.modal.ariaEdit': 'Edit automation',
  'automations.modal.ariaNew': 'New automation',
  'automations.modal.placeholderTitle': 'Automation title',
  'automations.modal.useTemplate': 'Use template',
  'automations.modal.close': 'Close (Esc)',
  'automations.modal.promptPlaceholder': 'Ask the agent what to run on this schedule, or @mention context...',
  'automations.modal.mention.aria': 'Automation context results',
  'automations.modal.mention.tabsAria': 'Context type',
  'automations.modal.mention.tab.all': 'All',
  'automations.modal.mention.tab.skills': 'Skills',
  'automations.modal.mention.tab.plugins': 'Plugins',
  'automations.modal.mention.tab.mcp': 'MCP',
  'automations.modal.mention.tab.connectors': 'Connectors',
  'automations.modal.mention.empty': 'Search skills, plugins, MCP servers, and connectors.',
  'automations.modal.mention.noResults': 'No results for "{query}".',
  'automations.modal.mention.section.skills': 'Skills',
  'automations.modal.mention.section.plugins': 'Plugins',
  'automations.modal.mention.section.mcp': 'MCP',
  'automations.modal.mention.section.connectors': 'Connectors',
  'automations.modal.selected.aria': 'Selected automation context',
  'automations.modal.selected.remove': 'Remove {label}',
  'automations.modal.selected.skill': 'Skill',
  'automations.modal.selected.plugin': 'Plugin',
  'automations.modal.selected.mcp': 'MCP',
  'automations.modal.selected.connector': 'Connector',
  'automations.modal.selected.connectorWith': 'Connector · {account}',
  'automations.modal.error.title': 'Add a title for this automation.',
  'automations.modal.error.prompt': 'Add a prompt for the scheduled conversation.',
  'automations.modal.cancel': 'Cancel',
  'automations.modal.create': 'Create',
  'automations.modal.creating': 'Creating...',
  'automations.modal.save': 'Save',
  'automations.modal.saving': 'Saving...',
  'automations.modal.project.newEachRun': 'New project each run',
  'automations.modal.project.newEachRunHint': 'Each run starts a fresh project and conversation.',
  'automations.modal.project.existing': 'Existing projects',
  'automations.modal.schedule.kind.hourly': 'Hourly',
  'automations.modal.schedule.kind.daily': 'Daily',
  'automations.modal.schedule.kind.weekdays': 'Weekdays',
  'automations.modal.schedule.kind.weekly': 'Weekly',
  'automations.modal.schedule.minute': 'Minute of every hour',
  'automations.modal.schedule.time': 'Time',
  'automations.modal.schedule.timezone': 'Timezone',
  'automations.modal.schedule.weekdayAria': 'Weekday',
  'automations.modal.schedule.done': 'Done',
};
