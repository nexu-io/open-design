...
export const en: Dict = {
  ...
  'chat.runNotice.title.fiveHourLimit': '5-hour model limit reached',
  'chat.runNotice.title.queued': 'High demand — task queued',
  ...
  'chat.runNotice.fiveHourLimitMessage': '{model} has reached its 5-hour usage limit. Available again at {retryAt}. This request was not charged.',
  'chat.runNotice.queuedMessage': 'Many people are using this model right now. Your task is queued and will start automatically—no need to submit it again.',
