...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to LeastGen Cloud — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrCard.switchCta': 'Switch to LeastGen Cloud & retry',
  'chat.amrError.authMessage': 'Your LeastGen Cloud account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your LeastGen Cloud allowance has run out. Top up to keep this run going.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'What you get with LeastGen Cloud',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'You\'re using the LeastGen Cloud agent — sign in and this task can start right away.',
  ...
  'chat.runError.signInMessage.amr': 'The LeastGen Cloud agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the LeastGen Cloud agent — steadier and better value.',
  ...
  'chat.runError.cpuUnsupportedMessage': "This agent's runtime needs a CPU instruction set (AVX2) that this device doesn't have, so it can't start. Update LeastGen Studio to the latest version, which ships a compatible runtime.",
  'chat.runError.cliSessionRefusedMessage':
    "{agent} refused to start a session. The installed version is usually incompatible with LeastGen Studio — switch to a different version and retry.",
  ...
  'settings.welcomeTitle': 'Welcome to LeastGen Studio',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. LeastGen Studio will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. LeastGen Studio reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingExecutionBody': 'Use the LeastGen Studio hosted service, connect a local coding agent, or bring your own model key.',
  ...
  'settings.onboardingCloudTitle': 'Sign in to LeastGen Studio',
  'settings.onboardingCloudBody': 'Sign in to start designing with cloud AI right away — no complex setup required.',
  'settings.onboardingCloudSignIn': 'Sign in to LeastGen Studio',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to LeastGen Cloud to continue.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the LeastGen Studio daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to LeastGen Studio.',
  ...
  'settings.amrAccountStatus': 'LeastGen Cloud account status',
  ...
  'settings.mcpServerHint': 'Expose LeastGen Studio as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the LeastGen Studio team',
  'settings.privacyConsentKicker': 'Help us improve LeastGen Studio',
  'settings.privacyConsentLead': 'Sharing usage data helps us understand how LeastGen Studio performs in real workflows, so we can improve the parts that matter most to your experience.',
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time LeastGen Studio starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but LeastGen Studio could not quit automatically.',
  ...
  'settings.mcpTitle': 'Connect LeastGen Studio to your coding agent',
  'settings.mcpHint': 'Use MCP to give supported agents access to your projects and design context.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure LeastGen Studio is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Use the project and file currently open in LeastGen Studio as context.',
  'settings.mcpRunningNote': 'Keep LeastGen Studio running. Restart your coding agent after setup.',
  ...
  'entry.discordAriaWithOnline': 'Join the LeastGen Studio Discord - {online}',
  ...
  'entry.followLinkedinLabel': 'Follow LeastGen Studio on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow LeastGen Studio on Xiaohongshu',
  ...
  "entry.cloudCalloutBody": "Sign in to use LeastGen Cloud and collaborate in the cloud",
  "entry.cloudCalloutDismissAria": "Dismiss LeastGen Cloud note",
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable LeastGen Studio plugin and add it to My plugins.',
  ...
  'handoff.amrWebsite': 'Visit LeastGen Cloud',
  ...
  'handoff.promptIntro': 'Continue from this local LeastGen Studio project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. LeastGen Studio Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use LeastGen Studio workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with LeastGen Studio and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to LeastGen Studio',
  'pluginCard.contributeTitle': 'Contribute plugin to LeastGen Studio with a pull request',
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use LeastGen Studio from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure LeastGen Studio is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use LeastGen Studio everywhere',
  'useEverywhere.modalTitle': 'Use LeastGen Studio everywhere',
  'useEverywhere.modalSubtitle': 'Drop LeastGen Studio into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'LeastGen Studio works wherever your agent works',
  'useEverywhere.section.overview.intro': 'LeastGen Studio is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires LeastGen Studio as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without LeastGen Studio at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive LeastGen Studio from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose LeastGen Studio as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'LeastGen Studio ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover LeastGen Studio tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the LeastGen Studio app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without LeastGen Studio running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). LeastGen Studio extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside LeastGen Studio and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + LeastGen Studio extras)',
  ...
  'entry.githubStarAria': 'Star LeastGen Studio on GitHub',
  ...
  'newproj.locationDefault': 'LeastGen Studio projects',
  ...
  'avatar.amrConsole': 'LeastGen Cloud',
  ...
  'socialShare.openDesignSection': 'Share LeastGen Studio',
  'socialShare.openDesignTitle': 'LeastGen Studio on GitHub',
  'socialShare.openDesignText': 'LeastGen Studio is a source-available workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with LeastGen Studio: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with LeastGen Studio: {title}\n{url}\nLeastGen Studio repo: {repo}',
  ...
  'brandEnrichment.body': "LeastGen Studio will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask LeastGen Studio to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want LeastGen Studio to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'preview.shareTextDefault': 'LeastGen Studio template: {title}',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure LeastGen Studio is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying LeastGen Studio? Star us on GitHub.',
  ...
  'designFiles.usefulInfoTip18': 'Subscribe to LeastGen Studio on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow LeastGen Studio on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow LeastGen Studio on Xiaohongshu for tips and inspiration.',
  ...
  'fileViewer.publishFileRequiresWorkspace': 'A share link needs a signed-in workspace. Sign in to LeastGen Cloud, or use a deploy option to share this file.',
  ...
  'assistant.shareToOpenDesign': 'Share to LeastGen Studio',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with LeastGen Studio — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with LeastGen Studio — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple LeastGen Studio project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.customInstructionsHint': 'Fixed instructions LeastGen Studio should follow in every chat. Save facts, preferences, and project context as memories.',
  ...
  'settings.memoryStarterProjectDesc': 'LeastGen Studio v0.5 — chat-driven design editor',
  ...
  'updater.availableBody': 'LeastGen Studio {version} is available. It will download before the installer can open.',
  'updater.activeRunsTitle': 'LeastGen Studio is still working',
  'updater.activeRunsBody': '{count} active tasks are still running. Restarting now will interrupt them.',
  'updater.activeRunsUnknownBody': 'LeastGen Studio could not confirm whether tasks are still running. Restarting now may interrupt active work.',
  ...
  'updater.installerOpenBody': 'The installer is open. LeastGen Studio is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit LeastGen Studio',
  'updater.quitFailedBody': 'The installer is open, but LeastGen Studio could not quit. Quit LeastGen Studio before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. LeastGen Studio will close and open the installer.',
  'updater.readyVersion': 'LeastGen Studio {version} is ready. LeastGen Studio will close and open the installer.',
  'updater.reinstallLearnMore': 'Learn more',
  'updater.reinstallReadyGeneric': 'This update requires a full reinstall. LeastGen Studio will close and open the installer.',
  'updater.reinstallReadyVersion': 'LeastGen Studio {version} requires a full reinstall. LeastGen Studio will close and open the installer.',
  ...
  'whatsNew.updatedTitle': 'LeastGen Studio {version} is here',
  ...
  'dsManager.createBody': 'Teach LeastGen Studio your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions LeastGen Studio follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach LeastGen Studio your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'LeastGen Studio turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
  ...
  'campaign.deepseekV4Flash.ruleSummary': 'From Aug 13–27, paid users can use DeepSeek V4 Pro and V4 Flash for free in LeastGen Studio. Large-scale abuse may pause campaign access.',
  'campaign.deepseekV4Flash.windowLabel': 'Aug 13–27',
  'campaign.deepseekV4Flash.weekFreeSuffix': 'two weeks free',
  'campaign.deepseekV4Flash.boundary': 'Unlimited model quota and free generation counts in your plan apply only inside LeastGen Studio — not via MCP, CLI, API, or other surfaces. Final interpretation rests with LeastGen Studio. Some models may need to queue at peak hours.',
  ...
  'experienceSurvey.tag': "We'd love your feedback — help improve LeastGen Studio",
  'experienceSurvey.close': "Close",
  'experienceSurvey.recommendation': "How likely are you to recommend LeastGen Studio to a colleague or friend?",
  ...
  'labs.harnessHint': "Your next generation will use LeastGen Studio's latest strategy, with noticeably more polished results (beta)",
  'labs.harnessTooltip': "Switches to the agent harness LeastGen Studio built for design work. Output is noticeably better in layout, structure, and completeness.",
