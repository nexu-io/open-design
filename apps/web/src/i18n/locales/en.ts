...
export const en: Dict = {
  ...
  'fileViewer.displayDevDeployAnonymousHint': 'Leave the API key blank to publish a public 30-day preview with a claim link.',
  ...
  'fileViewer.displayDevDeployOwnedHint': 'Redeploys keep existing display.dev access settings unless you change them here.',
  ...
  'fileViewer.displayDevShowBranding': 'Show branding',
  'fileViewer.displayDevShowBrandingInherit': 'Inherit',
  'fileViewer.displayDevShowBrandingShow': 'Show',
  'fileViewer.displayDevShowBrandingHide': 'Hide',
