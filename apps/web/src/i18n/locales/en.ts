...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to Horangdesign — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrCard.switchCta': 'Switch to Horangdesign & retry',
  'chat.amrError.authMessage': 'Your Horangdesign account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your Horangdesign balance has run out. Top up to keep this run going.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'What you get with Horangdesign Cloud',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'You\'re using the Horangdesign Cloud agent — sign in and this task can start right away.',
  ...
  'chat.runError.signInMessage.amr': 'The Horangdesign agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the Horangdesign agent — steadier and better value.',
  ...
  'app.brandSubtitle': 'by Horang',
  'app.welcomeLoading': 'Loading workspace…',
  'settings.welcomeKicker': '',
  'settings.welcomeTitle': 'Welcome to Horangdesign',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. Horangdesign will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. Horangdesign reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingAmrModelSourceLabel': 'Horangdesign',
  ...
  'settings.onboardingCloudTitle': 'Sign in to Horangdesign',
  'settings.onboardingCloudBody': 'Sign in to start designing with cloud AI right away — no complex setup required.',
  'settings.onboardingCloudSignIn': 'Sign in to Horangdesign',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to Horangdesign to continue.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the Horangdesign daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to Horangdesign.',
  ...
  'settings.amrAccountStatus': 'Horangdesign account status',
  ...
  'settings.mcpServerHint': 'Expose Horangdesign as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the Horangdesign team',
  'settings.privacyConsentKicker': 'Help us improve Horangdesign',
  'settings.privacyConsentLead': 'Horangdesign can share usage data with our team to help us improve. This includes:',
  ...
  'settings.updateQuitFailed': 'The installer opened, but Horangdesign could not quit automatically.',
  ...
  'settings.mcpHint': 'Let coding agents (Cursor, Claude Code, VS Code…) read your Horangdesign projects directly.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure Horangdesign is running, then reopen this panel.',
  'settings.mcpBuildDaemon': 'Build the daemon first.',
  'settings.mcpNodeMissing': 'Node binary is missing.',
  'settings.mcpBuildHint': 'apps/daemon/dist/cli.js is missing. Run `pnpm --filter @horangdesign/daemon build` and refresh.',
  ...
  'settings.mcpCapabilityDefault': 'Default to the project and file you have open in Horangdesign, so you can say "build this in my app" without re-stating which design.',
  'settings.mcpRunningNote': 'Horangdesign must be running for MCP tool calls to succeed. If you started your coding agent before opening Horangdesign, restart the agent so it can reach the live daemon.',
  ...
  'entry.discordAria': 'Join the Horangdesign Discord',
  'entry.discordAriaWithOnline': 'Join the Horangdesign Discord - {online}',
  'entry.discordOnlineLabel': '{count} online',
  'entry.followXLabel': 'Follow @Horangdesign on X',
  ...
  'entry.followLinkedinLabel': 'Follow Horangdesign on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow Horangdesign on Xiaohongshu',
  ...
  'homeHero.title': 'Build an immersive 3D web experience.',
  ...
  'homeHero.subtitlePrefix': 'A Horangdesign studio runtime for Spline-inspired, Awwwards-grade motion sites.',
  'homeHero.placeholder': 'Describe the 3D/Spline-style site, references, motion mood, and output ratio…',
  'homeHero.placeholderActive': 'Refine the immersive brief, references, camera moves, and interaction model…',
  'homeHero.carousel.hint': 'Add references, Spline links, 3D mood, interaction notes, or a target launch page',
  'homeHero.carousel.onePageBrief': 'Plan a cinematic landing page',
  'homeHero.carousel.notesToDeck': 'Map reference motion into a storyboard',
  'homeHero.carousel.signupFlow': 'Prototype a scroll-driven 3D flow',
  'homeHero.carousel.improveBrief': 'Sharpen an immersive design brief',
  'homeHero.carousel.loadingAnimation': 'Create a WebGL-style loading animation',
  'homeHero.carousel.teamUpdateSlides': 'Design an Awwwards-style pitch scene',
  'homeHero.carousel.ordersDashboard': 'Prototype a technical product control room',
  'homeHero.carousel.productDetail': 'Design a 3D product showcase page',
  'homeHero.carousel.caseStudy': 'Build a studio case-study scroll story',
  'homeHero.carousel.landingIntro': 'Design a cinematic hero intro',
  'homeHero.carousel.pitchDeck': 'Turn a concept into motion-led sections',
  'homeHero.carousel.appIdea': 'Describe a spatial web concept',
  'homeHero.carousel.landingLayout': 'Sketch a 21:9 landing choreography',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable Horangdesign plugin and add it to My plugins.',
  ...
  'handoff.amrWebsite': 'Visit Horangdesign',
  ...
  'handoff.promptIntro': 'Continue from this local Horangdesign project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. Horangdesign Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use Horangdesign workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with Horangdesign and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to Horangdesign',
  'pluginCard.contributeTitle': 'Contribute plugin to Horangdesign with a pull request',
  'skillPluginCandidate.createForMe': 'Create plugin/template',
  'skillPluginCandidate.contributeToMain': 'Contribute to horangdesign',
  'skillPluginCandidate.repoDescription': 'This repo looks like it could work as a plugin.',
  'integrations.kicker': 'Integration',
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use Horangdesign from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure Horangdesign is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use Horangdesign everywhere',
  'useEverywhere.modalTitle': 'Use Horangdesign everywhere',
  'useEverywhere.modalSubtitle': 'Drop Horangdesign into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'Horangdesign works wherever your agent works',
  'useEverywhere.section.overview.intro': 'Horangdesign is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires Horangdesign as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without Horangdesign at all.',
  ...
  'useEverywhere.section.overview.footer': 'The daemon writes to `./.od/` (project-local) by default. Set `OD_DATA_DIR=~/.horangdesign` to share data across projects.',
  'useEverywhere.section.cli.tab': 'CLI · od',
  'useEverywhere.section.cli.heading': 'Drive Horangdesign from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose Horangdesign as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'Horangdesign ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover Horangdesign tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the Horangdesign app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  'useEverywhere.section.http.tab': 'HTTP API',
  'useEverywhere.section.http.heading': 'Same REST + SSE surface the web UI uses',
  'useEverywhere.section.http.intro': 'The local daemon serves an HTTP API at `http://127.0.0.1:7456` (port configurable). Every endpoint the web UI calls is also fair game for your scripts. Streaming endpoints (chat turns, project runs) emit Server-Sent Events with the contract types in `@horangdesign/contracts`.',
  ...
  'useEverywhere.section.http.footer': 'Pure TypeScript types for every request/response live in `@horangdesign/contracts` — import them in your script for full autocomplete without wiring a generator.',
  'useEverywhere.section.skills.tab': 'Skills & headless',
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without Horangdesign running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). Horangdesign extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside Horangdesign and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + Horangdesign extras)',
  ...
  'entry.githubStarAria': 'Star Horangdesign on GitHub',
  ...
  'newproj.locationDefault': 'Horangdesign projects',
  ...
  'avatar.amrConsole': 'Horangdesign',
  ...
  'socialShare.openDesignSection': 'Share Horangdesign',
  'socialShare.openDesignTitle': 'Horangdesign on GitHub',
  'socialShare.openDesignText': 'Horangdesign is an open-source workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with Horangdesign: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with Horangdesign: {title}\n{url}\nHorangdesign repo: {repo}',
  ...
  'brandEnrichment.body': "Horangdesign will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask Horangdesign to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want Horangdesign to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'preview.shareTextDefault': 'Horangdesign template: {title}',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure Horangdesign is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying Horangdesign? Star us on GitHub.',
  'designFiles.usefulInfoTip8': 'Follow @Horangdesign on X for the latest updates.',
  ...
  'designFiles.usefulInfoTip18': 'Subscribe to Horangdesign on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow Horangdesign on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow Horangdesign on Xiaohongshu for tips and inspiration.',
  ...
  'assistant.shareToOpenDesign': 'Share to Horangdesign',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with Horangdesign — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with Horangdesign — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple Horangdesign project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.memoryStarterProjectDesc': 'Horangdesign v0.5 — chat-driven design editor',
  ...
  'updater.availableBody': 'Horangdesign {version} is available. It will download before the installer can open.',
  ...
  'updater.installerOpenBody': 'The installer is open. Horangdesign is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit Horangdesign',
  'updater.quitFailedBody': 'The installer is open, but Horangdesign could not quit. Quit Horangdesign before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. Horangdesign will close and open the installer.',
  'updater.readyVersion': 'Horangdesign {version} is ready. Horangdesign will close and open the installer.',
  ...
  'dsManager.createBody': 'Teach Horangdesign your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions Horangdesign follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach Horangdesign your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'Horangdesign turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
