...
export const en: Dict = {
  ...
  'settings.privacyConsentBannerFooter': 'Optional usage telemetry is on by default. You can turn it off any time in Settings → Privacy. Safety and crash diagnostics may still be sent.',
  ...
  'settings.privacySafety': 'Safety and crash diagnostics',
  'settings.privacySafetyHint': 'Scrubbed exception and reliability diagnostics may be sent even when usage telemetry is off. No prompts or artifact contents.',
  'settings.privacyInstallationId': 'Anonymous ID',
  'settings.privacyOptedOut': 'opted out',
  'settings.privacyDataDeletion': 'Delete my data',
  'settings.privacyDataDeletionHint': 'Rotates your anonymous ID and turns off optional usage telemetry. Existing traces age out under our retention policy.',
