...
export const en: Dict = {
  ...
  'handoff.download': 'Download',
  'handoff.downloadFailed': 'Download failed. Try again in a moment.',
  'handoff.remoteOpen': 'Remote Open',
  'handoff.remoteOpenTitle': 'Open this project in the web file workspace',
  'handoff.webActionsTitle': 'Export & open options',
  'handoff.openFolderUnavailable': 'Opening a local folder is unavailable here — the project lives on a remote or containerized daemon. Copy the path, download a .zip, or open it in the web workspace instead.',
