...
export const en: Dict = {
  ...
  'chat.runError.title.buildRoundSessionLost': "Build round lost its session",
  'chat.runError.title.roundInterrupted': "Round interrupted",
  'chat.runError.title.roundSettlementFailed': "Round could not be recorded",
  'chat.runError.title.taskRecordMismatch': "Task record mismatch",
  'chat.runError.title.attachmentsTooLarge': "Attachments too large",
  'chat.runError.title.attachmentsChanged': "Attachments changed",
  ...
  'chat.runError.buildRoundSessionLostMessage': "The build round was set to continue the planning round's agent session, but that session was gone by the time it started. Send the request again to start a new round: the plan stays in the conversation, and files already written stay in the project.",
  'chat.runError.roundInterruptedMessage': "The agent stopped before this round finished. Send the request again to start a new round in this conversation; files already written stay in the project.",
  'chat.runError.roundSettlementFailedMessage': "The agent finished, but Open Design ran into an error while recording this round and starting the next one. Send the request again to start a new round; if it keeps happening, export the logs and send them to us.",
  'chat.runError.taskRecordMismatchMessage': "Open Design's record of this task did not match the run it was starting, so the round stopped before the agent ran. Send the request again to start a fresh round with new records.",
  'chat.runError.attachmentsTooLargeMessage': "The attachments exceed what one request can carry. Remove or shrink some and send the request again.",
  'chat.runError.attachmentsChangedMessage': "The attachments changed while the request was being prepared, or their frozen copy did not match, so they could not be handed to the agent. Send the request again.",
  ...
  'designFiles.entryMissingTitle': 'No entry to preview.',
  'designFiles.entryMissingBody': 'This round wrote {n} file(s), but none of them opens as the entry:',
  'designFiles.entryMissingMore': 'and {n} more',
  'designFiles.entryMissingAsk': 'Ask the agent to add an entry',
  'designFiles.entryMissingHint': 'Or open a file’s menu and choose “Set as entry”.',
  'designFiles.setAsEntry': 'Set as entry',
  'designFiles.entryBadge': 'Entry',
  'designFiles.entryRequestMessage': 'No file in this project opens as the entry page. Add an entry (a root index.html that links to the pages you built, or point the existing main page at that name) so the preview can open it.',
