...
export const en: Dict = {
  ...
  'settings.customInstructionsHint': 'Fixed instructions Open Design should follow in every chat. Save facts, preferences, and project context as memories.',
