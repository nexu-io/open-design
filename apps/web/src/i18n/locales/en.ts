...
export const en: Dict = {
  ...
  'pet.railCollapse': 'Hide pet picker',
  ...
  'pet.atlasPickerHint': 'Codex pets ship 9 animation rows. Pick the loop you want and we will slice it into a strip.',
  'pet.atlasCancel': 'Discard atlas',
  'pet.atlasAdopt': 'Use this row',
