...
export const en: Dict = {
  ...
  'chat.runError.title.clientEnvironment': "Service not available in your region",
  ...
  'chat.runError.clientEnvironmentMessage': "The region your network is in isn’t supported right now. Try switching networks and try again.",
