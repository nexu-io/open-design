...
export const en: Dict = {
  ...
  'figma.import.dialogAria': 'Import from Figma',
  'figma.import.notesPlaceholder': "Optional: notes for the build (e.g. 'make it a marketing landing page')",
  'figma.import.submit': 'Import & build',
  'figma.import.colorsAria': 'Color tokens',
  'figma.import.summaryFoot': 'The prompt is ready in the composer — review and send to build the page.',
  'figma.import.tabFile': 'Upload .fig',
  'figma.import.dropHint': 'Decoded on your machine — tokens, components & assets. No Figma account.',
  'figma.import.urlHint': 'Runs through the Figma connector (OAuth) and the migration flow.',
  'figma.import.decoding': 'Decoding…',
  'figma.import.notFigError': 'That isn’t a .fig file. Export your Figma file as .fig (File → Save local copy) and drop it here.',
  'figma.import.importedLabel': 'Imported',
  'figma.import.assetsOnlySuffix': ' (assets only — the node tree could not be decoded)',
  'figma.import.statNodes': 'nodes',
  'figma.import.statPages': 'pages',
  'figma.import.statFrames': 'frames',
  'figma.import.statComponents': 'components',
  'figma.import.statColors': 'colors',
  'figma.import.statFonts': 'fonts',
  'figma.import.statAssets': 'assets',
  'designFiles.library.label': 'Import from library',
  'designFiles.library.title': 'Import from library',
  'library.upload.title': 'Upload to Library',
  'library.upload.closeAria': 'Close upload',
  'library.upload.dropHint': 'Images, fonts, text, HTML, and JSON / design data · up to {maxMb} MB each',
  'library.upload.uploading': 'Uploading…',
  'library.upload.deduped': 'Already in Library',
  'library.upload.added': 'Added',
  'library.upload.failed': 'Failed',
  'library.upload.empty': 'Nothing uploaded yet',
  'library.upload.summaryAdded': '{count} added',
  'library.upload.summaryFailed': '{count} failed',
  'library.upload.done': 'Done',
  ...
  'plugins.availableDetails.closeDialog': 'Close available plugin details',
  ...
  'plugins.contextChipsEmpty': 'No active plugin context.',
  'plugins.contextChipsRemove': 'Remove {kind} {label}',
  'plugins.import.kicker': 'User plugins',
  'plugins.import.title': 'Import a plugin',
  'plugins.import.closeDialog': 'Close import dialog',
  'plugins.import.sourceTabs': 'Import source',
  'plugins.import.tabGithub': 'From GitHub',
  'plugins.import.tabGithubBody': 'Install github:owner/repo paths.',
  'plugins.import.tabZip': 'Upload zip',
  'plugins.import.tabZipBody': 'Upload a plugin archive.',
  'plugins.import.tabFolder': 'Upload folder',
  'plugins.import.tabFolderBody': 'Upload a plugin directory.',
  'plugins.import.sourceLabel': 'GitHub, archive, or marketplace source',
  'plugins.import.sourceHelp': 'Supports {sourceSpec}, HTTPS {archiveExts} archives, or marketplace plugin names.',
  'plugins.import.submit': 'Import',
  'plugins.import.submitWorking': 'Importing…',
  'plugins.import.zipBody': 'Choose a .zip archive containing open-design.json, SKILL.md, or .claude-plugin/plugin.json.',
  'plugins.import.folderBody': 'Choose a plugin folder. Relative paths are preserved and installed into your user plugin registry.',
  'plugins.import.noZipSelected': 'No zip selected',
  'plugins.import.noFolderSelected': 'No folder selected',
  'plugins.import.filesSelected': 'Files selected: {count}',
  'plugins.import.footerNote': 'Imported plugins are user plugins and are stored separately from bundled official plugins.',
  'plugins.filtersAria': 'Plugin filters',
  'plugins.previewHero.eyebrow': 'What it produces',
  'plugins.previewHero.outputsAria': 'Example outputs',
  'plugins.previewHero.openNewTabTitle': 'Open this example in a new tab',
  'plugins.previewHero.openLabel': 'Open',
  ...
  'connectors.providerAria': 'Connector provider',
  ...
  'chat.comments.annotationAria': 'Annotation',
  'chat.comments.moveBox': 'Move comment box',
  ...
  'workspace.tabsChrome': 'Workspace tabs',
  'workspace.tabsStrip': 'Open workspaces',
  ...
  'brand.fontsMissingTitle': 'Brand font files missing',
  'brand.fontsMissingBody': 'Typography previews are using substitute web fonts until brand font files are added.',
  'brand.fontsAddFiles': 'Add brand font files',
  'brand.fontsKeepSubstitutes': 'Keep substitutes',
