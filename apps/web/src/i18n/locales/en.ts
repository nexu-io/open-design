...
export const en: Dict = {
  ...
  'serverDirectoryPicker.noRoots': 'No authorized server folders are available. Link a working directory first.',
  'serverDirectoryPicker.loadRootsFailed': 'Could not load server folders.',
  'serverDirectoryPicker.contentsAria': 'Directory contents',
  ...
  'settings.projectLocationsPickerInvalid': 'The folder picker returned an invalid response.',
  'settings.projectLocationsPickerFailed': 'Could not open the folder picker.',
