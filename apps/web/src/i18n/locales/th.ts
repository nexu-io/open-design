...
export const th: Dict = {
  ...
  'chat.dsExtractUser': "แยกดีไซน์ซิสเต็มจาก {source}",
  'chat.dsExtractRunning': "กำลังแยกดีไซน์ซิสเต็ม…",
  'chat.dsExtractDone': "แยก {name} แล้ว — โมดูลทั้งหมดพร้อมใช้งาน",
  'chat.dsNextStepsTitle': "ขั้นตอนถัดไป",
  'chat.dsMoreToggle': "การเพิ่มประสิทธิภาพเพิ่มเติม",
  ...
  'ds.fullSystemLabel': 'ระบบทั้งหมดของ {name}',
