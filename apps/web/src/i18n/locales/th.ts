...
export const th: Dict = {
  ...
  'chat.amrCard.switchBody': 'สลับไปยังบริการโมเดล AMR อย่างเป็นทางการของ Marketing AX — ไม่ต้องตั้งค่า API Key หลังจากเข้าสู่ระบบ ให้สิทธิ์ และเติมเงินแล้ว งานนี้จะถูกลองใหม่โดยอัตโนมัติ',
  ...
  'settings.onboardingCreateBody': 'อธิบายเว็บไซต์ แอป สไลด์ รูปภาพ หรือวิดีโอที่คุณต้องการ Marketing AX จะสร้างโปรเจกต์ให้และเก็บงานไว้ให้แก้ไขได้ตลอด',
  ...
  'settings.agentInstall.pathHint': 'หากคุณติดตั้ง CLI ด้วย npm หรือ Homebrew แล้วแต่ยังแสดงว่าไม่ได้ติดตั้ง โปรดตรวจสอบว่าโฟลเดอร์ bin ของเครื่องมือนั้นอยู่ใน PATH ที่ Marketing AX daemon ใช้งาน (บน macOS ค่า PATH ของ Terminal และแอป GUI อาจต่างกัน) ดู QUICKSTART.md (ส่วน "Local agent CLI and PATH")',
  'settings.agentInstall.stepOpenLinks': 'เปิดลิงก์ติดตั้งหรือเอกสารสำหรับเอเจนต์ที่ต้องการ',
  'settings.agentInstall.stepAuth': 'ยืนยันตัวตนกับ CLI ของผู้ให้บริการ (ลงชื่อเข้าใช้หรือเพิ่มข้อมูลรับรอง API) ก่อนกลับไปที่ Marketing AX',
  ...
  'settings.mcpServerHint': 'เปิดให้ Marketing AX เป็นเซิร์ฟเวอร์ MCP สำหรับเอเจนต์โค้ด',
  ...
  'settings.privacyHint': 'ข้อมูลที่แชร์กับทีม Marketing AX',
  'settings.privacyConsentKicker': 'ช่วยเราพัฒนา Marketing AX',
  'settings.privacyConsentLead': 'Marketing AX สามารถแชร์ข้อมูลการใช้งานกับทีมของเราเพื่อช่วยพัฒนา ซึ่งรวมถึง:',
  ...
  'settings.mcpHint': 'ให้ coding agent (Cursor, Claude Code, VS Code…) อ่านโปรเจกต์ Marketing AX ของคุณได้โดยตรง',
  'settings.mcpDaemonError': 'ไม่สามารถเชื่อมต่อกับ daemon ในเครื่องเพื่อระบุพาธการติดตั้งได้ ({error}) โปรดตรวจสอบว่า Marketing AX กำลังทำงานอยู่ จากนั้นเปิดแผงนี้ใหม่',
  'settings.mcpBuildDaemon': 'สร้าง daemon ก่อน',
  'settings.mcpNodeMissing': 'ไม่พบไบนารีของ Node',
  'settings.mcpBuildHint': 'ไม่พบ apps/daemon/dist/cli.js รัน `pnpm --filter @marketing-ax/daemon build` แล้วรีเฟรช',
  ...
  'settings.mcpCapabilityDefault': 'ตั้งค่าเริ่มต้นเป็นโปรเจกต์และไฟล์ที่คุณเปิดอยู่ใน Marketing AX เพื่อให้คุณพูดได้ว่า "สร้างสิ่งนี้ในแอปของฉัน" โดยไม่ต้องระบุดีไซน์ซ้ำอีก',
  'settings.mcpRunningNote': 'Marketing AX ต้องกำลังทำงานอยู่เพื่อให้การเรียกเครื่องมือ MCP สำเร็จ หากคุณเริ่มต้นโค้ดดิ้ง Agent ก่อนเปิด Marketing AX ให้รีสตาร์ท Agent เพื่อให้สามารถเชื่อมต่อกับ daemon ที่ทำงานอยู่ได้',
  ...
  'entry.discordAria': 'เข้าร่วม Discord ของ Marketing AX',
  'entry.discordAriaWithOnline': 'เข้าร่วม Discord ของ Marketing AX - {online}',
  ...
  'entry.navBrands': 'แบรนด์',
  'entry.navIntegrations': 'การเชื่อมต่อ',
  'brands.empty': 'ยังไม่มีแบรนด์ที่ลงทะเบียนไว้',
  'brands.back': 'ย้อนกลับ',
  'brands.core': 'แก่นแบรนด์',
  'brands.loadFailed': 'ไม่สามารถโหลดแบรนด์นี้ได้',
  'brands.pageTitle': 'แบรนด์',
  'brands.pageSubtitle': 'ลงทะเบียนบริบทและระบบดีไซน์ของแต่ละแบรนด์ แล้วสร้างโปรเจกต์',
  'brands.sectionContext': 'บริบทแบรนด์',
  'brands.sectionDesignSystem': 'ระบบดีไซน์',
  'brands.sectionDocs': 'เอกสารความรู้',
  'brands.docsHint': 'แก่นแบรนด์และเอกสารฝีมือ (.md) ของแต่ละช่องทางจะถูกฉีดเข้าไปใน run เลือกเอกสารเพื่อดู',
  'brands.fieldTagline': 'แท็กไลน์',
  'brands.fieldWebsite': 'เว็บไซต์',
  'brands.fieldAudience': 'กลุ่มเป้าหมายหลัก',
  'brands.fieldKeyMessage': 'ข้อความหลัก',
  'brands.fieldAvoid': 'สิ่งที่ควรหลีกเลี่ยง',
  'brands.fieldChannels': 'ช่องทาง',
  'brands.palette': 'จานสี',
  'brands.typography': 'การจัดพิมพ์',
  'brands.voiceTone': 'น้ำเสียงและโทน',
  'brands.coreDocLabel': 'แก่นแบรนด์',
  'brands.projectCount': '{n} โปรเจกต์',
  'brands.paletteChannelMeta': '{c} สี · ลงทะเบียน {n} ช่องทาง',
  'brands.newButton': '+ แบรนด์ใหม่',
  'brands.newTitle': 'แบรนด์ใหม่',
  'brands.newFieldTitle': 'ชื่อ',
  'brands.newFieldId': 'ID',
  'brands.newFieldIdHint': 'แนะนำอัตโนมัติจากชื่อ — ตัวพิมพ์เล็ก ตัวเลข และขีดกลางเท่านั้น',
  'brands.newSubmit': 'สร้าง',
  'brands.newDuplicateId': 'มีแบรนด์ที่ใช้ ID นี้อยู่แล้ว',
  'brands.newFailed': 'ไม่สามารถสร้างแบรนด์ได้',
  'brands.edit': 'แก้ไข',
  'brands.save': 'บันทึก',
  'brands.cancel': 'ยกเลิก',
  'brands.saveFailed': 'ไม่สามารถบันทึกการเปลี่ยนแปลงได้',
  'brands.fieldSubtitle': 'คำบรรยายรอง',
  'brands.fieldToneLabel': 'ป้ายโทนเสียง',
  'brands.fieldTypographyFamily': 'ตระกูลฟอนต์',
  'brands.fieldTypographyRoles': 'บทบาทฟอนต์',
  'brands.fieldTypographyWeights': 'น้ำหนักฟอนต์',
  'brands.fieldNeutralPalette': 'พาเลตต์สีกลาง',
  'brands.fieldCommaHint': 'คั่นหลายค่าด้วยเครื่องหมายจุลภาค',
  'brands.docEdit': 'แก้ไขเอกสาร',
  'brands.docSaveFailed': 'ไม่สามารถบันทึกเอกสารได้',
  'brands.channelAdd': '+ ช่องทาง',
  'brands.channelAddKey': 'คีย์',
  'brands.channelAddKeyHint': 'ตัวพิมพ์เล็ก ตัวเลข และขีดกลางเท่านั้น — ใช้เป็นคีย์ฉีดเข้าพรอมป์ต',
  'brands.channelAddLabel': 'ป้ายกำกับ',
  'brands.channelAddDesignSystem': 'ระบบดีไซน์',
  'brands.channelAddSubmit': 'เพิ่ม',
  'brands.channelAddFailed': 'ไม่สามารถเพิ่มช่องทางได้',
  'brands.channelRemove': 'ลบช่องทาง',
  'brands.channelRemoveConfirm': 'ลบช่องทาง {key} หรือไม่? เอกสารฝีมือของช่องทางนี้จะถูกลบด้วย',
  'brands.channelRemoveFailed': 'ไม่สามารถลบช่องทางได้',
  'brands.uploadIcon': 'อัปโหลดไอคอน',
  'brands.uploadLogo': 'อัปโหลดโลโก้',
  'brands.uploadFailed': 'ไม่สามารถอัปโหลดรูปภาพได้',
  'brands.uploadTooLarge': 'ไฟล์มีขนาดใหญ่เกินไป',
  'brands.deleteZone': 'โซนอันตราย',
  'brands.delete': 'ลบแบรนด์',
  'brands.deleteConfirm': 'ลบแบรนด์ {title} หรือไม่? การกระทำนี้ไม่สามารถย้อนกลับได้',
  'brands.deleteBlocked': 'มี {n} โปรเจกต์ที่ใช้แบรนด์นี้ กรุณาลบโปรเจกต์เหล่านั้นก่อน',
  'brands.deleteFailed': 'ไม่สามารถลบแบรนด์ได้',
  ...
  'homeHero.chip.createPluginHint': 'สร้างปลั๊กอิน Marketing AX ที่นำกลับมาใช้ใหม่ได้ และเพิ่มลงในปลั๊กอินของฉัน',
  ...
  'handoff.promptIntro': 'ดำเนินการต่อจากโฟลเดอร์โปรเจกต์ Marketing AX ในเครื่องนี้:',
  ...
  'pluginsHome.subtitle': 'เวิร์กโฟลว์ Marketing AX พร้อมใช้งานที่มาพร้อมกับรันไทม์นี้ เลือกหนึ่งรายการเพื่อโหลดพรอมป์ต์เริ่มต้น หรือเรียกดูรีจิสตรีเพื่อดูเพิ่มเติม',
  ...
  'pluginsHome.emptyCatalog': 'แคตตาล็อกว่างเปล่า ปลั๊กอินที่มาพร้อมกับ Marketing AX ควรปรากฏที่นี่โดยอัตโนมัติ — ลองรีสตาร์ท daemon หากยังเกิดปัญหานี้อยู่',
  ...
  'pluginCard.contributeAria': 'ร่วมสนับสนุน {title} ให้กับ Marketing AX',
  'pluginCard.contributeTitle': 'ร่วมสนับสนุน plugin ให้กับ Marketing AX ด้วย pull request',
  ...
  'integrations.lede': 'เชื่อมต่อระบบภายนอก นำเครื่องมือ MCP เข้าสู่ลูปของ Agent และใช้งาน Marketing AX จาก IDE สคริปต์ และระบบอัตโนมัติอื่น ๆ',
  ...
  'mcpClient.daemonError': 'ไม่สามารถเชื่อมต่อกับ daemon ภายในเครื่องได้ โปรดตรวจสอบว่า Marketing AX กำลังทำงานอยู่ จากนั้นเปิดแผงนี้อีกครั้ง',
  'mcpClient.saveFailed': 'บันทึกไม่สำเร็จ โปรดตรวจสอบว่า daemon กำลังทำงานอยู่ แล้วลองอีกครั้ง',
  'useEverywhere.modalAria': 'ใช้ Marketing AX ได้ทุกที่',
  'useEverywhere.modalTitle': 'ใช้ Marketing AX ได้ทุกที่',
  'useEverywhere.modalSubtitle': 'นำ Marketing AX ไปใช้ใน IDE, Agent หรือสคริปต์ใดก็ได้ — CLI, HTTP, MCP และ Skills ใช้ “Copy guide for an agent” แล้ววางลงใน Claude Code, Codex, Cursor, openclaw หรือ hermes เพื่อตั้งค่าทุกอย่าง',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — แพ็ก `SKILL.md` แบบ drop-in (รองรับ Claude) ที่ Agent ใดก็ตามซึ่งอยู่ใน PATH ของคุณสามารถเรียกใช้ได้โดยไม่ต้องมี Marketing AX เลย',
  ...
  'useEverywhere.section.cli.heading': 'ควบคุม Marketing AX จาก shell ใดก็ได้',
  ...
  'useEverywhere.section.mcp.heading': 'เปิดเผย Marketing AX เป็นเซิร์ฟเวอร์ MCP ให้กับ coding agent ใดก็ได้',
  'useEverywhere.section.mcp.intro': 'Marketing AX มาพร้อมกับเซิร์ฟเวอร์ Model Context Protocol (`od mcp`) ที่ให้ client ใดก็ตามซึ่งรองรับ MCP — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — ค้นพบเครื่องมือของ Marketing AX (แสดงรายการ skills, เรนเดอร์ตัวอย่าง, สร้างมีเดีย, รันปลั๊กอิน) ได้โดยไม่ต้องเรียกผ่าน shell เอง daemon จะเผยแพร่ snippet การติดตั้งที่พร้อมวางผ่าน `GET /api/mcp/install-info` สำหรับ client หลักแต่ละตัว',
  ...
  'useEverywhere.section.mcp.bullet4': 'ตรึง `MAX_DATA_DIR` เพื่อให้กระบวนการ MCP ที่ถูกสร้างขึ้นเขียนไปยังตำแหน่งเดียวกันกับที่ daemon ใช้อยู่แล้ว (หลีกเลี่ยง EPERM ในแอปบันเดิลแพ็กเกจของ macOS)',
  ...
  'useEverywhere.section.mcp.footer': 'ในแอป Marketing AX ให้เปิด Settings → Integrations เพื่อคัดลอกคำสั่งติดตั้งเฉพาะ client (Cursor, Claude Code, Antigravity, VS Code) แทนการแก้ไข JSON ด้วยมือ',
  'useEverywhere.section.http.tab': 'HTTP API',
  'useEverywhere.section.http.heading': 'REST + SSE surface เดียวกันกับที่ web UI ใช้',
  'useEverywhere.section.http.intro': 'daemon ในเครื่องให้บริการ HTTP API ที่ `http://127.0.0.1:7456` (กำหนดพอร์ตได้) ทุก endpoint ที่ web UI เรียกใช้สามารถใช้กับสคริปต์ของคุณได้เช่นกัน endpoint แบบสตรีมมิง (chat turn, project run) จะส่ง Server-Sent Events พร้อมชนิดตามสัญญาใน `@marketing-ax/contracts`',
  ...
  'useEverywhere.section.http.footer': 'ไทป์ TypeScript ล้วนสำหรับทุก request/response อยู่ใน `@marketing-ax/contracts` — import เข้าสคริปต์ของคุณเพื่อ autocomplete เต็มรูปแบบโดยไม่ต้องตั้งค่า generator',
  'useEverywhere.section.skills.tab': 'สกิลและ headless',
  'useEverywhere.section.skills.heading': 'Skills แบบ drop-in สำหรับ Agent ใดก็ตาม — แม้ไม่ได้รัน Marketing AX อยู่',
  'useEverywhere.section.skills.intro': 'Skill คือไดเรกทอรีที่มี `SKILL.md` ซึ่งรองรับ Claude (YAML front-matter + เนื้อหา) Marketing AX ขยายรูปแบบด้วย namespace `od:` (`mode`, `preview`, `design_system`, `inputs`, …) เพื่อให้ artifact เดียวกันใช้งานได้ทั้งภายใน Marketing AX และโดย Agent ทั่วไปอย่าง Claude Code, Codex, openclaw หรือ hermes การค้นพบจะเป็นไปตามลำดับความสำคัญเพื่อให้โปรเจกต์สามารถแทนที่ skills ของตัวเองได้',
  ...
  'useEverywhere.section.skills.snippet1': 'SKILL.md แบบขั้นต่ำ (front matter ที่เข้ากันได้กับ Claude + ส่วนเสริมของ Marketing AX)',
  ...
  'entry.githubStarAria': 'ติดดาว Marketing AX บน GitHub',
  ...
  'newproj.locationDefault': 'โปรเจกต์ Marketing AX',
  ...
  'ds.detailLoadFailed': 'ไม่สามารถโหลดดีไซน์ซิสเต็มนี้ได้',
  'ds.back': 'ย้อนกลับ',
  'ds.detailLoading': 'กำลังโหลดดีไซน์ซิสเต็ม…',
  'ds.detailLoadingHint': 'กำลังเปิดพื้นที่ทำงานสำหรับรีวิว',
  ...
  'socialShare.openDesignSection': 'แชร์ Marketing AX',
  'socialShare.openDesignTitle': 'Marketing AX บน GitHub',
  'socialShare.openDesignText': 'Marketing AX คือพื้นที่ทำงานแบบโอเพนซอร์สสำหรับการสร้าง แก้ไข เผยแพร่ และส่งต่อชิ้นงานออกแบบ',
  'socialShare.openDesignCopyText': '{text}\n{url}',
  'socialShare.projectSection': 'แชร์ลงโซเชียล',
  'socialShare.projectTitle': '{title} · Marketing AX',
  'socialShare.projectText': 'สร้างด้วย Marketing AX: {title} ดูชิ้นงานที่เผยแพร่และกดดาวให้ repo: {repo}',
  'socialShare.projectCopyText': 'สร้างด้วย Marketing AX: {title}\n{url}\nrepo ของ Marketing AX: {repo}',
  ...
  'chat.activeFilePlaceholder': 'ขอให้ Marketing AX แก้ไข {file}...',
  ...
  'chat.mode.design.solves': 'ใช้เมื่ออยากให้ Marketing AX สร้างไฟล์ อัปเดต workspace หรือเปลี่ยน brief เป็นงานส่งมอบหลายรูปแบบ',
  ...
  'preview.shareTextDefault': 'เทมเพลต Marketing AX: {title}',
  ...
  'designFiles.usefulInfoTip7': 'ถ้าชอบ Marketing AX ฝากกดดาวให้เราบน GitHub',
  ...
  'fileViewer.openFolder': 'เปิดโฟลเดอร์โปรเจกต์',
  'fileViewer.openFolderFailed': 'ไม่สามารถเปิดโฟลเดอร์โปรเจกต์ได้',
  'fileViewer.openFolderWebFallback': 'ไม่สามารถเปิดโฟลเดอร์จากเบราว์เซอร์ได้ พาธ:',
  'fileViewer.copyCaption': 'คัดลอกแคปชัน',
  'fileViewer.copyCaptionDone': 'คัดลอกแคปชันไปยังคลิปบอร์ดแล้ว',
  'fileViewer.copyCaptionFailed': 'ไม่สามารถคัดลอกแคปชันได้',
  ...
  'assistant.shareToOpenDesign': 'แชร์ไปยัง Marketing AX',
  ...
  'pet.tabBuiltInHint': 'จัดกลุ่มให้พร้อมใช้กับชุดระบบจาก Marketing AX แล้ว — เอาได้เลย',
  ...
  'pet.codexBundledTitle': 'เตรียมมาให้กับ Marketing AX แล้ว — ไม่ต้องดาวน์โหลดใหม่',
  ...
  'settings.projectLocationsDescription': 'เพิ่มฐานงานที่สามารถเก็บโฟลเดอร์โปรเจกต์ Marketing AX ได้หลายรายการ โปรเจกต์ใหม่จะถูกบันทึกเป็นหนึ่งโฟลเดอร์ภายในฐานที่เลือก',
  ...
  'settings.customInstructionsHint': 'คำสั่งตายตัวที่ Marketing AX ควรปฏิบัติตามในทุกการสนทนา บันทึกข้อเท็จจริง การตั้งค่า และบริบทของโปรเจกต์ไว้เป็นความทรงจำ',
  'settings.customInstructionsPlaceholder': 'เช่น "ใช้ TypeScript เสมอ เลือกใช้ functional component กระชับคำตอบให้สั้น"',
  'settings.defaultRouter.title': 'เราเตอร์เริ่มต้น',
  'settings.defaultRouter.description': 'ปลั๊กอินเราเตอร์สำหรับพรอมป์อิสระที่ไม่ตรงกับทริกเกอร์ใด ๆ',
  'settings.defaultRouter.builtin': 'ในตัว (Default design router)',
  ...
  'settings.memoryStarterProjectDesc': 'Marketing AX v0.5 — โปรแกรมแก้ไขดีไซน์ที่ขับเคลื่อนด้วยแชท',
  ...
  'updater.availableBody': 'Marketing AX {version} พร้อมใช้งานแล้ว จะดาวน์โหลดก่อนเปิดตัวติดตั้ง',
  ...
  'updater.installerOpenBody': 'ตัวติดตั้งเปิดอยู่ Marketing AX กำลังออกเพื่อให้คุณอัปเดตให้เสร็จ',
  ...
  'updater.quitButton': 'ออกจาก Marketing AX',
  'updater.quitFailedBody': 'ตัวติดตั้งเปิดอยู่ แต่ไม่สามารถออกจาก Marketing AX ได้ โปรดออกจาก Marketing AX ก่อนแทนที่แอป',
  'updater.quitFailedTitle': 'ออกไม่ได้',
  'updater.quitting': 'กำลังออก...',
  'updater.ready': 'อัปเดตพร้อมแล้ว',
  'updater.readyGeneric': 'เวอร์ชันใหม่พร้อมแล้ว Marketing AX จะปิดและเปิดตัวติดตั้ง',
  'updater.readyVersion': 'Marketing AX {version} พร้อมแล้ว Marketing AX จะปิดและเปิดตัวติดตั้ง',
  ...
  'dsManager.createBody': 'สอน Marketing AX ให้รู้จักแบรนด์ ผลิตภัณฑ์ โค้ด แอสเซ็ต และข้อมูลอ้างอิงการออกแบบของคุณ',
  ...
  'settings.customInstructionsDesc': 'คำสั่งตายตัวที่ Marketing AX ปฏิบัติตามในทุกการแชต สิ่งเหล่านี้ไม่ใช่หน่วยความจำที่บันทึกไว้ ใช้ Memory สำหรับข้อเท็จจริง ความชอบ และบริบทของโปรเจกต์',
