...
export const th: Dict = {
  ...
  'chat.runError.description.useOfficialAgent': 'เอเจนต์ที่เลือกยังไม่ได้ลงชื่อเข้าใช้ ใช้เอเจนต์ทางการของ Open Design เพื่อการรันที่เสถียรและคุ้มค่ากว่า หรือรันเอเจนต์ปัจจุบันอีกครั้ง',
  'chat.runError.description.rateLimitUseOfficialAgent': 'โมเดลหรือผู้ให้บริการปัจจุบันถึงโควตาหรือขีดจำกัดความถี่แล้ว ลองใหม่ภายหลัง หรือใช้เอเจนต์ Open Design เพื่อการรันที่เสถียรและคุ้มค่ากว่า',
  'chat.runError.description.upstreamUseOfficialAgent': 'ผู้ให้บริการโมเดลไม่พร้อมใช้งานชั่วคราว ลองใหม่ภายหลัง หรือใช้เอเจนต์ Open Design เพื่อการรันที่เสถียรและคุ้มค่ากว่า',
  'chat.runError.description.genericUseOfficialAgent': 'การดำเนินงานล้มเหลว ลองใหม่ภายหลัง หรือใช้เอเจนต์ Open Design เพื่อการรันที่เสถียรและคุ้มค่ากว่า',
