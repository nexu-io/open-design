...
export const id: Dict = {
  ...
  'settings.mediaProviderConnectionConnected': "Terhubung",
  'settings.mediaProviderConnectionDisconnected': "Tidak terhubung",
  'settings.mediaProviderConnectionConnectedTitle': "Login Codex CLI lokal berfungsi",
  'settings.mediaProviderConnectionDisconnectedTitle': "Login Codex CLI lokal tidak terdeteksi",
  'settings.mediaProviderConnectionConnectedNote': "Login Codex CLI lokal berfungsi",
  'settings.mediaProviderConnectionDisconnectedNote': "Masuk dengan Codex CLI lokal untuk memakai penyedia ini",
  ...
  'settings.projectLocationsManualPlaceholder': "Masukkan path folder",
  'settings.projectLocationsBrowseFolders': "Jelajahi folder",
  'settings.projectLocationsBrowserDialogLabel': "Pilih lokasi proyek",
  'settings.projectLocationsBrowserTitle': "Pilih folder",
  'settings.projectLocationsBrowserLoading': "Memuat folder...",
  'settings.projectLocationsBrowserParentFolder': "Folder induk",
  'settings.projectLocationsBrowserUseFolder': "Gunakan folder ini",
  'settings.projectLocationsBrowserLoadError': "Tidak bisa memuat folder. Masukkan path folder secara manual.",
  'settings.projectLocationsBrowserEmpty': "Tidak ada folder anak di sini.",
  ...
  'ds.contentsLabel': "Daftar isi",
  'ds.contentsAriaLabel': "Daftar isi design system",
