...
export const id: Dict = {
  ...
  'settings.agentInventoryTitle': 'Terpasang di {client}',
  'settings.agentInventoryRefresh': 'Muat ulang',
  'settings.agentInventoryLoading': 'Memuat server MCP dan keterampilan yang terpasang…',
  'settings.agentInventoryError': 'Tidak dapat memuat inventaris CLI ini ({error}).',
  'settings.agentInventoryUnsupported': 'Deteksi inventaris untuk {client} belum tersedia.',
  'settings.agentInventoryUnavailable': 'Konfigurasi {client} tidak terdeteksi.',
  'settings.agentInventoryEmpty': 'Tidak ada server MCP atau keterampilan terpasang yang terdeteksi untuk {client}.',
  'settings.agentInventoryMcpServers': 'Server MCP',
  'settings.agentInventorySkills': 'Keterampilan',
  'settings.agentInventoryNoMcpServers': 'Tidak ada server MCP yang terdeteksi.',
  'settings.agentInventoryNoSkills': 'Tidak ada keterampilan yang terdeteksi.',
  'settings.agentInventorySourceUser': 'Pengguna',
