...
export const id: Dict = {
  ...
  'chat.dsExtractUser': "Ekstrak sistem desain dari {source}",
  'chat.dsExtractRunning': "Mengekstrak sistem desain…",
  'chat.dsExtractDone': "{name} berhasil diekstrak — semua modul sudah siap.",
  'chat.dsNextStepsTitle': "Langkah berikutnya",
  'chat.dsMoreToggle': "Optimasi lainnya",
  ...
  'ds.fullSystemLabel': 'Sistem lengkap {name}',
