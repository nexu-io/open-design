...
export const esES: Dict = {
  ...
  'fileViewer.exportPdfServer': 'Exportar PDF — alta calidad',
  'fileViewer.exportPdfServerBusy': 'Exportando PDF…',
  'fileViewer.exportPdfServerError': 'Error al exportar PDF',
