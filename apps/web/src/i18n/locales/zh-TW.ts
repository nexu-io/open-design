...
export const zhTW: Dict = {
  ...
  'settings.orcaRouterConnectIntro': '使用您的 OrcaRouter 帳號登入，或貼上既有的 API 金鑰。兩者都計入您自己的帳號，並可隨時撤銷。',
  'settings.orcaRouterNotConnected': '未連線。',
  'settings.orcaRouterConnected': '已連線至 OrcaRouter。',
  'settings.orcaRouterNeedsReauthTitle': '需要重新登入 OrcaRouter。',
  'settings.orcaRouterNeedsReauth': 'OrcaRouter 拒絕了此憑證。請重新登入或貼上新的 API 金鑰。',
  'settings.orcaRouterScopeGranted': '已授予範圍：',
  'settings.orcaRouterWaiting': '正在等待授權…',
  'settings.orcaRouterWaitingHint': 'OpenDesign 正在等待回呼。您在瀏覽器中核准後，此面板將立即切換為「已連線」。',
  'settings.orcaRouterConnect': '使用 OrcaRouter 連線',
  'settings.orcaRouterReconnect': '重新連線',
  'settings.orcaRouterReconnectHint': '重新授權並取代已儲存的金鑰',
  'settings.orcaRouterConnecting': '正在連線…',
  'settings.orcaRouterOpeningBrowser': '正在開啟瀏覽器…',
  'settings.orcaRouterCancel': '取消',
  'settings.orcaRouterDisconnect': '中斷連線',
  'settings.orcaRouterDisconnecting': '正在中斷…',
  'settings.orcaRouterOpenManually': '瀏覽器分頁沒有開啟？',
  'settings.orcaRouterOpenManuallyLink': '手動開啟授權頁面',
  'settings.orcaRouterPasteHint': 'OrcaRouter 可能顯示代碼而不跳轉。請貼到這裡：',
  'settings.orcaRouterPastePlaceholder': '貼上授權碼',
  'settings.orcaRouterSubmitCode': '提交代碼',
  'settings.orcaRouterSubmitting': '正在提交…',
};
