...
export const zhTW: Dict = {
  ...
  'ds.setupCompanyPlaceholder': '例如：Mission Impastabowl：一家快休閒義大利麵餐廳，擁有店內觸控點餐、自有行動應用和網站',
  ...
  'ds.githubStatusCheckTimeout': '無法完成 GitHub 連接器檢查。你仍然可以新增儲存庫 URL，或手動連接 GitHub。',
  ...
  'ds.githubAccessDescChecking': '正在背景檢查連接器狀態；URL 讀取不會被阻塞。',
