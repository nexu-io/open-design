...
export const zhTW: Dict = {
  ...
  'figma.import.dialogAria': "從 Figma 匯入",
  'figma.import.notesPlaceholder': "選填：建置說明（例如「做成行銷登陸頁」）",
  'figma.import.submit': "匯入並建置",
  'figma.import.colorsAria': "色彩符記",
  'figma.import.summaryFoot': "提示詞已在編輯器中就緒——檢查並傳送以建置頁面。",
  'figma.import.tabFile': '上傳 .fig',
  'figma.import.dropHint': '在你的機器上解碼——符記、元件和資源。無需 Figma 帳戶。',
  'figma.import.urlHint': '透過 Figma 連接器（OAuth）和移轉流程執行。',
  'figma.import.decoding': '解碼中…',
  'figma.import.notFigError': '這不是 .fig 檔案。請將 Figma 檔案匯出為 .fig（File → Save local copy）並拖放到此處。',
  'figma.import.importedLabel': '已匯入',
  'figma.import.assetsOnlySuffix': '（僅資源——無法解碼節點樹）',
  'figma.import.statNodes': '節點',
  'figma.import.statPages': '頁面',
  'figma.import.statFrames': '框架',
  'figma.import.statComponents': '元件',
  'figma.import.statColors': '顏色',
  'figma.import.statFonts': '字體',
  'figma.import.statAssets': '資源',
  "designFiles.library.label": "從資源庫匯入",
  "designFiles.library.title": "從資源庫匯入",
  'library.upload.title': "上傳至資料庫",
  'library.upload.closeAria': "關閉上傳",
  'library.upload.dropHint': '圖片、字體、文字、HTML 和 JSON / 設計資料 · 每個最大 {maxMb} MB',
  'library.upload.uploading': '上傳中…',
  'library.upload.deduped': '已在資料庫中',
  'library.upload.added': '已新增',
  'library.upload.failed': '失敗',
  'library.upload.empty': '尚未上傳任何內容',
  'library.upload.summaryAdded': '已新增 {count} 項',
  'library.upload.summaryFailed': '{count} 項失敗',
  'library.upload.done': '完成',
  ...
  "plugins.availableDetails.closeDialog": "關閉可用外掛詳細資訊",
  ...
  "plugins.contextChipsEmpty": "沒有使用中的外掛情境。",
  "plugins.contextChipsRemove": "移除 {kind} {label}",
  "plugins.import.kicker": "使用者外掛",
  "plugins.import.title": "匯入外掛",
  "plugins.import.closeDialog": "關閉匯入對話框",
  "plugins.import.sourceTabs": "匯入來源",
  "plugins.import.tabGithub": "從 GitHub",
  "plugins.import.tabGithubBody": "安裝 github:owner/repo 路徑。",
  "plugins.import.tabZip": "上傳 zip",
  "plugins.import.tabZipBody": "上傳外掛壓縮檔。",
  "plugins.import.tabFolder": "上傳資料夾",
  "plugins.import.tabFolderBody": "上傳外掛目錄。",
  "plugins.import.sourceLabel": "GitHub、壓縮檔或市集來源",
  "plugins.import.sourceHelp": "支援 {sourceSpec}、HTTPS {archiveExts} 壓縮檔或市集外掛名稱。",
  "plugins.import.submit": "匯入",
  "plugins.import.submitWorking": "匯入中…",
  "plugins.import.zipBody": "選擇包含 open-design.json、SKILL.md 或 .claude-plugin/plugin.json 的 .zip 壓縮檔。",
  "plugins.import.folderBody": "選擇外掛資料夾。相對路徑將被保留並安裝到你的使用者外掛登錄中。",
  "plugins.import.noZipSelected": "未選擇 zip",
  "plugins.import.noFolderSelected": "未選擇資料夾",
  "plugins.import.filesSelected": "已選擇檔案：{count}",
  "plugins.import.footerNote": "匯入的外掛為使用者外掛，與內建的官方外掛分開儲存。",
  'plugins.filtersAria': "外掛篩選",
  'plugins.previewHero.eyebrow': "產出內容",
  'plugins.previewHero.outputsAria': "範例輸出",
  'plugins.previewHero.openNewTabTitle': "在新分頁中開啟此範例",
  'plugins.previewHero.openLabel': "開啟",
  "app.brand": "OpenDesign",
  "app.brandPill": "研究預覽版",
  "app.brandSubtitle": "由 Nexu Labs 出品",
  "app.welcomeLoading": "正在載入工作區…",
  "settings.welcomeKicker": "",
  'settings.sectionsAria': "設定區塊",
  ...
  'connectors.providerAria': "連接器提供方",
  ...
  'chat.comments.annotationAria': "註解",
  'chat.comments.moveBox': "移動評論框",
  ...
  "workspace.tabsChrome": "工作區標籤",
  "workspace.tabsStrip": "開啟的工作區",
  ...
  "brand.fontsMissingTitle": "缺少品牌字型檔案",
  "brand.fontsMissingBody": "在新增品牌字型檔案之前，字體預覽會使用替代網頁字型。",
  "brand.fontsAddFiles": "新增品牌字型檔案",
  "brand.fontsKeepSubstitutes": "保留替代字型",
  "newBrand.title": "新增品牌",
  "newBrand.subtitle":
