...
export const zhTW: Dict = {
  ...
  "assistant.compactionActiveTitle": "正在壓縮上下文",
  "assistant.compactionActiveDetail": "保留任務目標、關鍵決策和最近進度",
  "assistant.compactionCompletedTitle": "上下文已壓縮",
  "assistant.compactionFailedTitle": "上下文壓縮失敗",
