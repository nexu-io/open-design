...
export const zhTW: Dict = {
  ...
  'fileViewer.coolifyTokenReuseHint': 'Token already saved. Enter a new token to replace it.',
  'fileViewer.coolifyTokenRequired': 'Enter and save a Coolify API token first.',
  'fileViewer.coolifyPreviewHint': 'Publishes to your self-hosted Coolify instance via GitHub.',
  ...
  'fileViewer.coolifyGithubRepoLocked': 'Linked to this repository. Clear the app UUID to reconnect.',
