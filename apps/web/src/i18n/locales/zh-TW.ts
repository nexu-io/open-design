...
export const zhTW: Dict = {
  ...
  'chat.dsExtractUser': "從 {source} 提取設計系統",
  'chat.dsExtractRunning': "正在提取設計系統…",
  'chat.dsExtractDone': "已成功提取 {name} — 所有模組已就緒。",
  'chat.dsNextStepsTitle': "下一步",
  'chat.dsMoreToggle': "更多最佳化",
