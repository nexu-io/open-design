...
export const zhTW: Dict = {
  ...
  'settings.mediaProviderMiniMaxNote': '填 TokenPlan key 即可；Base URL 留空會使用 https://api.minimaxi.com/v1。只有代理或自訂閘道才需要改 URL。',
  'settings.mediaProviderGoogleNote': '先設定 ~/.config/open-design/google-vertex-config.json 的 Vertex ADC。開啟後只會在圖片模型下拉顯示 Google 圖片模型；Veo / Lyria 還沒接入真實生成。',
  'settings.mediaProviderExternalEnable': '在模型下拉中顯示 Google 圖片模型',
  'settings.mediaProviderEnabled': '已啟用',
