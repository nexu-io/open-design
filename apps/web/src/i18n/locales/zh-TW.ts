...
export const zhTW: Dict = {
  ...
  'settings.updatePreviewLabel': '更新狀態預覽',
  'settings.updatePreviewActual': '實際開發狀態',
  'settings.updatePreviewIdle': '未檢查',
  'settings.updatePreviewChecking': '檢查中',
  'settings.updatePreviewUpToDate': '已是最新版本',
  'settings.updatePreviewAvailable': '發現新版本',
  'settings.updatePreviewDownloading': '下載中',
  'settings.updatePreviewDownloaded': '已準備安裝',
  'settings.updatePreviewInstalling': '安裝中',
  'settings.updatePreviewError': '檢查失敗',
  'settings.updatePreviewUnsupported': '不支援環境',
