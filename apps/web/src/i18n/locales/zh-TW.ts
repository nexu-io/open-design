...
export const zhTW: Dict = {
  ...
  'fileViewer.commentSync.backfillFailedTitle': "分享已發布",
  'fileViewer.commentSync.backfillFailedBody': "已有評論暫未同步，訪客暫時看不到",
  'fileViewer.commentSync.backfillTerminalBody': "部分既有評論未能同步至分享頁，系統不會自動重試。分享連結仍可使用。",
  'fileViewer.commentSync.backfillRetryingBody': "既有評論尚未同步，訪客暫時看不到。正在背景自動重試。",
  'fileViewer.commentSync.backfillReopenedPendingBody': "正在同步重新開啟的分享連結；分享頁可能仍顯示已刪除或已處理的留言。",
  'fileViewer.commentSync.backfillReopenedRetryingBody': "留言同步尚未完成，分享頁可能仍顯示已刪除或已處理的留言。正在背景自動重試。",
  'fileViewer.commentSync.backfillReopenedTerminalBody': "留言同步尚未完成，分享頁可能仍顯示已刪除或已處理的留言。自動重試已停止；分享連結仍可使用。",
  'fileViewer.commentSync.backfillPendingBody': "正在同步既有評論，訪客暫時可能看不到。",
  'fileViewer.commentSync.alignFailedBody': "評論對齊未完成，可能有評論沒顯示出來",
  'fileViewer.shareGuide.title': "匯出完成",
  'fileViewer.shareGuide.description': "分享連結，邀請大家查看並留下留言。",
  'fileViewer.shareGuide.tryShare': "去分享",
  'fileViewer.shareGuide.neverShowAgain': "不再提示",
  'fileViewer.shareGuide.preferenceSaveFailed': "偏好儲存失敗，請重試。",
  "common.close": "關閉",
  "common.clear": "清除",
  "common.delete": "刪除",
  "common.rename": "重新命名",
  ...
  "designs.deleteConfirm": "刪除「{name}」？",
  'designs.deleteActiveShares': "專案裡有 {count} 個頁面正在分享，刪除後分享連結將失效，訪客無法再開啟。",
  'designs.deletedShareTitle': "原檔案已刪除",
  'designs.deletedShareRetrying': "連結正在停用，稍後將無法存取",
  'designs.deletedShareFailed': "連結停用失敗，可能仍可存取",
  'designs.deletedShareRetry': "重試停用",
  ...
  "chat.comments.expandBody": "展開",
  "chat.comments.collapseBody": "收起",
  ...
  "fileViewer.jsxModuleBody": "只能分享獨立的 HTML 檔案。請先將此元件匯出為 HTML。",
  ...
  "fileViewer.shareUpdateSuccess": "連結已更新",
  "fileViewer.shareUpdateFailed": "更新失敗，上一版仍可存取。",
  "fileViewer.shareUpdateUncertain": "更新結果尚未確定，公開連結的內容可能已變更。請先檢查連結或停止分享，再重試。",
  "fileViewer.shareUpdateRetry": "重試",
  ...
  "chat.artifact.shareStatusUnknown": "分享狀態未知",
  "chat.artifact.published": "已分享",
