...
export const zhTW: Dict = {
  ...
  'billing.codingPlanUnavailable': '方案用量暫時無法取得',
  'billing.codingPlanWindowHours': '{count} 小時視窗',
  'billing.codingPlanWindowDays': '{count} 天視窗',
  'billing.codingPlanUsedPercent': '已用 {percent}%',
  'billing.codingPlanRemainingAmount': '剩餘 {amount}',
