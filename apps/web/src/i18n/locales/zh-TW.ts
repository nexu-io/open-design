...
export const zhTW: Dict = {
  ...
  'settings.desktop': '桌面',
  'settings.desktopHint': '設定桌面應用程式行為。',
  'settings.autoLaunch': '登入時啟動',
  'settings.autoLaunchHint': '登入時自動啟動 Open Design。',
  'settings.network': '網路',
  'settings.networkHint': '設定守護程式的網路介面綁定方式。',
  'settings.networkRequiresDaemon': '連線到執行中的守護程式以變更網路設定。',
  'settings.networkWarning': '網路暴露已啟用',
  'settings.networkWarningHint': '守護程式可從網路存取。請啟用 API 金鑰驗證並設定 IP 允許清單。',
  'settings.bindHost': '綁定位址',
  'settings.bindHostHint': '127.0.0.1 = 僅本機。0.0.0.0 = 所有網路介面。',
  'settings.port': '連接埠',
  'settings.portHint': '守護程式監聽的 TCP 連接埠。預設值: 7456。',
  'settings.allowedHosts': '允許的主機',
  'settings.allowedHostsHint': '允許連線的 IP 或 CIDR 範圍，逗號分隔。留白 = 允許所有。',
  'settings.apiKeys': 'API 金鑰',
  'settings.apiKeysHint': '網路暴露時非本機連線所需的驗證金鑰。',
  'settings.revoke': '撤銷',
  'settings.newApiKey': '新 API 金鑰',
  'settings.newApiKeyHint': '請立即複製此金鑰，之後不會再次顯示。',
  'settings.keyLabel': '標籤（選填）',
  'settings.generateKey': '產生',
  'settings.networkKeyRequired': '網路存取需要 API 金鑰',
  'settings.networkKeyRequiredHint': '綁定到所有介面會將守護程式暴露給網路。將產生 API 金鑰以確保安全。',
  'settings.generateAndSwitch': '產生金鑰並切換',
  'settings.networkNoKeysWarning': '沒有 API 金鑰無法重啟',
  'settings.networkNoKeysWarningHint': '守護程式暴露在網路中時，至少需要一個 API 金鑰。請在重啟前先生成金鑰。',
  'settings.networkRestartHint': '變更綁定位址、連接埠或允許的主機後需要重新啟動守護程式。',
  'settings.restartDaemon': '重新啟動守護行程',
  'settings.restartingDaemon': '重新啟動中…',
  'settings.restartFailed': '重新啟動失敗，請手動重新啟動。',
  'settings.networkSaveError': '儲存失敗，請檢查輸入後重試。',
  'settings.networkLoadError': '載入網路設定失敗。',
  ...
  'settings.mcpCapabilitiesTitle': '你的代理能做什麼',
  'settings.mcpCapabilityRead':
    '讀取或搜尋專案中的任何檔案 (HTML, JSX, CSS, JSON, SVG, Markdown)。',
  'settings.mcpCapabilityPull':
    '一次呼叫即可取得設計包：入口檔案及其參考的所有 CSS 變數、元件和字型。',
  'settings.mcpCapabilityDefault':
    '預設使用你在 Open Design 中開啟的專案和檔案，這樣你可以說「把這個加到我的應用裡」而無需重新指定設計。',
  'settings.mcpRunningNote':
    'MCP 工具呼叫需要 Open Design 正在執行才能成功。如果你在開啟 Open Design 之前啟動了編碼代理，請重新啟動代理以便它能連線到正在執行的守護程式。',
  'settings.mcpRestartNote': '重新啟動你的用戶端以識別新伺服器。',
  'settings.mcpRestartDetail':
    '大多數編輯器只在啟動時載入 MCP 伺服器。在 Cursor / VS Code / Antigravity / Windsurf 中，你可以從命令面板執行 `Developer: Reload Window` 來代替完全重新啟動。Zed 和 Claude Code 需要退出並重新開啟。',
