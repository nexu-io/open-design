...
export const zhTW: Dict = {
  ...
  'fileViewer.cloudflareAccountIdHint': '可在 Cloudflare 控制台中找到帳號 ID。',
  'fileViewer.cloudflareProjectName': 'Pages project name',
  'fileViewer.cloudflareProjectNameHint': '專案不存在時會自動建立。',
  'fileViewer.optional': '可選',
  'fileViewer.vercelPreviewOnly': '目前僅部署 Preview。',
  'fileViewer.cloudflarePagesPreviewHint': 'Cloudflare Pages 使用 Direct Upload，專案不存在時會自動建立。',
