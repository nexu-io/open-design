...
export const zhTW: Dict = {
  ...
  'fileViewer.commentSync.backfillRetryingBody': "既有評論尚未同步，訪客暫時看不到。正在自動重試。",
  'fileViewer.commentSync.backfillReopenedPendingBody': "正在同步重新開啟的分享連結；分享頁可能仍顯示已刪除或已處理的留言。",
  'fileViewer.commentSync.backfillReopenedRetryingBody': "評論同步未完成，分享頁可能仍顯示已處理的評論。",
  ...
  'fileViewer.commentSync.backfillPendingCountBody': "同步既有評論 · {count} 則",
  "fileViewer.commentSync.reopenSyncBusy": "正在同步留言…",
  'fileViewer.commentSync.alignFailedBody': "評論對齊未完成，可能有評論沒顯示出來",
  'fileViewer.shareGuide.title': "分享連結，讓大家留下回饋",
  'fileViewer.shareGuide.description': "分享連結，直接收集留言。選擇多則回饋，交給 Agent 依序處理。",
  'fileViewer.shareGuide.tryShare': "試試分享",
  'fileViewer.shareGuide.neverShowAgain': "不再提示",
  'fileViewer.shareGuide.close': "關閉新功能引導",
  ...
  'designs.deletedShareRetrying': "專案已刪除，正在停止「{filePath}」的分享連結",
  'designs.deletedShareFailed': "專案已刪除，「{filePath}」的分享連結停止失敗，仍可存取",
  'designs.deletedShareRetry': "重試",
  ...
  "fileViewer.shareUpdateHint": "檔案有新變更，訪客看到的仍是上一版。",
  ...
  'fileViewer.signInToShareDescription': "登入 Open Design 帳號後，即可產生分享連結，邀請他人查看和評論。",
