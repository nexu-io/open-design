...
export const zhTW: Dict = {
  ...
  'settings.welcomeTitle': '先生成一個結果',
  'settings.welcomeSubtitle': '告訴 Open Design 你想做什麼，給一點素材，然後用 AMR 新手額度生成一個首版。',
  ...
  'settings.onboardingStepConnect': '目標',
  'settings.onboardingStepDesignSystem': '生成',
  'settings.onboardingStepProfile': '素材',
  ...
  'settings.onboardingGithubTitle': '貼上官網 URL',
  'settings.onboardingGithubBody': '使用產品、文件或品牌官網。',
  'settings.onboardingUploadTitle': '上傳檔案',
  'settings.onboardingUploadBody': '加入截圖、PPT、PDF、文件或參考圖。',
  'settings.onboardingPromptTitle': '寫一句需求',
  'settings.onboardingPromptBody': '描述產品、品牌或目標結果。',
