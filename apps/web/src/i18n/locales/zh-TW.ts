...
export const zhTW: Dict = {
  ...
  'settings.onboardingAmrBody': "Open Design 官方 Model Router 平台。\n支援主流模型，並享有 Token 價格優惠。\n一個 API 完成全部設定，後續支援多模態模型、Skill 和 Connector。",
  'settings.onboardingAmrAction': "繼續使用 AMR Cloud",
  'settings.onboardingAmrWaitingTitle': "等待 AMR 登入 / 註冊",
  'settings.onboardingAmrWaitingBody': "我們已經開啟一個模擬的 AMR 登入視窗。當前 mock 會在約 5 秒後自動驗證通過，並繼續設定。",
  'settings.onboardingAmrOpenAgain': "重新開啟 AMR",
