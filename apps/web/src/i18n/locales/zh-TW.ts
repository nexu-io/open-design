...
export const zhTW: Dict = {
  ...
  "chat.compactBoundary": "以上對話已壓縮為摘要",
  "chat.compactDone": "對話已壓縮",
  "chat.compactAutoStarted": "上下文接近模型上限，正在自動壓縮…",
  "chat.compactAutoDone": "上下文已自動壓縮",
  "chat.compactAutoDryRun": "已觸發自動壓縮（dry-run，未實際執行）",
  "chat.compactAutoFailed": "自動壓縮失敗，已按原始上下文繼續傳送",
  "chat.contextWindowTitle": "上下文視窗",
  "chat.contextWindowModel": "模型",
  "chat.contextWindowCapacity": "視窗容量",
  "chat.contextWindowUsed": "當前轉錄估算",
  "chat.contextWindowAutoLine": "自動壓縮觸發線",
  "chat.contextWindowNote": "本地估算：容量取自 LiteLLM 模型目錄，占用按轉錄字元數折算（ASCII≈0.25 token）。達到觸發線時將在下次傳送前自動壓縮。",
  "chat.compactFailed": "壓縮失敗，請重試",
  "chat.compactProgress": "正在壓縮對話…",
  "chat.compactSlash": "把之前的對話壓縮成摘要，節省上下文",
  "chat.compactUnavailableReason": "壓縮僅支援 API 或 Antigravity 會話",
