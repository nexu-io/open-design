...
export const zhTW: Dict = {
  ...
  'settings.onboardingCloudTitle': '歡迎使用 OpenDesign',
  'settings.onboardingCloudBody': '讓靈感化為設計。',
  'settings.onboardingCloudSignIn': '登入 / 註冊',
  'settings.onboardingFreeCredits': '免費額度',
  'settings.onboardingFreeCreditsHint': '新用戶註冊即贈體驗額度，可免費試用 DeepSeek V4.1 Flash 模型。',
  'settings.onboardingOwnAi': '或使用自己的 AI',
  'settings.onboardingLocalAi': '本機 AI',
  'settings.onboardingApiKey': 'API 金鑰',
  ...
  "fileViewer.cloudflareWorkersScriptName": "指令碼名稱",
  "fileViewer.cloudflareWorkersCompatibilityDate": "相容性日期",
  "fileViewer.cloudflareWorkersBindings": "繫結",
  "fileViewer.cloudflareWorkersAddBinding": "新增繫結",
  "fileViewer.cloudflareWorkersRemoveBinding": "移除",
  "fileViewer.cloudflareWorkersBindingName": "繫結名稱",
  "fileViewer.cloudflareWorkersBindingBucketName": "儲存貯體名稱",
  "fileViewer.cloudflareWorkersBindingDatabaseId": "資料庫 ID",
  'fileViewer.cloudflareWorkersBindingDatabaseName': '資料庫名稱（不存在時建立）',
  'fileViewer.cloudflareWorkersBindingDatabaseNameHint': '將 ID 留空即可在部署時依此名稱建立 D1 資料庫',
  'fileViewer.cloudflareWorkersBindingR2CreateHint': '儲存貯體不存在時會自動建立',
  'fileViewer.cloudflareWorkersCustomDomain': '自訂網域',
  'fileViewer.cloudflareWorkersCustomDomainZone': '區域',
  'fileViewer.cloudflareWorkersCustomDomainHostname': '主機名稱',
  'fileViewer.cloudflareWorkersScopeD1Write': 'D1 寫入',
  'fileViewer.cloudflareWorkersScopeR2Write': 'R2 儲存空間寫入',
  "fileViewer.cloudflareWorkersBindingsEmpty": "尚無繫結。",
  "fileViewer.cloudflareWorkersCapabilities": "功能",
  "fileViewer.cloudflareWorkersCapabilitiesLoading": "載入中…",
  "fileViewer.cloudflareWorkersCapabilitiesLoadFailed": "無法載入功能。",
  "fileViewer.cloudflareWorkersCapabilitiesRefresh": "重新整理",
  "fileViewer.cloudflareWorkersCapabilitiesEmpty": "儲存設定後可查看功能。",
  "fileViewer.cloudflareWorkersEnabled": "已啟用",
  "fileViewer.cloudflareWorkersDisabled": "已停用",
  "fileViewer.cloudflareWorkersWorkers": "Workers",
  "fileViewer.cloudflareWorkersSubdomain": "Workers Dev 子網域",
  "fileViewer.cloudflareWorkersR2": "R2",
  "fileViewer.cloudflareWorkersD1": "D1",
  "fileViewer.cloudflareWorkersAccess": "Access",
  "fileViewer.cloudflareWorkersAccessEnabled": "私人 (Cloudflare Access)",
  "fileViewer.cloudflareWorkersAccessNotAvailable": "此認證無法使用 Cloudflare Access",
  "fileViewer.cloudflareWorkersAccessRule": "誰可以開啟此部署",
  "fileViewer.cloudflareWorkersAccessRuleEmails": "特定電子郵件",
  "fileViewer.cloudflareWorkersAccessRuleEmailDomain": "電子郵件網域",
  "fileViewer.cloudflareWorkersAccessRuleSelf": "僅限我自己",
  "fileViewer.cloudflareWorkersAccessRulePolicy": "現有的 Access 政策",
  ...
  "fileViewer.cloudflareWorkersReasonUnknown": "未知",
  'fileViewer.cloudflareWorkersOauthCredentialMode': '憑證方式',
  'fileViewer.cloudflareWorkersOauthCredentialModeToken': 'API 權杖',
  'fileViewer.cloudflareWorkersOauthCredentialModeOauth': '使用 Cloudflare 登入',
  'fileViewer.cloudflareWorkersOauthClientId': '用戶端 ID',
  'fileViewer.cloudflareWorkersOauthRedirectUri': '重新導向 URI',
  'fileViewer.cloudflareWorkersOauthScopes': '範圍',
  'fileViewer.cloudflareWorkersOauthScopeZoneRead': '讀取區域',
  'fileViewer.cloudflareWorkersOauthScopeAccessWrite': '寫入 Access 應用程式',
  'fileViewer.cloudflareWorkersOauthScopeD1Read': '讀取 D1',
  'fileViewer.cloudflareWorkersOauthScopeR2Read': '讀取 R2 儲存空間',
  'fileViewer.cloudflareWorkersOauthConnect': '連接 Cloudflare',
  'fileViewer.cloudflareWorkersOauthOpening': '正在開啟 Cloudflare…',
  'fileViewer.cloudflareWorkersOauthConnected': '已連線',
  'fileViewer.cloudflareWorkersOauthConnectFailed': '無法啟動 Cloudflare 登入。',
  'fileViewer.cloudflareWorkersOpenSite': '開啟已部署的網站',
  'fileViewer.cloudflareOAuthSignIn': '使用 Cloudflare 登入',
  'fileViewer.cloudflareOAuthOpening': '正在開啟瀏覽器…',
  'fileViewer.cloudflareOAuthAwaiting': '正在等待 Cloudflare 授權…',
  'fileViewer.cloudflareOAuthNotConnected': '未連線',
  'fileViewer.cloudflareOAuthBound': '已綁定至帳戶 {accountId}',
  'fileViewer.cloudflareOAuthExpiresIn': '權杖將在 {minutes} 分鐘後到期',
  'fileViewer.cloudflareOAuthGrantedScopes': '已授予的範圍：{scope}',
  'fileViewer.cloudflareOAuthExpired': '權杖已過期。請重新登入。',
  'fileViewer.cloudflareOAuthReconnect': '重新連線',
  'fileViewer.cloudflareOAuthDisconnect': '中斷連線',
  'fileViewer.cloudflareOAuthDisconnecting': '正在中斷連線…',
  'fileViewer.cloudflareOAuthRefresh': '重新整理狀態',
  'fileViewer.cloudflareOAuthOpenManually': '手動開啟授權頁面',
