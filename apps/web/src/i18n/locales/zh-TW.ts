...
export const zhTW: Dict = {
  // Default any key we haven't explicitly translated yet to English instead of
  // tripping the Dict typecheck — main went strict-keys-only, branch keeps the
  // spread as a safety net while the in-flight feature work lands its keys.
  ...en,
