...
export const zhTW: Dict = {
  ...
  'app.brandPill': 'Beta',
  'app.brandSubtitle': '由 Wix Japan Design 出品',
  ...
  'fileViewer.googleSlidesPagesLabel': '頁',
  'fileViewer.googleSlidesOpen': '在 Slides 中開啟',
  'fileViewer.googleSlidesNotReady': '正在產生 deck…',
  'fileViewer.googleSlidesInvalidUrl': '無效的 embed URL — 只允許 Google Slides 的 /embed 網域。',
  'fileViewer.googleSlidesMissingFields': '缺失的欄位',
  'fileViewer.googleSlidesMissingImages': '缺失的圖片',
  'fileViewer.googleSlidesSideEffects': '已知副作用',
