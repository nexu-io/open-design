...
export const zhTW: Dict = {
  ...
  "settings.agentInventoryTitle": "已安裝到 {client}",
  "settings.agentInventoryRefresh": "重新整理",
  "settings.agentInventoryLoading": "正在載入已安裝的 MCP 伺服器和技能…",
  "settings.agentInventoryError": "無法載入此 CLI 清單（{error}）。",
  "settings.agentInventoryUnsupported": "暫不支援偵測 {client} 的清單。",
  "settings.agentInventoryUnavailable": "未偵測到 {client} 設定。",
  "settings.agentInventoryEmpty": "未偵測到 {client} 中已安裝的 MCP 伺服器或技能。",
  "settings.agentInventoryMcpServers": "MCP 伺服器",
  "settings.agentInventorySkills": "技能",
  "settings.agentInventoryNoMcpServers": "未偵測到 MCP 伺服器。",
  "settings.agentInventoryNoSkills": "未偵測到技能。",
  "settings.agentInventorySourceUser": "使用者",
