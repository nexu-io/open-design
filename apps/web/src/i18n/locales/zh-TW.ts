...
export const zhTW: Dict = {
  ...
  'brandExtractionTranscript.next': '接下來，你可以執行 AI 優化做更深一輪抽取，或者用這個系統建立新設計。',
  ...
  'nextStep.brandAiOptimizeTitle': 'AI 優化',
  'nextStep.brandAiOptimizeBody': '讓智慧助理繼續最佳化擷取出的品牌套件。',
  'nextStep.brandCreateDesignTitle': '建立新設計',
  'nextStep.brandCreateDesignBody': '使用這個設計系統啟動新專案。',
