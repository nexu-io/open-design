...
export const zhTW: Dict = {
  ...
  'chat.runError.title.auth': '智能體需要授權',
  'chat.runError.title.balance': 'AMR 餘額不足',
  'chat.runError.title.connectionDropped': '模型連線中斷',
  'chat.runError.title.rateLimit': '模型服務額度受限',
  'chat.runError.title.modelUnavailable': '所選模型不可用',
  'chat.runError.title.promptTooLarge': '任務上下文過大',
  'chat.runError.title.agentUnavailable': '智能體 CLI 不可用',
  'chat.runError.title.processExit': '智能體行程異常結束',
  'chat.runError.title.generic': '任務執行失敗',
  'chat.runError.description.auth': '目前智能體需要先完成授權才能繼續。完成登入後，可重試目前任務。',
  'chat.runError.description.rateLimit': '目前智能體觸發了模型額度或限流。可以切換模型、使用官方智能體，或稍後重試。',
  'chat.runError.description.useOfficialAgent': '目前智能體尚未登入，請在本機檢查登入狀態。建議使用 Open Design 智能體，更穩定划算',
  'chat.runError.description.rateLimitUseOfficialAgent': '目前模型或服務商已達配額或頻率限制，可稍後重試。建議使用 Open Design 智能體，更穩定划算',
  'chat.runError.description.upstreamUseOfficialAgent': '模型服務商暫時不可用，可稍後重試。建議使用 Open Design 智能體，更穩定划算',
  'chat.runError.description.genericUseOfficialAgent': '任務執行失敗，可稍後重試。建議使用 Open Design 智能體，更穩定划算',
  'chat.runError.description.promptTooLarge': '目前任務超出了模型可處理的上下文範圍。請縮短需求或減少附件後重試。',
  'chat.runError.description.agentUnavailable': 'Open Design 無法啟動目前本地智能體。請檢查 CLI 安裝，或改用官方智能體。',
  'chat.runError.description.processExit': '智能體行程在完成前停止了。可以重試目前任務，或複製報錯源碼用於排查。',
  'chat.runError.description.generic': '任務在完成前停止了。可以重試目前任務，或複製報錯源碼用於排查。',
  'chat.runError.useOfficialAgentCta': '使用官方智能體',
  'chat.runError.rawLabel': '報錯源碼',
  'chat.runError.rawExpand': '展開',
  'chat.runError.rawCollapse': '收起',
  'common.cancel': '取消',
  'common.save': '儲存',
  'common.close': '關閉',
  'common.clear': '清除',
