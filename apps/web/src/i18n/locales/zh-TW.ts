...
export const zhTW: Dict = {
  ...
  'pluginApply.inputsMissing': '缺少必填的外掛程式輸入：{fields}',
  'pluginApply.configurationInvalid': '外掛程式設定無效。請重新安裝或更新外掛程式後再試一次。',
  'pluginApply.resourceUnavailable': '所需的外掛程式資源無法使用。請重新安裝或更新外掛程式後再試一次。',
  'pluginApply.genericFailure': '無法套用外掛程式，請再試一次。',
  'pluginApply.workspaceContextIncomplete': '工作區內容不完整。請等待工作區同步完成後再試一次。',
  'pluginApply.notFound': '找不到外掛程式。',
  'pluginApply.failedNamedWithReason': '無法套用 {plugin}：{reason}',
