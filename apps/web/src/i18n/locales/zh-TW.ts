...
export const zhTW: Dict = {
  ...
  "settings.onboardingExecutionBody":
    "使用 Open Design 託管服務，也可以連接本地 Coding Agent，或使用自己的模型 Key。",
  "settings.onboardingAmrCloudBenefitOfficial": "官方推薦",
  "settings.onboardingAmrCloudBenefitReady": "免部署即用",
  "settings.onboardingAmrCloudBenefitModels": "使用 Open Design 額度調用 Claude、GPT、Fable 5 和 5.6 sol，限時優惠並支援高並行。",
  ...
  "settings.onboardingAmrModelSourceLabel": "Open Design 託管服務",
  ...
  "settings.onboardingLocalBody":
    "支援 Claude Code、Codex、Cursor、OpenCode、Kimi、Qwen、Hermes、Kiro 等本地 Agent。",
  "settings.onboardingLocalAction": "開啟 CLI 設定",
  "settings.onboardingCliScanHint": "通常 5 到 10 秒內完成掃描。",
  "settings.onboardingByokTitle": "使用自己的 API Key",
  "settings.onboardingByokBody": "使用自己的 API Key，安全連接你選擇的模型服務商。",
