...
export const zhTW: Dict = {
  ...
  "settings.modelSourceLocalConfig": "本機設定",
  "settings.modelPickerCliFallbackHint": "即時模型探索暫時無法使用。可重新整理後重試，或透過「自訂」輸入其他模型 ID。",
  "settings.modelPickerLocalConfigLiveHint": "模型來自本機路由設定。重新整理可再次讀取已設定的路由。",
  "settings.modelPickerLocalConfigFallbackHint": "{agent} 不提供模型目錄指令。重新整理只會再次讀取本機路由設定；內建別名仍可使用，其他 ID 可透過「自訂」輸入。",
  "settings.modelPickerUnsupportedCustomHint": "此 CLI 不支援模型探索。請透過「自訂」輸入其他模型 ID。",
  "settings.modelPickerUnsupportedConfiguredHint": "此 CLI 不支援模型探索。請在 CLI 自身設定中選擇模型。",
  "settings.modelRefreshTitle": "重新整理模型目錄",
  "settings.modelRefreshRunning": "正在重新整理模型目錄",
