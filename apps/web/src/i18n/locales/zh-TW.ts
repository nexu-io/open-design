...
export const zhTW: Dict = {
  ...
  "homeHero.noTeamResults": "找不到符合「{query}」的團隊。",
  "homeHero.noTeamsAvailable": "找不到可用的本機 Agent。啟用 Agent 後即可產生團隊。",
  "homeHero.teamsDisabled": "啟用 WaitTeam 後即可提及團隊。",
  ...
  "chat.mentionTabTeams": "團隊",
  "chat.mentionNoResults": "找不到「{query}」的結果。",
  "chat.mentionTeamEmpty": "找不到可用的本機 Agent。啟用 Agent 後即可產生團隊。",
