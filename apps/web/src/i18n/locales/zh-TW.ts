...
export const zhTW: Dict = {
  ...
  'chat.amrCard.switchBody': '可切換到 Marketing AX 官方 AMR 模型服務，無需設定 API Key。完成登入、授權與儲值後，將自動重試目前任務。',
  ...
  'settings.onboardingCreateBody': '描述你想做的網站、應用、Deck、圖片或影片，Marketing AX 會建立專案，並保留可繼續編輯的產出。',
  ...
  'settings.agentInstall.pathHint': '如果你透過 npm 或 Homebrew 安裝了 CLI，但仍顯示為未安裝，請確認該工具的 bin 目錄已加入 Marketing AX daemon 繼承的 PATH（在 macOS 上，Terminal 與 GUI 應用的 PATH 可能不同）。請參閱 QUICKSTART.md（「Local agent CLI and PATH」章節）。',
  'settings.agentInstall.stepOpenLinks': '在目標代理卡片上開啟「安裝」或「文件」連結。',
  'settings.agentInstall.stepAuth': '返回 Marketing AX 前，請先在對應 CLI 完成驗證（登入或新增 API 憑證）。',
  ...
  'settings.mcpServerHint': '將 Marketing AX 作為 MCP 伺服器暴露給你的編碼代理。',
  ...
  'settings.privacy': '隱私',
  'settings.privacyHint': '與 Marketing AX 團隊共享哪些資料',
  'settings.privacyConsentKicker': '協助我們改進 Marketing AX',
  'settings.privacyConsentLead': 'Marketing AX 可以將使用資料分享給我們的團隊以協助改進。包含:',
  ...
  'settings.mcpHint': '讓其他專案中的程式碼代理（Claude Code、Cursor、VS Code、Antigravity、Zed、Windsurf）讀取您的 Marketing AX 專案。您可以直接將設計匯入應用程式，無需先匯出 zip。',
  'settings.mcpDaemonError': '無法連線到本地守護程序以解析安裝路徑（{error}）。請確認 Marketing AX 正在執行，然後重新開啟此面板。',
  'settings.mcpBuildDaemon': '請先建置守護行程。',
  'settings.mcpNodeMissing': '缺少 Node 執行檔。',
  'settings.mcpBuildHint': '缺少 apps/daemon/dist/cli.js。請執行 `pnpm --filter @marketing-ax/daemon build` 後重新整理。',
  ...
  'settings.mcpCapabilityDefault': '預設使用您在 Marketing AX 中開啟的專案與檔案，因此您可以說「在我的應用程式中建置這個」，無需重新說明是哪個設計。',
  'settings.mcpRunningNote': 'Marketing AX 必須正在執行，MCP 工具呼叫才能成功。如果您在開啟 Marketing AX 之前就已啟動 coding agent，請重新啟動 agent，使其能夠連線到正在執行的守護行程。',
  ...
  'entry.discordAria': '加入 Marketing AX Discord',
  'entry.discordAriaWithOnline': '加入 Marketing AX Discord - {online}',
  ...
  'brands.empty': '尚未註冊任何品牌。',
  'brands.back': '返回',
  'brands.core': '品牌核心',
  'brands.loadFailed': '無法載入此品牌。',
  'brands.pageTitle': '品牌',
  'brands.pageSubtitle': '註冊每個品牌的背景與設計系統，然後建立專案。',
  'brands.sectionContext': '品牌背景',
  'brands.sectionDesignSystem': '設計系統',
  'brands.sectionDocs': '知識文件',
  'brands.docsHint': '品牌核心與各管道的製作文件 (.md) 會被注入到執行中。選擇文件即可檢視。',
  'brands.fieldTagline': '標語',
  'brands.fieldWebsite': '網站',
  'brands.fieldAudience': '核心受眾',
  'brands.fieldKeyMessage': '關鍵訊息',
  'brands.fieldAvoid': '避免事項',
  'brands.fieldChannels': '管道',
  'brands.palette': '色彩板',
  'brands.typography': '排版',
  'brands.voiceTone': '語氣與風格',
  'brands.coreDocLabel': '品牌核心',
  'brands.projectCount': '{n} 個專案',
  'brands.paletteChannelMeta': '{c} 種顏色 · 已註冊 {n} 個管道',
  'brands.newButton': '+ 新增品牌',
  'brands.newTitle': '新增品牌',
  'brands.newFieldTitle': '名稱',
  'brands.newFieldId': 'ID',
  'brands.newFieldIdHint': '依名稱自動建議 — 僅限小寫字母、數字與連字號。',
  'brands.newSubmit': '建立',
  'brands.newDuplicateId': '已存在相同 ID 的品牌。',
  'brands.newFailed': '無法建立品牌。',
  'brands.edit': '編輯',
  'brands.save': '儲存',
  'brands.cancel': '取消',
  'brands.saveFailed': '無法儲存變更。',
  'brands.fieldSubtitle': '副標題',
  'brands.fieldToneLabel': '語調標籤',
  'brands.fieldTypographyFamily': '字型家族',
  'brands.fieldTypographyRoles': '字型角色',
  'brands.fieldTypographyWeights': '字重',
  'brands.fieldNeutralPalette': '中性色盤',
  'brands.fieldCommaHint': '多個值請以逗號分隔。',
  'brands.docEdit': '編輯文件',
  'brands.docSaveFailed': '無法儲存文件。',
  'brands.channelAdd': '+ 管道',
  'brands.channelAddKey': '鍵',
  'brands.channelAddKeyHint': '僅限小寫字母、數字與連字號 — 將用作提示詞注入鍵。',
  'brands.channelAddLabel': '標籤',
  'brands.channelAddDesignSystem': '設計系統',
  'brands.channelAddSubmit': '新增',
  'brands.channelAddFailed': '無法新增管道。',
  'brands.channelRemove': '移除管道',
  'brands.channelRemoveConfirm': '移除 {key} 管道？其製作文件將被刪除。',
  'brands.channelRemoveFailed': '無法移除管道。',
  'brands.uploadIcon': '上傳圖示',
  'brands.uploadLogo': '上傳標誌',
  'brands.uploadFailed': '無法上傳圖片。',
  'brands.uploadTooLarge': '檔案過大。',
  'brands.deleteZone': '危險區域',
  'brands.delete': '刪除品牌',
  'brands.deleteConfirm': '刪除 {title} 品牌？此操作無法復原。',
  'brands.deleteBlocked': '有 {n} 個專案正在使用此品牌。請先刪除這些專案。',
  'brands.deleteFailed': '無法刪除品牌。',
  ...
  'homeHero.chip.brazeIamHint': '製作 Braze Custom-HTML 應用程式內訊息：訪談 → 方案 → 確認 → A/B HTML 變體。',
  ...
  'homeHero.chip.createPluginHint': '編寫可重複使用的 Marketing AX 外掛並將其加入「我的外掛」。',
  ...
  'handoff.promptIntro': '請基於這個 Marketing AX 專案的本機資料夾繼續實作：',
  ...
  'pluginsHome.subtitle': '隨附於此執行環境、可立即使用的 Marketing AX 工作流程。挑選一個以載入起始提示，或瀏覽登錄檔取得更多。',
  'pluginsHome.browseRegistry': '瀏覽登錄檔',
  'pluginsHome.count': '{total} 個中的 {filtered} 個',
  'pluginsHome.loadingCatalog': '正在載入目錄…',
  'pluginsHome.emptyCatalog': '目錄是空的。內建外掛隨 Marketing AX 一同提供，應會自動出現在此處 — 若問題持續發生，請嘗試重新啟動 daemon。',
  ...
  'pluginCard.contributeAria': '將 {title} 貢獻至 Marketing AX',
  'pluginCard.contributeTitle': '透過 pull request 將外掛貢獻至 Marketing AX',
  ...
  'integrations.lede': '連接外部系統，把 MCP 工具帶入智能體迴圈，並在其他 IDE、腳本與自動化流程中使用 Marketing AX。',
  ...
  'mcpClient.daemonError': '無法連線到本機 daemon。請確認 Marketing AX 正在執行，然後重新開啟此面板。',
  'mcpClient.saveFailed': '儲存失敗。請確認 daemon 正在執行後再試一次。',
  'useEverywhere.modalAria': '隨處使用 Marketing AX',
  'useEverywhere.modalTitle': '隨處使用 Marketing AX',
  'useEverywhere.modalSubtitle': '將 Marketing AX 接入任何 IDE、Agent 或指令碼 — CLI、HTTP、MCP 及 Skills。使用「複製 Agent 指南」並貼到 Claude Code、Codex、Cursor、openclaw 或 hermes 中，即可設定一切。',
  ...
  'useEverywhere.section.overview.heading': '你的 Agent 在哪裡運作，Marketing AX 就在哪裡運作',
  'useEverywhere.section.overview.intro': 'Marketing AX 不只是一個視窗 — 它是一個本機特權 daemon（`od`），外加一個 Skills + Design-Systems + Atoms 登錄。一旦它在您的機器上執行，任何程式碼 Agent（Claude Code、Codex、Cursor、OpenCode/openclaw、Hermes、您自己的指令碼）都能透過四個可互換的介面來驅動產生作業、檢視專案並產出設計成品。',
  'useEverywhere.section.overview.bullet1': 'CLI — 以 `od <command>` 用於無頭指令碼、CI 及 shell 自動化。',
  'useEverywhere.section.overview.bullet2': 'MCP server — 將 Marketing AX 接成 Model Context Protocol 伺服器，讓任何支援 MCP 的 Agent 都能列出技能、執行情境並讀取成品。',
  'useEverywhere.section.overview.bullet3': 'HTTP API — `http://127.0.0.1:7456/api/*` REST + SSE 端點；與網頁 UI 使用的介面相同。',
  'useEverywhere.section.overview.bullet4': 'Skills — 隨插即用的 `SKILL.md` 套件（相容於 Claude），任何已在您 PATH 上的 Agent 完全無需 Marketing AX 即可調用。',
  ...
  'useEverywhere.section.cli.heading': '從任何 shell 操作 Marketing AX',
  ...
  'useEverywhere.section.mcp.heading': '將 Marketing AX 以 MCP 伺服器形式開放給任何程式設計 Agent',
  'useEverywhere.section.mcp.intro': 'Marketing AX 隨附一個 Model Context Protocol 伺服器（`od mcp`），讓任何支援 MCP 的用戶端 — Cursor、Claude Code、Antigravity、VS Code Copilot Chat、openclaw、hermes — 都能探索 Marketing AX 工具（列出技能、算繪預覽、產生媒體、執行外掛），而無需手動使用 shell。daemon 透過 `GET /api/mcp/install-info` 為每個主要用戶端發布可直接貼上的安裝程式碼片段。',
  ...
  'useEverywhere.section.mcp.bullet4': '固定 `MAX_DATA_DIR`，讓衍生的 MCP 程序寫入 daemon 已使用的相同位置（避免在 macOS 打包應用程式套件中發生 EPERM）。',
  ...
  'useEverywhere.section.mcp.footer': '在 Marketing AX 應用程式中，開啟「設定 → 整合」即可複製特定用戶端的安裝指令（Cursor、Claude Code、Antigravity、VS Code），而無需手動編輯 JSON。',
  'useEverywhere.section.http.tab': 'HTTP API',
  'useEverywhere.section.http.heading': '與 web UI 所用相同的 REST + SSE 介面',
  'useEverywhere.section.http.intro': '本機 daemon 會在 `http://127.0.0.1:7456` 提供 HTTP API（連接埠可設定）。web UI 呼叫的每個端點，你的指令稿同樣可以使用。串流端點（聊天回合、專案執行）會發出 Server-Sent Events，其合約型別定義於 `@marketing-ax/contracts`。',
  ...
  'useEverywhere.section.http.footer': '每個請求／回應的純 TypeScript 型別都位於 `@marketing-ax/contracts` 中 — 在您的指令碼中匯入它們，即可享有完整的自動完成，而無需接上產生器。',
  'useEverywhere.section.skills.tab': '技能與無頭模式',
  'useEverywhere.section.skills.heading': '適用於任何 Agent 的隨插即用 Skills — 即使 Marketing AX 未在執行也行',
  'useEverywhere.section.skills.intro': 'Skill 是一個包含相容於 Claude 的 `SKILL.md`（YAML 前置資料 + 內文）的目錄。Marketing AX 以 `od:` 命名空間（`mode`、`preview`、`design_system`、`inputs`、…）擴充此格式，因此同一個成品既能在 Marketing AX 內使用，也能被像 Claude Code、Codex、openclaw 或 hermes 這類原生 Agent 使用。探索作業遵循一條優先順序鏈，因此專案可覆寫自己的技能。',
  ...
  'useEverywhere.section.skills.snippet1': '最精簡的 SKILL.md（Claude 相容的前置資料 + Marketing AX 額外設定）',
  ...
  'entry.githubStarAria': '在 GitHub 為 Marketing AX 點亮 Star',
  ...
  'newproj.locationDefault': 'Marketing AX 專案',
  ...
  'ds.detailLoadFailed': '無法載入此設計系統。',
  'ds.back': '返回',
  'ds.detailLoading': '正在載入設計系統…',
  'ds.detailLoadingHint': '正在開啟審閱工作區。',
  'avatar.title': '帳號與設定',
  ...
  'socialShare.openDesignSection': '分享 Marketing AX',
  'socialShare.openDesignTitle': 'GitHub 上的 Marketing AX',
  'socialShare.openDesignText': 'Marketing AX 是開源的設計智慧工作區，可以生成、編輯、部署並交付設計產物。',
  'socialShare.openDesignCopyText': '{text}\n{url}',
  'socialShare.projectSection': '社群分享',
  'socialShare.projectTitle': '{title} · Marketing AX',
  'socialShare.projectText': '我用 Marketing AX 做了 {title}。查看已部署產物，也推薦收藏倉庫：{repo}',
  'socialShare.projectCopyText': '我用 Marketing AX 做了 {title}\n{url}\nMarketing AX 倉庫：{repo}',
  ...
  'chat.activeFilePlaceholder': '讓 Marketing AX 修改 {file}...',
  ...
  'chat.mode.design.solves': '當你希望 Marketing AX 產生檔案、更新 workspace，或把需求變成多模態可交付結果時使用。',
  ...
  'preview.shareTextDefault': 'Marketing AX 模板：{title}',
  ...
  'preview.errorBody': '範例 HTML 載入失敗。請確認 Marketing AX 正在執行後重試。',
  'preview.retry': '重試',
  ...
  'fileViewer.openFolder': '開啟專案資料夾',
  'fileViewer.openFolderFailed': '無法開啟專案資料夾。',
  'fileViewer.openFolderWebFallback': '無法從瀏覽器開啟資料夾。路徑:',
  'fileViewer.copyCaption': '複製文案',
  'fileViewer.copyCaptionDone': '文案已複製到剪貼簿',
  'fileViewer.copyCaptionFailed': '無法複製文案。',
  ...
  'assistant.shareToOpenDesign': '分享到 Marketing AX',
  ...
  'pet.navHint': '領養與自訂',
  'pet.tabBuiltIn': '內建',
  'pet.tabBuiltInHint': 'Marketing AX 內建的精選寵物 — 一鍵領養。',
  ...
  'pet.codexBundled': '內建',
  'pet.codexBundledTitle': 'Marketing AX 內建寵物，無需下載。',
  ...
  'settings.projectLocationsDescription': '新增可包含多個 Marketing AX 專案資料夾的工作基目錄。新專案會儲存為所選基目錄中的一個資料夾。',
  ...
  'settings.customInstructionsHint': 'Marketing AX 在每次聊天中都應遵循的固定指示。將事實、偏好與專案脈絡儲存為記憶。',
  'settings.customInstructionsPlaceholder': '例如「一律使用 TypeScript。優先採用函式型元件。回覆保持簡潔。」',
  'settings.defaultRouter.title': '預設路由器',
  'settings.defaultRouter.description': '處理未符合任何外掛觸發詞的自由輸入的路由外掛。',
  'settings.defaultRouter.builtin': '內建 (Default design router)',
  ...
  'settings.memoryStarterProjectDesc': 'Marketing AX v0.5 — 聊天驅動的設計編輯器',
  ...
  'updater.availableBody': 'Marketing AX {version} 可用。下載完成後即可開啟安裝器。',
  ...
  'updater.done': '完成',
  'updater.failed': '更新失敗',
  'updater.installerOpenBody': '安裝器已開啟。Marketing AX 正在結束，以便你完成更新。',
  ...
  'updater.quitButton': '結束 Marketing AX',
  'updater.quitFailedBody': '安裝器已開啟，但 Marketing AX 無法結束。替換應用程式前請先結束 Marketing AX。',
  'updater.quitFailedTitle': '無法結束',
  'updater.quitting': '正在結束…',
  'updater.ready': '更新已就緒',
  'updater.readyGeneric': '新版本已就緒。Marketing AX 會關閉並開啟安裝器。',
  'updater.readyVersion': 'Marketing AX {version} 已就緒。Marketing AX 會關閉並開啟安裝器。',
  ...
  'dsManager.createBody': '把你的品牌、產品、程式碼、素材與設計參考教給 Marketing AX。',
  ...
  'settings.customInstructionsDesc': 'Marketing AX 在每次對話中都會遵循的固定指令。它們不是儲存的記憶；事實、偏好與專案脈絡請使用「記憶」。',
