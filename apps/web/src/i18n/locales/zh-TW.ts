...
export const zhTW: Dict = {
  ...
  'settings.mediaProviderConnectionConnected': "已連線",
  'settings.mediaProviderConnectionDisconnected': "未連線",
  'settings.mediaProviderConnectionConnectedTitle': "本機 Codex CLI 登入可用",
  'settings.mediaProviderConnectionDisconnectedTitle': "未偵測到本機 Codex CLI 登入",
  'settings.mediaProviderConnectionConnectedNote': "本機 Codex CLI 登入可用",
  'settings.mediaProviderConnectionDisconnectedNote': "請使用本機 Codex CLI 登入以使用此供應商",
  'settings.privacy': '隱私',
  ...
  'settings.projectLocationsManualPlaceholder': "輸入資料夾路徑",
  'settings.projectLocationsBrowseFolders': "瀏覽資料夾",
  'settings.projectLocationsBrowserDialogLabel': "選擇專案位置",
  'settings.projectLocationsBrowserTitle': "選擇資料夾",
  'settings.projectLocationsBrowserLoading': "正在載入資料夾...",
  'settings.projectLocationsBrowserParentFolder': "上一層資料夾",
  'settings.projectLocationsBrowserUseFolder': "使用此資料夾",
  'settings.projectLocationsBrowserLoadError': "無法載入資料夾。請手動輸入資料夾路徑。",
  'settings.projectLocationsBrowserEmpty': "這裡沒有子資料夾。",
