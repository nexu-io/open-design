...
export const zhTW: Dict = {
  ...
  'fileViewer.cloudflareProjectNameHint': '無需填寫；系統會根據目前專案自動產生 Pages 專案名稱，並在不存在時自動建立。',
  'fileViewer.optional': '可選',
  'fileViewer.vercelPreviewOnly': '目前僅部署 Preview。',
  'fileViewer.cloudflarePagesPreviewHint': 'Cloudflare Pages 使用 Direct Upload；Pages 專案名稱會自動選擇，不需要使用者填寫。',
