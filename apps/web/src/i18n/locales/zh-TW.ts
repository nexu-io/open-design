...
export const zhTW: Dict = {
  ...
  'chat.runError.title.buildRoundSessionLost': "建造輪的工作階段遺失了",
  'chat.runError.title.roundInterrupted': "這一輪被中斷了",
  'chat.runError.title.roundSettlementFailed': "這一輪沒能記錄下來",
  'chat.runError.title.taskRecordMismatch': "任務記錄對不上",
  'chat.runError.title.attachmentsTooLarge': "附件太大",
  'chat.runError.title.attachmentsChanged': "附件變了",
  ...
  'chat.runError.buildRoundSessionLostMessage': "建造輪原本要接續規劃輪的 agent 工作階段，但開始時該工作階段已不存在。再送一次請求就會在這個對話裡新起一輪：規劃內容留在對話記錄裡，已寫好的檔案留在專案裡。",
  'chat.runError.roundInterruptedMessage': "agent 在這一輪結束前停了下來。再送一次請求就會在這個對話裡新起一輪；已寫好的檔案留在專案裡。",
  'chat.runError.roundSettlementFailedMessage': "agent 已經執行完畢，但 Open Design 在記錄這一輪、準備下一輪時發生錯誤。再送一次請求就會新起一輪；反覆出現的話，請匯出日誌寄給我們。",
  'chat.runError.taskRecordMismatchMessage': "Open Design 裡這個任務的記錄與正要啟動的執行對不上，這一輪在 agent 啟動前就停了。再送一次請求就會用新的記錄重新起一輪。",
  'chat.runError.attachmentsTooLargeMessage': "附件超出了一次請求能攜帶的上限。移除或壓縮一部分後再送一次。",
  'chat.runError.attachmentsChangedMessage': "準備請求時附件發生了變化，或凍結下來的副本對不上，沒能交給 agent。再送一次即可。",
  ...
  "designFiles.entryMissingTitle": "沒有可預覽的入口。",
  "designFiles.entryMissingBody": "這一輪寫了 {n} 個檔案，但沒有一個能作為入口開啟：",
  "designFiles.entryMissingMore": "還有 {n} 個",
  "designFiles.entryMissingAsk": "讓 agent 補一個入口",
  "designFiles.entryMissingHint": "也可以開啟某個檔案的選單，選擇「設為入口」。",
  "designFiles.setAsEntry": "設為入口",
  "designFiles.entryBadge": "入口",
  "designFiles.entryRequestMessage": "專案裡沒有能作為入口開啟的檔案。請補一個入口（根目錄的 index.html，連結到已經做好的頁面，或把現有的主頁面改成這個名字），讓預覽能開啟。",
  ...
  "assistant.canceledByRestartLabel": "應用重啟時已停止",
