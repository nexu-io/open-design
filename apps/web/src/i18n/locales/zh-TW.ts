...
export const zhTW: Dict = {
  ...
  'scene3d.title': '3D 場景',
  'scene3d.compile': '編譯',
  'scene3d.compiling': '編譯中…',
  'scene3d.recompile': '重新編譯',
  'scene3d.verdict': '結論',
  'scene3d.verdictClean': '編譯通過 · {warnings} 則警告',
  'scene3d.verdictFailed': '{errors} 個錯誤 · {warnings} 則警告',
  'scene3d.neverCompiled': '尚未編譯',
  'scene3d.parts': '零件',
  'scene3d.noParts': '尚無零件',
  'scene3d.issues': '問題',
  'scene3d.noIssues': '沒有問題',
  'scene3d.assets': '資產',
  'scene3d.noAssets': '尚未匯出',
  'scene3d.noProof': '尚無校樣圖 — 請先編譯',
  'scene3d.frameAlt': '校樣圖',
  'scene3d.frameSlider': '轉台影格',
  'scene3d.dragHint': '拖曳以旋轉',
  'scene3d.issuesStoredHint': '重新編譯以查看詳情',
  'scene3d.meshCounts': '{verts}頂點 / {faces}面',
  'scene3d.fixPrefix': '修正：',
  'scene3d.exportMenu': '匯出',
  'scene3d.exportEmpty': '尚未編譯任何內容',
  'scene3d.exportAll': '下載全部（{count} 個檔案）',
  'scene3d.exportAllScenes': '所有場景',
  'scene3d.exportAllChip': '全部',
  'scene3d.exportAllBusy': '正在準備壓縮檔…',
  'scene3d.exportModels': '模型',
  'scene3d.formatGlb': 'glTF / GLB',
  'scene3d.formatUsd': 'OpenUSD',
  'scene3d.formatObj': 'OBJ',
  'scene3d.formatMinecraft': 'Minecraft 模型',
  'scene3d.formatImage': '校樣影格',
  'scene3d.formatOther': '其他檔案',
  'scene3d.kindScene': '場景',
  'scene3d.kindProp': '道具',
  'scene3d.kindKit': '套件',
  'scene3d.kindAnimation': '動畫',
  'scene3d.kindSprite': '精靈圖',
  'scene3d.kindFlipbook': '翻頁動畫',
  'scene3d.kindVfx': '特效',
  'scene3d.kindSkybox': '天空盒',
  'scene3d.kindTexture': '紋理',
  'scene3d.partsCount': '{count} 個零件',
  'scene3d.trisCount': '{count} 個三角形',
  'scene3d.claimsProven': '已驗證 {count} 項聲明',
  'scene3d.blenderVersion': 'Blender {version}',
  'scene3d.scenes': '場景',
  'scene3d.kitScenes': '{count} 個場景',
  'scene3d.kitStageTitle': '套件檢視器',
  'scene3d.kitTruncated': '僅顯示前 {count} 個場景',
  'scene3d.backToKit': '返回套件',
  'homeHero.chip.scene3dChip': '3D 場景',
  'homeHero.chip.scene3dChipDesc': '模型、紋理、精靈圖與翻頁動畫',
  'homeHero.chip.scene3dChipHint': '用程式碼創作 3D 資產，並透過無頭 Blender 編譯——轉台校樣、約定檢查、GLB 與 USD 匯出。',
  'scene3d.replay': '重播',
  'scene3d.stop': '停止',
