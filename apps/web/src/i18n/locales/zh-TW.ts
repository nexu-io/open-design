...
export const zhTW: Dict = {
  ...
  "handoff.download": "下載",
  "handoff.downloadFailed": "下載失敗，請稍後再試。",
  "handoff.remoteOpen": "遠端開啟",
  "handoff.remoteOpenTitle": "在 Web 檔案工作區中開啟此專案",
  "handoff.webActionsTitle": "匯出與開啟選項",
  "handoff.openFolderUnavailable": "目前環境無法開啟本機資料夾——專案位於遠端或容器中的守護程序上。請改用複製路徑、下載 .zip，或在 Web 工作區中開啟。",
