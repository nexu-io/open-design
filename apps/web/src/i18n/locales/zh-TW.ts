...
export const zhTW: Dict = {
  ...
  "chat.runError.title.modelDocumentUnsupported": "此模型不接受文件",
  ...
  "chat.runError.modelDocumentUnsupportedMessage": "此模型在 Bedrock 上不接受文件 (PDF)。請切換至 Anthropic 或 Amazon Nova 模型後重試。",
