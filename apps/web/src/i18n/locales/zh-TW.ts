...
export const zhTW: Dict = {
  ...
  'serverDirectoryPicker.noRoots': '沒有可用的已授權伺服器資料夾。請先連結工作目錄。',
  'serverDirectoryPicker.loadRootsFailed': '無法載入伺服器資料夾。',
  'serverDirectoryPicker.contentsAria': '目錄內容',
  ...
  "settings.projectLocationsPickerInvalid": "資料夾選擇器傳回了無效回應。",
  "settings.projectLocationsPickerFailed": "無法開啟資料夾選擇器。",
