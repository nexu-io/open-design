...
export const fr: Dict = {
  ...
  'settings.privacyConsentBannerFooter': 'Nous ne partageons rien tant que vous n’avez pas activé l’option. Vous pouvez modifier ce choix à tout moment dans Paramètres → Confidentialité. Nous ne téléversons jamais le contenu de vos fichiers d’artefacts générés.',
