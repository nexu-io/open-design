...
export const fr: Dict = {
  ...
  'settings.fetchModelsTitle': 'Récupérer les modèles disponibles depuis ce fournisseur',
  'settings.fetchModelsRunning': 'Récupération des modèles…',
  'settings.fetchModelsSuccess': '{count} modèles récupérés.',
  'settings.fetchModelsEmpty': 'Aucun modèle texte compatible n’a été renvoyé.',
  'settings.fetchModelsUnsupported': 'La découverte automatique des modèles n’est pas disponible pour ce protocole.',
  ...
  'settings.cliEnvHint':
    'Définissez les dossiers de configuration non secrets utilisés par l’application empaquetée et la détection des agents.',
  'settings.cliEnvClaudeConfigDir': 'Dossier de configuration Claude Code',
  'settings.cliEnvCodexHome': 'Dossier home de Codex',
  ...
  'settings.privacyConsentLead': 'Open Design peut partager des données d’utilisation avec notre équipe pour nous aider à l’améliorer. Cela inclut :',
  ...
  'settings.privacyConsentShare': 'Aider à améliorer',
  'settings.privacyConsentDecline': 'Pas maintenant',
  'settings.privacyMetrics': 'Métriques anonymes',
  'settings.privacyMetricsHint': 'Nombre d’exécutions, usage des tokens, taux d’erreur, durée. Aucun prompt, aucune donnée de projet.',
  'settings.privacyContent': 'Contenu des conversations',
  'settings.privacyContentHint': 'Vos prompts et les réponses de l’assistant (tronqués à 8 Ko / 16 Ko). Les clés API, tokens, JWT, e-mails, IP et numéros de carte bancaire sont supprimés automatiquement avant l’envoi.',
  ...
  'settings.privacyDataDeletionHint': 'Renouvelle votre ID anonyme et arrête les envois. Les traces existantes expirent selon notre politique de conservation.',
  ...
  'settings.mcpNodeMissing': 'Le binaire Node est manquant.',
  'settings.mcpBuildHint':
    'apps/daemon/dist/cli.js est manquant. Exécutez `pnpm --filter @open-design/daemon build` puis actualisez.',
  ...
  'settings.mcpInstructionCodex':
    'Ajoutez cette table à {path}. La même configuration est partagée entre la CLI Codex et l’extension IDE Codex.',
  'settings.mcpMethodOneClick': 'Installation en un clic',
  'settings.mcpInstructionCursor':
    'Cliquez sur « Installer dans Cursor » pour installer via une boîte de confirmation, ou fusionnez ce JSON dans {path}.',
  ...
  'settings.mcpInstructionAntigravity':
    'Dans Antigravity : menu « ... » du panneau Agent → MCP Servers → Manage MCP Servers → View raw config. Fusionnez ce JSON.',
  'settings.mcpInstructionZed':
    'Ouvrez les paramètres Zed ({shortcut}) et fusionnez ceci dans l’objet racine. Zed utilise « context_servers », pas « mcpServers ».',
  ...
  'settings.mcpResolvingFailed': '# échec de résolution des chemins, consultez l’erreur ci-dessus',
  ...
  'settings.mcpCursorApproval': 'Cursor affiche une boîte de confirmation avant d’écrire la configuration.',
  'settings.mcpRestartNote': 'Redémarrez votre client pour charger le nouveau serveur.',
  'settings.mcpRestartDetail':
    'La plupart des éditeurs ne chargent les serveurs MCP qu’au démarrage. Dans Cursor / VS Code / Antigravity / Windsurf, vous pouvez lancer `Developer: Reload Window` depuis la palette de commandes au lieu d’un redémarrage complet. Zed et Claude Code doivent être quittés puis rouverts.',
  'settings.mcpCapabilitiesTitle': 'Ce que votre agent peut faire',
  'settings.mcpCapabilityRead':
    'Lire ou rechercher n’importe quel fichier d’un projet (HTML, JSX, CSS, JSON, SVG, Markdown).',
  'settings.mcpCapabilityPull':
    'Récupérer un bundle de design en un seul appel : le fichier d’entrée plus toutes les variables CSS, composants et polices qu’il référence.',
  'settings.mcpCapabilityDefault':
    'Utiliser par défaut le projet et le fichier ouverts dans Open Design, afin que vous puissiez dire « construis ceci dans mon app » sans repréciser le design.',
  'settings.mcpRunningNote':
    'Open Design doit être en cours d’exécution pour que les appels d’outils MCP réussissent. Si vous avez lancé votre agent de code avant d’ouvrir Open Design, redémarrez l’agent afin qu’il puisse joindre le daemon actif.',

  'entry.tabDesigns': 'Mes designs',
  ...
  'newproj.tabLiveArtifact': 'Artefact live',
  ...
  'newproj.titleLiveArtifact': 'Nouvel artefact live',
  ...
  'newproj.createLiveArtifact': 'Créer un artefact live',
  ...
  'designs.liveArtifactBadgesAria': 'Badges d’artefact live',
  'designs.liveCount': '{n} live',
  'designs.statusLive': 'Artefact live',
  ...
  'chat.conversationsHeading': 'Historique des conversations',
  'chat.new': 'Nouvelle',
  ...
  'workspace.focusMode': 'Espace de travail concentré',
  ...
  'designFiles.sectionLiveArtifacts': 'Artefacts live',
  ...
  'designFiles.kindLiveArtifact': 'Artefact live',
  ...
  'manualEdit.selectLayer': 'Sélectionner un calque',
  ...
  'fileViewer.cloudflareApiTokenScopeHint': 'Pages Edit est requis pour déployer. Zone Read est requis pour lister les domaines. DNS Edit n’est nécessaire que pour lier un domaine personnalisé.',
  ...
  'fileViewer.cloudflareDomainPrefixInvalid': 'Utilisez un seul label DNS : lettres minuscules, chiffres et traits d’union.',
  'fileViewer.cloudflareHostnamePreview': 'Aperçu du domaine personnalisé : {hostname}',
  'fileViewer.cloudflareCustomDomainHint': 'Optionnel : choisissez un domaine Cloudflare et un préfixe pour lier un sous-domaine personnalisé. pages.dev restera disponible.',
  ...
  'settings.orbit.artifactKickerLive': 'artefact live',
  ...
  'liveArtifact.refresh.buttonTitle': 'Actualiser cet artefact live',
  'liveArtifact.refresh.loadingTitle': 'Chargement de l’artefact live…',
  ...
  'liveArtifact.refresh.successOne': 'Actualisation terminée. Les données ont été mises à jour.',
  'liveArtifact.refresh.successMany': 'Actualisation terminée. Les données ont été mises à jour.',
  'liveArtifact.refresh.successAction': 'L’aperçu a été rechargé avec les dernières données enregistrées.',
  'liveArtifact.refresh.previousFailure': 'L’actualisation précédente a échoué : {message}',
