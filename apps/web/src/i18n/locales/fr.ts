...
export const fr: Dict = {
  ...
  'app.brandPill': 'Preview de recherche',
  ...
  'settings.modeDaemonInstalledMeta': '{count} détecté(s)',
  ...
  'settings.noAgentsDetected':
    'Aucun agent détecté pour l’instant. Installez l’une des CLI prises en charge, puis cliquez sur Rescanner.',
  ...
  'newproj.toggleSpeakerNotes': 'Utiliser les notes de l’orateur',
  ...
  'newproj.dsNoneSubtitleEmpty': 'Pas de design tokens, choisissez votre propre palette',
  'newproj.dsNoneSubtitleSelected': 'Ignorer les design tokens. L’agent choisit sa propre palette.',
  ...
  'newproj.dsNoneSub': 'Ignorer les design tokens. L’agent choisit sa propre palette.',
  ...
  'chat.comments.attached': 'Attaché à la conversation',
  ...
  'chat.composerPlaceholder':
    'Décrivez le design souhaité, collez ou déposez des images, ou mentionnez un fichier avec @…',
  'chat.composerHint':
  ...
  'sketch.toolSelect': 'Sélectionner (inactif)',
  ...
  'pet.imageHintIdle': 'PNG, JPG, WebP, GIF ou SVG. Spritesheet ? Déposez une bande horizontale et indiquez le nombre de frames.',
