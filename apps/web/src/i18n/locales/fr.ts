...
export const fr: Dict = {
  ...
  'settings.subtitle':
    'Choisissez entre un agent CLI et un fournisseur d\'API (BYOK). Votre clé API est stockée uniquement dans ce navigateur.',
  ...
  'settings.baseUrlInvalid': 'Saisissez une URL http:// ou https:// valide.',
