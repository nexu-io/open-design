...
export const fr: Dict = {
  ...
  'settings.onboardingAmrCloudBenefitModels': 'Compatible avec Claude Opus 4.8',
  ...
  'settings.onboardingAmrCloudUpcomingSkills': 'Bibliothèque de compétences étendue',
  ...
  'settings.onboardingConnectTitle': 'Choisir un environnement d’exécution',
  ...
  'settings.onboardingUseLanding': '🌐 Pages d’atterrissage',
  ...
  'settings.byokNoFileToolsNotice': 'Le mode BYOK parle directement au modèle et n’a pas accès aux outils de code généraux des agents CLI locaux. Selon le fournisseur, il peut néanmoins générer des artefacts comme des images, de l’audio ou de la vidéo dans le projet actif. Passez en mode CLI local (Claude Code, Codex, …) si vous voulez une lecture et une écriture complètes des fichiers du projet.',
  ...
  'settings.noAgentsDetected': 'Aucun agent détecté pour l’instant. Installez une CLI prise en charge comme Claude Code, Codex, Devin for Terminal, Cursor Agent, Gemini CLI, OpenCode, Qwen Code, Qoder CLI, GitHub Copilot CLI, Hermes, Kimi CLI, Pi, Kiro CLI, Kilo, Mistral Vibe CLI ou DeepSeek TUI, puis cliquez sur Réanalyser.',
  ...
  'settings.mcpCodexInstallError': 'L’opération a échoué : {error}',
  ...
  'pluginsHome.subtitle': 'Flux de travail Open Design prêts à l’emploi, intégrés à cet environnement d’exécution. Choisissez-en un pour charger un prompt de départ, ou parcourez le registre pour en trouver d’autres.',
  ...
  'tasks.primitive.orbit.body': 'Un environnement d’exécution persistant pour les travaux agent longs ou récurrents.',
