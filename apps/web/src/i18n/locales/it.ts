...
export const it: Dict = {
  ...
  'settings.agentInventoryTitle': 'Installato in {client}',
  'settings.agentInventoryRefresh': 'Aggiorna',
  'settings.agentInventoryLoading': 'Caricamento dei server MCP e delle competenze installati…',
  'settings.agentInventoryError': 'Impossibile caricare l’inventario di questa CLI ({error}).',
  'settings.agentInventoryUnsupported': 'Il rilevamento dell’inventario per {client} non è ancora disponibile.',
  'settings.agentInventoryUnavailable': 'La configurazione di {client} non è stata rilevata.',
  'settings.agentInventoryEmpty': 'Nessun server MCP o competenza installati rilevati per {client}.',
  'settings.agentInventoryMcpServers': 'Server MCP',
  'settings.agentInventorySkills': 'Competenze',
  'settings.agentInventoryNoMcpServers': 'Nessun server MCP rilevato.',
  'settings.agentInventoryNoSkills': 'Nessuna competenza rilevata.',
  'settings.agentInventorySourceUser': 'Utente',
