...
export const it: Dict = {
  ...
  'chat.dsExtractUser': "Estrai il sistema di design da {source}",
  'chat.dsExtractRunning': "Estrazione del sistema di design…",
  'chat.dsExtractDone': "{name} estratto — tutti i moduli sono pronti.",
  'chat.dsNextStepsTitle': "Passaggi successivi",
  'chat.dsMoreToggle': "Altre ottimizzazioni",
  ...
  'ds.fullSystemLabel': 'Sistema completo di {name}',
