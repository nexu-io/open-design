...
export const it: Dict = {
  ...
  'useEverywhere.section.overview.footer': 'Per impostazione predefinita, il daemon scrive in `./.od/` (locale al progetto). Imposta `MAX_DATA_DIR=~/.open-design` per condividere i dati tra progetti.',
