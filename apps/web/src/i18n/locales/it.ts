...
export const it: Dict = {
  ...
  'chat.runError.description.useOfficialAgent': 'L’agente selezionato non ha effettuato l’accesso. Usa l’agente ufficiale Open Design per un’esecuzione più stabile e conveniente, oppure riprova con l’agente attuale.',
  'chat.runError.description.rateLimitUseOfficialAgent': 'Il modello o il provider attuale ha raggiunto la quota o il limite di frequenza. Riprova più tardi, oppure usa l’agente Open Design per un’esecuzione più stabile e conveniente.',
  'chat.runError.description.upstreamUseOfficialAgent': 'Il provider del modello è temporaneamente non disponibile. Riprova più tardi, oppure usa l’agente Open Design per un’esecuzione più stabile e conveniente.',
  'chat.runError.description.genericUseOfficialAgent': 'L’esecuzione dell’attività non è riuscita. Riprova più tardi, oppure usa l’agente Open Design per un’esecuzione più stabile e conveniente.',
