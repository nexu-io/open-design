...
export const it: Dict = {
  ...
  'pet.railAria': 'Selettore di compagno',
  'pet.railTitle': 'Compagni',
  'pet.railHint': 'Scegli un compagno da far fluttuare sopra il tuo spazio di lavoro.',
  'pet.railExpand': 'Mostra selettore di compagno',
  'pet.railCollapse': 'Riduci selettore di compagno',
  'pet.railHide': 'Nascondi selettore di compagno',
  'pet.railShow': 'Mostra selettore di compagno',
