...
export const uk: Dict = {
  ...
  'settings.desktop': 'Робочий стіл',
  'settings.desktopHint': 'Налаштувати поведінку десктопного додатка.',
  'settings.autoLaunch': 'Запускати при вході',
  'settings.autoLaunchHint': 'Автоматично запускати Open Design при вході в систему.',
  'settings.network': 'Мережа',
  'settings.networkHint': 'Налаштувати прив\'язку демона до мережевих інтерфейсів.',
  'settings.networkRequiresDaemon': 'Підключіться до запущеного демона, щоб змінити мережеві налаштування.',
  'settings.networkWarning': 'Мережевий доступ увімкнено',
  'settings.networkWarningHint': 'Демон доступний з мережі. Увімкніть автентифікацію за API-ключем і налаштуйте список дозволених IP.',
  'settings.bindHost': 'Адреса прив\'язки',
  'settings.bindHostHint': '127.0.0.1 = лише localhost. 0.0.0.0 = усі мережеві інтерфейси.',
  'settings.port': 'Порт',
  'settings.portHint': 'TCP-порт, який прослуховує демон. За замовчуванням: 7456.',
  'settings.allowedHosts': 'Дозволені хости',
  'settings.allowedHostsHint': 'IP-адреси або діапазони CIDR через кому. Порожньо = усі.',
  'settings.apiKeys': 'API-ключі',
  'settings.apiKeysHint': 'Ключі для нелокальних підключень при увімкненому мережевому доступі.',
  'settings.revoke': 'Відкликати',
  'settings.newApiKey': 'Новий API-ключ',
  'settings.newApiKeyHint': 'Скопіюйте цей ключ зараз. Він більше не відображатиметься.',
  'settings.keyLabel': 'Мітка (необов\'язково)',
  'settings.generateKey': 'Створити',
  'settings.networkKeyRequired': 'Для доступу до мережі потрібен ключ API',
  'settings.networkKeyRequiredHint': 'Прив\'язка до всіх інтерфейсів відкриває демон для мережі. Для безпеки буде згенеровано ключ API.',
  'settings.generateAndSwitch': 'Згенерувати ключ і перемкнути',
  'settings.networkNoKeysWarning': 'Неможливо перезапустити без ключа API',
  'settings.networkNoKeysWarningHint': 'Потрібен хоча б один ключ API, коли демон доступний із мережі. Створіть ключ вище перед перезапуском.',
  'settings.networkRestartHint': 'Зміна адреси прив\'язки, порту або дозволених хостів потребує перезапуску демона.',
  'settings.restartDaemon': 'Перезапустити демон',
  'settings.restartingDaemon': 'Перезапуск…',
  'settings.restartFailed': 'Не вдалося перезапустити. Перезапустіть вручну.',
  'settings.networkSaveError': 'Не вдалося зберегти. Перевірте введені дані та повторіть.',
  'settings.networkLoadError': 'Не вдалося завантажити мережеві налаштування.',
  ...
  'settings.mcpTabLocal': 'Локальний',
  'settings.mcpTabRemote': 'Віддалений',
  'settings.mcpInstallTypeAria': 'MCP install type',
  'settings.mcpRemoteDisabled':
    'Для віддаленого доступу демон має бути прив\'язаний до адреси, відмінної від loopback. Запустіть з --host 0.0.0.0 або встановіть OD_BIND_HOST, щоб відкрити демон у мережі.',
  ...
  'settings.mcpKeysRevoke': 'Відкликати',
