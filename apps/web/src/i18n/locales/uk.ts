...
export const uk: Dict = {
  ...
  'fileViewer.cloudflareProjectName': 'Pages project name',
  'fileViewer.cloudflareProjectNameHint': 'No input needed. Open Design generates a Pages project name automatically and creates the project if it is missing.',
  'fileViewer.optional': 'Необов\'язково',
  'fileViewer.vercelPreviewOnly': 'Розгортання наразі лише для попереднього перегляду.',
  'fileViewer.cloudflarePagesPreviewHint': 'Cloudflare Pages deploys use Direct Upload. The Pages project name is selected automatically; users only save the token and Account ID.',
