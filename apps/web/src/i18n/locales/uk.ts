...
export const uk: Dict = {
  ...
  'fileViewer.cloudflareProjectNameHint': 'The project will be created automatically if it does not exist.',
  'fileViewer.optional': 'Необов\'язково',
  'fileViewer.vercelPreviewOnly': 'Розгортання наразі лише для попереднього перегляду.',
  'fileViewer.cloudflarePagesPreviewHint': 'Cloudflare Pages deploys use Direct Upload and auto-create the Pages project if it is missing.',
