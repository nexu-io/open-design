...
export const hu: Dict = {
  ...
  'pet.railCollapse': 'Háziállat-választó elrejtése',
  ...
  'pet.atlasPickerHint':
    'A Codex háziállatok 9 animációs sort hoznak. Válaszd ki a kívánt hurkot, és felszeleteljük szalaggá.',
  'pet.atlasCancel': 'Atlas eldobása',
  'pet.atlasAdopt': 'Ezt a sort használom',
