...
export const hu: Dict = {
  ...
  'chat.dsExtractUser': "A dizájnrendszer kinyerése innen: {source}",
  'chat.dsExtractRunning': "A dizájnrendszer kinyerése folyamatban…",
  'chat.dsExtractDone': "{name} kinyerve — minden modul készen áll.",
  'chat.dsNextStepsTitle': "Következő lépések",
  'chat.dsMoreToggle': "További optimalizálások",
  ...
  'ds.fullSystemLabel': '{name} teljes rendszere',
