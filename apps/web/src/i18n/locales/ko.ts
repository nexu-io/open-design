...
export const ko: Dict = {
  ...
  'chat.dsExtractUser': "{source}에서 디자인 시스템 추출",
  'chat.dsExtractRunning': "디자인 시스템을 추출하는 중…",
  'chat.dsExtractDone': "{name} 추출 완료 — 모든 모듈이 준비되었습니다.",
  'chat.dsNextStepsTitle': "다음 단계",
  'chat.dsMoreToggle': "추가 최적화",
  ...
  'ds.fullSystemLabel': '{name} 전체 시스템',
