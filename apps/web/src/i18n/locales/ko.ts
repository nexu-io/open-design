...
export const ko: Dict = {
  ...
  'settings.updatePreviewLabel': '업데이트 미리보기',
  'settings.updatePreviewActual': '실제 개발 상태',
  'settings.updatePreviewIdle': '확인 안 됨',
  'settings.updatePreviewChecking': '확인 중',
  'settings.updatePreviewUpToDate': '최신 버전',
  'settings.updatePreviewAvailable': '새 버전',
  'settings.updatePreviewDownloading': '다운로드 중',
  'settings.updatePreviewDownloaded': '설치 준비됨',
  'settings.updatePreviewInstalling': '설치 중',
  'settings.updatePreviewError': '확인 실패',
  'settings.updatePreviewUnsupported': '지원 안 됨',
