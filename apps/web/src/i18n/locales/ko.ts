...
export const ko: Dict = {
  ...
  'settings.agentInventoryTitle': '{client}에 설치됨',
  'settings.agentInventoryRefresh': '새로고침',
  'settings.agentInventoryLoading': '설치된 MCP 서버와 스킬을 불러오는 중…',
  'settings.agentInventoryError': '이 CLI 인벤토리를 불러올 수 없습니다({error}).',
  'settings.agentInventoryUnsupported': '{client}의 인벤토리 감지는 아직 사용할 수 없습니다.',
  'settings.agentInventoryUnavailable': '{client} 설정을 감지하지 못했습니다.',
  'settings.agentInventoryEmpty': '{client}에서 설치된 MCP 서버 또는 스킬을 감지하지 못했습니다.',
  'settings.agentInventoryMcpServers': 'MCP 서버',
  'settings.agentInventorySkills': '스킬',
  'settings.agentInventoryNoMcpServers': 'MCP 서버가 감지되지 않았습니다.',
  'settings.agentInventoryNoSkills': '스킬이 감지되지 않았습니다.',
  'settings.agentInventorySourceUser': '사용자',
