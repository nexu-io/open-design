...
export const ko: Dict = {
  ...
  'chat.runError.description.useOfficialAgent': '선택한 에이전트가 로그인되어 있지 않습니다. 더 안정적이고 비용 효율적인 실행을 위해 Open Design 공식 에이전트를 사용하거나 현재 에이전트로 다시 시도하세요.',
  'chat.runError.description.rateLimitUseOfficialAgent': '현재 모델 또는 제공업체가 할당량이나 빈도 제한에 도달했습니다. 나중에 다시 시도하거나 더 안정적이고 비용 효율적인 Open Design 에이전트를 사용하세요.',
  'chat.runError.description.upstreamUseOfficialAgent': '모델 제공업체를 일시적으로 사용할 수 없습니다. 나중에 다시 시도하거나 더 안정적이고 비용 효율적인 Open Design 에이전트를 사용하세요.',
  'chat.runError.description.genericUseOfficialAgent': '작업 실행에 실패했습니다. 나중에 다시 시도하거나 더 안정적이고 비용 효율적인 Open Design 에이전트를 사용하세요.',
