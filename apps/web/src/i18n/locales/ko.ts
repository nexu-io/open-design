...
export const ko: Dict = {
  ...
  'fileViewer.googleSlidesPagesLabel': '페이지',
  'fileViewer.googleSlidesOpen': 'Slides에서 열기',
  'fileViewer.googleSlidesNotReady': '덱 생성 중…',
  'fileViewer.googleSlidesInvalidUrl': '유효하지 않은 embed URL — Google Slides /embed URL만 허용됩니다.',
  'fileViewer.googleSlidesMissingFields': '누락된 필드',
  'fileViewer.googleSlidesMissingImages': '누락된 이미지',
  'fileViewer.googleSlidesSideEffects': '알려진 부작용',
