...
export const ko: Dict = {
  ...
  'ds.manager.cardAria': '디자인 시스템',
  'ds.manager.eyebrow': '디자인 시스템',
  'ds.manager.yourSystems': '내 디자인 시스템',
  'ds.manager.userFilterAria': '디자인 시스템 필터',
  'ds.manager.userFilter.all': '전체',
  'ds.manager.userFilter.published': '게시됨',
  'ds.manager.userFilter.draft': '초안',
  'ds.manager.create.title': '새 디자인 시스템 만들기',
  'ds.manager.create.hint': '브랜드·제품·코드·자료·디자인 레퍼런스를 Open Design에 학습시킵니다.',
  'ds.manager.create.action': '만들기',
  'ds.manager.userEmpty': '아직 디자인 시스템이 없습니다. 실제 제품 컨텍스트로 만들고 초안을 검토한 뒤 향후 프로젝트에 사용할 수 있도록 게시하세요.',
  'ds.manager.row.youUpdated': '나 · 업데이트 {date}',
  'ds.manager.row.justNow': '방금 전',
  'ds.manager.row.edit': '편집',
  'ds.manager.row.makeDefault': '기본으로 설정',
  'ds.manager.row.published': '게시됨',
  'ds.manager.row.draft': '초안',
  'ds.manager.row.openAria': '{title} 열기',
  'ds.manager.row.deleteAria': '{title} 삭제',
  'ds.manager.row.deleteConfirm': '"{title}"을(를) 삭제할까요? 이 기기에서 초안 디자인 시스템이 제거됩니다.',
  'ds.manager.templates.aria': '템플릿',
  'ds.manager.templates.eyebrow': '템플릿',
  'ds.manager.templates.heading': '템플릿',
  'ds.manager.templates.empty': '아직 템플릿이 없습니다. 템플릿 게시 기능이 활성화된 뒤 생성된 프로젝트에서 공유하여 만들 수 있습니다.',
  'ds.manager.privateNote': '이 설정은 본인만 볼 수 있습니다.',
  'ds.manager.library.aria': '내장 디자인 시스템',
  'ds.manager.library.eyebrow': '라이브러리',
  'ds.manager.library.heading': '내장 라이브러리',
  'ds.manager.card.edit': '편집',
  'ds.manager.card.open': '열기',
  ...
  'automations.eyebrow': '예약된 에이전트 세션',
  'automations.title': '자동화',
  'automations.lede': '프로젝트 작업, Orbit 다이제스트, 라이브 아티팩트를 위한 반복 대화를 예약하세요.',
  'automations.metricsAria': '자동화 요약',
  'automations.metric.active': '활성',
  'automations.metric.paused': '일시중지',
  'automations.metric.templates': '템플릿',
  'automations.new': '새 자동화',

  'automations.yours.aria': '내 자동화',
  'automations.yours.title': '내 자동화',
  'automations.yours.loading': '로딩 중',
  'automations.empty.title': '아직 자동화가 없습니다',
  'automations.empty.body': '템플릿에서 만들거나 빈 일정으로 시작해 보세요.',

  'automations.row.targetNew': '실행할 때마다 새 프로젝트',
  'automations.row.run': '실행',
  'automations.row.runTitle': '지금 실행하고 대화 열기',
  'automations.row.history': '기록',
  'automations.row.hideHistory': '기록 숨기기',
  'automations.row.edit': '편집',
  'automations.row.pause': '일시중지',
  'automations.row.resume': '재개',
  'automations.row.delete': '자동화 삭제',
  'automations.row.deleteTitle': '이 자동화 삭제',
  'automations.row.deleteConfirm': '이 자동화를 삭제할까요? 과거 실행 기록과 프로젝트는 유지됩니다.',
  'automations.row.lastRun': '최근 실행 {time}',
  'automations.row.openResult': '결과 열기',

  'automations.schedule.hourly': '매시 :{minute}',
  'automations.schedule.daily': '매일 {time} · {tz}',
  'automations.schedule.weekdays': '평일 {time} · {tz}',
  'automations.schedule.weekly': '{day} {time} · {tz}',
  'automations.schedule.paused': '일시중지',
  'automations.schedule.manualOnly': '수동 실행만',
  'automations.schedule.scheduled': '예약됨',
  'automations.schedule.next': '다음 {time}',

  'automations.history.aria': '자동화 실행 기록',
  'automations.history.loading': '실행 기록 로딩 중…',
  'automations.history.empty': '아직 실행 기록이 없습니다.',
  'automations.history.head': '실행 기록',
  'automations.history.latest': '최근 10건',
  'automations.history.crystallize': '결정화',
  'automations.history.crystallizing': '결정화 중',
  'automations.history.crystallizeTitle': '이 실행에서 스킬·메모리 제안 초안 작성',
  'automations.history.openConversation': '대화 열기',
  'automations.history.durationInProgress': '진행 중',

  'automations.status.succeeded': '성공',
  'automations.status.failed': '실패',
  'automations.status.running': '실행 중',
  'automations.status.queued': '대기 중',
  'automations.status.canceled': '취소됨',

  'automations.ingest.aria': '소스 수집',
  'automations.ingest.title': '소스 수집',
  'automations.ingest.sub': '커넥터·리포지토리·아티팩트·채팅 컨텍스트를 검토 가능한 진화 제안으로 변환합니다.',
  'automations.ingest.recent': '최근 {n}건',
  'automations.ingest.field.template': '템플릿',
  'automations.ingest.field.source': '소스',
  'automations.ingest.field.compression': '압축',
  'automations.ingest.field.connector': '커넥터',
  'automations.ingest.field.title': '제목',
  'automations.ingest.field.sourceRef': '소스 참조',
  'automations.ingest.field.content': '본문',
  'automations.ingest.anyConnector': '연결된 모든 소스',
  'automations.ingest.placeholderTitle': '결정, 브랜드 메모, 워크플로 패턴...',
  'automations.ingest.placeholderSourceRef': 'URL, 리포 경로, 커넥터 이벤트 ID, 아티팩트 ID...',
  'automations.ingest.placeholderContent': '소스 패킷과 제안으로 정규화할 내용을 붙여넣으세요.',
  'automations.ingest.empty': '아직 소스 패킷이 없습니다.',
  'automations.ingest.recentAria': '최근 소스 패킷',
  'automations.ingest.action.ingest': '수집',
  'automations.ingest.action.ingesting': '수집 중',
  'automations.ingest.error.empty': '수집 전에 소스 내용을 붙여넣으세요.',
  'automations.ingest.recentMeta': '{kind} · 토큰 {tokens}개',

  'automations.source.connector': '커넥터',
  'automations.source.url': 'URL',
  'automations.source.repo': '리포지토리',
  'automations.source.artifact': '아티팩트',
  'automations.source.chat': '채팅',
  'automations.source.upload': '업로드',

  'automations.compression.balanced': '균형',
  'automations.compression.aggressive': '강력',
  'automations.compression.off': '끔',

  'automations.proposals.aria': '자동화 진화 제안',
  'automations.proposals.title': '진화 제안',
  'automations.proposals.sub': '메모리·스킬·디자인 시스템에 적용하기 전 자동화 산출물을 검토하세요.',
  'automations.proposals.pending': '대기 중 {n}건',
  'automations.proposals.apply': '적용',
  'automations.proposals.reject': '거절',
  'automations.proposals.rejectReason': '자동화에서 무시됨',
  'automations.proposals.target.memory': '메모리',
  'automations.proposals.target.designSystem': '디자인 시스템',
  'automations.proposals.target.skill': '스킬',
  'automations.proposals.target.template': '자동화 템플릿',
  'automations.proposals.action.create': '생성',
  'automations.proposals.action.update': '업데이트',
  'automations.proposals.action.merge': '병합',
  'automations.proposals.action.move': '이동',
  'automations.proposals.action.delete': '삭제',
  'automations.proposals.action.promote': '승격',

  'automations.templates.aria': '자동화 템플릿',
  'automations.templates.title': '템플릿',
  'automations.templates.sub': 'Orbit과 라이브 아티팩트는 같은 자동화 흐름 안의 템플릿입니다.',
  'automations.templates.filtersAria': '템플릿 필터',
  'automations.templates.countMeta': '{total}개 중 {shown}개',
  'automations.templates.emptyTitle': '이 카테고리에는 아직 템플릿이 없습니다.',
  'automations.templates.emptyHint': '다른 필터를 시도하거나 빈 자동화에서 시작해 보세요.',
  'automations.templates.useTemplate': '템플릿 사용',
  'automations.templates.kind.orbit': 'Orbit',
  'automations.templates.kind.liveArtifact': '라이브 아티팩트',
  'automations.templates.kind.automation': '자동화',
  'automations.templates.filter.all': '전체',
  'automations.templates.filter.orbit': 'Orbit',
  'automations.templates.filter.liveArtifact': '라이브 아티팩트',
  'automations.templates.filter.memory': '메모리',
  'automations.templates.filter.designSystem': '디자인 시스템',
  'automations.templates.filter.skills': '스킬',
  'automations.templates.filter.connectors': '커넥터',
  'automations.templates.filter.compression': '압축',
  'automations.templates.filter.release': '릴리스',
  'automations.templates.filter.quality': '품질',

  'automations.static.memoryRefresh.title': '최근 작업으로 프로젝트 메모리 갱신.',
  'automations.static.memoryRefresh.description': '반복되는 결정·선호·피드백을 재사용 가능한 메모리 업데이트로 만듭니다.',
  'automations.static.memoryRefresh.defaultName': '메모리 갱신',
  'automations.static.designSystemRefresh.title': '배포된 아티팩트로부터 디자인 시스템 업데이트.',
  'automations.static.designSystemRefresh.description': '최근 디자인 작업에서 재사용 가능한 토큰·컴포넌트·규칙을 찾아냅니다.',
  'automations.static.designSystemRefresh.defaultName': '디자인 시스템 유지보수',
  'automations.static.liveArtifactRegistry.title': '라이브 아티팩트 점검 및 오래된 버전 갱신.',
  'automations.static.liveArtifactRegistry.description': '대시보드·리포트·미리보기를 새로 만들지 않고 최신으로 유지합니다.',
  'automations.static.liveArtifactRegistry.defaultName': '라이브 아티팩트 유지보수',
  'automations.static.orbitDashboard.title': '커넥터 활동 대시보드 만들기.',
  'automations.static.orbitDashboard.description': '선택한 커넥터를 Orbit 스타일 라이브 대시보드로 집계합니다.',
  'automations.static.orbitDashboard.defaultName': '커넥터 활동 대시보드',
  'automations.static.releaseNotes.title': '배포된 디자인 작업으로 릴리스 노트 초안 작성.',
  'automations.static.releaseNotes.description': '머지된 PR, 아티팩트, 제품 변경사항을 릴리스 노트로 엮습니다.',
  'automations.static.releaseNotes.defaultName': '주간 릴리스 노트',
  'automations.static.qualityRegressionWatch.title': '디자인·구현 회귀 감시.',
  'automations.static.qualityRegressionWatch.description': '최근 변경을 벤치마크·트레이스·승인된 참조와 비교합니다.',
  'automations.static.qualityRegressionWatch.defaultName': '회귀 감시',

  'automations.fallback.orbitDaily.title': '일일 커넥터 다이제스트.',
  'automations.fallback.orbitDaily.description': '커넥터 활동 다이제스트를 일정에 맞춰 갱신합니다.',
  'automations.fallback.orbitDaily.defaultName': '일일 커넥터 다이제스트',
  'automations.fallback.liveStatusBoard.title': '라이브 상태 아티팩트를 항상 최신으로.',
  'automations.fallback.liveStatusBoard.description': '매번 새 리포트를 만들지 않고 하나의 영구 아티팩트를 업데이트합니다.',
  'automations.fallback.liveStatusBoard.defaultName': '라이브 상태 보드',

  'automations.modal.ariaEdit': '자동화 편집',
  'automations.modal.ariaNew': '새 자동화',
  'automations.modal.placeholderTitle': '자동화 제목',
  'automations.modal.useTemplate': '템플릿 사용',
  'automations.modal.close': '닫기 (Esc)',
  'automations.modal.promptPlaceholder': '이 일정에 어떤 작업을 실행할지 알려 주세요. @로 컨텍스트를 멘션할 수 있습니다...',
  'automations.modal.mention.aria': '자동화 컨텍스트 결과',
  'automations.modal.mention.tabsAria': '컨텍스트 유형',
  'automations.modal.mention.tab.all': '전체',
  'automations.modal.mention.tab.skills': '스킬',
  'automations.modal.mention.tab.plugins': '플러그인',
  'automations.modal.mention.tab.mcp': 'MCP',
  'automations.modal.mention.tab.connectors': '커넥터',
  'automations.modal.mention.empty': '스킬·플러그인·MCP 서버·커넥터를 검색하세요.',
  'automations.modal.mention.noResults': '"{query}"에 대한 결과 없음.',
  'automations.modal.mention.section.skills': '스킬',
  'automations.modal.mention.section.plugins': '플러그인',
  'automations.modal.mention.section.mcp': 'MCP',
  'automations.modal.mention.section.connectors': '커넥터',
  'automations.modal.selected.aria': '선택된 자동화 컨텍스트',
  'automations.modal.selected.remove': '{label} 제거',
  'automations.modal.selected.skill': '스킬',
  'automations.modal.selected.plugin': '플러그인',
  'automations.modal.selected.mcp': 'MCP',
  'automations.modal.selected.connector': '커넥터',
  'automations.modal.selected.connectorWith': '커넥터 · {account}',
  'automations.modal.error.title': '자동화 제목을 입력하세요.',
  'automations.modal.error.prompt': '예약된 대화에 사용할 프롬프트를 입력하세요.',
  'automations.modal.cancel': '취소',
  'automations.modal.create': '생성',
  'automations.modal.creating': '생성 중...',
  'automations.modal.save': '저장',
  'automations.modal.saving': '저장 중...',
  'automations.modal.project.newEachRun': '실행할 때마다 새 프로젝트',
  'automations.modal.project.newEachRunHint': '실행마다 새 프로젝트와 대화를 시작합니다.',
  'automations.modal.project.existing': '기존 프로젝트',
  'automations.modal.schedule.kind.hourly': '매시간',
  'automations.modal.schedule.kind.daily': '매일',
  'automations.modal.schedule.kind.weekdays': '평일',
  'automations.modal.schedule.kind.weekly': '매주',
  'automations.modal.schedule.minute': '매시 몇 분',
  'automations.modal.schedule.time': '시각',
  'automations.modal.schedule.timezone': '시간대',
  'automations.modal.schedule.weekdayAria': '요일',
  'automations.modal.schedule.done': '완료',
};
