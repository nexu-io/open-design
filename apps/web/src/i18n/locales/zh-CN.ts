...
export const zhCN: Dict = {
  ...
  'fileViewer.commentSync.backfillFailedTitle': "分享已发布",
  ...
  'fileViewer.commentSync.backfillRetryingBody': "已有评论暂未同步，访客暂时看不到。正在后台自动重试。",
  'fileViewer.commentSync.backfillReopenedPendingBody': "正在同步重新开启的分享链接；分享页可能仍显示已删除或已处理的评论。",
  'fileViewer.commentSync.backfillReopenedRetryingBody': "评论同步尚未完成，分享页可能仍显示已删除或已处理的评论。正在后台自动重试。",
