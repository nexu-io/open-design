...
export const zhCN: Dict = {
  ...
  'fileViewer.shareGuide.title': "导出完成",
  'fileViewer.shareGuide.description': "分享链接，邀请大家查看并留下评论。",
  ...
  "fileViewer.shareUpdateSuccess": "链接已更新",
  "fileViewer.shareUpdateFailed": "更新失败，上一版仍可访问。",
