...
export const zhCN: Dict = {
  ...
  'fileViewer.cloudflareAccountIdHint': '可在 Cloudflare 控制台中找到账号 ID。',
  'fileViewer.cloudflareProjectName': 'Pages project name',
  'fileViewer.cloudflareProjectNameHint': '项目不存在时会自动创建。',
  'fileViewer.optional': '可选',
  'fileViewer.vercelPreviewOnly': '当前仅部署 Preview。',
  'fileViewer.cloudflarePagesPreviewHint': 'Cloudflare Pages 使用 Direct Upload，项目不存在时会自动创建。',
