...
export const zhCN: Dict = {
  ...
  'chat.dsExtractUser': "从 {source} 提取设计系统",
  'chat.dsExtractRunning': "正在提取设计系统…",
  'chat.dsExtractDone': "已成功提取 {name} — 所有模块已就绪。",
  'chat.dsNextStepsTitle': "下一步",
  'chat.dsMoreToggle': "更多优化",
