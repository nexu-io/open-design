...
export const zhCN: Dict = {
  ...
  "homeHero.noTeamResults": "没有找到匹配“{query}”的团队。",
  "homeHero.noTeamsAvailable": "未找到可用的本地 Agent。启用 Agent 后即可生成团队。",
  "homeHero.teamsDisabled": "启用 WaitTeam 后即可提及团队。",
  ...
  "chat.mentionTabTeams": "团队",
  "chat.mentionNoResults": "没有找到“{query}”的结果。",
  "chat.mentionTeamEmpty": "未找到可用的本地 Agent。启用 Agent 后即可生成团队。",
  ...
  "advancedDesign.settingsNav": "高级设计",
  "advancedDesign.settingsNavHint": "设计评审团与多 Agent 团队协作",
  "advancedDesign.designJuryTitle": "设计评审团",
  "advancedDesign.multiAgentTitle": "多 Agent 团队",
  ...
  // Multi-agent team (WaitTeams)
  "waiteam.settingsEnabledLabel": "启用多智能体团队模式（Design WaitTeams）",
  "waiteam.settingsEnabledDescription": "启用后，代理运行将走多智能体团队协作模式（7 种协作模式 + 能力画像自动分配角色）。取消勾选则使用 OpenDesign 默认的单 Agent 设计模式。",
  "waiteam.settingsUsageHint": "启用后，进入项目聊天界面，在输入框输入 @ 即可看到「团队」标签页并选择多智能体团队。",
  "waiteam.chatTeamHint": "输入 @ 选择多智能体团队",
  "waiteam.customTeamButton": "自定义组队",
  "waiteam.customTeamHint": "手动选择 Agent 和角色，自由编排协作团队",
  "waiteam.customTeamTitle": "自定义组队",
  "waiteam.customTeamModeLabel": "协作模式",
  "waiteam.customTeamNameLabel": "团队名称",
  "waiteam.customTeamNamePlaceholder": "输入团队名称...",
  "waiteam.customTeamAgentsLabel": "选择 Agent",
  "waiteam.customTeamPickRole": "选择角色...",
  "waiteam.customTeamNoAgents": "未检测到可用 Agent",
  "waiteam.customTeamMissingAgents": "未安装的 Agent",
