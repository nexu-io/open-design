...
export const zhCN: Dict = {
  ...
  'settings.orcaRouterConnectIntro': '使用您的 OrcaRouter 账号登录，或粘贴已有的 API 密钥。两者都计入您自己的账号，并可随时撤销。',
  'settings.orcaRouterNotConnected': '未连接。',
  'settings.orcaRouterConnected': '已连接到 OrcaRouter。',
  'settings.orcaRouterNeedsReauthTitle': '需要重新登录 OrcaRouter。',
  'settings.orcaRouterNeedsReauth': 'OrcaRouter 拒绝了此凭据。请重新登录或粘贴新的 API 密钥。',
  'settings.orcaRouterScopeGranted': '已授予范围：',
  'settings.orcaRouterWaiting': '正在等待授权…',
  'settings.orcaRouterWaitingHint': 'OpenDesign 正在等待回调。您在浏览器中批准后，此面板将立即切换为“已连接”。',
  'settings.orcaRouterConnect': '使用 OrcaRouter 连接',
  'settings.orcaRouterReconnect': '重新连接',
  'settings.orcaRouterReconnectHint': '重新授权并替换已保存的密钥',
  'settings.orcaRouterConnecting': '正在连接…',
  'settings.orcaRouterOpeningBrowser': '正在打开浏览器…',
  'settings.orcaRouterCancel': '取消',
  'settings.orcaRouterDisconnect': '断开连接',
  'settings.orcaRouterDisconnecting': '正在断开…',
  'settings.orcaRouterOpenManually': '浏览器标签页没有打开？',
  'settings.orcaRouterOpenManuallyLink': '手动打开授权页面',
  'settings.orcaRouterPasteHint': 'OrcaRouter 可能显示代码而不跳转。请粘贴到此处：',
  'settings.orcaRouterPastePlaceholder': '粘贴授权码',
  'settings.orcaRouterSubmitCode': '提交代码',
