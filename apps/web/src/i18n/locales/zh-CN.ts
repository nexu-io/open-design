...
export const zhCN: Dict = {
  ...
  'brandExtractionTranscript.next': '接下来，你可以运行 AI 优化做更深一轮抽取，或者用这个系统新建设计。',
  ...
  'nextStep.brandAiOptimizeTitle': 'AI 优化',
  'nextStep.brandAiOptimizeBody': '让智能体继续优化提取出的品牌套件。',
  'nextStep.brandCreateDesignTitle': '新建设计',
  'nextStep.brandCreateDesignBody': '使用这个设计系统启动新项目。',
