...
export const zhCN: Dict = {
  ...
  "chat.runError.title.modelDocumentUnsupported": "此模型不接受文档",
  ...
  "chat.runError.modelDocumentUnsupportedMessage": "此模型在 Bedrock 上不接受文档 (PDF)。请切换到 Anthropic 或 Amazon Nova 模型后重试。",
  ...
  "settings.bedrockRegionLabel": "AWS 区域",
