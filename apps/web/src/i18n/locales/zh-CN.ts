...
export const zhCN: Dict = {
  ...
  "chat.compactBoundary": "以上对话已压缩为摘要",
  "chat.compactDone": "对话已压缩",
  "chat.compactAutoStarted": "上下文接近模型上限，正在自动压缩…",
  "chat.compactAutoDone": "上下文已自动压缩",
  "chat.compactAutoDryRun": "已触发自动压缩（dry-run，未实际执行）",
  "chat.compactAutoFailed": "自动压缩失败，已按原始上下文继续发送",
  "chat.contextWindowTitle": "上下文窗口",
  "chat.contextWindowModel": "模型",
  "chat.contextWindowCapacity": "窗口容量",
  "chat.contextWindowUsed": "当前转录估算",
  "chat.contextWindowAutoLine": "自动压缩触发线",
  "chat.contextWindowNote": "本地估算：容量取自 LiteLLM 模型目录，占用按转录字符数折算（ASCII≈0.25 token）。达到触发线时将在下次发送前自动压缩。",
  "chat.compactFailed": "压缩失败，请重试",
  "chat.compactProgress": "正在压缩对话…",
  "chat.compactSlash": "把之前的对话压缩成摘要，节省上下文",
  "chat.compactUnavailableReason": "压缩仅支持 API 或 Antigravity 会话",
