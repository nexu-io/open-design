...
export const zhCN: Dict = {
  ...
  'serverDirectoryPicker.noRoots': '没有可用的已授权服务器文件夹。请先关联一个工作目录。',
  'serverDirectoryPicker.loadRootsFailed': '无法加载服务器文件夹。',
  'serverDirectoryPicker.contentsAria': '目录内容',
  ...
  "settings.projectLocationsPickerInvalid": "文件夹选择器返回了无效响应。",
  "settings.projectLocationsPickerFailed": "无法打开文件夹选择器。",
