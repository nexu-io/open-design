...
export const zhCN: Dict = {
  ...
  'chat.amrCard.switchBody': '可切换到 Marketing AX 官方 AMR 模型服务，无需配置 API Key。完成登录、授权和充值后，将自动重试当前任务。',
  ...
  'settings.onboardingCreateBody': '描述你想做的网站、应用、Deck、图片或视频，Marketing AX 会创建项目，并保留可继续编辑的产物。',
  ...
  'settings.agentInstall.pathHint': '如果你通过 npm 或 Homebrew 安装了 CLI，但仍显示为未安装，请确认该工具的 bin 目录已加入 Marketing AX daemon 继承的 PATH（在 macOS 上，Terminal 与 GUI 应用的 PATH 可能不同）。请参阅 QUICKSTART.md（“Local agent CLI and PATH” 章节）。',
  'settings.agentInstall.stepOpenLinks': '在目标代理卡片上打开“安装”或“文档”链接。',
  'settings.agentInstall.stepAuth': '返回 Marketing AX 之前，请先在对应 CLI 中完成认证（登录或添加 API 凭据）。',
  ...
  'settings.mcpServerHint': '将 Marketing AX 作为 MCP 服务器暴露给你的编码代理。',
  ...
  'settings.privacy': '隐私',
  'settings.privacyHint': '与 Marketing AX 团队共享哪些数据',
  'settings.privacyConsentKicker': '帮助我们改进 Marketing AX',
  'settings.privacyConsentLead': 'Marketing AX 可以将使用数据共享给我们的团队以协助改进。包括:',
  ...
  'settings.mcpHint': '让其他仓库中的编码助手（Claude Code、Cursor、VS Code、Antigravity、Zed、Windsurf）读取你的 Marketing AX 项目。无需先导出 zip，即可将设计拉取到你的应用中。',
  'settings.mcpDaemonError': '无法连接到本地守护进程以解析安装路径（{error}）。请确保 Marketing AX 正在运行，然后重新打开此面板。',
  'settings.mcpBuildDaemon': '请先构建守护进程。',
  'settings.mcpNodeMissing': 'Node 二进制文件缺失。',
  'settings.mcpBuildHint': 'apps/daemon/dist/cli.js 缺失。请运行 `pnpm --filter @marketing-ax/daemon build` 并刷新。',
  ...
  'settings.mcpCapabilityDefault': '默认使用你在 Marketing AX 中打开的项目和文件，因此你可以直接说"在我的应用中构建这个"，无需重复说明是哪个设计。',
  'settings.mcpRunningNote': 'Marketing AX 必须处于运行状态，MCP 工具调用才能成功。如果你在打开 Marketing AX 之前启动了编码助手，请重启助手以便它能连接到正在运行的守护进程。',
  ...
  'brands.empty': '尚未注册任何品牌。',
  'brands.back': '返回',
  'brands.core': '品牌核心',
  'brands.loadFailed': '无法加载此品牌。',
  'brands.pageTitle': '品牌',
  'brands.pageSubtitle': '注册每个品牌的背景和设计系统，然后创建项目。',
  'brands.sectionContext': '品牌背景',
  'brands.sectionDesignSystem': '设计系统',
  'brands.sectionDocs': '知识文档',
  'brands.docsHint': '品牌核心和每个渠道的创作文档 (.md) 会被注入到运行中。选择文档即可查看。',
  'brands.fieldTagline': '标语',
  'brands.fieldWebsite': '网站',
  'brands.fieldAudience': '核心受众',
  'brands.fieldKeyMessage': '关键信息',
  'brands.fieldAvoid': '避免事项',
  'brands.fieldChannels': '渠道',
  'brands.palette': '色彩板',
  'brands.typography': '排版',
  'brands.voiceTone': '语气与风格',
  'brands.coreDocLabel': '品牌核心',
  'brands.projectCount': '{n} 个项目',
  'brands.paletteChannelMeta': '{c} 种颜色 · 已注册 {n} 个渠道',
  'brands.newButton': '+ 新建品牌',
  'brands.newTitle': '新建品牌',
  'brands.newFieldTitle': '名称',
  'brands.newFieldId': 'ID',
  'brands.newFieldIdHint': '根据名称自动建议 — 仅限小写字母、数字和连字符。',
  'brands.newSubmit': '创建',
  'brands.newDuplicateId': '已存在相同 ID 的品牌。',
  'brands.newFailed': '无法创建品牌。',
  'brands.edit': '编辑',
  'brands.save': '保存',
  'brands.cancel': '取消',
  'brands.saveFailed': '无法保存更改。',
  'brands.fieldSubtitle': '副标题',
  'brands.fieldToneLabel': '语调标签',
  'brands.fieldTypographyFamily': '字体家族',
  'brands.fieldTypographyRoles': '字体角色',
  'brands.fieldTypographyWeights': '字重',
  'brands.fieldNeutralPalette': '中性色板',
  'brands.fieldCommaHint': '多个值请用逗号分隔。',
  'brands.docEdit': '编辑文档',
  'brands.docSaveFailed': '无法保存文档。',
  'brands.channelAdd': '+ 渠道',
  'brands.channelAddKey': '键',
  'brands.channelAddKeyHint': '仅限小写字母、数字和连字符 — 将用作提示词注入键。',
  'brands.channelAddLabel': '标签',
  'brands.channelAddDesignSystem': '设计系统',
  'brands.channelAddSubmit': '添加',
  'brands.channelAddFailed': '无法添加渠道。',
  'brands.channelRemove': '移除渠道',
  'brands.channelRemoveConfirm': '移除 {key} 渠道？其创作文档将被删除。',
  'brands.channelRemoveFailed': '无法移除渠道。',
  'brands.uploadIcon': '上传图标',
  'brands.uploadLogo': '上传徽标',
  'brands.uploadFailed': '无法上传图片。',
  'brands.uploadTooLarge': '文件过大。',
  'brands.deleteZone': '危险区域',
  'brands.delete': '删除品牌',
  'brands.deleteConfirm': '删除 {title} 品牌？此操作无法撤销。',
  'brands.deleteBlocked': '有 {n} 个项目正在使用此品牌。请先删除这些项目。',
  'brands.deleteFailed': '无法删除品牌。',
  ...
  'homeHero.chip.brazeIamHint': '创作 Braze Custom-HTML 应用内消息：访谈 → 方案 → 确认 → A/B HTML 变体。',
  ...
  'homeHero.chip.createPluginHint': '创作可复用的 Marketing AX 插件，并添加到我的插件。',
  ...
  'handoff.promptIntro': '请基于这个 Marketing AX 项目的本地文件夹继续实现：',
  ...
  'pluginsHome.subtitle': '当前运行环境内置的 Marketing AX 工作流。选择一个加载 starter prompt，或浏览插件市场查看更多。',
  'pluginsHome.browseRegistry': '浏览插件市场',
  'pluginsHome.count': '{filtered} / {total}',
  'pluginsHome.loadingCatalog': '正在加载目录…',
  'pluginsHome.emptyCatalog': '目录为空。Marketing AX 会随附内置插件，如果这里一直为空，请尝试重启 daemon。',
  ...
  'pluginCard.contributeAria': '将 {title} 贡献到 Marketing AX',
  'pluginCard.contributeTitle': '通过 pull request 将插件贡献到 Marketing AX',
  ...
  'integrations.lede': '连接外部系统，把 MCP 工具带入智能体循环，并在其它 IDE、脚本和自动化中使用 Marketing AX。',
  ...
  'mcpClient.daemonError': '无法连接本地 daemon。请确认 Marketing AX 正在运行，然后重新打开此面板。',
  'mcpClient.saveFailed': '保存失败。请检查 daemon 是否正在运行后重试。',
  'useEverywhere.modalAria': '随处使用 Marketing AX',
  'useEverywhere.modalTitle': '随处使用 Marketing AX',
  'useEverywhere.modalSubtitle': '把 Marketing AX 接入任何 IDE、智能体或脚本：CLI、HTTP、MCP 和 Skills。使用“复制智能体指南”，粘贴到 Claude Code、Codex、Cursor、openclaw 或 hermes 中即可完成配置。',
  ...
  'useEverywhere.section.overview.heading': 'Marketing AX 可在智能体工作的任何地方运行',
  'useEverywhere.section.overview.intro': 'Marketing AX 不只是一个窗口；它包含本地特权 daemon（`od`），以及 Skills + Design Systems + Atoms registry。它在你的机器上运行后，任何代码智能体（Claude Code、Codex、Cursor、OpenCode/openclaw、Hermes 或你自己的脚本）都可以通过四种可互换入口驱动生成、检查项目并产出设计制品。',
  'useEverywhere.section.overview.bullet1': 'CLI — 使用 `od <command>` 支持无头脚本、CI 和 shell 自动化。',
  'useEverywhere.section.overview.bullet2': 'MCP 服务器 — 将 Marketing AX 作为 Model Context Protocol 服务器接入，使任何支持 MCP 的智能体都能列出技能、运行场景并读取制品。',
  'useEverywhere.section.overview.bullet3': 'HTTP API — `http://127.0.0.1:7456/api/*` REST + SSE 端点；与 Web UI 使用同一套接口。',
  'useEverywhere.section.overview.bullet4': 'Skills — 可直接放入的 `SKILL.md` 包（兼容 Claude），任何已在 PATH 中的智能体都能调用，甚至不需要打开 Marketing AX。',
  ...
  'useEverywhere.section.cli.heading': '从任意 shell 驱动 Marketing AX',
  ...
  'useEverywhere.section.mcp.heading': '把 Marketing AX 暴露为任意代码智能体可用的 MCP 服务器',
  'useEverywhere.section.mcp.intro': 'Marketing AX 内置 Model Context Protocol 服务器（`od mcp`），让任何支持 MCP 的客户端（Cursor、Claude Code、Antigravity、VS Code Copilot Chat、openclaw、hermes）都能发现 Marketing AX 工具（列出技能、渲染预览、生成媒体、运行插件），无需手动 shell 调用。daemon 会通过 `GET /api/mcp/install-info` 为主流客户端发布可直接粘贴的安装片段。',
  ...
  'useEverywhere.section.mcp.bullet4': '固定 `MAX_DATA_DIR`，让派生的 MCP 进程写入 daemon 已使用的位置，避免打包 macOS app bundle 中的 EPERM 问题。',
  ...
  'useEverywhere.section.mcp.footer': '在 Marketing AX 应用中，打开“设置 → 集成”即可复制特定客户端的安装命令（Cursor、Claude Code、Antigravity、VS Code），无需手写 JSON。',
  'useEverywhere.section.http.tab': 'HTTP API',
  'useEverywhere.section.http.heading': '与 Web UI 相同的 REST + SSE 接口',
  'useEverywhere.section.http.intro': '本地 daemon 在 `http://127.0.0.1:7456` 提供 HTTP API（端口可配置）。Web UI 调用的每个端点也都可以供你的脚本使用。流式端点（聊天回合、项目运行）会发出 Server-Sent Events，事件类型定义在 `@marketing-ax/contracts` 中。',
  ...
  'useEverywhere.section.http.footer': '每个请求 / 响应的纯 TypeScript 类型都在 `@marketing-ax/contracts` 中；脚本中导入即可获得完整自动补全，无需接入生成器。',
  'useEverywhere.section.skills.tab': 'Skills 和无头模式',
  'useEverywhere.section.skills.heading': '任意智能体可直接使用的 Skills，即使 Marketing AX 未运行',
  'useEverywhere.section.skills.intro': 'Skill 是一个包含 Claude 兼容 `SKILL.md`（YAML front matter + 正文）的目录。Marketing AX 通过 `od:` 命名空间（`mode`、`preview`、`design_system`、`inputs` 等）扩展该格式，使同一个制品既能在 Marketing AX 内使用，也能被 Claude Code、Codex、openclaw 或 hermes 这类普通智能体使用。发现逻辑遵循优先级链，因此项目可以覆盖自己的 skills。',
  ...
  'useEverywhere.section.skills.snippet1': '最小 SKILL.md（Claude 兼容 front matter + Marketing AX 扩展）',
  ...
  'entry.githubStarAria': '在 GitHub 上为 Marketing AX 点亮 Star',
  ...
  'newproj.locationDefault': 'Marketing AX 项目',
  ...
  'ds.detailLoadFailed': '无法加载此设计系统。',
  'ds.back': '返回',
  'ds.detailLoading': '正在加载设计系统…',
  'ds.detailLoadingHint': '正在打开审阅工作区。',
  'avatar.title': '账户与设置',
  ...
  'chat.activeFilePlaceholder': '让 Marketing AX 修改 {file}...',
  ...
  'chat.mode.design.solves': '当你希望 Marketing AX 生成文件、更新工作区，或把需求变成多模态可交付结果时使用。',
  ...
  'preview.errorBody': '示例 HTML 加载失败。请确认 Marketing AX 正在运行后重试。',
  'preview.retry': '重试',
  ...
  'fileViewer.openFolder': '打开项目文件夹',
  'fileViewer.openFolderFailed': '无法打开项目文件夹。',
  'fileViewer.openFolderWebFallback': '无法从浏览器打开文件夹。路径:',
  'fileViewer.copyCaption': '复制文案',
  'fileViewer.copyCaptionDone': '文案已复制到剪贴板',
  'fileViewer.copyCaptionFailed': '无法复制文案。',
  ...
  'pet.navHint': '领养与自定义',
  'pet.tabBuiltIn': '内置',
  'pet.tabBuiltInHint': 'Marketing AX 内置的精选宠物 — 一键领养。',
  ...
  'pet.codexBundled': '内置',
  'pet.codexBundledTitle': 'Marketing AX 内置宠物，无需下载。',
  ...
  'settings.projectLocationsDescription': '添加可包含多个 Marketing AX 项目文件夹的工作基目录。新项目会作为所选基目录内的一个文件夹保存。',
  ...
  'settings.defaultRouter.title': '默认路由器',
  'settings.defaultRouter.description': '处理未匹配任何插件触发词的自由输入的路由插件。',
  'settings.defaultRouter.builtin': '内置 (Default design router)',
  ...
  'settings.memoryStarterProjectDesc': 'Marketing AX v0.5 — 聊天驱动的设计编辑器',
  ...
  'updater.availableBody': 'Marketing AX {version} 可用。下载安装完成后即可打开安装器。',
  ...
  'updater.done': '完成',
  'updater.failed': '更新失败',
  'updater.installerOpenBody': '安装器已打开。Marketing AX 正在退出，以便你完成更新。',
  ...
  'updater.payloadReadyGeneric': 'Marketing AX 更新已就绪。Marketing AX 会关闭并自动重启。',
  'updater.payloadReadyVersion': 'Marketing AX {version} 已就绪。Marketing AX 会关闭并自动重启。',
  'updater.quitButton': '退出 Marketing AX',
  'updater.quitFailedBody': '安装器已打开，但 Marketing AX 无法退出。替换应用前请先退出 Marketing AX。',
  'updater.quitFailedTitle': '无法退出',
  'updater.quitting': '正在退出…',
  'updater.ready': '更新已就绪',
  'updater.readyGeneric': '新版本已就绪。Marketing AX 会关闭并打开安装器。',
  'updater.readyVersion': 'Marketing AX {version} 已就绪。Marketing AX 会关闭并打开安装器。',
  ...
  'dsManager.createBody': '把你的品牌、产品、代码、素材和设计参考教给 Marketing AX。',
  ...
  'settings.customInstructionsDesc': 'Marketing AX 在每次对话中都会遵循的固定指令。它们不是保存的记忆；事实、偏好和项目上下文请使用「记忆」。',
