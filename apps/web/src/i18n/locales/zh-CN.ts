...
export const zhCN: Dict = {
  ...
  'chat.runError.title.auth': '智能体需要授权',
  'chat.runError.title.balance': 'AMR 余额不足',
  'chat.runError.title.connectionDropped': '模型连接中断',
  'chat.runError.title.rateLimit': '模型服务额度受限',
  'chat.runError.title.modelUnavailable': '所选模型不可用',
  'chat.runError.title.promptTooLarge': '任务上下文过大',
  'chat.runError.title.agentUnavailable': '智能体 CLI 不可用',
  'chat.runError.title.processExit': '智能体进程异常退出',
  'chat.runError.title.generic': '任务执行失败',
  'chat.runError.description.auth': '当前智能体需要先完成授权才能继续。完成登录后，可重试当前任务。',
  'chat.runError.description.rateLimit': '当前智能体触发了模型额度或限流。可以切换模型、使用官方智能体，或稍后重试。',
  'chat.runError.description.useOfficialAgent': '当前智能体尚未登录，请本地检查登录状态。推荐使用 Open Design 智能体，更稳定划算',
  'chat.runError.description.rateLimitUseOfficialAgent': '当前模型或服务商已达配额或频率限制，可稍后重试。推荐使用 Open Design 智能体，更稳定划算',
  'chat.runError.description.upstreamUseOfficialAgent': '模型服务商暂时不可用，可稍后重试。推荐使用 Open Design 智能体，更稳定划算',
  'chat.runError.description.genericUseOfficialAgent': '任务执行失败，可稍后重试。推荐使用 Open Design 智能体，更稳定划算',
  'chat.runError.description.promptTooLarge': '当前任务超出了模型可处理的上下文范围。请缩短需求或减少附件后重试。',
  'chat.runError.description.agentUnavailable': 'Open Design 无法启动当前本地智能体。请检查 CLI 安装，或改用官方智能体。',
  'chat.runError.description.processExit': '智能体进程在完成前停止了。可以重试当前任务，或复制报错源码用于排查。',
  'chat.runError.description.generic': '任务在完成前停止了。可以重试当前任务，或复制报错源码用于排查。',
  'chat.runError.useOfficialAgentCta': '使用官方智能体',
  'chat.runError.rawLabel': '报错源码',
  'chat.runError.rawExpand': '展开',
