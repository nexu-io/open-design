...
export const zhCN: Dict = {
  ...
  'manualEdit.order': '层级',
  'manualEdit.corners': '圆角',
  'manualEdit.rotate': '旋转',
  'manualEdit.shadow': '阴影',
  'manualEdit.shadowNone': '无',
  'manualEdit.sendBackward': '下移一层 (Ctrl+[)',
  'manualEdit.bringForward': '上移一层 (Ctrl+])',
  'manualEdit.toFront': '置于顶层 (Ctrl+Shift+])',
  'manualEdit.toBack': '置于底层 (Ctrl+Shift+[)',
  'manualEdit.alignLeft': '左对齐',
  'manualEdit.alignCenterH': '水平居中',
  'manualEdit.alignRight': '右对齐',
  'manualEdit.alignTop': '顶对齐',
  'manualEdit.alignCenterV': '垂直居中',
  'manualEdit.alignBottom': '底对齐',
  'manualEdit.distributeH': '水平分布',
  'manualEdit.distributeV': '垂直分布',
  'manualEdit.drawingTools': '绘图工具',
  'manualEdit.toolSelect': '选择 (Esc)',
  'manualEdit.toolRect': '矩形',
  'manualEdit.toolCircle': '圆形',
  'manualEdit.toolText': '文本',
  'manualEdit.toolLine': '线条',
  'manualEdit.toolImage': '图片 (URL)',
  'manualEdit.pickColor': '选择颜色',
