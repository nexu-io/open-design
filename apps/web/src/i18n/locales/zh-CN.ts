...
export const zhCN: Dict = {
  ...
  'scene3d.title': '3D 场景',
  'scene3d.compile': '编译',
  'scene3d.compiling': '编译中…',
  'scene3d.recompile': '重新编译',
  'scene3d.verdict': '结论',
  'scene3d.verdictClean': '编译通过 · {warnings} 条警告',
  'scene3d.verdictFailed': '{errors} 个错误 · {warnings} 条警告',
  'scene3d.neverCompiled': '尚未编译',
  'scene3d.parts': '零件',
  'scene3d.noParts': '暂无零件',
  'scene3d.issues': '问题',
  'scene3d.noIssues': '没有问题',
  'scene3d.assets': '资产',
  'scene3d.noAssets': '尚未导出',
  'scene3d.noProof': '暂无校样图 — 请先编译',
  'scene3d.frameAlt': '校样图',
  'scene3d.frameSlider': '转台帧',
  'scene3d.dragHint': '拖动以旋转',
  'scene3d.issuesStoredHint': '重新编译以查看详情',
  'scene3d.meshCounts': '{verts}顶点 / {faces}面',
  'scene3d.fixPrefix': '修复：',
  'scene3d.exportMenu': '导出',
  'scene3d.exportEmpty': '尚未编译任何内容',
  'scene3d.exportAll': '下载全部（{count} 个文件）',
  'scene3d.exportAllScenes': '所有场景',
  'scene3d.exportAllChip': '全部',
  'scene3d.exportAllBusy': '正在准备压缩包…',
  ...
  'scene3d.kindProp': '道具',
  'scene3d.kindKit': '套件',
  'scene3d.kindAnimation': '动画',
  'scene3d.kindSprite': '精灵图',
  'scene3d.kindFlipbook': '翻页动画',
  'scene3d.kindVfx': '特效',
  'scene3d.kindSkybox': '天空盒',
  'scene3d.kindTexture': '纹理',
  'scene3d.partsCount': '{count} 个零件',
  'scene3d.trisCount': '{count} 个三角形',
  'scene3d.claimsProven': '已验证 {count} 项声明',
  'scene3d.blenderVersion': 'Blender {version}',
  'scene3d.scenes': '场景',
  'scene3d.kitScenes': '{count} 个场景',
  'scene3d.kitStageTitle': '套件查看器',
  'scene3d.kitTruncated': '仅显示前 {count} 个场景',
  'scene3d.backToKit': '返回套件',
  'homeHero.chip.scene3dChip': '3D 场景',
  'homeHero.chip.scene3dChipDesc': '模型、纹理、精灵图与翻页动画',
  'homeHero.chip.scene3dChipHint': '用代码创作 3D 资产，并通过无头 Blender 编译——转台校样、约定检查、GLB 与 USD 导出。',
  'scene3d.replay': '重播',
  'scene3d.stop': '停止',
};
