...
export const zhCN: Dict = {
  ...
  "settings.agentInventoryTitle": "已安装到 {client}",
  "settings.agentInventoryRefresh": "刷新",
  "settings.agentInventoryLoading": "正在加载已安装的 MCP 服务器和技能…",
  "settings.agentInventoryError": "无法加载此 CLI 清单（{error}）。",
  "settings.agentInventoryUnsupported": "暂不支持检测 {client} 的清单。",
  "settings.agentInventoryUnavailable": "未检测到 {client} 配置。",
  "settings.agentInventoryEmpty": "未检测到 {client} 中已安装的 MCP 服务器或技能。",
  "settings.agentInventoryMcpServers": "MCP 服务器",
  "settings.agentInventorySkills": "技能",
  "settings.agentInventoryNoMcpServers": "未检测到 MCP 服务器。",
  "settings.agentInventoryNoSkills": "未检测到技能。",
  "settings.agentInventorySourceUser": "用户",
