...
export const zhCN: Dict = {
  ...
  'settings.mediaProviderConnectionConnected': "已连接",
  'settings.mediaProviderConnectionDisconnected': "未连接",
  'settings.mediaProviderConnectionConnectedTitle': "本地 Codex CLI 登录可用",
  'settings.mediaProviderConnectionDisconnectedTitle': "未检测到本地 Codex CLI 登录",
  'settings.mediaProviderConnectionConnectedNote': "本地 Codex CLI 登录可用",
  'settings.mediaProviderConnectionDisconnectedNote': "请使用本地 Codex CLI 登录以使用此提供商",
  'settings.privacy': '隐私',
  ...
  'settings.projectLocationsManualPlaceholder': "输入文件夹路径",
  'settings.projectLocationsBrowseFolders': "浏览文件夹",
  'settings.projectLocationsBrowserDialogLabel': "选择项目位置",
  'settings.projectLocationsBrowserTitle': "选择文件夹",
  'settings.projectLocationsBrowserLoading': "正在加载文件夹...",
  'settings.projectLocationsBrowserParentFolder': "上级文件夹",
  'settings.projectLocationsBrowserUseFolder': "使用此文件夹",
  'settings.projectLocationsBrowserLoadError': "无法加载文件夹。请手动输入文件夹路径。",
  'settings.projectLocationsBrowserEmpty': "这里没有子文件夹。",
