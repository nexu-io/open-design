...
export const zhCN: Dict = {
  ...
  'figma.import.dialogAria': "从 Figma 导入",
  'figma.import.notesPlaceholder': "可选：构建说明（例如「做成营销着陆页」）",
  'figma.import.submit': "导入并构建",
  'figma.import.colorsAria': "颜色令牌",
  'figma.import.summaryFoot': "提示词已在编辑器中就绪——检查并发送以构建页面。",
  'figma.import.tabFile': '上传 .fig',
  'figma.import.dropHint': '在你的机器上解码——令牌、组件和资源。无需 Figma 账户。',
  'figma.import.urlHint': '通过 Figma 连接器（OAuth）和迁移流程运行。',
  'figma.import.decoding': '解码中…',
  'figma.import.notFigError': '这不是 .fig 文件。请将 Figma 文件导出为 .fig（File → Save local copy）并拖放到此处。',
  'figma.import.importedLabel': '已导入',
  'figma.import.assetsOnlySuffix': '（仅资源——无法解码节点树）',
  'figma.import.statNodes': '节点',
  'figma.import.statPages': '页面',
  'figma.import.statFrames': '框架',
  'figma.import.statComponents': '组件',
  'figma.import.statColors': '颜色',
  'figma.import.statFonts': '字体',
  'figma.import.statAssets': '资源',
  "designFiles.library.label": "从资源库导入",
  "designFiles.library.title": "从资源库导入",
  'library.upload.title': "上传到库",
  'library.upload.closeAria': "关闭上传",
  'library.upload.dropHint': '图片、字体、文本、HTML 和 JSON / 设计数据 · 每个最大 {maxMb} MB',
  'library.upload.uploading': '上传中…',
  'library.upload.deduped': '已在库中',
  'library.upload.added': '已添加',
  'library.upload.failed': '失败',
  'library.upload.empty': '尚未上传任何内容',
  'library.upload.summaryAdded': '已添加 {count} 项',
  'library.upload.summaryFailed': '{count} 项失败',
  ...
  'plugins.filtersAria': "插件筛选",
  'plugins.previewHero.eyebrow': "产出内容",
  'plugins.previewHero.outputsAria': "示例输出",
  'plugins.previewHero.openNewTabTitle': "在新标签页中打开此示例",
  'plugins.previewHero.openLabel': "打开",
  ...
  'connectors.providerAria': "连接器提供方",
  ...
  'chat.comments.annotationAria': "批注",
  'chat.comments.moveBox': "移动评论框",
  ...
  "workspace.tabsChrome": "工作区标签",
  "workspace.tabsStrip": "打开的工作区",
