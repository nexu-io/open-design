...
export const zhCN: Dict = {
  ...
  "settings.modelSourceLocalConfig": "本地配置",
  "settings.modelPickerCliFallbackHint": "实时模型发现暂时不可用。可刷新重试，或通过“自定义”输入其他模型 ID。",
  "settings.modelPickerLocalConfigLiveHint": "模型来自本地路由配置。刷新可重新读取已配置的路由。",
  "settings.modelPickerLocalConfigFallbackHint": "{agent} 不提供模型目录命令。刷新只会重新读取本地路由配置；内置别名仍可用，其他 ID 可通过“自定义”输入。",
  "settings.modelPickerUnsupportedCustomHint": "此 CLI 不支持模型发现。请通过“自定义”输入其他模型 ID。",
  "settings.modelPickerUnsupportedConfiguredHint": "此 CLI 不支持模型发现。请在 CLI 自身配置中选择模型。",
  "settings.modelRefreshTitle": "刷新模型目录",
  "settings.modelRefreshRunning": "正在刷新模型目录",
