...
export const zhCN: Dict = {
  ...
  'chat.mentionSectionTeams': '多智能体团队',
  'chat.mentionTeamEmpty': '未检测到可用 Agent，请确保至少安装了两个 CLI 工具（如 Claude Code、Codebuddy、Codex 等）。',
  'chat.mentionTeamRoleLabel': '{role}: {agent}',
  'chat.mentionTeamScore': '评分 {score}',
  ...
  'advancedDesign.settingsNav': '进阶设计',
  'advancedDesign.settingsNavHint': '设计评审团与多智能体团队等进阶设计能力',
  'advancedDesign.designJuryTitle': 'Design Jury（设计评审团）',
  'advancedDesign.multiAgentTitle': 'Multi-Agent Team（多智能体团队）',
