...
export const zhCN: Dict = {
  ...
  'fileViewer.commentSync.backfillFailedBody': "已有评论暂未同步，访客暂时看不到",
  'fileViewer.commentSync.backfillTerminalBody': "部分已有评论未能同步到分享页，系统不会自动重试。分享链接仍可使用。",
  'fileViewer.commentSync.backfillRetryingBody': "已有评论还没同步，访问者暂时看不到。正在自动重试。",
  'fileViewer.commentSync.backfillReopenedPendingBody': "正在同步重新开启的分享链接；分享页可能仍显示已删除或已处理的评论。",
  'fileViewer.commentSync.backfillReopenedRetryingBody': "评论同步未完成，分享页可能仍显示已处理的评论。",
  'fileViewer.commentSync.backfillReopenedTerminalBody': "评论同步尚未完成，分享页可能仍显示已删除或已处理的评论。自动重试已停止；分享链接仍可使用。",
  'fileViewer.commentSync.backfillPendingBody': "正在同步已有评论，访客暂时可能看不到。",
  'fileViewer.commentSync.backfillPendingCountBody': "同步已有评论 · {count} 条",
  "fileViewer.commentSync.reopenSyncBusy": "正在同步评论…",
  'fileViewer.commentSync.alignFailedBody': "评论对齐未完成，可能有评论没显示出来",
  'fileViewer.shareGuide.title': "分享链接，让大家留下反馈",
  'fileViewer.shareGuide.description': "分享链接，直接收集评论。选择多条反馈，交给 Agent 依次处理。",
  'fileViewer.shareGuide.tryShare': "试试分享",
  'fileViewer.shareGuide.neverShowAgain': "不再提示",
  'fileViewer.shareGuide.close': "关闭新功能引导",
  ...
  'designs.deletedShareRetrying': "项目已删除，正在停止「{filePath}」的分享链接",
  'designs.deletedShareFailed': "项目已删除，「{filePath}」的分享链接停止失败，仍可访问",
  'designs.deletedShareRetry': "重试",
  ...
  "fileViewer.jsxModuleBody": "只能分享独立的 HTML 文件。请先将此组件导出为 HTML。",
  ...
  "fileViewer.shareReopening": "正在开启…",
  ...
  "fileViewer.shareUpdateHint": "文件有新改动，访问者看到的还是上一版。",
  ...
  'fileViewer.signInToShareDescription': "登录 Open Design 账号后，即可生成分享链接，邀请他人查看和评论。",
  "fileViewer.shareUpdateSuccess": "已更新，访问者刷新后可看到最新版本",
  "fileViewer.shareUpdateFailed": "更新失败，访问者仍看到上一版",
  "fileViewer.shareUpdateUncertain": "更新结果尚不确定，公开链接的内容可能已变化。请先检查链接或停止分享，再重试。",
  "fileViewer.shareUpdateRetry": "重试",
  "fileViewer.unpublishFileFailed": "关闭链接失败，请重试。",
  "fileViewer.publishFileFailed": "上传失败，请检查网络后重试。",
  ...
  "chat.artifact.shareStatusUnknown": "分享状态未知",
