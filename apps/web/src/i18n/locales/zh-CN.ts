...
export const zhCN: Dict = {
  ...
  'fileViewer.cloudflareProjectNameHint': '无需填写；系统会根据当前项目自动生成 Pages 项目名，并在不存在时自动创建。',
  'fileViewer.optional': '可选',
  'fileViewer.vercelPreviewOnly': '当前仅部署 Preview。',
  'fileViewer.cloudflarePagesPreviewHint': 'Cloudflare Pages 使用 Direct Upload；Pages 项目名会自动选择，不需要用户填写。',
