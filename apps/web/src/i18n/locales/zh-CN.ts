...
export const zhCN: Dict = {
  ...
  'ds.manager.cardAria': '设计系统',
  'ds.manager.eyebrow': '设计系统',
  'ds.manager.yourSystems': '我的设计系统',
  'ds.manager.userFilterAria': '筛选设计系统',
  'ds.manager.userFilter.all': '全部',
  'ds.manager.userFilter.published': '已发布',
  'ds.manager.userFilter.draft': '草稿',
  'ds.manager.create.title': '新建设计系统',
  'ds.manager.create.hint': '把品牌、产品、代码、素材与设计参考一并教给 Open Design。',
  'ds.manager.create.action': '创建',
  'ds.manager.userEmpty': '还没有设计系统。基于真实产品上下文新建一个,审阅草稿后再发布给未来的项目使用。',
  'ds.manager.row.youUpdated': '由你 · 更新于 {date}',
  'ds.manager.row.justNow': '刚刚',
  'ds.manager.row.edit': '编辑',
  'ds.manager.row.makeDefault': '设为默认',
  'ds.manager.row.published': '已发布',
  'ds.manager.row.draft': '草稿',
  'ds.manager.row.openAria': '打开 {title}',
  'ds.manager.row.deleteAria': '删除 {title}',
  'ds.manager.row.deleteConfirm': '删除 "{title}"?这将从本设备移除该草稿设计系统。',
  'ds.manager.templates.aria': '模板',
  'ds.manager.templates.eyebrow': '模板',
  'ds.manager.templates.heading': '模板',
  'ds.manager.templates.empty': '还没有模板。模板发布启用后,可在已生成项目中通过分享创建。',
  'ds.manager.privateNote': '只有你能查看这些设置。',
  'ds.manager.library.aria': '内置设计系统',
  'ds.manager.library.eyebrow': '库',
  'ds.manager.library.heading': '内置库',
  'ds.manager.card.edit': '编辑',
  'ds.manager.card.open': '打开',
  ...
  'automations.eyebrow': '预定的代理会话',
  'automations.title': '自动化',
  'automations.lede': '为项目工作、Orbit 摘要和实时制品规划周期性对话。',
  'automations.metricsAria': '自动化摘要',
  'automations.metric.active': '运行中',
  'automations.metric.paused': '已暂停',
  'automations.metric.templates': '模板',
  'automations.new': '新建自动化',

  'automations.yours.aria': '我的自动化',
  'automations.yours.title': '我的自动化',
  'automations.yours.loading': '加载中',
  'automations.empty.title': '还没有自动化',
  'automations.empty.body': '从模板创建,或以空白排程开始。',

  'automations.row.targetNew': '每次运行新建项目',
  'automations.row.run': '运行',
  'automations.row.runTitle': '立即运行并打开对话',
  'automations.row.history': '历史',
  'automations.row.hideHistory': '隐藏历史',
  'automations.row.edit': '编辑',
  'automations.row.pause': '暂停',
  'automations.row.resume': '恢复',
  'automations.row.delete': '删除自动化',
  'automations.row.deleteTitle': '删除此自动化',
  'automations.row.deleteConfirm': '删除此自动化?过往的运行记录及其项目将保留。',
  'automations.row.lastRun': '最近运行 {time}',
  'automations.row.openResult': '打开结果',

  'automations.schedule.hourly': '每小时 :{minute}',
  'automations.schedule.daily': '每天 {time} · {tz}',
  'automations.schedule.weekdays': '工作日 {time} · {tz}',
  'automations.schedule.weekly': '{day} {time} · {tz}',
  'automations.schedule.paused': '已暂停',
  'automations.schedule.manualOnly': '仅手动',
  'automations.schedule.scheduled': '已排程',
  'automations.schedule.next': '下次 {time}',

  'automations.history.aria': '自动化运行历史',
  'automations.history.loading': '正在加载运行历史…',
  'automations.history.empty': '还没有运行记录。',
  'automations.history.head': '运行历史',
  'automations.history.latest': '最近 10 次',
  'automations.history.crystallize': '结晶化',
  'automations.history.crystallizing': '结晶化中',
  'automations.history.crystallizeTitle': '从此次运行起草技能与记忆建议',
  'automations.history.openConversation': '打开对话',
  'automations.history.durationInProgress': '进行中',

  'automations.status.succeeded': '成功',
  'automations.status.failed': '失败',
  'automations.status.running': '运行中',
  'automations.status.queued': '排队中',
  'automations.status.canceled': '已取消',

  'automations.ingest.aria': '来源摄取',
  'automations.ingest.title': '摄取来源',
  'automations.ingest.sub': '把连接器、仓库、制品或聊天上下文转换为可审阅的演进建议。',
  'automations.ingest.recent': '近 {n} 条',
  'automations.ingest.field.template': '模板',
  'automations.ingest.field.source': '来源',
  'automations.ingest.field.compression': '压缩',
  'automations.ingest.field.connector': '连接器',
  'automations.ingest.field.title': '标题',
  'automations.ingest.field.sourceRef': '来源引用',
  'automations.ingest.field.content': '内容',
  'automations.ingest.anyConnector': '任意已连接来源',
  'automations.ingest.placeholderTitle': '决策、品牌备注、工作流模式...',
  'automations.ingest.placeholderSourceRef': 'URL、仓库路径、连接器事件 ID、制品 ID...',
  'automations.ingest.placeholderContent': '粘贴要规范化为来源包与建议的内容。',
  'automations.ingest.empty': '还没有来源包。',
  'automations.ingest.recentAria': '近期来源包',
  'automations.ingest.action.ingest': '摄取',
  'automations.ingest.action.ingesting': '摄取中',
  'automations.ingest.error.empty': '摄取前请先粘贴来源内容。',
  'automations.ingest.recentMeta': '{kind} · {tokens} tokens',

  'automations.source.connector': '连接器',
  'automations.source.url': 'URL',
  'automations.source.repo': '仓库',
  'automations.source.artifact': '制品',
  'automations.source.chat': '聊天',
  'automations.source.upload': '上传',

  'automations.compression.balanced': '均衡',
  'automations.compression.aggressive': '激进',
  'automations.compression.off': '关闭',

  'automations.proposals.aria': '自动化演进建议',
  'automations.proposals.title': '演进建议',
  'automations.proposals.sub': '在变更记忆、技能或设计系统之前审阅自动化产出。',
  'automations.proposals.pending': '待审 {n} 条',
  'automations.proposals.apply': '应用',
  'automations.proposals.reject': '拒绝',
  'automations.proposals.rejectReason': '在自动化中已忽略',
  'automations.proposals.target.memory': '记忆',
  'automations.proposals.target.designSystem': '设计系统',
  'automations.proposals.target.skill': '技能',
  'automations.proposals.target.template': '自动化模板',
  'automations.proposals.action.create': '创建',
  'automations.proposals.action.update': '更新',
  'automations.proposals.action.merge': '合并',
  'automations.proposals.action.move': '移动',
  'automations.proposals.action.delete': '删除',
  'automations.proposals.action.promote': '推送',

  'automations.templates.aria': '自动化模板',
  'automations.templates.title': '模板',
  'automations.templates.sub': 'Orbit 与实时制品都是同一自动化流程中的模板。',
  'automations.templates.filtersAria': '模板筛选',
  'automations.templates.countMeta': '{shown} / {total}',
  'automations.templates.emptyTitle': '此分类还没有模板。',
  'automations.templates.emptyHint': '试试其他筛选,或从空白自动化开始。',
  'automations.templates.useTemplate': '使用模板',
  'automations.templates.kind.orbit': 'Orbit',
  'automations.templates.kind.liveArtifact': '实时制品',
  'automations.templates.kind.automation': '自动化',
  'automations.templates.filter.all': '全部',
  'automations.templates.filter.orbit': 'Orbit',
  'automations.templates.filter.liveArtifact': '实时制品',
  'automations.templates.filter.memory': '记忆',
  'automations.templates.filter.designSystem': '设计系统',
  'automations.templates.filter.skills': '技能',
  'automations.templates.filter.connectors': '连接器',
  'automations.templates.filter.compression': '压缩',
  'automations.templates.filter.release': '发布',
  'automations.templates.filter.quality': '质量',

  'automations.static.memoryRefresh.title': '从近期工作刷新项目记忆。',
  'automations.static.memoryRefresh.description': '把反复出现的决定、偏好与反馈转化为可复用的记忆更新。',
  'automations.static.memoryRefresh.defaultName': '记忆刷新',
  'automations.static.designSystemRefresh.title': '从已交付的制品更新设计系统。',
  'automations.static.designSystemRefresh.description': '在近期设计工作中找出可复用的 token、组件与规则。',
  'automations.static.designSystemRefresh.defaultName': '设计系统维护者',
  'automations.static.liveArtifactRegistry.title': '审计实时制品并刷新陈旧版本。',
  'automations.static.liveArtifactRegistry.description': '保持持久化仪表盘、报告与预览处于最新,而不是重复创建。',
  'automations.static.liveArtifactRegistry.defaultName': '实时制品维护者',
  'automations.static.orbitDashboard.title': '构建连接器活动仪表盘。',
  'automations.static.orbitDashboard.description': '把选定的连接器聚合成 Orbit 风格的实时仪表盘。',
  'automations.static.orbitDashboard.defaultName': '连接器活动仪表盘',
  'automations.static.releaseNotes.title': '从交付的设计工作起草发布说明。',
  'automations.static.releaseNotes.description': '把合并的 PR、制品和面向产品的变更串联成发布说明。',
  'automations.static.releaseNotes.defaultName': '周发布说明',
  'automations.static.qualityRegressionWatch.title': '监控设计与实现回归。',
  'automations.static.qualityRegressionWatch.description': '把近期变更与基准、追踪与已接受的参考做对比。',
  'automations.static.qualityRegressionWatch.defaultName': '回归监控',

  'automations.fallback.orbitDaily.title': '每日连接器摘要。',
  'automations.fallback.orbitDaily.description': '按计划刷新连接器活动摘要。',
  'automations.fallback.orbitDaily.defaultName': '每日连接器摘要',
  'automations.fallback.liveStatusBoard.title': '保持实时状态制品最新。',
  'automations.fallback.liveStatusBoard.description': '更新一个持久制品,而不是每次都生成新报告。',
  'automations.fallback.liveStatusBoard.defaultName': '实时状态看板',

  'automations.modal.ariaEdit': '编辑自动化',
  'automations.modal.ariaNew': '新建自动化',
  'automations.modal.placeholderTitle': '自动化标题',
  'automations.modal.useTemplate': '使用模板',
  'automations.modal.close': '关闭 (Esc)',
  'automations.modal.promptPlaceholder': '告诉代理在此排程上执行什么,或用 @ 提及上下文...',
  'automations.modal.mention.aria': '自动化上下文结果',
  'automations.modal.mention.tabsAria': '上下文类型',
  'automations.modal.mention.tab.all': '全部',
  'automations.modal.mention.tab.skills': '技能',
  'automations.modal.mention.tab.plugins': '插件',
  'automations.modal.mention.tab.mcp': 'MCP',
  'automations.modal.mention.tab.connectors': '连接器',
  'automations.modal.mention.empty': '搜索技能、插件、MCP 服务器和连接器。',
  'automations.modal.mention.noResults': '没有匹配 "{query}" 的结果。',
  'automations.modal.mention.section.skills': '技能',
  'automations.modal.mention.section.plugins': '插件',
  'automations.modal.mention.section.mcp': 'MCP',
  'automations.modal.mention.section.connectors': '连接器',
  'automations.modal.selected.aria': '已选自动化上下文',
  'automations.modal.selected.remove': '移除 {label}',
  'automations.modal.selected.skill': '技能',
  'automations.modal.selected.plugin': '插件',
  'automations.modal.selected.mcp': 'MCP',
  'automations.modal.selected.connector': '连接器',
  'automations.modal.selected.connectorWith': '连接器 · {account}',
  'automations.modal.error.title': '请为这个自动化添加标题。',
  'automations.modal.error.prompt': '请为计划对话添加 prompt。',
  'automations.modal.cancel': '取消',
  'automations.modal.create': '创建',
  'automations.modal.creating': '创建中...',
  'automations.modal.save': '保存',
  'automations.modal.saving': '保存中...',
  'automations.modal.project.newEachRun': '每次运行新建项目',
  'automations.modal.project.newEachRunHint': '每次运行都开启一个新项目和对话。',
  'automations.modal.project.existing': '已有项目',
  'automations.modal.schedule.kind.hourly': '每小时',
  'automations.modal.schedule.kind.daily': '每天',
  'automations.modal.schedule.kind.weekdays': '工作日',
  'automations.modal.schedule.kind.weekly': '每周',
  'automations.modal.schedule.minute': '每小时的第几分',
  'automations.modal.schedule.time': '时间',
  'automations.modal.schedule.timezone': '时区',
  'automations.modal.schedule.weekdayAria': '星期',
  'automations.modal.schedule.done': '完成',
};
