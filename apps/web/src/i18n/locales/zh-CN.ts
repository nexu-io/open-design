...
export const zhCN: Dict = {
  ...
  'tasks.heading': '自动化',
  'tasks.eyebrow': '计划式智能体会话',
  'tasks.heroParagraph': '为项目工作、Orbit 摘要和实时制品规划定期对话。',
  'tasks.yourAutomations': '我的自动化',
  'tasks.empty.title': '暂无自动化',
  'tasks.empty.hint': '从模板创建一个，或从空白计划开始。',
  'tasks.ingestSource': '导入来源',
  'tasks.templates': '模板',
  'tasks.kicker': '自动化工作区',
