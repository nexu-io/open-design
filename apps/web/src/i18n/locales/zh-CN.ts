...
export const zhCN: Dict = {
  ...
  'ds.setupCompanyPlaceholder': '例如：Mission Impastabowl：一家快休闲意面餐厅，拥有店内触屏点餐、自有移动应用和网站',
  ...
  'ds.githubStatusCheckTimeout': '无法完成 GitHub 连接器检查。你仍然可以添加仓库 URL，或手动连接 GitHub。',
  ...
  'ds.githubAccessDescChecking': '正在后台检查连接器状态；URL 读取不会被阻塞。',
  ...
  'manualEdit.editableCount': '{count} 个可编辑项',
  ...
  'manualEdit.selectedHtml': '所选元素 HTML',
  'manualEdit.fullSource': '完整制品源码',
