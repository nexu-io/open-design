...
export const zhCN: Dict = {
  ...
  "settings.onboardingExecutionBody":
    "使用 Open Design 托管服务，也可以连接本地 Coding Agent，或使用自己的模型 Key。",
  "settings.onboardingAmrCloudBenefitOfficial": "官方推荐",
  "settings.onboardingAmrCloudBenefitReady": "免部署即用",
  "settings.onboardingAmrCloudBenefitModels": "使用 Open Design 额度调用 Claude、GPT、Fable 5 和 5.6 sol，限时优惠并支持高并发。",
  ...
  "settings.onboardingAmrModelSourceLabel": "Open Design 托管服务",
  ...
  "settings.onboardingLocalBody":
    "支持 Claude Code、Codex、Cursor、OpenCode、Kimi、Qwen、Hermes、Kiro 等本地 Agent。",
  ...
  "settings.onboardingByokBody": "使用自己的 API Key，安全连接你选择的模型服务商。",
