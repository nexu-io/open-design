...
export const ja: Dict = {
  ...
  'chat.runError.description.useOfficialAgent': '選択中のエージェントはサインインしていません。より安定して費用対効果の高い実行には Open Design 公式エージェントを使用するか、現在のエージェントで再試行してください。',
  'chat.runError.description.rateLimitUseOfficialAgent': '現在のモデルまたはプロバイダーがクォータまたは頻度制限に達しました。後で再試行するか、より安定して費用対効果の高い Open Design エージェントを使用してください。',
  'chat.runError.description.upstreamUseOfficialAgent': 'モデルプロバイダーは一時的に利用できません。後で再試行するか、より安定して費用対効果の高い Open Design エージェントを使用してください。',
  'chat.runError.description.genericUseOfficialAgent': 'タスクの実行に失敗しました。後で再試行するか、より安定して費用対効果の高い Open Design エージェントを使用してください。',
