...
export const ja: Dict = {
  ...
  'chat.dsExtractUser': "{source} からデザインシステムを抽出",
  'chat.dsExtractRunning': "デザインシステムを抽出しています…",
  'chat.dsExtractDone': "{name} を抽出しました — すべてのモジュールが準備できました。",
  'chat.dsNextStepsTitle': "次のステップ",
  'chat.dsMoreToggle': "その他の最適化",
  ...
  'ds.fullSystemLabel': '{name} の完全なシステム',
