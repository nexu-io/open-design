...
export const ja: Dict = {
  ...
  'settings.welcomeTitle': 'Wix Japan Slide Generator を設定',
  ...
  'fileViewer.googleSlidesOpen': 'Google Slides で編集 ↗',
  ...
  'fileViewer.googleSlidesMissingImages': '未配置の画像',
  'fileViewer.googleSlidesSideEffects': '既知の副作用',
