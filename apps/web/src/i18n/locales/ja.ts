...
export const ja: Dict = {
  ...
  'settings.mediaProviderConnectionConnected': "接続済み",
  'settings.mediaProviderConnectionDisconnected': "未接続",
  'settings.mediaProviderConnectionConnectedTitle': "ローカルの Codex CLI ログインは有効です",
  'settings.mediaProviderConnectionDisconnectedTitle': "ローカルの Codex CLI ログインが検出されませんでした",
  'settings.mediaProviderConnectionConnectedNote': "ローカルの Codex CLI ログインは有効です",
  'settings.mediaProviderConnectionDisconnectedNote': "このプロバイダーを使うにはローカルの Codex CLI でサインインしてください",
  ...
  'settings.projectLocationsManualPlaceholder': "フォルダパスを入力",
  'settings.projectLocationsBrowseFolders': "フォルダを参照",
  'settings.projectLocationsBrowserDialogLabel': "プロジェクトの場所を選択",
  'settings.projectLocationsBrowserTitle': "フォルダを選択",
  'settings.projectLocationsBrowserLoading': "フォルダを読み込み中...",
  'settings.projectLocationsBrowserParentFolder': "親フォルダ",
  'settings.projectLocationsBrowserUseFolder': "このフォルダを使用",
  'settings.projectLocationsBrowserLoadError': "フォルダを読み込めませんでした。フォルダパスを手動で入力してください。",
  'settings.projectLocationsBrowserEmpty': "子フォルダはありません。",
  ...
  'ds.contentsLabel': "目次",
  'ds.contentsAriaLabel': "デザインシステムの目次",
