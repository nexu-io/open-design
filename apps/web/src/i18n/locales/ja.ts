...
export const ja: Dict = {
  ...
  'settings.updatePreviewLabel': '更新プレビュー',
  'settings.updatePreviewActual': '実際の開発状態',
  'settings.updatePreviewIdle': '未確認',
  'settings.updatePreviewChecking': '確認中',
  'settings.updatePreviewUpToDate': '最新版',
  'settings.updatePreviewAvailable': '新バージョン',
  'settings.updatePreviewDownloading': 'ダウンロード中',
  'settings.updatePreviewDownloaded': 'インストール準備完了',
  'settings.updatePreviewInstalling': 'インストール中',
  'settings.updatePreviewError': '確認失敗',
  'settings.updatePreviewUnsupported': '非対応',
