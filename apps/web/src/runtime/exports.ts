...
export function buildDesignManifestContent(opts: {
  ...
  const title = opts.title || 'LeastGen Studio artifact';
...
- Keep generated product UI free of LeastGen Studio chrome, preview labels, or design-process annotations.
...
- Do not keep prototype-only annotations, frame labels, or LeastGen Studio chrome in the production UI.
