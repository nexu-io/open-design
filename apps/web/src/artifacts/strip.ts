...
// `PersistedArtifactFileRef`, `matchPersistedArtifactFile` and
// `summarizeArtifactsForTranscript` moved to `@open-design/contracts`
// (artifact-transcript.ts) so the daemon can summarize prior-turn artifacts
// exactly like this client does. Re-exported here for existing imports.
export {
