...
export function ProjectView({
  ...
  // Audio override (kept for unified runByokMediaChat path).
  ...
  // Live model option lists (same hooks the composer/Settings pickers use).
  ...
  // overrides it for that turn. Keyed on project.id so a manual mid-session
  // change is not clobbered until the user switches projects.
  useEffect(() => {
