...
const EDITORS: Record<string, EditorVisual> = {
  ...
  // Official Kiro mark — purple squircle app icon, see https://github.com/vscode-icons/vscode-icons/issues/3834
  kiro: { bg: '#ffffff', fg: '#8845f4', glyph: kiroLogo },
