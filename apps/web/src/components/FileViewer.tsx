...
function HtmlViewer({
  ...
  // once, so a mid-pass file change can't slip a fresh snapshot in. Cleared
  // on exit so `previewSource` falls back to the latest
  ...
  const previewSource =
    manualEditMode && manualEditFrozenSource !== null
  ...
  const srcDoc = useMemo(
    ...
    [editableSnapshotPreviewSource, effectiveDeck, projectId, file.name, previewStateKey],
  );
