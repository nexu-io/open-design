        ...
        <div className="plugins-home__overlay-actions">
          <div className="plugins-home__overlay-actions-main">
            <button
              ...
              aria-label={t('plugins.card.detailsAria', { title: record.title })}
            ...
            >
              ...
              >
                {isPending ? t('plugins.card.applying') : t('plugins.card.use')}
              </button>
              {hasQuery ? (
                <>
                  <button
                    ...
                    aria-label={t('plugins.card.chooseUseAria', { title: record.title })}
                  ...
                  {useMenuOpen ? (
                    <div
                      ...
                      role="menu"
                      aria-label={t('plugins.card.useOptionsAria', { title: record.title })}
                    >
                      <button
                        type="button"
                        role="menuitem"
          ...
          {onShareAction ? (
            <div
              ...
              aria-label={t('plugins.card.shareAria', { title: record.title })}
            >
              <button
                type="button"
                ...
                aria-label={t('plugins.card.publishAria', { title: record.title })}
                title={t('plugins.card.publishTitle')}
              ...
              >
                <Icon
                  ...
                  size={12}
                />
                <span>{sharePendingAction === 'publish-github' ? t('plugins.card.publishStarting') : t('plugins.card.publish')}</span>
              </button>
              <button
                type="button"
                className="plugins-home__action plugins-home__action--secondary plugins-home__action--compact"
                ...
                aria-label={t('plugins.card.contributeAria', { title: record.title })}
                title={t('plugins.card.contributeTitle')}
              ...
              >
                <Icon
                  ...
                  size={12}
                />
                <span>{sharePendingAction === 'contribute-open-design' ? t('plugins.card.contributeStarting') : t('plugins.card.contribute')}</span>
              </button>
            </div>
          ) : null}
        </div>
