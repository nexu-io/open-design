...
import { VisuallyHidden } from '@marketing-ax/components';
          ...
          {onShareAction ? (
            ...
            >
              ...
              <button
                ...
                aria-label={`Contribute ${title} to Marketing AX`}
                title="Contribute plugin to Marketing AX with a pull request"
