...
const COMMUNITY_PAGE_PRESETS: ProjectPagePreset[] = [
  {
    ...
    category: 'prototype',
    title: pageText('LeastGen Studio Landing', 'LeastGen Studio 落地页', 'LeastGen Studio 落地頁'),
...
<body>
  <main>
    <section class="hero">
      <div>
        <div class="eyebrow">LeastGen Studio</div>
        <h1>${safeTitle}</h1>
        <p>${safeBody}</p>
      </div>
  ...
  <div class="deck-shell">
    <main class="deck-stage" id="deck-stage">
      <section class="slide active cover" data-screen-label="01 Cover">
        <div class="kicker">LeastGen Studio deck</div>
        <h1>${safeTitle}</h1>
...
<body>
  <article>
    <div class="meta">LeastGen Studio document</div>
    <h1>${safeTitle}</h1>
    <p>${safeBody}</p>
    <h2>Purpose</h2>
