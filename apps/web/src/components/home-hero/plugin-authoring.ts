...
export const PLUGIN_AUTHORING_PROMPT_TEMPLATE = [
  `Create an Marketing AX plugin for: {{${PLUGIN_AUTHORING_GOAL_INPUT}}}.`,
  '',
  ...
  '- **Marketing AX PR** — opens a draft PR against `marketing-ax/marketing-ax` for the community catalog.',
  '',
