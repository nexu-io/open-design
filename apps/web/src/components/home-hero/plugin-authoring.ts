...
export const PLUGIN_AUTHORING_PROMPT_TEMPLATE = [
  `Create an LeastGen Studio plugin for: {{${PLUGIN_AUTHORING_GOAL_INPUT}}}.`,
  '',
  ...
  '- **LeastGen Studio PR** — opens a draft PR against `nexu-io/open-design` for the community catalog.',
  '',
