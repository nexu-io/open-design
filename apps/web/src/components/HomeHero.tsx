...
const HOME_PROMPT_EXAMPLES: Record<Locale, Record<string, string[]>> = {
  ...
  "hi": {
    prototype: [
      "एक AI CRM के लिए हाई-कन्वर्टिंग वेबसाइट डिज़ाइन करें — साफ़ हीरो, फ़ीचर कहानी, सबूत और ट्रायल CTA के साथ",
      "टीम नॉलेज बेस के लिए डेस्कटॉप डैशबोर्ड बनाएं — खोज, हाल के अपडेट, अनुमतियां और सहयोग एंट्री पॉइंट्स के साथ",
      "किसी फ़ाइनेंशियल SaaS प्रोडक्ट के लिए ऑनबोर्डिंग दोबारा डिज़ाइन करें ताकि नए यूज़र जल्दी डेटा कनेक्ट करें, सेटअप पूरा करें और पहली वैल्यू जल्दी देखें",
      "मोबाइल फ़िटनेस कोचिंग ऐप प्रोटोटाइप करें — लक्ष्य सेटअप, साप्ताहिक प्लान, वर्कआउट चेक-इन और प्रोग्रेस समीक्षा सहित",
    ],
    deck: [
      "प्रोडक्ट लॉन्च के लिए मार्केट अवसर पर शोध करें — प्रतिस्पर्धी, टारगेट यूज़र, प्राइसिंग परिकल्पना और लॉन्च नैरेटिव सहित",
      "साप्ताहिक टीम स्टेटस रिपोर्ट बनाएं — प्रोग्रेस, जोखिम, मेट्रिक बदलाव और अगले हफ़्ते की प्राथमिकताएं सहित",
      "इन्वेस्टर पिच डिज़ाइन करें — मार्केट साइज़िंग, ग्रोथ मॉडल, प्रोडक्ट एडवांटेज और तीन साल का फ़ोरकास्ट डेटा सहित",
      "रणनीतिक बिज़नेस रिव्यू डेक बनाएं — तिमाही परफ़ॉर्मेंस, मूल कारण, अवसर और अगले कदम सहित",
    ],
    image: [
      "ग्लासमोर्फ़िज्म AI वर्कस्पेस पोस्टर बनाएं — मल्टी-स्क्रीन सहयोग, सॉफ़्ट लाइटिंग और प्रीमियम लॉन्च मूड के साथ",
      "नई वायरलेस हेडफ़ोन के लिए ई-कॉमर्स हीरो इमेज बनाएं जो मटेरियल डिटेल, लाइफ़स्टाइल संदर्भ और मुख्य फ़ायदे उजागर करे",
      "मिनिमलिस्ट टेक लॉन्च की विज़ुअल डिज़ाइन करें — साफ़ कम्पोज़िशन, मज़बूत प्रोडक्ट फ़ोकस और संयमित लॉन्च कॉपी के साथ",
      "प्रोडक्ट ड्रॉप के लिए सोशल टीज़र सेट बनाएं — काउंटडाउन, क्लोज़-अप डिटेल, फ़ायदा रिवील और लॉन्च-डे विज़ुअल सहित",
    ],
    video: [
      "8-सेकंड का प्रोडक्ट रिवील फ़िल्म बनाएं जो सिल्हूएट से क्लोज़-अप डिटेल तक जाए और ब्रांड मार्क पर ख़त्म हो",
      "ऐप फ़ीचर डेमो वीडियो बनाएं जो यूज़र जर्नी, मुख्य स्टेट्स और फ़ाइनल आउटकम का अनुसरण करे",
      "शॉर्ट-फ़ॉर्म वीडियो के लिए वर्टिकल ब्रांड ओपनर बनाएं — तालबद्ध टाइपोग्राफ़ी, प्रोडक्ट क्लोज़-अप और साफ़ लोगो एंडिंग के साथ",
      "वेबसाइट को 15-सेकंड के सोशल ऐड में बदलें — हीरो क्लेम, इंटरैक्शन हाइलाइट और साफ़ CTA निकालकर",
    ],
    hyperframes: [
      "कैप्शन वाला प्रोडक्ट लॉन्श शॉर्ट बनाएं — टाइटल कार्ड, फ़ीचर शॉट, तालबद्ध ट्रांज़िशन और एंडिंग CTA के साथ",
      "ऑडियो-रिएक्टिव डेटा विज़ुअलाइज़ेशन बनाएं जहाँ बार, कण और टाइटल नैरेशन बीट्स पर प्रतिक्रिया करें",
      "3-सेकंड का लोगो आउट्रो बनाएं — लाइन कन्वर्जेंस, सूक्ष्म इलास्टिसिटी और ब्रांड कलर सिस्टम के साथ",
      "एनिमेटेड फ़्लाइट-रूट मैप बनाएं — शहर नोड्स, रूट ग्रोथ, माइलेज डेटा और फ़ाइनल समरी फ़्रेम दिखाते हुए",
    ],
    audio: [
      "प्रोडक्ट स्टार्टअप साउंड बनाएं जो हल्का, भरोसेमंद, हल्का फ़्यूचरिस्टिक लगे और डेस्कटॉप ऐप लॉन्च के लिए उपयुक्त हो",
      "20-सेकंड का पॉडकास्ट इंट्रो बेड बनाएं — गर्मजोशी भरा ओपनिंग, साफ़ पल्स और वॉइसओवर में स्मूद हैंडऑफ़ के साथ",
      "मेडिटेशन ऐप के लिए सीमलेस एम्बिएंट लूप बनाएं — सॉफ़्ट प्रकृति टेक्सचर, लो-फ़्रीक्वेंसी वार्मथ और शांत पेसिंग के साथ",
      "ब्रांडेड नोटिफ़िकेशन साउंड सेट बनाएं — सक्सेस, रिमाइंडर और एरर स्टेट्स के लिए, एक सोनिक आइडेंटिटी बनाए रखते हुए",
    ],
  },
};
