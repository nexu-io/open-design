...
const HOME_PROMPT_EXAMPLES: Record<Locale, Record<string, string[]>> = {
  ...
  "ta": {
    prototype: [
      "ஒரு AI CRM-க்கான ஹை-கன்வர்ட்டிங் வெப்சைட்டை வடிவமைக்கவும் - தெளிவான ஹீரோ, அம்சக் கதை, ஆதாரங்கள் மற்றும் ட்ரயல் CTA உடன்",
      "ஒரு டீம் நாலெட்ஜ் பேஸுக்கான டெஸ்க்டாப் டாஷ்போர்டை உருவாக்கவும் - சர்ச், சமீபத்திய அப்டேட்கள், அனுமதிகள் மற்றும் கொலாபரேஷன் என்ட்ரி பாயிண்ட்களுடன்",
      "ஒரு ஃபைனான்ஷியல் SaaS தயாரிப்புக்கான ஆன்போர்டிங்கை மறுவடிவமைப்பு செய்யவும், இதனால் புதிய பயனர்கள் டேட்டாவை கனெக்ட் செய்யலாம், செட்அப்பை முடிக்கலாம் மற்றும் முதல் மதிப்பை விரைவாகக் காணலாம்",
      "மொபைல் ஃபிட்னெஸ் கோச்சிங் ஆப்பை ப்ரோட்டோடைப் செய்யவும் - கோல் செட்அப், வாராந்திர திட்டங்கள், வொர்க்அவுட் செக்-இன்கள் மற்றும் ப்ராகிரஸ் ரிவ்யூவுடன்",
    ],
    deck: [
      "தயாரிப்பு லாஞ்சுக்கான சந்தை வாய்ப்பை ஆராயவும் - போட்டியாளர்கள், டார்கெட் பயனர்கள், விலை நிர்ணய கருதுகோள்கள் மற்றும் லாஞ்ச் நெறிமுறையுடன்",
      "ப்ராகிரஸ், ரிஸ்க்குகள், மெட்ரிக் மாற்றங்கள் மற்றும் அடுத்த வார முன்னுரிமைகளுடன் வாராந்திர டீம் ஸ்டேட்டஸ் அறிக்கையை உருவாக்கவும்",
      "மார்க்கெட் சைசிங், க்ரோத் மாடல், தயாரிப்பு அட்வான்டேஜ் மற்றும் மூன்றாண்டு ஃபோர்காஸ்ட் டேட்டாவுடன் இன்வெஸ்டர் பிட்ச்சை வடிவமைக்கவும்",
      "க்வார்டர்லி செயல்திறன், ரூட் காரணங்கள், வாய்ப்புகள் மற்றும் அடுத்த செயல்களை உள்ளடக்கிய ஸ்ட்ராடஜிக் பிசினஸ் ரிவ்யூ டெக்கை உருவாக்கவும்",
    ],
    image: [
      "மல்டி-ஸ்கிரீன் கொலாபரேஷன், சாஃப்ட் லைட்டிங் மற்றும் ப்ரீமியம் லாஞ்ச் மூடுடன் கூடிய கிளாஸ்மார்ஃபிசம் AI வொர்க்ஸ்பேஸ் போஸ்டரை உருவாக்கவும்",
      "மெட்டீரியல் விவரம், லைஃப்ஸ்டைல் சூழல் மற்றும் முக்கிய நன்மைகளை முன்னிலைப்படுத்தும் புதிய வயர்லெஸ் ஹெட்ஃபோன்களுக்கான இ-காமர்ஸ் ஹீரோ இமேஜ்களை உருவாக்கவும்",
      "க்ளீன் கம்போசிஷன், வலுவான தயாரிப்பு ஃபோகஸ் மற்றும் கட்டுப்படுத்தப்பட்ட லாஞ்ச் காப்பியுடன் மினிமலிஸ்ட் டெக் லாஞ்ச் கீ விஷுவலை வடிவமைக்கவும்",
      "கவுண்டவுன், க்ளோஸ்-அப் விவரம், நன்மை வெளிப்பாடு மற்றும் லாஞ்ச்-டே விஷுவலுடன் தயாரிப்பு ட்ராப்புக்கான சோஷல் டீஸர் செட்டை உருவாக்கவும்",
    ],
    video: [
      "சில்ஹோயெட்டிலிருந்து க்ளோஸ்-அப் விவரத்திற்கு நகர்ந்து பிராண்ட் மார்க்கில் முடியும் 8-விநாடி தயாரிப்பு ரிவீல் ஃபில்மை உருவாக்கவும்",
      "பயனர் ஜர்னி, கீ ஸ்டேட்கள் மற்றும் ஃபைனல் அவுட்கமைப் பின்பற்றும் ஆப் ஃபீச்சர் டெமோ வீடியோவை உருவாக்கவும்",
      "ரித்மிக் டைப்போகிரஃபி, தயாரிப்பு க்ளோஸ்-அப்கள் மற்றும் க்ளீன் லோகோ என்டிங்குடன் ஷார்ட்-ஃபார்ம் வீடியோவுக்கான வெர்டிகல் பிராண்ட் ஓப்பனரை உருவாக்கவும்",
      "ஹீரோ க்ளெய்ம், இன்டராக்ஷன் ஹைலைட்கள் மற்றும் க்ளியர் CTA-வை வெளியெடுத்து வெப்சைட்டை 15-விநாடி சோஷல் ஆடாக மாற்றவும்",
    ],
    hyperframes: [
      "டைட்டில் கார்டுகள், ஃபீச்சர் ஷாட்கள், ரித்மிக் ட்ரான்சிஷன்கள் மற்றும் என்டிங் CTA உடன் கேப்ஷன் செய்யப்பட்ட தயாரிப்பு லாஞ்ச் ஷார்ட்டை உருவாக்கவும்",
      "பார்கள், பார்டிகிள்கள் மற்றும் டைட்டில்கள் நரேஷன் பீட்களுக்கு பதிலளிக்கும் ஆடியோ-ரியாக்டிவ் டேட்டா விஷுவலைசேஷனை உருவாக்கவும்",
      "லைன் கன்வர்ஜென்ஸ், சூட்டில் எலாஸ்டிசிட்டி மற்றும் பிராண்ட் கலர் சிஸ்டத்தைப் பயன்படுத்தி 3-விநாடி லோகோ அவுட்ரோவை உருவாக்கவும்",
      "சிட்டி நோட்கள், ரூட் க்ரோத், மைலேஜ் டேட்டா மற்றும் ஃபைனல் சம்மரி ஃப்ரேமைக் காட்டும் அனிமேட்டட் ஃப்ளைட்-ரூட் மேப்பை உருவாக்கவும்",
    ],
    audio: [
      "லேசாக, நம்பகமானதாக, லேசாக ஃப்யூச்சுரிஸ்டிக்காக இருக்கும் மற்றும் டெஸ்க்டாப் ஆப் லாஞ்சுக்கு ஏற்ற தயாரிப்பு ஸ்டார்ட்அப் சவுண்டை உருவாக்கவும்",
      "வார்ம் ஓப்பனிங், க்ளியர் பல்ஸ் மற்றும் வாய்ஸ்ஓவருக்குள் க்ளீன் ஹேண்டாஃப் உடன் 20-விநாடி பாட்காஸ்ட் இன்ட்ரோ பெட்டை உருவாக்கவும்",
      "சாஃப்ட் நேச்சர் டெக்ஸ்ச்சர்கள், லோ-ஃப்ரீக்வென்சி வார்ம்த் மற்றும் காம் பேசிங் ஆகியவற்றைப் பயன்படுத்தி மெடிடேஷன் ஆப்புக்கான சீம்லெஸ் அம்பியன்ட் லூப்பை உருவாக்கவும்",
      "சக்ஸஸ், ரிமைண்டர் மற்றும் எர்ரர் ஸ்டேட்களுக்கான, ஒரே சோனிக் ஐடென்டிட்டியைத் தக்கவைத்துக்கொண்டு பிராண்டட் நோட்டிஃபிகேஷன் சவுண்ட் செட்டை உருவாக்கவும்",
    ],
  },
};
