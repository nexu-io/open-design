...
const HOME_PROMPT_EXAMPLES: Record<Locale, Record<string, string[]>> = {
  ...
  "te": {
    prototype: [
      "ఒక AI CRM కోసం హై-కన్వర్టింగ్ వెబ్‌సైట్‌ను డిజైన్ చేయండి - స్పష్టమైన హీరో, ఫీచర్ కథ, ఆధారాలు మరియు ట్రయల్ CTAతో",
      "టీమ్ నాలెడ్జ్ బేస్ కోసం డెస్క్‌టాప్ డ్యాష్‌బోర్డ్‌ను సృష్టించండి - సెర్చ్, ఇటీవలి అప్‌డేట్‌లు, అనుమతులు మరియు కొలాబరేషన్ ఎంట్రీ పాయింట్‌లతో",
      "ఒక ఫైనాన్షియల్ SaaS ప్రొడక్ట్ కోసం ఆన్‌బోర్డింగ్‌ను తిరిగి డిజైన్ చేయండి, తద్వారా కొత్త యూజర్లు డేటా కనెక్ట్ చేయగలరు, సెటప్ పూర్తి చేయగలరు మరియు మొదటి విలువను త్వరగా చూడగలరు",
      "మొబైల్ ఫిట్‌నెస్ కోచింగ్ యాప్‌ను ప్రోటోటైప్ చేయండి - గోల్ సెటప్, వారపు ప్లాన్‌లు, వర్కౌట్ చెక్-ఇన్‌లు మరియు ప్రోగ్రెస్ రివ్యూతో",
    ],
    deck: [
      "ప్రొడక్ట్ లాంచ్ కోసం మార్కెట్ అవకాశాన్ని రీసెర్చ్ చేయండి - కాంపిటీటర్లు, టార్గెట్ యూజర్లు, ప్రైసింగ్ అంచనాలు మరియు లాంచ్ నారేటివ్‌తో",
      "ప్రోగ్రెస్, రిస్క్‌లు, మెట్రిక్ మార్పులు మరియు వచ్చే వారం ప్రాధాన్యతలతో వారపు టీమ్ స్టేటస్ రిపోర్ట్‌ను సృష్టించండి",
      "మార్కెట్ సైజింగ్, గ్రోత్ మోడల్, ప్రొడక్ట్ అడ్వాంటేజ్ మరియు మూడేళ్ల ఫోర్‌కాస్ట్ డేటాతో ఇన్వెస్టర్ పిచ్‌ను డిజైన్ చేయండి",
      "క్వార్టర్లీ పెర్ఫార్మెన్స్, రూట్ కాజ్‌లు, అవకాశాలు మరియు తదుపరి చర్యలను కవర్ చేస్తూ స్ట్రాటజిక్ బిజినెస్ రివ్యూ డెక్‌ను సృష్టించండి",
    ],
    image: [
      "మల్టీ-స్క్రీన్ కొలాబరేషన్, సాఫ్ట్ లైటింగ్ మరియు ప్రీమియం లాంచ్ మూడ్‌తో గ్లాస్‌మోర్ఫిజం AI వర్క్‌స్పేస్ పోస్టర్‌ను సృష్టించండి",
      "మెటీరియల్ వివరం, లైఫ్‌స్టైల్ సందర్భం మరియు ముఖ్య ప్రయోజనాలను హైలైట్ చేస్తూ కొత్త వైర్‌లెస్ హెడ్‌ఫోన్‌ల కోసం ఇ-కామర్స్ హీరో ఇమేజ్‌ను సృష్టించండి",
      "క్లీన్ కంపోజిషన్, బలమైన ప్రొడక్ట్ ఫోకస్ మరియు నియంత్రిత లాంచ్ కాపీతో మినిమలిస్ట్ టెక్ లాంచ్ కీ విజువల్‌ను డిజైన్ చేయండి",
      "కౌంట్‌డౌన్, క్లోజ్-అప్ వివరం, ప్రయోజనం వెల్లడి మరియు లాంచ్-డే విజువల్‌తో ప్రొడక్ట్ డ్రాప్ కోసం సోషల్ టీజర్ సెట్‌ను సృష్టించండి",
    ],
    video: [
      "సిల్యూయెట్ నుండి క్లోజ్-అప్ వివరానికి వెళ్లి బ్రాండ్ మార్క్‌పై ముగిసే 8-సెకన్ల ప్రొడక్ట్ రివీల్ ఫిల్మ్‌ను సృష్టించండి",
      "యూజర్ జర్నీ, కీ స్టేట్స్ మరియు ఫైనల్ అవుట్‌కమ్‌ను అనుసరిస్తూ యాప్ ఫీచర్ డెమో వీడియోను సృష్టించండి",
      "రిథమిక్ టైపోగ్రఫీ, ప్రొడక్ట్ క్లోజ్-అప్‌లు మరియు క్లీన్ లోగో ఎండింగ్‌తో షార్ట్-ఫారమ్ వీడియో కోసం వర్టికల్ బ్రాండ్ ఓపనర్‌ను సృష్టించండి",
      "హీరో క్లెయిమ్, ఇంటరాక్షన్ హైలైట్‌లు మరియు క్లియర్ CTAను బయటకు తీస్తూ వెబ్‌సైట్‌ను 15-సెకన్ల సోషల్ యాడ్‌గా మార్చండి",
    ],
    hyperframes: [
      "టైటిల్ కార్డ్‌లు, ఫీచర్ షాట్లు, రిథమిక్ ట్రాన్సిషన్లు మరియు ఎండింగ్ CTAతో క్యాప్షన్‌తో కూడిన ప్రొడక్ట్ లాంచ్ షార్ట్‌ను సృష్టించండి",
      "బార్‌లు, పార్టికల్స్ మరియు టైటిల్స్ నరేషన్ బీట్స్‌కు స్పందించేలా ఆడియో-రియాక్టివ్ డేటా విజువలైజేషన్‌ను సృష్టించండి",
      "లైన్ కన్వర్జెన్స్, సూక్ష్మ ఎలాస్టిసిటీ మరియు బ్రాండ్ కలర్ సిస్టమ్‌తో 3-సెకన్ల లోగో అవుట్రోను సృష్టించండి",
      "సిటీ నోడ్‌లు, రూట్ గ్రోత్, మైలేజీ డేటా మరియు ఫైనల్ సమ్మరీ ఫ్రేమ్‌ను చూపించే యానిమేటెడ్ ఫ్లైట్-రూట్ మ్యాప్‌ను సృష్టించండి",
    ],
    audio: [
      "తేలికగా, నమ్మదగినది, కొద్దిగా ఫ్యూచరిస్టిక్‌గా ఉండి డెస్క్‌టాప్ యాప్ లాంచ్‌కు అనుకూలంగా ఉండే ప్రొడక్ట్ స్టార్టప్ సౌండ్‌ను సృష్టించండి",
      "వార్మ్ ఓపెనింగ్, క్లియర్ పల్స్ మరియు వాయిస్‌ఓవర్‌లోకి క్లీన్ హ్యాండాఫ్‌తో 20-సెకన్ల పాడ్‌కాస్ట్ ఇంట్రో బెడ్‌ను సృష్టించండి",
      "సాఫ్ట్ నేచుర్ టెక్స్చర్లు, లో-ఫ్రీక్వెన్సీ వార్మ్త్ మరియు ప్రశాంత పేసింగ్‌తో మెడిటేషన్ యాప్ కోసం సీమ్‌లెస్ ఎంబియంట్ లూప్‌ను సృష్టించండి",
      "సక్సెస్, రిమైండర్ మరియు ఎర్రర్ స్టేట్స్ కోసం, ఒకే సోనిక్ ఐడెంటిటీని నిలుపుకుంటూ బ్రాండెడ్ నోటిఫికేషన్ సౌండ్ సెట్‌ను సృష్టించండి",
    ],
  },
};
