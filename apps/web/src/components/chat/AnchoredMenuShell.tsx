 ...
 * ## 位置修正
 *
 * 分享菜单的工具栏与产物卡入口都传入各自的按钮锚点；两者都经 body portal
 * 脱离裁切容器。包裹盒随按钮定位并承载横向偏移，菜单保留既有 CSS。
 * 未传锚点的其他调用方仍可原地渲染，横向偏移落在菜单的 transform 上。
 *
 * ## 锚点看不见了就收起来
 *
...
export function AnchoredMenuShell({
  ...
  /** 锚点 ID = body portal；null = 原地渲染，供未锚定的其他调用方使用。 */
