...
import { notifyCompletionFeedbackGesture } from './host-api';
...
import { DEFAULT_UNSELECTED_SCENARIO_PLUGIN_ID } from './contracts';
import type {
  ContextItem,
...
import type { LibraryAsset, LibraryElementMeta } from './contracts';
import {
...
import {
  ...
  type CaretRect,
} from './components/composer/LexicalComposerInput';
...
import { QuotedRefs } from '../QuotedRefs';
          ...
          */}
          ...
          <div className="composer-row">
            ...
            <ComposerPlusMenu
              ...
              onImportFigma={projectId ? () => setFigmaModalOpen(true) : undefined}
            />
