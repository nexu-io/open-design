import { Icon as LegacyIcon, type IconName as LegacyIconName } from '../../../Icon';
...
const REMIX_ICON: Partial<Record<MainIconName, string>> = {
 ...
 */
function MainIcon({ name, size = 14, strokeWidth = 1.6, ...rest }: Props) {
...
export type IconName = MainIconName | LegacyIconName;
const mainIconNames = new Set<string>(["alert-triangle", "arrow-left", "arrow-up", "arrow-up-fill", "artboard", "attach", "bar-chart-box", "bell", "blocks", "brain", "check", "chevron-down", "chevron-left", "chevron-right", "close", "copy", "crop", "comment", "dashboard", "discord", "download", "draw", "edit", "external-link", "eye", "eye-off", "file", "file-code", "file-text", "folder", "folder-filled", "fork", "github", "github-filled", "grip-vertical", "magic", "headset", "grid-4", "grid", "globe", "hammer", "help-circle", "history", "home", "home-filled", "image", "import", "info", "kanban", "key", "layers-filled", "languages", "layout", "lightbulb", "arrow-right", "link", "lock", "mail", "log-in", "log-out", "integrations-filled", "maximize", "mic", "minimize", "minus", "more-horizontal", "orbit", "paint-bucket", "panel-left", "palette", "palette-filled", "pencil", "plus", "plus-filled", "puzzle", "slides", "star", "swatchbook", "pause", "play", "present", "refresh", "reload", "robot", "search", "send", "settings", "share", "sliders", "smartphone", "spinner", "sparkles", "stop", "sun", "moon", "sun-moon", "terminal", "thumbs-down", "thumbs-up", "translate", "tweaks", "undo", "redo", "upload", "users", "trash", "video-ai", "volume", "zoom-in", "zoom-out"]);
export function Icon(props: Omit<Props, 'name'> & {name: IconName}) {
  if (mainIconNames.has(props.name)) return <MainIcon {...props} name={props.name as MainIconName} />;
  return <LegacyIcon {...props} name={props.name as LegacyIconName} />;
}
