...
import { ChatPlusIcon } from '../../primitives/icons';
  ...
  return (
    <div className="plus-menu" ref={rootRef}>
      ...
      {open && typeof document !== 'undefined' ? createPortal(
        <div
          ref={popupRef}
          {...chatSeam(`plus-menu__popup plus-menu__popup--flyout-${flyoutPlacement} plus-menu__popup--flyout-y-${flyoutVerticalPlacement}`)}
          role="menu"
          style={popupStyle}
        >
          <button
