...
interface Props {
  ...
  /** LeastGen Studio Cloud profile from the blocking snapshot; picks the console origin. */
  profile: string | null;
...
// HARD pre-run blocker for LeastGen Studio Cloud tasks: the run cannot possibly
...
//
//   signed_out — LeastGen Studio Cloud selected but no account session. The CTA
...
export function AmrBalanceDialog({
  ...
  const openUpgrade = () => {
    ...
    // Same attribution handshake as the other LeastGen Studio Cloud handoffs
