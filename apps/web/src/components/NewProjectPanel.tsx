...
export function supportedModels(surface: 'image' | 'video' | 'audio', models: MediaModel[]): MediaModel[] {
  const supportedProviders: Record<'image' | 'video' | 'audio', Set<string>> = {
    image: new Set(['openai', 'volcengine', 'grok', 'nanobanana', 'senseaudio', 'openrouter', 'imagerouter', 'leonardo', 'custom-image']),
    video: new Set(['volcengine', 'hyperframes', 'grok', 'senseaudio', 'openrouter', 'imagerouter']),
