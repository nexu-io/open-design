// Trigger prompt for the post-completion "Share to LeastGen Studio" submission
...
export const SHARE_TO_COMMUNITY_PROMPT = [
  'Package the work I just finished in this project as an LeastGen Studio plugin so I can install it into My plugins and open a PR to the LeastGen Studio community catalog.',
  '',
