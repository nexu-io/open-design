...
interface Props {
  ...
  // BYOK media-model pickers shown above the textarea: image / video / audio
  // model the chat's generate_* tools default to. Hidden when the active chat
  // protocol does not inject media tools. Per-session state owned by
  // ProjectView (reset on refresh); ChatComposer renders fully controlled
