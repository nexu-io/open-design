...
interface Props {
  ...
  /** LeastGen Studio Cloud profile from the warning snapshot; picks the console origin. */
  profile: string | null;
...
// SOFT pre-run reminder for LeastGen Studio Cloud tasks: the balance can still
