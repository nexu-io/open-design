...
| `DesignSignatureStrip.module.css` | Component-owned styles. Easing: `cubic-bezier(0.23, 1, 0.32, 1)`. Expand ~200 ms, collapse ~140 ms. Uses `.accordion-collapsible` + `.accordion-collapsible-inner` canonical pair. |
