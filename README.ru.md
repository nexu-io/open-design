...
<p align="center">
  ...
  <a href="#системы-дизайна"><img alt="Design systems" src="https://img.shields.io/badge/design%20systems-152-orange?style=flat-square" /></a>
  <a href="#навыки"><img alt="Skills" src="https://img.shields.io/badge/skills-134-teal?style=flat-square" /></a>
...
<td width="50%">
<img src="docs/screenshots/06-design-systems-library.png" alt="06 · Библиотека из 152 систем" /><br/>
<sub><b>Библиотека из 152 систем</b> — каждая продуктовая система показывает свою 4-цветную сигнатуру. По клику открываются полные <code>DESIGN.md</code>, сетка swatch’ей и live showcase.</sub>
</td>
</tr>
<tr>
<td width="50%">
...
**134 навык поставляется из коробки.** Каждый — это папка в [`skills/`](skills/), следующая Claude Code-конвенции [`SKILL.md`][skill] с расширенным `od:` frontmatter, который демон парсит как есть: `mode`, `platform`, `scenario`, `preview.type`, `design_system.requires`, `default_for`, `featured`, `fidelity`, `speaker_notes`, `animations`, `example_prompt` ([`apps/daemon/src/skills.ts`](apps/daemon/src/skills.ts)).
...
2. Загружаются 134 skill + 152 design systems.
...
│
├── design-systems/                ← 152 системы DESIGN.md
...
<p align="center">
  <img src="docs/assets/design-systems-library.png" alt="Библиотека из 152 design systems — разворот style guide" width="100%" />
</p>

152 системы из коробки, каждая — один файл [`DESIGN.md`](design-systems/README.md):
...
- **Шаблоны, сохранённые пользователем.** Когда вам нравится результат, `POST /api/templates` делает snapshot HTML и metadata в SQLite-таблицу `templates`. В следующем проекте он появляется в строке «your templates» внутри picker’а — в том же surface, что и встроенные 134 skill, только уже ваш.
...
- [x] 134 skill + 152 design systems + 5 visual directions + 5 device frames
