...
> ⚠️ **OBSOLETE (2026-06-23)** — M-AX 아키텍처 결정 "단일 마케팅 제품"으로 이 문서의 전제(engine/brain 물리분리 + BrainProvider DI)는 폐기됨. 두뇌 1개라 도메인무관 추상화는 YAGNI. P1은 `startChatRun` 정리 리팩터로 축소. **두 번째 버티컬 등장 시 참고용으로만 보관.** 근거: `DECISIONS.md` 2026-06-23, `FORK-DELTA.md §7`.
