...
> **존치 확정 (2026-07-14)**: 구 존치 보류(2026-07-13, 보드 25핀 0핀)는 139핀
> 재분석으로 해제 — 풀블리드 비주얼 카드 계열 ~40핀, scene 모드가 오버레이형
> (visual-layout-patterns.md §1-b)의 생성 경로다. layer와 동급 선택지.
> 미니멀 씬 미학(추상 컬러 필드, 환경 묘사 금지)은 불변 — 생성 씬 한정 가드레일.
