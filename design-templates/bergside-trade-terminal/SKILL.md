...
en_name: "Trading Terminal Dashboard"
zh_name: "交易终端仪表盘"
...
zh_description: "黑客帝国风深色交易终端仪表盘：Space Mono 等宽字、密集数据表、红绿价格语义、单一绿色交互强调。"
triggers:
  - "trading dashboard"
  - "trading terminal"
  - "crypto dashboard"
...
od:
  ...
  design_system:
    requires: false
  example_prompt: "Build a dark terminal-style trading dashboard: watchlist with sparklines, live price chart, open orders, order book with depth bars, and a recent-trades tape."
---
