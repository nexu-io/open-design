...
zh_description: "暖色黏土风宠物科技移动端首页：厚边框卡片、偏移黏土阴影、Fredoka 圆体、橙色调。"
triggers:
  - "pet app"
  - "pet care"
  - "cute app"
...
od:
  ...
  design_system:
    requires: false
  example_prompt: "Design a cute pet-care mobile app home screen with a pet profile hero card, daily quick actions, an activity timeline, and a bottom tab bar."
---
# Pet Care Mobile App
