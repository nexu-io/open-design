...
zh_description: "克制的浅色 SaaS 设置控制台：软蓝强调、左侧栏、3 个 KPI 卡、带帮助和错误文案的表单、任务状态表，12 栏网格。"
triggers:
  - "admin console"
  - "settings console"
  - "saas admin"
...
od:
  ...
  design_system:
    requires: false
  example_prompt: "Build a calm SaaS admin settings console: sidebar navigation, KPI cards, a notification settings form, and a job status table."
---
