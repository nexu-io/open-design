...
en_name: "Writing Quality Review"
zh_name: "写作质量评审"
...
zh_description: "编辑评审表，按优先级列出问题、保留优点，并给出具体的替换草稿。"
triggers:
  - "writing review"
  - "editorial review"
  - "proofread"
...
od:
  ...
  design_system:
    requires: false
  example_prompt: "Review this draft: prioritized findings, what to keep, and a concrete replacement draft."
license: "MIT"
metadata:
  author: "Open Design"
  version: "0.1.0"
