...
en_name: "High-Conversion Landing Page"
zh_name: "高转化落地页"
...
zh_description: "高转化单一 offer 落地页：结果型标题、单一 CTA、主张旁放证据、3 步流程、FAQ 处理异议、风险逆转。"
triggers:
  - "high converting"
  - "conversion landing"
  - "single offer"
...
od:
  ...
  design_system:
    requires: false
  example_prompt: "Create a high-converting landing page for a reporting automation SaaS: one offer, one CTA, proof, FAQ, risk reversal."
---
