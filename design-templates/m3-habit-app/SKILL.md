---
name: "m3-habit-app"
en_name: "Material 3 Habit Tracker"
zh_name: "Material 3 习惯打卡 App"
...
zh_description: "Material Design 3 移动端习惯打卡首页：绿色种子配色、顶部应用栏、连续打卡卡片、复选框习惯列表、色调 FAB、底部导航。"
triggers:
  - "material design"
  - "material you"
  - "md3"
...
od:
  ...
  design_system:
    requires: false
  example_prompt: "Design a Material 3 Android habit-tracker home screen: streak card, habit checklist, FAB, and bottom navigation in a phone frame."
---
