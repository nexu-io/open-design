...
zh_description: "单页决策备忘录，建议、证据、选项权衡、控制措施和下一步动作一眼可扫。"
triggers:
  - "decision memo"
  - "memo"
  - "recommendation memo"
...
od:
  ...
  design_system:
    requires: false
  example_prompt: "Write a one-page decision memo: recommendation, evidence, option trade-offs, controls, and next action."
license: "MIT"
metadata:
  author: "Open Design"
  version: "0.1.0"
