...
en_name: "Artisan Local-Business Page"
zh_name: "手工艺商家页面"
...
zh_description: "本地手工艺商家的暖纸衬线编辑页：年鉴刊头、双栏规线目录、线描 SVG 图标、斜体描述、双线分区框。"
triggers:
  - "local business page"
  - "artisan"
  - "coffee roaster"
...
od:
  ...
  design_system:
    requires: false
  example_prompt: "Build a warm serif editorial page for a local coffee roasting studio: almanac masthead, two-column menu catalogue with line-art icons and prices, and a visit section."
---
