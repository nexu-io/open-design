...
en_name: "Healthcare Analytics Dashboard"
zh_name: "医疗分析仪表盘"
...
zh_description: "浅色临床分析仪表盘：侧栏、KPI 卡、内联 SVG 折线和环形图、记录表、日程栏。"
triggers:
...
od:
  ...
  design_system:
    requires: false
  example_prompt: "Build a hospital operations dashboard with KPI cards, an admissions trend chart, a department donut chart, a recent-patients table, and today's schedule."
---
