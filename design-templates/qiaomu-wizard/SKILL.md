...
zh_description: "浅色暖纸多步预订向导：步骤指示器、内联校验、复核步骤、成功态。"
triggers:
  - "wizard"
  - "multi-step form"
  - "booking flow"
...
od:
  ...
  design_system:
    requires: false
  example_prompt: "Build a three-step flight booking wizard: pick a flight, enter passenger details with validation, confirm payment, then show a success state."
---
# Booking Wizard
