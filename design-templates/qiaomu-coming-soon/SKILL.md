---
name: "qiaomu-coming-soon"
en_name: "Coming Soon Page"
zh_name: "即将上线页"
...
zh_description: "电影感太空航行「即将上线」页：星空、旋转坐标环、发射倒计时、邮箱等候 CTA。"
triggers:
  - "coming soon"
  - "waitlist page"
  - "launch countdown"
...
od:
  ...
  design_system:
    requires: false
  example_prompt: "Design a coming-soon page for a product launch: space voyage theme, launch countdown, and an email waitlist signup."
---
# Coming Soon Page
