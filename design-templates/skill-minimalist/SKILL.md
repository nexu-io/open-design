...
en_name: "Editorial Minimalist Product Page"
zh_name: "极简编辑风产品页"
...
zh_description: "高端实用极简：暖单色、衬线与无衬线对比、扁平 bento 网格、柔和粉彩强调、近零阴影。"
triggers:
  - "minimalist"
...
od:
  ...
  design_system:
    requires: false
  example_prompt: "Design a quiet editorial-minimal product page for a research notes app: serif hero, bento grid, no gradients."
---
