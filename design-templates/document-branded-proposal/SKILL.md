...
zh_description: "结构化合作伙伴提案，涵盖建议、方法、范围、治理和交付安排，品牌化版式。"
triggers:
  - "proposal"
  - "partner proposal"
  - "pilot proposal"
...
od:
  ...
  design_system:
    requires: false
  example_prompt: "Turn my pilot outline into a branded partner proposal covering recommendation, approach, scope, governance, and delivery."
license: "MIT"
metadata:
  author: "Open Design"
  version: "0.1.0"
