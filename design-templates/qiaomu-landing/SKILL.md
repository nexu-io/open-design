...
zh_description: "深色 Linear 风 SaaS 落地页：分割 hero、分层产品 mockup、功能网格、定价、客户评价。"
triggers:
  - "saas landing page"
  - "dark landing"
  - "linear style"
...
od:
  ...
  design_system:
    requires: false
  example_prompt: "Build a dark landing page for an AI meeting-notes SaaS: split hero with product mockup, feature grid, pricing tiers, and testimonials."
---
