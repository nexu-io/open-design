...
en_name: "Craft-First SaaS Dashboard"
zh_name: "工艺优先 SaaS 仪表盘"
...
zh_description: "工艺优先的产品 UI，适合仪表盘、后台、SaaS 应用：明确层级、细腻表面分层、领域派生配色，拒绝通用指标框模板。"
triggers:
  - "saas dashboard"
  - "admin panel"
  - "product ui"
...
od:
  ...
  design_system:
    requires: false
  example_prompt: "Design a dark ops dashboard for a solar fleet monitoring SaaS with a clear focal metric and quiet layered surfaces."
---
