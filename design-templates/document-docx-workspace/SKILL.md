...
od:
  ...
  design_system:
    requires: false
  example_prompt: "Build an editable DOCX update from these source notes: decision-ready structure, headings, and tracked open items."
license: "MIT"
metadata:
  author: "Open Design"
  version: "0.1.0"
