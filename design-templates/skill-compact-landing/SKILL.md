...
en_name: "Compact Premium Landing"
zh_name: "紧凑高端落地页"
...
zh_description: "紧凑高端落地页：窄版心、安静排版、微小触感控件、产品原生签名元素、清晰 CTA 层级、零布局偏移。"
triggers:
  - "compact landing"
  - "minimal landing"
  - "narrow column"
...
od:
  ...
  design_system:
    requires: false
  example_prompt: "Build a compact premium landing page for a webhook delivery tool: narrow column, quiet type, one clear CTA."
---
