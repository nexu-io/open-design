...
en_name: "Material 3 Ops Dashboard"
zh_name: "Material 3 运维仪表盘"
...
zh_description: "Material Design 3 运营仪表盘：色调分层表面、导航栏、填充和色调按钮、状态卡、事件时间线、SVG 资源环，M3 基线紫配色。"
triggers:
  - "material dashboard"
  - "md3 dashboard"
  - "ops dashboard"
...
od:
  ...
  design_system:
    requires: false
  example_prompt: "Build a Material Design 3 operations dashboard: navigation rail, tonal service status cards, incident timeline, and resource usage rings."
---
